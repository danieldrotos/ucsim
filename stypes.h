...
enum cpu_type {
  ...
  CPU_STM8S		= 0x0001,
  // Devices of S serie 0x00 00 00 XX
  DEV_STM8S903		= 0x00000001,
  DEV_STM8S003		= 0x00000002,
  DEV_STM8S005		= 0x00000003,
  DEV_STM8S007		= 0x00000004,
  DEV_STM8S103		= 0x00000005,
  DEV_STM8S105		= 0x00000006,
  DEV_STM8S207		= 0x00000007,
  DEV_STM8S208		= 0x00000008,
  // Devices of AF serie 0x00 00 XX 00
  
  CPU_STM8L		= 0x0002,
  // Devices of AL serie 0x00 XX 00 00

  // Devices of L serie 0xXX 00 00 00
  DEV_STM8L051		= 0x01000000,
  DEV_STM8L052C		= 0x02000000,
  DEV_STM8L052R		= 0x03000000,
  DEV_STM8L151x23	= 0x04000000,
  DEV_STM8L15x46	= 0x05000000,
  DEV_STM8L15x8		= 0x06000000,
  DEV_STM8L162		= 0x07000000,
  
  CPU_STM8101		= 0x0004,
  // Devices of L101 serie
  DEV_STM8101		= 0x7f000000,
