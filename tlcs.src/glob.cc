...
struct dis_entry disass_tlcs[]= {
  ...
  { 0x1400f0, 0xfc00fc, 'd', 3, "ADD %j,(%I+%n)" },
  { 0x1800f0, 0xf800fc, 'd', 3, "TSET %B,(%I+%n)" },
  { 0x2800f0, 0xf800fc, 'd', 3, "LD %t,(%I+%n)" },
  { 0x4800f0, 0xf800fc, 'd', 3, "LD %u,(%I+%n)" },
  { 0x5000f0, 0xf800fc, 'd', 3, "EX (%I+%n),%u" },
  { 0xA800f0, 0xf800fc, 'd', 3, "BIT %B,(%I+%n)" },
  { 0xB000f0, 0xf800fc, 'd', 3, "RES %B,(%I+%n)" },
  { 0xB800f0, 0xf800fc, 'd', 3, "SET %B,(%I+%n)" },
  /* F4+ix group */
