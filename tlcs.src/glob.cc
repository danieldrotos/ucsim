...
struct dis_entry disass_tlcs[]= {
  ...
  { 0x0700, 0xff00, 'n', 2, "INCX (0xff%n)" },
  { 0x0F00, 0xff00, 'n', 2, "DECX (0xff%n)" },
  { 0x1200, 0xff00, 'n', 2, "MUL HL,%n" },
  { 0x1300, 0xff00, 'n', 2, "DIV HL,%n" },
  { 0x1800, 0xff00, 'd', 2, "DJNZ %d" },
  { 0x1900, 0xff00, 'd', 2, "DJNZ BC,%d" },
  { 0x2700, 0xff00, 'n', 2, "LD A,(0xff%n)" },
  { 0x2F00, 0xff00, 'n', 2, "LD (0xff%n),A" },
  { 0x4700, 0xff00, 'n', 2, "LD HL,(0xff%n)" },
  { 0x6000, 0xff00, 'n', 2, "ADD A,(0xff%n)" },
  { 0x6100, 0xff00, 'n', 2, "ADC A,(0xff%n)" },
  { 0x6200, 0xff00, 'n', 2, "SUB A,(0xff%n)" },
  { 0x6300, 0xff00, 'n', 2, "SBC A,(0xff%n)" },
  { 0x6400, 0xff00, 'n', 2, "AND A,(0xff%n)" },
  { 0x6500, 0xff00, 'n', 2, "XOR A,(0xff%n)" },
  { 0x6600, 0xff00, 'n', 2, "OR A,(0xff%n)" },
  { 0x6700, 0xff00, 'n', 2, "CP A,(0xff%n)" },
  { 0x6800, 0xff00, 'n', 2, "ADD A,%n" },
  { 0x6900, 0xff00, 'n', 2, "ADC A,%n" },
  { 0x6A00, 0xff00, 'n', 2, "SUB A,%n" },
  { 0x6B00, 0xff00, 'n', 2, "SBC A,%n" },
  { 0x6C00, 0xff00, 'n', 2, "AND A,%n" },
  { 0x6D00, 0xff00, 'n', 2, "XOR A,%n" },
  { 0x6E00, 0xff00, 'n', 2, "OR A,%n" },
  { 0x6F00, 0xff00, 'n', 2, "CP A,%n" },
  { 0x7000, 0xff00, 'n', 2, "ADD HL,(0xff%n)" },
  { 0x7100, 0xff00, 'n', 2, "ADC HL,(0xff%n)" },
  { 0x7200, 0xff00, 'n', 2, "SUB HL,(0xff%n)" },
  { 0x7300, 0xff00, 'n', 2, "SBC HL,(0xff%n)" },
  { 0x7400, 0xff00, 'n', 2, "AND HL,(0xff%n)" },
  { 0x7500, 0xff00, 'n', 2, "XOR HL,(0xff%n)" },
  { 0x7600, 0xff00, 'n', 2, "OR HL,(0xff%n)" },
  { 0x7700, 0xff00, 'n', 2, "CP HL,(0xff%n)" },
  { 0x8700, 0xff00, 'n', 2, "INC (0xff%n)" },
  { 0x8F00, 0xff00, 'n', 2, "DEC (0xff%n)" },
