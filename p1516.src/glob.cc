...
struct dis_entry disass_p2223[]=
  {
   ...
   { 0x03030000, 0x0f0f0000, ' ', 1, "mvs %d:=#'s15'", false },
   { 0x03040000, 0x0f0f0000, ' ', 1, "add %d:=%d+#'s15'", false },
   { 0x03050000, 0x0f0f0000, ' ', 1, "adc %d:=%d+#'s15'", false },
   { 0x03060000, 0x0f0f0000, ' ', 1, "sub %d:=%d-#'s15'", false },
   { 0x03070000, 0x0f0f0000, ' ', 1, "sbb %d:=%d-#'s15'", false },
   { 0x03080000, 0x0f0f0000, ' ', 1, "cmp F:=%d-#'s15'", false },
   { 0x03090000, 0x0f0f0000, ' ', 1, "mul %d:=%d*#'s15'", false },
   { 0x030a0000, 0x0f0f0000, ' ', 1, "and %d:=%d&#'s15'", false },
   { 0x030b0000, 0x0f0f0000, ' ', 1, "or %d:=%d|#'s15'", false },
   { 0x030c0000, 0x0f0f0000, ' ', 1, "xor %d:=%d^#'s15'", false },
   { 0x030d0000, 0x0f0f0000, ' ', 1, "plus %d:=%d+#'s15'", false },
   { 0x030e0000, 0x0f0f0000, ' ', 1, "test %d:=%d&~#'s15'", false },

   { 0x01000000, 0x0f0f0000, ' ', 1, "zexb %d", false },
   { 0x01010000, 0x0f0f0000, ' ', 1, "zexw %d", false },
   { 0x01020000, 0x0f0f0000, ' ', 1, "sexb %d", false },
   { 0x01030000, 0x0f0f0000, ' ', 1, "sexw %d", false },
   { 0x01040000, 0x0f0f0000, ' ', 1, "not %d:=~%d", false },
   { 0x01050000, 0x0f0f0000, ' ', 1, "neg %d:=-%d", false },
   { 0x01060000, 0x0f0f0000, ' ', 1, "ror %d:=(%d,C)>>1", false },
   { 0x01070000, 0x0f0f0000, ' ', 1, "rol %d:=(C,%d)<<1", false },
