...
struct dis_entry disass_p2223[]=
  {
   ...
   { 0x03030000, 0x0f0f0000, ' ', 1, "mvs %d:=#'s16'", false },
   { 0x03040000, 0x0f0f0000, ' ', 1, "add %d:=%d+#'s16'", false },
   { 0x03050000, 0x0f0f0000, ' ', 1, "adc %d:=%d+#'s16'", false },
   { 0x03060000, 0x0f0f0000, ' ', 1, "sub %d:=%d-#'s16'", false },
