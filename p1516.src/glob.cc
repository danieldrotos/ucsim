...
struct dis_entry disass_p2223[]=
  {
    // CALL
   { 0x00000000, 0x0f000000, ' ', 1, "call 'ar'", false },
   { 0x01000000, 0x0f000000, ' ', 1, "call %d,'s20'", false },

   // ALU 1op
   { 0x02000000, 0x0f0f0000, ' ', 1, "zeb %d", false },
   { 0x02010000, 0x0f0f0000, ' ', 1, "zew %d", false },
   { 0x02020000, 0x0f0f0000, ' ', 1, "seb %d", false },
   { 0x02030000, 0x0f0f0000, ' ', 1, "sew %d", false },
   { 0x02040000, 0x0f0f0000, ' ', 1, "not %d:=~%d", false },
   { 0x02050000, 0x0f0f0000, ' ', 1, "neg %d:=-%d", false },
   { 0x02060000, 0x0f0f0000, ' ', 1, "ror %d:=(%d,C)>>1", false },
   { 0x02070000, 0x0f0f0000, ' ', 1, "rol %d:=(C,%d)<<1", false },
   { 0x02080000, 0x0f0f0000, ' ', 1, "shl %d:=u(%d)<<1", false },
   { 0x02090000, 0x0f0f0000, ' ', 1, "shr %d:=u(%d)>>1", false },
   { 0x020a0000, 0x0f0f0000, ' ', 1, "sha %d:=s(%d)>>1", false },
   { 0x020b0000, 0x0f0f0000, ' ', 1, "sz F.SZ=%d", false },
   { 0x020c0000, 0x0f0f0000, ' ', 1, "sec F.C=1", false },
   { 0x020d0000, 0x0f0f0000, ' ', 1, "clc F.C=0", false },
   { 0x020e0000, 0x0f0f0000, ' ', 1, "getf %d:=F", false },
   { 0x020f0000, 0x0f0f0000, ' ', 1, "setf F:=%d", false },

   // ALU R
   { 0x04000000, 0x0f0f0000, ' ', 1, "mov %d:=%b", false },
   { 0x04030000, 0x0f0f0000, ' ', 1, "sed %d:=s(%b)", false },
   { 0x04040000, 0x0f0f0000, ' ', 1, "add %d:=%d+%b", false },
   { 0x04050000, 0x0f0f0000, ' ', 1, "adc %d:=%d+%b", false },
   { 0x04060000, 0x0f0f0000, ' ', 1, "sub %d:=%d-%b", false },
   { 0x04070000, 0x0f0f0000, ' ', 1, "sbb %d:=%d-%b", false },
   { 0x04080000, 0x0f0f0000, ' ', 1, "cmp F:=%d-%b", false },
   { 0x04090000, 0x0f0f0000, ' ', 1, "mul %d:=%d*%b", false },
   { 0x040a0000, 0x0f0f0000, ' ', 1, "and %d:=%d&%b", false },
   { 0x040b0000, 0x0f0f0000, ' ', 1, "or %d:=%d&%b", false },
   { 0x040c0000, 0x0f0f0000, ' ', 1, "xor %d:=%d^%b", false },
   { 0x040d0000, 0x0f0f0000, ' ', 1, "plus %d:=%d+%b", false },
   { 0x040e0000, 0x0f0f0000, ' ', 1, "test F:=%d&%b", false },

   // ALU #immed
   { 0x05000000, 0x0f0f0000, ' ', 1, "mvl %d:=%l", false },
   { 0x05010000, 0x0f0f0000, ' ', 1, "mvh %d:=%h", false },
   { 0x05020000, 0x0f0f0000, ' ', 1, "mvzl %d:=%0", false },
   { 0x05030000, 0x0f0f0000, ' ', 1, "mvs %d:=#'s16'", false },
   { 0x05040000, 0x0f0f0000, ' ', 1, "add %d:=%d+#'s16'", false },
   { 0x05050000, 0x0f0f0000, ' ', 1, "adc %d:=%d+#'s16'", false },
   { 0x05060000, 0x0f0f0000, ' ', 1, "sub %d:=%d-#'s16'", false },
   { 0x05070000, 0x0f0f0000, ' ', 1, "sbb %d:=%d-#'s16'", false },
   { 0x05080000, 0x0f0f0000, ' ', 1, "cmp F:=%d-#'s16'", false },
   { 0x05090000, 0x0f0f0000, ' ', 1, "mul %d:=%d*#'s16'", false },
   { 0x050a0000, 0x0f0f0000, ' ', 1, "plus %d:=%d+#'s16'", false },
   { 0x050c0000, 0x0f0f0000, ' ', 1, "test %d:=%d&#'u16'", false },
   { 0x050d0000, 0x0f0f0000, ' ', 1, "or %d:=%d|#'u16'", false },
   { 0x050e0000, 0x0f0f0000, ' ', 1, "xor %d:=%d^#'u16'", false },
   { 0x050f0000, 0x0f0f0000, ' ', 1, "and %d:=%d&#'and16'", false },
