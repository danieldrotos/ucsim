...
0x0000f008, 0x01f2f3d3, /* 01f2f3d3 //C 0f008 _f008:	jmp	check_uart */
...
0x0000f00d, 0x01f2f3db, /* 01f2f3db //C 0f00d _f00d:	jmp	read */
0x0000f00e, 0x01f2f3dd, /* 01f2f3dd //C 0f00e _f00e:	jmp	putchar */
0x0000f00f, 0x01f2f3e7, /* 01f2f3e7 //C 0f00f _f00f:	jmp	prints */
0x0000f010, 0x01f2f3fb, /* 01f2f3fb //C 0f010 _f010:	jmp	printsnl */
0x0000f011, 0x01f2f403, /* 01f2f403 //C 0f011 _f011:	jmp	print_vhex */
...
0x0000f021, 0x0600f498, /* 0600f498 //C 0f021 st	r0,reg0 */
0x0000f022, 0x0610f499, /* 0610f499 //C 0f022 st	r1,reg1 */
0x0000f023, 0x0620f49a, /* 0620f49a //C 0f023 st	r2,reg2 */
0x0000f024, 0x0630f49b, /* 0630f49b //C 0f024 st	r3,reg3 */
0x0000f025, 0x0640f49c, /* 0640f49c //C 0f025 st	r4,reg4 */
0x0000f026, 0x0650f49d, /* 0650f49d //C 0f026 st	r5,reg5 */
0x0000f027, 0x0660f49e, /* 0660f49e //C 0f027 st	r6,reg6 */
0x0000f028, 0x0670f49f, /* 0670f49f //C 0f028 st	r7,reg7 */
0x0000f029, 0x0680f4a0, /* 0680f4a0 //C 0f029 st	r8,reg8 */
0x0000f02a, 0x0690f4a1, /* 0690f4a1 //C 0f02a st	r9,reg9 */
0x0000f02b, 0x06a0f4a2, /* 06a0f4a2 //C 0f02b st	r10,reg10 */
0x0000f02c, 0x06b0f4a3, /* 06b0f4a3 //C 0f02c st	r11,reg11 */
0x0000f02d, 0x06c0f4a4, /* 06c0f4a4 //C 0f02d st	r12,reg12 */
0x0000f02e, 0x06d0f4a5, /* 06d0f4a5 //C 0f02e st	r13,reg13 */
0x0000f02f, 0x06e0f4a6, /* 06e0f4a6 //C 0f02f st	r14,reg14 */
0x0000f030, 0x06e0f4a7, /* 06e0f4a7 //C 0f030 st	r14,reg15 */
0x0000f031, 0x020e0000, /* 020e0000 //C 0f031 getf	r0 */
0x0000f032, 0x0600f4a8, /* 0600f4a8 //C 0f032 st	r0,regf */
0x0000f033, 0x01020001, /* 01020001 //C 0f033 mvzl	r0,1 */
0x0000f034, 0x0600f496, /* 0600f496 //C 0f034 st	r0,called */
...
0x0000f039, 0x0600f496, /* 0600f496 //C 0f039 st	r0,called */
...
0x0000f03e, 0x0600f4a8, /* 0600f4a8 //C 0f03e st	r0,regf		; FALGS= 0 */
0x0000f03f, 0x0102f7ff, /* 0102f7ff //C 0f03f mvzl	r0,0xf7ff	; R13= 0xf7ff */
0x0000f040, 0x0600f4a5, /* 0600f4a5 //C 0f040 st	r0,reg13 */
0x0000f041, 0x01f2f042, /* 01f2f042 //C 0f041 jmp	common_start: */
0x0000f042, 0x01d2f6e4, /* 01d2f6e4 //C 0f042 mvzl	sp,stack_end */
0x0000f043, 0x01020001, /* 01020001 //C 0f043 mvzl	r0,1 */
0x0000f044, 0x0600f495, /* 0600f495 //C 0f044 st	r0,echo */
...
0x0000f04b, 0x0102f4a9, /* 0102f4a9 //C 0f04b mvzl	r0,msg_start */
0x0000f04c, 0x0400f3fb, /* 0400f3fb //C 0f04c call	printsnl */
0x0000f04d, 0x0700f496, /* 0700f496 //C 0f04d ld	r0,called */
...
0x0000f051, 0x0400f3dd, /* 0400f3dd //C 0f051 call	putchar */
0x0000f052, 0x0102f4b7, /* 0102f4b7 //C 0f052 mvzl	r0,msg_stopat */
0x0000f053, 0x0400f3e7, /* 0400f3e7 //C 0f053 call	prints */
0x0000f054, 0x0700f4a6, /* 0700f4a6 //C 0f054 ld	r0,reg14 */
0x0000f055, 0x01120004, /* 01120004 //C 0f055 mvzl	r1,4 */
0x0000f056, 0x0400f403, /* 0400f403 //C 0f056 call	print_vhex */
0x0000f057, 0x0102000a, /* 0102000a //C 0f057 mvzl	r0,LF */
0x0000f058, 0x0400f3dd, /* 0400f3dd //C 0f058 call	putchar */
...
0x0000f05d, 0x0610f48e, /* 0610f48e //C 0f05d st	r1,line_ptr */
0x0000f05e, 0x0610f42a, /* 0610f42a //C 0f05e st	r1,line		; line[0]= 0 */
0x0000f05f, 0x01120000, /* 01120000 //C 0f05f mvzl	r1,0		; at_eol= 0 */
0x0000f060, 0x0610f48f, /* 0610f48f //C 0f060 st	r1,at_eol */
0x0000f061, 0x0102f4c5, /* 0102f4c5 //C 0f061 mvzl	r0,prompt */
0x0000f062, 0x0400f3e7, /* 0400f3e7 //C 0f062 call	prints */
0x0000f063, 0x0fed0000, /* 0fed0000 //C 0f063 pop	lr */
0x0000f064, 0x00f00e00, /* 00f00e00 //C 0f064 ret */
0x0000f065, 0x0400f3d3, /* 0400f3d3 //C 0f065 call	check_uart */
0x0000f066, 0x41f2f06c, /* 41f2f06c //C 0f066 C0 jmp	no_input */
0x0000f067, 0x0400f3db, /* 0400f3db //C 0f067 call	read */
...
0x0000f077, 0x0700f48e, /* 0700f48e //C 0f077 ld	r0,line_ptr */
...
0x0000f07b, 0x0600f48e, /* 0600f48e //C 0f07b st	r0,line_ptr */
0x0000f07c, 0x0112f42a, /* 0112f42a //C 0f07c mvzl	r1,line */
0x0000f07d, 0x01220000, /* 01220000 //C 0f07d mvzl	r2,0 */
0x0000f07e, 0x08210000, /* 08210000 //C 0f07e st	r2,r1,r0 */
0x0000f07f, 0x0102f4c1, /* 0102f4c1 //C 0f07f mvzl	r0,msg_BS */
0x0000f080, 0x0400f3e7, /* 0400f3e7 //C 0f080 call	prints */
...
0x0000f088, 0x0620f48f, /* 0620f48f //C 0f088 st	r2,at_eol */
0x0000f089, 0x0112f48e, /* 0112f48e //C 0f089 mvzl	r1,line_ptr	; line[line_ptr]= char */
0x0000f08a, 0x0e310000, /* 0e310000 //C 0f08a ld	r3,r1 */
0x0000f08b, 0x0122f42a, /* 0122f42a //C 0f08b mvzl	r2,line */
...
0x0000f092, 0x0142f495, /* 0142f495 //C 0f092 mvzl	r4,echo		; check if echo is turned on */
0x0000f093, 0x0e440000, /* 0e440000 //C 0f093 ld	r4,r4 */
0x0000f094, 0x024b0000, /* 024b0000 //C 0f094 sz	r4 */
0x0000f095, 0x2400f3dd, /* 2400f3dd //C 0f095 NZ call	putchar		; echo */
0x0000f096, 0x020d0000, /* 020d0000 //C 0f096 clc */
0x0000f097, 0x01f2f09d, /* 01f2f09d //C 0f097 jmp	proc_input_ret */
0x0000f098, 0x0112f48f, /* 0112f48f //C 0f098 mvzl	r1,at_eol */
...
0x0000f0a1, 0x0400f3dd, /* 0400f3dd //C 0f0a1 call	putchar */
0x0000f0a2, 0x0700f42a, /* 0700f42a //C 0f0a2 ld	r0,line */
...
0x0000f0ab, 0x0400f3fb, /* 0400f3fb //C 0f0ab call	printsnl */
0x0000f0ac, 0x01120001, /* 01120001 //C 0f0ac mvzl	r1,1		; at_eol= 1 */
0x0000f0ad, 0x0610f48f, /* 0610f48f //C 0f0ad st	r1,at_eol */
...
0x0000f0c6, 0x0112f4c7, /* 0112f4c7 //C 0f0c6 mvzl	r1,delimiters */
...
0x0000f0cb, 0x0142f490, /* 0142f490 //C 0f0cb mvzl	r4,words	; array of result */
0x0000f0cc, 0x0152f42a, /* 0152f42a //C 0f0cc mvzl	r5,line		; address of next char */
...
0x0000f0f0, 0x0700f490, /* 0700f490 //C 0f0f0 ld	r0,words	; R0= 1st word of command */
...
0x0000f107, 0x0630f497, /* 0630f497 //C 0f107 st	r3,nuof_reg */
0x0000f108, 0x01f2f10b, /* 01f2f10b //C 0f108 jmp	find_rx */
0x0000f109, 0x01260030, /* 01260030 //C 0f109 sub	r2,'0' */
0x0000f10a, 0x0620f497, /* 0620f497 //C 0f10a st	r2,nuof_reg */
...
0x0000f10e, 0x01a2f4e3, /* 01a2f4e3 //C 0f10e mvzl	r10,commands */
...
0x0000f134, 0x0122f490, /* 0122f490 //C 0f134 mvzl	r2,words */
...
0x0000f13f, 0x0400f3fb, /* 0400f3fb //C 0f13f call	printsnl */
...
0x0000f14d, 0x0400f3fb, /* 0400f3fb //C 0f14d call	printsnl */
...
0x0000f152, 0x0400f403, /* 0400f403 //C 0f152 call	print_vhex */
0x0000f153, 0x01020020, /* 01020020 //C 0f153 mvzl	r0,0x20 */
0x0000f154, 0x0400f3dd, /* 0400f3dd //C 0f154 call	putchar */
0x0000f155, 0x0e040000, /* 0e040000 //C 0f155 ld	r0,r4 */
0x0000f156, 0x01120004, /* 01120004 //C 0f156 mvzl	r1,4 */
0x0000f157, 0x0400f403, /* 0400f403 //C 0f157 call	print_vhex */
0x0000f158, 0x0102000a, /* 0102000a //C 0f158 mvzl	r0,LF */
0x0000f159, 0x0400f3dd, /* 0400f3dd //C 0f159 call	putchar */
...
0x0000f189, 0x0122f490, /* 0122f490 //C 0f189 mvzl	r2,words */
...
0x0000f1a6, 0x0400f3fb, /* 0400f3fb //C 0f1a6 call	printsnl */
...
0x0000f1c0, 0x0400f3d3, /* 0400f3d3 //C 0f1c0 call	check_uart */
0x0000f1c1, 0x41f2f1c0, /* 41f2f1c0 //C 0f1c1 C0 jmp	l_cyc */
0x0000f1c2, 0x0400f3db, /* 0400f3db //C 0f1c2 call	read */
...
0x0000f1ef, 0x0400f3dd, /* 0400f3dd //C 0f1ef call	putchar		; print record type */
...
0x0000f21e, 0x0400f3dd, /* 0400f3dd //C 0f21e call	putchar */
0x0000f21f, 0x0102002e, /* 0102002e //C 0f21f mvzl	r0,'.' */
0x0000f220, 0x0400f3dd, /* 0400f3dd //C 0f220 call	putchar */
...
0x0000f226, 0x0400f3dd, /* 0400f3dd //C 0f226 call	putchar */
...
0x0000f22a, 0x0122f490, /* 0122f490 //C 0f22a mvzl	r2,words */
...
0x0000f231, 0x0400f3e7, /* 0400f3e7 //C 0f231 call	prints */
0x0000f232, 0x00000b00, /* 00000b00 //C 0f232 mov	r0,r11 */
0x0000f233, 0x01120004, /* 01120004 //C 0f233 mvzl	r1,4 */
0x0000f234, 0x0400f403, /* 0400f403 //C 0f234 call	print_vhex */
0x0000f235, 0x0102000a, /* 0102000a //C 0f235 mvzl	r0,LF */
0x0000f236, 0x0400f3dd, /* 0400f3dd //C 0f236 call	putchar */
0x0000f237, 0x06b0f4a7, /* 06b0f4a7 //C 0f237 st	r11,reg15 */
...
0x0000f23d, 0x0600f496, /* 0600f496 //C 0f23d st	r0,called */
0x0000f23e, 0x0700f4a8, /* 0700f4a8 //C 0f23e ld	r0,regf */
0x0000f23f, 0x020f0000, /* 020f0000 //C 0f23f setf	r0 */
0x0000f240, 0x0700f498, /* 0700f498 //C 0f240 ld	r0,reg0 */
0x0000f241, 0x0710f499, /* 0710f499 //C 0f241 ld	r1,reg1 */
0x0000f242, 0x0720f49a, /* 0720f49a //C 0f242 ld	r2,reg2 */
0x0000f243, 0x0730f49b, /* 0730f49b //C 0f243 ld	r3,reg3 */
0x0000f244, 0x0740f49c, /* 0740f49c //C 0f244 ld	r4,reg4 */
0x0000f245, 0x0750f49d, /* 0750f49d //C 0f245 ld	r5,reg5 */
0x0000f246, 0x0760f49e, /* 0760f49e //C 0f246 ld	r6,reg6 */
0x0000f247, 0x0770f49f, /* 0770f49f //C 0f247 ld	r7,reg7 */
0x0000f248, 0x0780f4a0, /* 0780f4a0 //C 0f248 ld	r8,reg8 */
0x0000f249, 0x0790f4a1, /* 0790f4a1 //C 0f249 ld	r9,reg9 */
0x0000f24a, 0x07a0f4a2, /* 07a0f4a2 //C 0f24a ld	r10,reg10 */
0x0000f24b, 0x07b0f4a3, /* 07b0f4a3 //C 0f24b ld	r11,reg11 */
0x0000f24c, 0x07c0f4a4, /* 07c0f4a4 //C 0f24c ld	r12,reg12 */
0x0000f24d, 0x07d0f4a5, /* 07d0f4a5 //C 0f24d ld	r13,reg13 */
0x0000f24e, 0x07e0f4a6, /* 07e0f4a6 //C 0f24e ld	r14,reg14 */
0x0000f24f, 0x07f0f4a7, /* 07f0f4a7 //C 0f24f ld	r15,reg15 */
0x0000f250, 0x0700f496, /* 0700f496 //C 0f250 ld	r0,called */
0x0000f251, 0x020b0000, /* 020b0000 //C 0f251 sz	r0 */
0x0000f252, 0x11f2f255, /* 11f2f255 //C 0f252 jz	g_err */
0x0000f253, 0x07b0f4a7, /* 07b0f4a7 //C 0f253 ld	r11,reg15 */
0x0000f254, 0x01f2f230, /* 01f2f230 //C 0f254 jmp	g_go11 */
0x0000f255, 0x0102f259, /* 0102f259 //C 0f255 mvzl	r0,g_err_addr */
0x0000f256, 0x0400f3fb, /* 0400f3fb //C 0f256 call	printsnl */
...
0x0000f26a, 0x0122f534, /* 0122f534 //C 0f26a mvzl	r2,helps */
...
0x0000f272, 0x0400f3dd, /* 0400f3dd //C 0f272 call	putchar */
...
0x0000f27e, 0x0400f3dd, /* 0400f3dd //C 0f27e call	putchar */
0x0000f27f, 0x01020020, /* 01020020 //C 0f27f mvzl	r0,32 */
0x0000f280, 0x0400f3dd, /* 0400f3dd //C 0f280 call	putchar */
0x0000f281, 0x0400f3dd, /* 0400f3dd //C 0f281 call	putchar */
...
0x0000f286, 0x0400f3e7, /* 0400f3e7 //C 0f286 call	prints */
...
0x0000f28f, 0x0400f3e7, /* 0400f3e7 //C 0f28f call	prints */
...
0x0000f298, 0x0400f3e7, /* 0400f3e7 //C 0f298 call	prints */
...
0x0000f29f, 0x0400f3dd, /* 0400f3dd //C 0f29f call	putchar */
...
0x0000f2a4, 0x0400f3dd, /* 0400f3dd //C 0f2a4 call	putchar */
0x0000f2a5, 0x01020020, /* 01020020 //C 0f2a5 mvzl	r0,32 */
0x0000f2a6, 0x0400f3dd, /* 0400f3dd //C 0f2a6 call	putchar */
0x0000f2a7, 0x01f2f2ae, /* 01f2f2ae //C 0f2a7 jmp	prn_ret */
0x0000f2a8, 0x01020031, /* 01020031 //C 0f2a8 mvzl	r0,'1' */
0x0000f2a9, 0x0400f3dd, /* 0400f3dd //C 0f2a9 call	putchar */
...
0x0000f2ad, 0x0400f3dd, /* 0400f3dd //C 0f2ad call	putchar */
...
0x0000f2b5, 0x0112f498, /* 0112f498 //C 0f2b5 mvzl	r1,reg0 */
0x0000f2b6, 0x0a010000, /* 0a010000 //C 0f2b6 ld	r0,r1,r0 */
0x0000f2b7, 0x01120004, /* 01120004 //C 0f2b7 mvzl	r1,4 */
0x0000f2b8, 0x0400f403, /* 0400f403 //C 0f2b8 call	print_vhex */
...
0x0000f2c2, 0x0400f3dd, /* 0400f3dd //C 0f2c2 call	putchar */
...
0x0000f2c6, 0x0400f3dd, /* 0400f3dd //C 0f2c6 call	putchar */
...
0x0000f2cc, 0x0400f3dd, /* 0400f3dd //C 0f2cc call	putchar */
...
0x0000f2d0, 0x0400f3dd, /* 0400f3dd //C 0f2d0 call	putchar */
0x0000f2d1, 0x00000300, /* 00000300 //C 0f2d1 mov	r0,r3 */
0x0000f2d2, 0x0400f3dd, /* 0400f3dd //C 0f2d2 call	putchar */
...
0x0000f2db, 0x0710f4a8, /* 0710f4a8 //C 0f2db ld	r1,regf */
...
0x0000f2f3, 0x07a0f497, /* 07a0f497 //C 0f2f3 ld	r10,nuof_reg	; Reg num is in R10 */
...
0x0000f2f7, 0x0400f3fb, /* 0400f3fb //C 0f2f7 call	printsnl */
...
0x0000f30a, 0x0122f490, /* 0122f490 //C 0f30a mvzl	r2,words */
...
0x0000f313, 0x0400f3fb, /* 0400f3fb //C 0f313 call	printsnl */
...
0x0000f323, 0x0102f498, /* 0102f498 //C 0f323 mvzl	r0,reg0 */
...
0x0000f3b8, 0x11f2f3cc, /* 11f2f3cc //C 0f3b8 jz	htoi_eos */
...
0x0000f3bd, 0x0d0d0000, /* 0d0d0000 //C 0f3bd push	r0 */
0x0000f3be, 0x00000200, /* 00000200 //C 0f3be mov	r0,r2 */
0x0000f3bf, 0x0400f37d, /* 0400f37d //C 0f3bf call	hexchar2value */
0x0000f3c0, 0x00200000, /* 00200000 //C 0f3c0 mov	r2,r0 */
0x0000f3c1, 0x0f0d0000, /* 0f0d0000 //C 0f3c1 pop	r0 */
0x0000f3c2, 0x41f2f3ca, /* 41f2f3ca //C 0f3c2 C0 jmp	htoi_nok */
0x0000f3c3, 0x02180000, /* 02180000 //C 0f3c3 shl	r1 */
0x0000f3c4, 0x02180000, /* 02180000 //C 0f3c4 shl	r1 */
0x0000f3c5, 0x02180000, /* 02180000 //C 0f3c5 shl	r1 */
0x0000f3c6, 0x02180000, /* 02180000 //C 0f3c6 shl	r1 */
0x0000f3c7, 0x012f000f, /* 012f000f //C 0f3c7 and	r2,0xf */
0x0000f3c8, 0x001d0200, /* 001d0200 //C 0f3c8 or	r1,r2 */
0x0000f3c9, 0x01f2f3b6, /* 01f2f3b6 //C 0f3c9 jmp	htoi_cyc */
0x0000f3ca, 0x020d0000, /* 020d0000 //C 0f3ca clc */
0x0000f3cb, 0x01f2f3cf, /* 01f2f3cf //C 0f3cb jmp	htoi_ret */
0x0000f3cc, 0x01380001, /* 01380001 //C 0f3cc cmp	r3,1 */
0x0000f3cd, 0x920d0000, /* 920d0000 //C 0f3cd HI clc */
0x0000f3ce, 0xa20c0000, /* a20c0000 //C 0f3ce LS sec */
0x0000f3cf, 0x0f3d0000, /* 0f3d0000 //C 0f3cf pop	r3 */
0x0000f3d0, 0x0f2d0000, /* 0f2d0000 //C 0f3d0 pop	r2 */
0x0000f3d1, 0x0fed0000, /* 0fed0000 //C 0f3d1 pop	lr */
0x0000f3d2, 0x00f00e00, /* 00f00e00 //C 0f3d2 ret */
0x0000f3d3, 0x0d0d0000, /* 0d0d0000 //C 0f3d3 push	r0 */
0x0000f3d4, 0x0700ff42, /* 0700ff42 //C 0f3d4 ld	r0,UART_RSTAT */
0x0000f3d5, 0x010c0001, /* 010c0001 //C 0f3d5 test	r0,1 */
0x0000f3d6, 0x020d0000, /* 020d0000 //C 0f3d6 clc */
0x0000f3d7, 0x220c0000, /* 220c0000 //C 0f3d7 Z0 sec */
0x0000f3d8, 0x0f0d0000, /* 0f0d0000 //C 0f3d8 pop	r0 */
0x0000f3d9, 0x30f00e00, /* 30f00e00 //C 0f3d9 C1 ret */
0x0000f3da, 0x00f00e00, /* 00f00e00 //C 0f3da ret */
0x0000f3db, 0x0700ff40, /* 0700ff40 //C 0f3db ld	r0,UART_DR */
0x0000f3dc, 0x00f00e00, /* 00f00e00 //C 0f3dc ret */
0x0000f3dd, 0x0d9d0000, /* 0d9d0000 //C 0f3dd push	r9 */
0x0000f3de, 0x01920070, /* 01920070 //C 0f3de mvzl	r9,'p' */
0x0000f3df, 0x0690ffff, /* 0690ffff //C 0f3df st	r9,SIMIF */
0x0000f3e0, 0x0600ffff, /* 0600ffff //C 0f3e0 st	r0,SIMIF */
0x0000f3e1, 0x0790ff43, /* 0790ff43 //C 0f3e1 ld	r9,UART_TSTAT */
0x0000f3e2, 0x019c0001, /* 019c0001 //C 0f3e2 test	r9,1 */
0x0000f3e3, 0x11f2f3e1, /* 11f2f3e1 //C 0f3e3 jz	wait_tc */
0x0000f3e4, 0x0600ff40, /* 0600ff40 //C 0f3e4 st	r0,UART_DR */
0x0000f3e5, 0x0f9d0000, /* 0f9d0000 //C 0f3e5 pop	r9 */
0x0000f3e6, 0x00f00e00, /* 00f00e00 //C 0f3e6 ret */
0x0000f3e7, 0x0ded0000, /* 0ded0000 //C 0f3e7 push	lr */
0x0000f3e8, 0x0d0d0000, /* 0d0d0000 //C 0f3e8 push	r0 */
0x0000f3e9, 0x0d3d0000, /* 0d3d0000 //C 0f3e9 push	r3 */
0x0000f3ea, 0x0d4d0000, /* 0d4d0000 //C 0f3ea push	r4 */
0x0000f3eb, 0x0d2d0000, /* 0d2d0000 //C 0f3eb push	r2 */
0x0000f3ec, 0x01420000, /* 01420000 //C 0f3ec mvzl	r4,0 */
0x0000f3ed, 0x020b0000, /* 020b0000 //C 0f3ed sz	r0 */
0x0000f3ee, 0x1102f4d0, /* 1102f4d0 //C 0f3ee Z1 mvzl	r0,null_str */
0x0000f3ef, 0x00200000, /* 00200000 //C 0f3ef mov	r2,r0 */
0x0000f3f0, 0x0b048200, /* 0b048200 //C 0f3f0 ld	r0,r4+,r2 */
0x0000f3f1, 0x020b0000, /* 020b0000 //C 0f3f1 sz	r0 */
0x0000f3f2, 0x11f2f3f5, /* 11f2f3f5 //C 0f3f2 jz	prints_done */
0x0000f3f3, 0x0400f3dd, /* 0400f3dd //C 0f3f3 call	putchar */
0x0000f3f4, 0x01f2f3f0, /* 01f2f3f0 //C 0f3f4 jmp	prints_go */
0x0000f3f5, 0x0f2d0000, /* 0f2d0000 //C 0f3f5 pop	r2 */
0x0000f3f6, 0x0f4d0000, /* 0f4d0000 //C 0f3f6 pop	r4 */
0x0000f3f7, 0x0f3d0000, /* 0f3d0000 //C 0f3f7 pop	r3 */
0x0000f3f8, 0x0f0d0000, /* 0f0d0000 //C 0f3f8 pop	r0 */
0x0000f3f9, 0x0fed0000, /* 0fed0000 //C 0f3f9 pop	lr */
0x0000f3fa, 0x00f00e00, /* 00f00e00 //C 0f3fa ret */
0x0000f3fb, 0x0ded0000, /* 0ded0000 //C 0f3fb push	lr */
0x0000f3fc, 0x0400f3e7, /* 0400f3e7 //C 0f3fc call	prints */
0x0000f3fd, 0x0d0d0000, /* 0d0d0000 //C 0f3fd push	r0 */
0x0000f3fe, 0x0102000a, /* 0102000a //C 0f3fe mvzl	r0,LF */
0x0000f3ff, 0x0400f3dd, /* 0400f3dd //C 0f3ff call	putchar */
0x0000f400, 0x0f0d0000, /* 0f0d0000 //C 0f400 pop	r0 */
0x0000f401, 0x0fed0000, /* 0fed0000 //C 0f401 pop	lr */
0x0000f402, 0x00f00e00, /* 00f00e00 //C 0f402 ret */
0x0000f403, 0x0ded0000, /* 0ded0000 //C 0f403 push	lr */
0x0000f404, 0x0d0d0000, /* 0d0d0000 //C 0f404 push	r0 */
0x0000f405, 0x0d1d0000, /* 0d1d0000 //C 0f405 push	r1 */
0x0000f406, 0x0d2d0000, /* 0d2d0000 //C 0f406 push	r2 */
0x0000f407, 0x0d3d0000, /* 0d3d0000 //C 0f407 push	r3 */
0x0000f408, 0x0d4d0000, /* 0d4d0000 //C 0f408 push	r4 */
0x0000f409, 0x00300000, /* 00300000 //C 0f409 mov	r3,r0 */
0x0000f40a, 0x01220000, /* 01220000 //C 0f40a mvzl	r2,0 */
0x0000f40b, 0x01420001, /* 01420001 //C 0f40b mvzl	r4,1 */
0x0000f40c, 0x01020000, /* 01020000 //C 0f40c mvzl	r0,0 */
0x0000f40d, 0x02380000, /* 02380000 //C 0f40d shl	r3 */
0x0000f40e, 0x02070000, /* 02070000 //C 0f40e rol	r0 */
...
0x0000f415, 0x0400f395, /* 0400f395 //C 0f415 call	value2Hexchar */
0x0000f416, 0x0400f3dd, /* 0400f3dd //C 0f416 call	putchar */
0x0000f417, 0x01240001, /* 01240001 //C 0f417 add	r2,1 */
0x0000f418, 0x01280008, /* 01280008 //C 0f418 cmp	r2,8 */
0x0000f419, 0x11f2f423, /* 11f2f423 //C 0f419 jz	print_vhex_ret */
0x0000f41a, 0x021b0000, /* 021b0000 //C 0f41a sz	r1 */
0x0000f41b, 0x11f2f421, /* 11f2f421 //C 0f41b jz	print_vhex_nosep */
0x0000f41c, 0x00480100, /* 00480100 //C 0f41c cmp	r4,r1 */
0x0000f41d, 0x21f2f421, /* 21f2f421 //C 0f41d jnz	print_vhex_nosep */
0x0000f41e, 0x0102005f, /* 0102005f //C 0f41e mvzl	r0,'_' */
0x0000f41f, 0x0400f3dd, /* 0400f3dd //C 0f41f call	putchar */
0x0000f420, 0x01420000, /* 01420000 //C 0f420 mvzl	r4,0 */
0x0000f421, 0x01440001, /* 01440001 //C 0f421 add	r4,1 */
0x0000f422, 0x01f2f40c, /* 01f2f40c //C 0f422 jmp	print_vhex_cyc */
0x0000f423, 0x0f4d0000, /* 0f4d0000 //C 0f423 pop	r4 */
0x0000f424, 0x0f3d0000, /* 0f3d0000 //C 0f424 pop	r3 */
0x0000f425, 0x0f2d0000, /* 0f2d0000 //C 0f425 pop	r2 */
0x0000f426, 0x0f1d0000, /* 0f1d0000 //C 0f426 pop	r1 */
0x0000f427, 0x0f0d0000, /* 0f0d0000 //C 0f427 pop	r0 */
0x0000f428, 0x0fed0000, /* 0fed0000 //C 0f428 pop	lr */
0x0000f429, 0x00f00e00, /* 00f00e00 //C 0f429 ret */
0x0000f496, 0x00000000, /* 00000000 //C 0f496 dd	0 */
0x0000f497, 0x00000000, /* 00000000 //C 0f497 dd	0 */
...
0x0000f4a9, 0x00000050, /* 00000050 //C 0f4a9 db	80 */
0x0000f4aa, 0x0000004d, /* 0000004d //C 0f4aa db	77 */
0x0000f4ab, 0x0000006f, /* 0000006f //C 0f4ab db	111 */
0x0000f4ac, 0x0000006e, /* 0000006e //C 0f4ac db	110 */
0x0000f4ad, 0x00000069, /* 00000069 //C 0f4ad db	105 */
0x0000f4ae, 0x00000074, /* 00000074 //C 0f4ae db	116 */
0x0000f4af, 0x0000006f, /* 0000006f //C 0f4af db	111 */
0x0000f4b0, 0x00000072, /* 00000072 //C 0f4b0 db	114 */
0x0000f4b1, 0x00000020, /* 00000020 //C 0f4b1 db	32 */
0x0000f4b2, 0x00000076, /* 00000076 //C 0f4b2 db	118 */
0x0000f4b3, 0x00000031, /* 00000031 //C 0f4b3 db	49 */
0x0000f4b4, 0x0000002e, /* 0000002e //C 0f4b4 db	46 */
0x0000f4b5, 0x00000030, /* 00000030 //C 0f4b5 db	48 */
0x0000f4b6, 0x00000000, /* 00000000 //C 0f4b6 db */
0x0000f4b7, 0x00000053, /* 00000053 //C 0f4b7 db	83 */
0x0000f4b8, 0x00000074, /* 00000074 //C 0f4b8 db	116 */
0x0000f4b9, 0x0000006f, /* 0000006f //C 0f4b9 db	111 */
0x0000f4ba, 0x00000070, /* 00000070 //C 0f4ba db	112 */
0x0000f4bb, 0x00000020, /* 00000020 //C 0f4bb db	32 */
0x0000f4bc, 0x00000061, /* 00000061 //C 0f4bc db	97 */
0x0000f4bd, 0x00000074, /* 00000074 //C 0f4bd db	116 */
0x0000f4be, 0x0000003a, /* 0000003a //C 0f4be db	58 */
0x0000f4bf, 0x00000020, /* 00000020 //C 0f4bf db	32 */
0x0000f4c0, 0x00000000, /* 00000000 //C 0f4c0 db */
0x0000f4c1, 0x00000008, /* 00000008 //C 0f4c1 db	8 */
0x0000f4c2, 0x00000020, /* 00000020 //C 0f4c2 db	32 */
0x0000f4c3, 0x00000008, /* 00000008 //C 0f4c3 db	8 */
0x0000f4c4, 0x00000000, /* 00000000 //C 0f4c4 db	0 */
0x0000f4c5, 0x0000003a, /* 0000003a //C 0f4c5 db	58 */
0x0000f4c6, 0x00000000, /* 00000000 //C 0f4c6 db */
0x0000f4c7, 0x00000020, /* 00000020 //C 0f4c7 db	32 */
0x0000f4c8, 0x0000003b, /* 0000003b //C 0f4c8 db	59 */
0x0000f4c9, 0x00000009, /* 00000009 //C 0f4c9 db	9 */
0x0000f4ca, 0x0000000b, /* 0000000b //C 0f4ca db	11 */
0x0000f4cb, 0x0000002c, /* 0000002c //C 0f4cb db	44 */
0x0000f4cc, 0x0000003d, /* 0000003d //C 0f4cc db	61 */
0x0000f4cd, 0x0000005b, /* 0000005b //C 0f4cd db	91 */
0x0000f4ce, 0x0000005d, /* 0000005d //C 0f4ce db	93 */
0x0000f4cf, 0x00000000, /* 00000000 //C 0f4cf db */
0x0000f4d0, 0x00000028, /* 00000028 //C 0f4d0 db	40 */
0x0000f4d1, 0x0000006e, /* 0000006e //C 0f4d1 db	110 */
0x0000f4d2, 0x00000075, /* 00000075 //C 0f4d2 db	117 */
0x0000f4d3, 0x0000006c, /* 0000006c //C 0f4d3 db	108 */
0x0000f4d4, 0x0000006c, /* 0000006c //C 0f4d4 db	108 */
0x0000f4d5, 0x00000029, /* 00000029 //C 0f4d5 db	41 */
0x0000f4d6, 0x00000000, /* 00000000 //C 0f4d6 db */
0x0000f4d7, 0x00000000, /* 00000000 //C 0f4d7 db	0 */
0x0000f4d8, 0x00000000, /* 00000000 //C 0f4d8 db	0 */
0x0000f4e3, 0x0000f133, /* 0000f133 //C 0f4e3 dd	cmd_m */
0x0000f4e4, 0x0000006d, /* 0000006d //C 0f4e4 db	109 */
0x0000f4e5, 0x00000000, /* 00000000 //C 0f4e5 db */
0x0000f4e6, 0x0000f133, /* 0000f133 //C 0f4e6 dd	cmd_m */
0x0000f4e7, 0x0000006d, /* 0000006d //C 0f4e7 db	109 */
0x0000f4e8, 0x00000065, /* 00000065 //C 0f4e8 db	101 */
0x0000f4e9, 0x0000006d, /* 0000006d //C 0f4e9 db	109 */
0x0000f4ea, 0x00000000, /* 00000000 //C 0f4ea db */
0x0000f4eb, 0x0000f188, /* 0000f188 //C 0f4eb dd	cmd_d */
0x0000f4ec, 0x00000064, /* 00000064 //C 0f4ec db	100 */
0x0000f4ed, 0x00000000, /* 00000000 //C 0f4ed db */
0x0000f4ee, 0x0000f188, /* 0000f188 //C 0f4ee dd	cmd_d */
0x0000f4ef, 0x00000064, /* 00000064 //C 0f4ef db	100 */
0x0000f4f0, 0x00000075, /* 00000075 //C 0f4f0 db	117 */
0x0000f4f1, 0x0000006d, /* 0000006d //C 0f4f1 db	109 */
0x0000f4f2, 0x00000070, /* 00000070 //C 0f4f2 db	112 */
0x0000f4f3, 0x00000000, /* 00000000 //C 0f4f3 db */
0x0000f4f4, 0x0000f1bc, /* 0000f1bc //C 0f4f4 dd	cmd_l */
0x0000f4f5, 0x0000006c, /* 0000006c //C 0f4f5 db	108 */
0x0000f4f6, 0x00000000, /* 00000000 //C 0f4f6 db */
0x0000f4f7, 0x0000f1bc, /* 0000f1bc //C 0f4f7 dd	cmd_l */
0x0000f4f8, 0x0000006c, /* 0000006c //C 0f4f8 db	108 */
0x0000f4f9, 0x0000006f, /* 0000006f //C 0f4f9 db	111 */
0x0000f4fa, 0x00000061, /* 00000061 //C 0f4fa db	97 */
0x0000f4fb, 0x00000064, /* 00000064 //C 0f4fb db	100 */
0x0000f4fc, 0x00000000, /* 00000000 //C 0f4fc db */
0x0000f4fd, 0x0000f229, /* 0000f229 //C 0f4fd dd	cmd_g */
0x0000f4fe, 0x00000067, /* 00000067 //C 0f4fe db	103 */
0x0000f4ff, 0x00000000, /* 00000000 //C 0f4ff db */
0x0000f500, 0x0000f229, /* 0000f229 //C 0f500 dd	cmd_g */
0x0000f501, 0x00000067, /* 00000067 //C 0f501 db	103 */
0x0000f502, 0x0000006f, /* 0000006f //C 0f502 db	111 */
0x0000f503, 0x00000000, /* 00000000 //C 0f503 db */
0x0000f504, 0x0000f229, /* 0000f229 //C 0f504 dd	cmd_g */
0x0000f505, 0x00000072, /* 00000072 //C 0f505 db	114 */
0x0000f506, 0x00000075, /* 00000075 //C 0f506 db	117 */
0x0000f507, 0x0000006e, /* 0000006e //C 0f507 db	110 */
0x0000f508, 0x00000000, /* 00000000 //C 0f508 db */
0x0000f509, 0x0000f269, /* 0000f269 //C 0f509 dd	cmd_h */
0x0000f50a, 0x0000003f, /* 0000003f //C 0f50a db	63 */
0x0000f50b, 0x00000000, /* 00000000 //C 0f50b db */
0x0000f50c, 0x0000f269, /* 0000f269 //C 0f50c dd	cmd_h */
0x0000f50d, 0x00000068, /* 00000068 //C 0f50d db	104 */
0x0000f50e, 0x00000000, /* 00000000 //C 0f50e db */
0x0000f50f, 0x0000f269, /* 0000f269 //C 0f50f dd	cmd_h */
0x0000f510, 0x00000068, /* 00000068 //C 0f510 db	104 */
0x0000f511, 0x00000065, /* 00000065 //C 0f511 db	101 */
0x0000f512, 0x0000006c, /* 0000006c //C 0f512 db	108 */
0x0000f513, 0x00000070, /* 00000070 //C 0f513 db	112 */
0x0000f514, 0x00000000, /* 00000000 //C 0f514 db */
0x0000f515, 0x0000f2d5, /* 0000f2d5 //C 0f515 dd	cmd_r */
0x0000f516, 0x00000072, /* 00000072 //C 0f516 db	114 */
0x0000f517, 0x00000000, /* 00000000 //C 0f517 db */
0x0000f518, 0x0000f2d5, /* 0000f2d5 //C 0f518 dd	cmd_r */
0x0000f519, 0x00000072, /* 00000072 //C 0f519 db	114 */
0x0000f51a, 0x00000065, /* 00000065 //C 0f51a db	101 */
0x0000f51b, 0x00000067, /* 00000067 //C 0f51b db	103 */
0x0000f51c, 0x00000000, /* 00000000 //C 0f51c db */
0x0000f51d, 0x0000f2d5, /* 0000f2d5 //C 0f51d dd	cmd_r */
0x0000f51e, 0x00000072, /* 00000072 //C 0f51e db	114 */
0x0000f51f, 0x00000065, /* 00000065 //C 0f51f db	101 */
0x0000f520, 0x00000067, /* 00000067 //C 0f520 db	103 */
0x0000f521, 0x00000073, /* 00000073 //C 0f521 db	115 */
0x0000f522, 0x00000000, /* 00000000 //C 0f522 db */
0x0000f523, 0x0000f328, /* 0000f328 //C 0f523 dd	cmd_sp */
0x0000f524, 0x00000073, /* 00000073 //C 0f524 db	115 */
0x0000f525, 0x00000070, /* 00000070 //C 0f525 db	112 */
0x0000f526, 0x00000000, /* 00000000 //C 0f526 db */
0x0000f527, 0x0000f32b, /* 0000f32b //C 0f527 dd	cmd_lr */
0x0000f528, 0x0000006c, /* 0000006c //C 0f528 db	108 */
0x0000f529, 0x00000072, /* 00000072 //C 0f529 db	114 */
0x0000f52a, 0x00000000, /* 00000000 //C 0f52a db */
0x0000f52b, 0x0000f32e, /* 0000f32e //C 0f52b dd	cmd_pc */
0x0000f52c, 0x00000070, /* 00000070 //C 0f52c db	112 */
0x0000f52d, 0x00000063, /* 00000063 //C 0f52d db	99 */
0x0000f52e, 0x00000000, /* 00000000 //C 0f52e db */
0x0000f52f, 0x0000f331, /* 0000f331 //C 0f52f dd	cmd_f */
0x0000f530, 0x00000066, /* 00000066 //C 0f530 db	102 */
0x0000f531, 0x00000000, /* 00000000 //C 0f531 db */
0x0000f532, 0x00000000, /* 00000000 //C 0f532 dd	0 */
0x0000f533, 0x00000000, /* 00000000 //C 0f533 dd	0 */
0x0000f534, 0x0000006d, /* 0000006d //C 0f534 db	109 */
0x0000f535, 0x0000005b, /* 0000005b //C 0f535 db	91 */
...
0x0000f53a, 0x00000061, /* 00000061 //C 0f53a db	97 */
0x0000f53b, 0x00000064, /* 00000064 //C 0f53b db	100 */
0x0000f53c, 0x00000064, /* 00000064 //C 0f53c db	100 */
0x0000f53d, 0x00000072, /* 00000072 //C 0f53d db	114 */
0x0000f53e, 0x00000020, /* 00000020 //C 0f53e db	32 */
0x0000f53f, 0x0000005b, /* 0000005b //C 0f53f db	91 */
0x0000f540, 0x00000076, /* 00000076 //C 0f540 db	118 */
0x0000f541, 0x00000061, /* 00000061 //C 0f541 db	97 */
0x0000f542, 0x0000006c, /* 0000006c //C 0f542 db	108 */
0x0000f543, 0x0000005d, /* 0000005d //C 0f543 db	93 */
0x0000f544, 0x00000020, /* 00000020 //C 0f544 db	32 */
0x0000f545, 0x00000020, /* 00000020 //C 0f545 db	32 */
0x0000f546, 0x00000047, /* 00000047 //C 0f546 db	71 */
0x0000f547, 0x00000065, /* 00000065 //C 0f547 db	101 */
0x0000f548, 0x00000074, /* 00000074 //C 0f548 db	116 */
0x0000f549, 0x0000002f, /* 0000002f //C 0f549 db	47 */
0x0000f54a, 0x00000073, /* 00000073 //C 0f54a db	115 */
0x0000f54b, 0x00000065, /* 00000065 //C 0f54b db	101 */
0x0000f54c, 0x00000074, /* 00000074 //C 0f54c db	116 */
0x0000f54d, 0x00000020, /* 00000020 //C 0f54d db	32 */
0x0000f54e, 0x0000006d, /* 0000006d //C 0f54e db	109 */
0x0000f54f, 0x00000065, /* 00000065 //C 0f54f db	101 */
0x0000f550, 0x0000006d, /* 0000006d //C 0f550 db	109 */
0x0000f551, 0x0000006f, /* 0000006f //C 0f551 db	111 */
0x0000f552, 0x00000072, /* 00000072 //C 0f552 db	114 */
0x0000f553, 0x00000079, /* 00000079 //C 0f553 db	121 */
0x0000f554, 0x0000000a, /* 0000000a //C 0f554 db	10 */
0x0000f555, 0x00000000, /* 00000000 //C 0f555 db */
0x0000f556, 0x00000064, /* 00000064 //C 0f556 db	100 */
0x0000f557, 0x0000005b, /* 0000005b //C 0f557 db	91 */
0x0000f558, 0x00000075, /* 00000075 //C 0f558 db	117 */
0x0000f559, 0x0000006d, /* 0000006d //C 0f559 db	109 */
0x0000f55a, 0x00000070, /* 00000070 //C 0f55a db	112 */
0x0000f55b, 0x0000005d, /* 0000005d //C 0f55b db	93 */
0x0000f55c, 0x00000020, /* 00000020 //C 0f55c db	32 */
0x0000f55d, 0x00000073, /* 00000073 //C 0f55d db	115 */
0x0000f55e, 0x00000074, /* 00000074 //C 0f55e db	116 */
0x0000f55f, 0x00000061, /* 00000061 //C 0f55f db	97 */
0x0000f560, 0x00000072, /* 00000072 //C 0f560 db	114 */
0x0000f561, 0x00000074, /* 00000074 //C 0f561 db	116 */
0x0000f562, 0x00000020, /* 00000020 //C 0f562 db	32 */
0x0000f563, 0x00000065, /* 00000065 //C 0f563 db	101 */
0x0000f564, 0x0000006e, /* 0000006e //C 0f564 db	110 */
0x0000f565, 0x00000064, /* 00000064 //C 0f565 db	100 */
0x0000f566, 0x00000020, /* 00000020 //C 0f566 db	32 */
0x0000f567, 0x00000020, /* 00000020 //C 0f567 db	32 */
0x0000f568, 0x00000044, /* 00000044 //C 0f568 db	68 */
0x0000f569, 0x00000075, /* 00000075 //C 0f569 db	117 */
0x0000f56a, 0x0000006d, /* 0000006d //C 0f56a db	109 */
0x0000f56b, 0x00000070, /* 00000070 //C 0f56b db	112 */
0x0000f56c, 0x00000020, /* 00000020 //C 0f56c db	32 */
0x0000f56d, 0x0000006d, /* 0000006d //C 0f56d db	109 */
0x0000f56e, 0x00000065, /* 00000065 //C 0f56e db	101 */
0x0000f56f, 0x0000006d, /* 0000006d //C 0f56f db	109 */
0x0000f570, 0x0000006f, /* 0000006f //C 0f570 db	111 */
0x0000f571, 0x00000072, /* 00000072 //C 0f571 db	114 */
0x0000f572, 0x00000079, /* 00000079 //C 0f572 db	121 */
0x0000f573, 0x00000020, /* 00000020 //C 0f573 db	32 */
0x0000f574, 0x00000063, /* 00000063 //C 0f574 db	99 */
0x0000f575, 0x0000006f, /* 0000006f //C 0f575 db	111 */
0x0000f576, 0x0000006e, /* 0000006e //C 0f576 db	110 */
0x0000f577, 0x00000074, /* 00000074 //C 0f577 db	116 */
0x0000f578, 0x00000065, /* 00000065 //C 0f578 db	101 */
0x0000f579, 0x0000006e, /* 0000006e //C 0f579 db	110 */
0x0000f57a, 0x00000074, /* 00000074 //C 0f57a db	116 */
0x0000f57b, 0x0000000a, /* 0000000a //C 0f57b db	10 */
0x0000f57c, 0x00000000, /* 00000000 //C 0f57c db */
0x0000f57d, 0x0000006c, /* 0000006c //C 0f57d db	108 */
0x0000f57e, 0x0000005b, /* 0000005b //C 0f57e db	91 */
0x0000f57f, 0x0000006f, /* 0000006f //C 0f57f db	111 */
...
0x0000f58f, 0x0000004c, /* 0000004c //C 0f58f db	76 */
0x0000f590, 0x0000006f, /* 0000006f //C 0f590 db	111 */
0x0000f591, 0x00000061, /* 00000061 //C 0f591 db	97 */
0x0000f592, 0x00000064, /* 00000064 //C 0f592 db	100 */
0x0000f593, 0x00000020, /* 00000020 //C 0f593 db	32 */
0x0000f594, 0x00000068, /* 00000068 //C 0f594 db	104 */
0x0000f595, 0x00000065, /* 00000065 //C 0f595 db	101 */
0x0000f596, 0x00000078, /* 00000078 //C 0f596 db	120 */
0x0000f597, 0x00000020, /* 00000020 //C 0f597 db	32 */
0x0000f598, 0x00000066, /* 00000066 //C 0f598 db	102 */
0x0000f599, 0x00000069, /* 00000069 //C 0f599 db	105 */
0x0000f59a, 0x0000006c, /* 0000006c //C 0f59a db	108 */
0x0000f59b, 0x00000065, /* 00000065 //C 0f59b db	101 */
0x0000f59c, 0x00000020, /* 00000020 //C 0f59c db	32 */
0x0000f59d, 0x00000074, /* 00000074 //C 0f59d db	116 */
0x0000f59e, 0x0000006f, /* 0000006f //C 0f59e db	111 */
0x0000f59f, 0x00000020, /* 00000020 //C 0f59f db	32 */
0x0000f5a0, 0x0000006d, /* 0000006d //C 0f5a0 db	109 */
0x0000f5a1, 0x00000065, /* 00000065 //C 0f5a1 db	101 */
0x0000f5a2, 0x0000006d, /* 0000006d //C 0f5a2 db	109 */
0x0000f5a3, 0x0000006f, /* 0000006f //C 0f5a3 db	111 */
0x0000f5a4, 0x00000072, /* 00000072 //C 0f5a4 db	114 */
0x0000f5a5, 0x00000079, /* 00000079 //C 0f5a5 db	121 */
0x0000f5a6, 0x0000000a, /* 0000000a //C 0f5a6 db	10 */
0x0000f5a7, 0x00000000, /* 00000000 //C 0f5a7 db */
0x0000f5a8, 0x00000067, /* 00000067 //C 0f5a8 db	103 */
0x0000f5a9, 0x0000005b, /* 0000005b //C 0f5a9 db	91 */
0x0000f5aa, 0x0000006f, /* 0000006f //C 0f5aa db	111 */
0x0000f5ab, 0x0000005d, /* 0000005d //C 0f5ab db	93 */
0x0000f5ac, 0x0000007c, /* 0000007c //C 0f5ac db	124 */
0x0000f5ad, 0x00000072, /* 00000072 //C 0f5ad db	114 */
0x0000f5ae, 0x00000075, /* 00000075 //C 0f5ae db	117 */
0x0000f5af, 0x0000006e, /* 0000006e //C 0f5af db	110 */
0x0000f5b0, 0x00000020, /* 00000020 //C 0f5b0 db	32 */
0x0000f5b1, 0x0000005b, /* 0000005b //C 0f5b1 db	91 */
0x0000f5b2, 0x00000061, /* 00000061 //C 0f5b2 db	97 */
0x0000f5b3, 0x00000064, /* 00000064 //C 0f5b3 db	100 */
0x0000f5b4, 0x00000064, /* 00000064 //C 0f5b4 db	100 */
0x0000f5b5, 0x00000072, /* 00000072 //C 0f5b5 db	114 */
0x0000f5b6, 0x0000005d, /* 0000005d //C 0f5b6 db	93 */
0x0000f5b7, 0x00000020, /* 00000020 //C 0f5b7 db	32 */
0x0000f5b8, 0x00000020, /* 00000020 //C 0f5b8 db	32 */
0x0000f5b9, 0x00000020, /* 00000020 //C 0f5b9 db	32 */
0x0000f5ba, 0x00000052, /* 00000052 //C 0f5ba db	82 */
0x0000f5bb, 0x00000075, /* 00000075 //C 0f5bb db	117 */
0x0000f5bc, 0x0000006e, /* 0000006e //C 0f5bc db	110 */
0x0000f5bd, 0x00000020, /* 00000020 //C 0f5bd db	32 */
0x0000f5be, 0x00000066, /* 00000066 //C 0f5be db	102 */
0x0000f5bf, 0x00000072, /* 00000072 //C 0f5bf db	114 */
0x0000f5c0, 0x0000006f, /* 0000006f //C 0f5c0 db	111 */
0x0000f5c1, 0x0000006d, /* 0000006d //C 0f5c1 db	109 */
...
0x0000f5c5, 0x00000064, /* 00000064 //C 0f5c5 db	100 */
0x0000f5c6, 0x00000072, /* 00000072 //C 0f5c6 db	114 */
0x0000f5c7, 0x00000065, /* 00000065 //C 0f5c7 db	101 */
0x0000f5c8, 0x00000073, /* 00000073 //C 0f5c8 db	115 */
0x0000f5c9, 0x00000073, /* 00000073 //C 0f5c9 db	115 */
0x0000f5ca, 0x0000000a, /* 0000000a //C 0f5ca db	10 */
0x0000f5cb, 0x00000000, /* 00000000 //C 0f5cb db */
0x0000f5cc, 0x00000072, /* 00000072 //C 0f5cc db	114 */
0x0000f5cd, 0x0000005b, /* 0000005b //C 0f5cd db	91 */
0x0000f5ce, 0x00000065, /* 00000065 //C 0f5ce db	101 */
0x0000f5cf, 0x00000067, /* 00000067 //C 0f5cf db	103 */
0x0000f5d0, 0x0000005b, /* 0000005b //C 0f5d0 db	91 */
0x0000f5d1, 0x00000073, /* 00000073 //C 0f5d1 db	115 */
0x0000f5d2, 0x0000005d, /* 0000005d //C 0f5d2 db	93 */
0x0000f5d3, 0x0000005d, /* 0000005d //C 0f5d3 db	93 */
...
0x0000f5de, 0x00000050, /* 00000050 //C 0f5de db	80 */
0x0000f5df, 0x00000072, /* 00000072 //C 0f5df db	114 */
0x0000f5e0, 0x00000069, /* 00000069 //C 0f5e0 db	105 */
0x0000f5e1, 0x0000006e, /* 0000006e //C 0f5e1 db	110 */
0x0000f5e2, 0x00000074, /* 00000074 //C 0f5e2 db	116 */
...
0x0000f5e6, 0x00000067, /* 00000067 //C 0f5e6 db	103 */
0x0000f5e7, 0x00000069, /* 00000069 //C 0f5e7 db	105 */
0x0000f5e8, 0x00000073, /* 00000073 //C 0f5e8 db	115 */
0x0000f5e9, 0x00000074, /* 00000074 //C 0f5e9 db	116 */
0x0000f5ea, 0x00000065, /* 00000065 //C 0f5ea db	101 */
...
0x0000f5ef, 0x00000072, /* 00000072 //C 0f5ef db	114 */
0x0000f5f0, 0x00000058, /* 00000058 //C 0f5f0 db	88 */
0x0000f5f1, 0x00000020, /* 00000020 //C 0f5f1 db	32 */
0x0000f5f2, 0x0000005b, /* 0000005b //C 0f5f2 db	91 */
0x0000f5f3, 0x00000076, /* 00000076 //C 0f5f3 db	118 */
0x0000f5f4, 0x00000061, /* 00000061 //C 0f5f4 db	97 */
0x0000f5f5, 0x0000006c, /* 0000006c //C 0f5f5 db	108 */
0x0000f5f6, 0x0000005d, /* 0000005d //C 0f5f6 db	93 */
...
0x0000f601, 0x00000047, /* 00000047 //C 0f601 db	71 */
0x0000f602, 0x00000065, /* 00000065 //C 0f602 db	101 */
0x0000f603, 0x00000074, /* 00000074 //C 0f603 db	116 */
0x0000f604, 0x0000002f, /* 0000002f //C 0f604 db	47 */
0x0000f605, 0x00000073, /* 00000073 //C 0f605 db	115 */
0x0000f606, 0x00000065, /* 00000065 //C 0f606 db	101 */
0x0000f607, 0x00000074, /* 00000074 //C 0f607 db	116 */
0x0000f608, 0x00000020, /* 00000020 //C 0f608 db	32 */
0x0000f609, 0x00000052, /* 00000052 //C 0f609 db	82 */
0x0000f60a, 0x00000058, /* 00000058 //C 0f60a db	88 */
0x0000f60b, 0x0000000a, /* 0000000a //C 0f60b db	10 */
0x0000f60c, 0x00000000, /* 00000000 //C 0f60c db */
0x0000f60d, 0x00000073, /* 00000073 //C 0f60d db	115 */
0x0000f60e, 0x00000070, /* 00000070 //C 0f60e db	112 */
0x0000f60f, 0x00000020, /* 00000020 //C 0f60f db	32 */
0x0000f610, 0x0000005b, /* 0000005b //C 0f610 db	91 */
0x0000f611, 0x00000076, /* 00000076 //C 0f611 db	118 */
0x0000f612, 0x00000061, /* 00000061 //C 0f612 db	97 */
...
0x0000f61f, 0x00000047, /* 00000047 //C 0f61f db	71 */
0x0000f620, 0x00000065, /* 00000065 //C 0f620 db	101 */
0x0000f621, 0x00000074, /* 00000074 //C 0f621 db	116 */
0x0000f622, 0x0000002f, /* 0000002f //C 0f622 db	47 */
0x0000f623, 0x00000073, /* 00000073 //C 0f623 db	115 */
0x0000f624, 0x00000065, /* 00000065 //C 0f624 db	101 */
0x0000f625, 0x00000074, /* 00000074 //C 0f625 db	116 */
0x0000f626, 0x00000020, /* 00000020 //C 0f626 db	32 */
0x0000f627, 0x00000052, /* 00000052 //C 0f627 db	82 */
0x0000f628, 0x00000031, /* 00000031 //C 0f628 db	49 */
0x0000f629, 0x00000033, /* 00000033 //C 0f629 db	51 */
0x0000f62a, 0x0000000a, /* 0000000a //C 0f62a db	10 */
0x0000f62b, 0x00000000, /* 00000000 //C 0f62b db */
0x0000f62c, 0x0000006c, /* 0000006c //C 0f62c db	108 */
0x0000f62d, 0x00000072, /* 00000072 //C 0f62d db	114 */
0x0000f62e, 0x00000020, /* 00000020 //C 0f62e db	32 */
0x0000f62f, 0x0000005b, /* 0000005b //C 0f62f db	91 */
0x0000f630, 0x00000076, /* 00000076 //C 0f630 db	118 */
0x0000f631, 0x00000061, /* 00000061 //C 0f631 db	97 */
0x0000f632, 0x0000006c, /* 0000006c //C 0f632 db	108 */
0x0000f633, 0x0000005d, /* 0000005d //C 0f633 db	93 */
0x0000f634, 0x00000020, /* 00000020 //C 0f634 db	32 */
0x0000f635, 0x00000020, /* 00000020 //C 0f635 db	32 */
...
0x0000f63e, 0x00000047, /* 00000047 //C 0f63e db	71 */
0x0000f63f, 0x00000065, /* 00000065 //C 0f63f db	101 */
0x0000f640, 0x00000074, /* 00000074 //C 0f640 db	116 */
0x0000f641, 0x0000002f, /* 0000002f //C 0f641 db	47 */
0x0000f642, 0x00000073, /* 00000073 //C 0f642 db	115 */
...
0x0000f646, 0x00000052, /* 00000052 //C 0f646 db	82 */
0x0000f647, 0x00000031, /* 00000031 //C 0f647 db	49 */
0x0000f648, 0x00000034, /* 00000034 //C 0f648 db	52 */
0x0000f649, 0x0000000a, /* 0000000a //C 0f649 db	10 */
0x0000f64a, 0x00000000, /* 00000000 //C 0f64a db */
0x0000f64b, 0x00000070, /* 00000070 //C 0f64b db	112 */
0x0000f64c, 0x00000063, /* 00000063 //C 0f64c db	99 */
0x0000f64d, 0x00000020, /* 00000020 //C 0f64d db	32 */
0x0000f64e, 0x0000005b, /* 0000005b //C 0f64e db	91 */
0x0000f64f, 0x00000076, /* 00000076 //C 0f64f db	118 */
0x0000f650, 0x00000061, /* 00000061 //C 0f650 db	97 */
0x0000f651, 0x0000006c, /* 0000006c //C 0f651 db	108 */
0x0000f652, 0x0000005d, /* 0000005d //C 0f652 db	93 */
0x0000f653, 0x00000020, /* 00000020 //C 0f653 db	32 */
0x0000f654, 0x00000020, /* 00000020 //C 0f654 db	32 */
...
0x0000f65d, 0x00000047, /* 00000047 //C 0f65d db	71 */
0x0000f65e, 0x00000065, /* 00000065 //C 0f65e db	101 */
0x0000f65f, 0x00000074, /* 00000074 //C 0f65f db	116 */
0x0000f660, 0x0000002f, /* 0000002f //C 0f660 db	47 */
0x0000f661, 0x00000073, /* 00000073 //C 0f661 db	115 */
0x0000f662, 0x00000065, /* 00000065 //C 0f662 db	101 */
0x0000f663, 0x00000074, /* 00000074 //C 0f663 db	116 */
0x0000f664, 0x00000020, /* 00000020 //C 0f664 db	32 */
0x0000f665, 0x00000052, /* 00000052 //C 0f665 db	82 */
0x0000f666, 0x00000031, /* 00000031 //C 0f666 db	49 */
0x0000f667, 0x00000035, /* 00000035 //C 0f667 db	53 */
0x0000f668, 0x0000000a, /* 0000000a //C 0f668 db	10 */
0x0000f669, 0x00000000, /* 00000000 //C 0f669 db */
0x0000f66a, 0x00000066, /* 00000066 //C 0f66a db	102 */
0x0000f66b, 0x00000020, /* 00000020 //C 0f66b db	32 */
0x0000f66c, 0x0000005b, /* 0000005b //C 0f66c db	91 */
0x0000f66d, 0x00000076, /* 00000076 //C 0f66d db	118 */
0x0000f66e, 0x00000061, /* 00000061 //C 0f66e db	97 */
0x0000f66f, 0x0000006c, /* 0000006c //C 0f66f db	108 */
0x0000f670, 0x0000005d, /* 0000005d //C 0f670 db	93 */
...
0x0000f67c, 0x00000047, /* 00000047 //C 0f67c db	71 */
0x0000f67d, 0x00000065, /* 00000065 //C 0f67d db	101 */
0x0000f67e, 0x00000074, /* 00000074 //C 0f67e db	116 */
0x0000f67f, 0x0000002f, /* 0000002f //C 0f67f db	47 */
0x0000f680, 0x00000073, /* 00000073 //C 0f680 db	115 */
0x0000f681, 0x00000065, /* 00000065 //C 0f681 db	101 */
0x0000f682, 0x00000074, /* 00000074 //C 0f682 db	116 */
0x0000f683, 0x00000020, /* 00000020 //C 0f683 db	32 */
0x0000f684, 0x00000066, /* 00000066 //C 0f684 db	102 */
0x0000f685, 0x0000006c, /* 0000006c //C 0f685 db	108 */
0x0000f686, 0x00000061, /* 00000061 //C 0f686 db	97 */
0x0000f687, 0x00000067, /* 00000067 //C 0f687 db	103 */
0x0000f688, 0x00000073, /* 00000073 //C 0f688 db	115 */
0x0000f689, 0x0000000a, /* 0000000a //C 0f689 db	10 */
0x0000f68a, 0x00000000, /* 00000000 //C 0f68a db */
0x0000f68b, 0x00000068, /* 00000068 //C 0f68b db	104 */
0x0000f68c, 0x0000002c, /* 0000002c //C 0f68c db	44 */
0x0000f68d, 0x0000003f, /* 0000003f //C 0f68d db	63 */
...
0x0000f69d, 0x00000048, /* 00000048 //C 0f69d db	72 */
0x0000f69e, 0x00000065, /* 00000065 //C 0f69e db	101 */
0x0000f69f, 0x0000006c, /* 0000006c //C 0f69f db	108 */
0x0000f6a0, 0x00000070, /* 00000070 //C 0f6a0 db	112 */
0x0000f6a1, 0x0000000a, /* 0000000a //C 0f6a1 db	10 */
0x0000f6a2, 0x00000000, /* 00000000 //C 0f6a2 db */
0x0000f6a3, 0x00000000, /* 00000000 //C 0f6a3 dd	0 */
0x0000f6e5, 0x00000045, /* 00000045 //C 0f6e5 db	69 */
0x0000f6e6, 0x0000004f, /* 0000004f //C 0f6e6 db	79 */
0x0000f6e7, 0x00000046, /* 00000046 //C 0f6e7 db	70 */
0x0000f6e8, 0x00000020, /* 00000020 //C 0f6e8 db	32 */
0x0000f6e9, 0x00000050, /* 00000050 //C 0f6e9 db	80 */
0x0000f6ea, 0x0000004d, /* 0000004d //C 0f6ea db	77 */
0x0000f6eb, 0x0000006f, /* 0000006f //C 0f6eb db	111 */
0x0000f6ec, 0x0000006e, /* 0000006e //C 0f6ec db	110 */
0x0000f6ed, 0x00000069, /* 00000069 //C 0f6ed db	105 */
0x0000f6ee, 0x00000074, /* 00000074 //C 0f6ee db	116 */
0x0000f6ef, 0x0000006f, /* 0000006f //C 0f6ef db	111 */
0x0000f6f0, 0x00000072, /* 00000072 //C 0f6f0 db	114 */
0x0000f6f1, 0x0000000a, /* 0000000a //C 0f6f1 db	10 */
0x0000f6f2, 0x00000000, /* 00000000 //C 0f6f2 db */
