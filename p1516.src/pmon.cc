...
0x0000f009, 0x01f2f3c8, /* 01f2f3c8 //C 0f009 _f009:	jmp	read */
0x0000f00a, 0x01f2f3da, /* 01f2f3da //C 0f00a _f00a:	jmp	putchar */
0x0000f00b, 0x01f2f3e4, /* 01f2f3e4 //C 0f00b _f00b:	jmp	prints */
0x0000f00c, 0x01f2f3f8, /* 01f2f3f8 //C 0f00c _f00c:	jmp	printsnl */
0x0000f00d, 0x01f2f400, /* 01f2f400 //C 0f00d _f00d:	jmp	print_vhex */
0x0000f00e, 0x0600f495, /* 0600f495 //C 0f00e st	r0,reg0 */
0x0000f00f, 0x0610f496, /* 0610f496 //C 0f00f st	r1,reg1 */
0x0000f010, 0x0620f497, /* 0620f497 //C 0f010 st	r2,reg2 */
0x0000f011, 0x0630f498, /* 0630f498 //C 0f011 st	r3,reg3 */
0x0000f012, 0x0640f499, /* 0640f499 //C 0f012 st	r4,reg4 */
0x0000f013, 0x0650f49a, /* 0650f49a //C 0f013 st	r5,reg5 */
0x0000f014, 0x0660f49b, /* 0660f49b //C 0f014 st	r6,reg6 */
0x0000f015, 0x0670f49c, /* 0670f49c //C 0f015 st	r7,reg7 */
0x0000f016, 0x0680f49d, /* 0680f49d //C 0f016 st	r8,reg8 */
0x0000f017, 0x0690f49e, /* 0690f49e //C 0f017 st	r9,reg9 */
0x0000f018, 0x06a0f49f, /* 06a0f49f //C 0f018 st	r10,reg10 */
0x0000f019, 0x06b0f4a0, /* 06b0f4a0 //C 0f019 st	r11,reg11 */
0x0000f01a, 0x06c0f4a1, /* 06c0f4a1 //C 0f01a st	r12,reg12 */
0x0000f01b, 0x06d0f4a2, /* 06d0f4a2 //C 0f01b st	r13,reg13 */
0x0000f01c, 0x06e0f4a3, /* 06e0f4a3 //C 0f01c st	r14,reg14 */
0x0000f01d, 0x06e0f4a4, /* 06e0f4a4 //C 0f01d st	r14,reg15 */
0x0000f01e, 0x020e0000, /* 020e0000 //C 0f01e getf	r0 */
0x0000f01f, 0x0600f4a5, /* 0600f4a5 //C 0f01f st	r0,regf */
0x0000f020, 0x01020001, /* 01020001 //C 0f020 mvzl	r0,1 */
0x0000f021, 0x0600f493, /* 0600f493 //C 0f021 st	r0,called */
...
0x0000f026, 0x0600f493, /* 0600f493 //C 0f026 st	r0,called */
...
0x0000f02b, 0x0600f4a5, /* 0600f4a5 //C 0f02b st	r0,regf		; FALGS= 0 */
0x0000f02c, 0x0102f7ff, /* 0102f7ff //C 0f02c mvzl	r0,0xf7ff	; R13= 0xf7ff */
0x0000f02d, 0x0600f4a2, /* 0600f4a2 //C 0f02d st	r0,reg13 */
0x0000f02e, 0x01f2f02f, /* 01f2f02f //C 0f02e jmp	common_start: */
0x0000f02f, 0x01d2f6d3, /* 01d2f6d3 //C 0f02f mvzl	sp,stack_end */
0x0000f030, 0x01020001, /* 01020001 //C 0f030 mvzl	r0,1 */
0x0000f031, 0x0600f492, /* 0600f492 //C 0f031 st	r0,echo */
...
0x0000f038, 0x0102f4a6, /* 0102f4a6 //C 0f038 mvzl	r0,msg_start */
0x0000f039, 0x0400f3f8, /* 0400f3f8 //C 0f039 call	printsnl */
...
0x0000f03e, 0x0610f48b, /* 0610f48b //C 0f03e st	r1,line_ptr */
0x0000f03f, 0x0610f427, /* 0610f427 //C 0f03f st	r1,line		; line[0]= 0 */
0x0000f040, 0x01120000, /* 01120000 //C 0f040 mvzl	r1,0		; at_eol= 0 */
0x0000f041, 0x0610f48c, /* 0610f48c //C 0f041 st	r1,at_eol */
0x0000f042, 0x0102f4b4, /* 0102f4b4 //C 0f042 mvzl	r0,prompt */
0x0000f043, 0x0400f3e4, /* 0400f3e4 //C 0f043 call	prints */
...
0x0000f048, 0x0400f3c8, /* 0400f3c8 //C 0f048 call	read */
...
0x0000f054, 0x0620f48c, /* 0620f48c //C 0f054 st	r2,at_eol */
0x0000f055, 0x0112f48b, /* 0112f48b //C 0f055 mvzl	r1,line_ptr	; line[line_ptr]= char */
0x0000f056, 0x0e310000, /* 0e310000 //C 0f056 ld	r3,r1 */
0x0000f057, 0x0122f427, /* 0122f427 //C 0f057 mvzl	r2,line */
...
0x0000f05e, 0x0142f492, /* 0142f492 //C 0f05e mvzl	r4,echo		; check if echo is turned on */
0x0000f05f, 0x0e440000, /* 0e440000 //C 0f05f ld	r4,r4 */
0x0000f060, 0x024b0000, /* 024b0000 //C 0f060 sz	r4 */
0x0000f061, 0x2400f3da, /* 2400f3da //C 0f061 NZ call	putchar		; echo */
0x0000f062, 0x020d0000, /* 020d0000 //C 0f062 clc */
0x0000f063, 0x01f2f069, /* 01f2f069 //C 0f063 jmp	proc_input_ret */
0x0000f064, 0x0112f48c, /* 0112f48c //C 0f064 mvzl	r1,at_eol */
...
0x0000f06d, 0x0400f3da, /* 0400f3da //C 0f06d call	putchar */
0x0000f06e, 0x0700f427, /* 0700f427 //C 0f06e ld	r0,line */
...
0x0000f077, 0x0400f3f8, /* 0400f3f8 //C 0f077 call	printsnl */
0x0000f078, 0x01120001, /* 01120001 //C 0f078 mvzl	r1,1		; at_eol= 1 */
0x0000f079, 0x0610f48c, /* 0610f48c //C 0f079 st	r1,at_eol */
...
0x0000f092, 0x0112f4b6, /* 0112f4b6 //C 0f092 mvzl	r1,delimiters */
...
0x0000f097, 0x0142f48d, /* 0142f48d //C 0f097 mvzl	r4,words	; array of result */
0x0000f098, 0x0152f427, /* 0152f427 //C 0f098 mvzl	r5,line		; address of next char */
...
0x0000f0bc, 0x0700f48d, /* 0700f48d //C 0f0bc ld	r0,words	; R0= 1st word of command */
...
0x0000f0d3, 0x0630f494, /* 0630f494 //C 0f0d3 st	r3,nuof_reg */
0x0000f0d4, 0x01f2f0d7, /* 01f2f0d7 //C 0f0d4 jmp	find_rx */
0x0000f0d5, 0x01260030, /* 01260030 //C 0f0d5 sub	r2,'0' */
0x0000f0d6, 0x0620f494, /* 0620f494 //C 0f0d6 st	r2,nuof_reg */
...
0x0000f0da, 0x01a2f4d2, /* 01a2f4d2 //C 0f0da mvzl	r10,commands */
...
0x0000f100, 0x0122f48d, /* 0122f48d //C 0f100 mvzl	r2,words */
...
0x0000f10b, 0x0400f3f8, /* 0400f3f8 //C 0f10b call	printsnl */
...
0x0000f119, 0x0400f3f8, /* 0400f3f8 //C 0f119 call	printsnl */
...
0x0000f11e, 0x0400f400, /* 0400f400 //C 0f11e call	print_vhex */
0x0000f11f, 0x01020020, /* 01020020 //C 0f11f mvzl	r0,0x20 */
0x0000f120, 0x0400f3da, /* 0400f3da //C 0f120 call	putchar */
0x0000f121, 0x0e040000, /* 0e040000 //C 0f121 ld	r0,r4 */
0x0000f122, 0x01120004, /* 01120004 //C 0f122 mvzl	r1,4 */
0x0000f123, 0x0400f400, /* 0400f400 //C 0f123 call	print_vhex */
0x0000f124, 0x0102000a, /* 0102000a //C 0f124 mvzl	r0,LF */
0x0000f125, 0x0400f3da, /* 0400f3da //C 0f125 call	putchar */
...
0x0000f155, 0x0122f48d, /* 0122f48d //C 0f155 mvzl	r2,words */
...
0x0000f172, 0x0400f3f8, /* 0400f3f8 //C 0f172 call	printsnl */
...
0x0000f18e, 0x0400f3c8, /* 0400f3c8 //C 0f18e call	read */
...
0x0000f1bb, 0x0400f3da, /* 0400f3da //C 0f1bb call	putchar		; print record type */
...
0x0000f1ea, 0x0400f3da, /* 0400f3da //C 0f1ea call	putchar */
0x0000f1eb, 0x0102002e, /* 0102002e //C 0f1eb mvzl	r0,'.' */
0x0000f1ec, 0x0400f3da, /* 0400f3da //C 0f1ec call	putchar */
...
0x0000f1f2, 0x0400f3da, /* 0400f3da //C 0f1f2 call	putchar */
...
0x0000f1f6, 0x0122f48d, /* 0122f48d //C 0f1f6 mvzl	r2,words */
...
0x0000f1fd, 0x0400f3e4, /* 0400f3e4 //C 0f1fd call	prints */
0x0000f1fe, 0x00000b00, /* 00000b00 //C 0f1fe mov	r0,r11 */
0x0000f1ff, 0x01120004, /* 01120004 //C 0f1ff mvzl	r1,4 */
0x0000f200, 0x0400f400, /* 0400f400 //C 0f200 call	print_vhex */
0x0000f201, 0x0102000a, /* 0102000a //C 0f201 mvzl	r0,LF */
0x0000f202, 0x0400f3da, /* 0400f3da //C 0f202 call	putchar */
0x0000f203, 0x06b0f4a4, /* 06b0f4a4 //C 0f203 st	r11,reg15 */
...
0x0000f209, 0x0600f493, /* 0600f493 //C 0f209 st	r0,called */
0x0000f20a, 0x0700f4a5, /* 0700f4a5 //C 0f20a ld	r0,regf */
0x0000f20b, 0x020f0000, /* 020f0000 //C 0f20b setf	r0 */
0x0000f20c, 0x0700f495, /* 0700f495 //C 0f20c ld	r0,reg0 */
0x0000f20d, 0x0710f496, /* 0710f496 //C 0f20d ld	r1,reg1 */
0x0000f20e, 0x0720f497, /* 0720f497 //C 0f20e ld	r2,reg2 */
0x0000f20f, 0x0730f498, /* 0730f498 //C 0f20f ld	r3,reg3 */
0x0000f210, 0x0740f499, /* 0740f499 //C 0f210 ld	r4,reg4 */
0x0000f211, 0x0750f49a, /* 0750f49a //C 0f211 ld	r5,reg5 */
0x0000f212, 0x0760f49b, /* 0760f49b //C 0f212 ld	r6,reg6 */
0x0000f213, 0x0770f49c, /* 0770f49c //C 0f213 ld	r7,reg7 */
0x0000f214, 0x0780f49d, /* 0780f49d //C 0f214 ld	r8,reg8 */
0x0000f215, 0x0790f49e, /* 0790f49e //C 0f215 ld	r9,reg9 */
0x0000f216, 0x07a0f49f, /* 07a0f49f //C 0f216 ld	r10,reg10 */
0x0000f217, 0x07b0f4a0, /* 07b0f4a0 //C 0f217 ld	r11,reg11 */
0x0000f218, 0x07c0f4a1, /* 07c0f4a1 //C 0f218 ld	r12,reg12 */
0x0000f219, 0x07d0f4a2, /* 07d0f4a2 //C 0f219 ld	r13,reg13 */
0x0000f21a, 0x07e0f4a3, /* 07e0f4a3 //C 0f21a ld	r14,reg14 */
0x0000f21b, 0x07f0f4a4, /* 07f0f4a4 //C 0f21b ld	r15,reg15 */
0x0000f21c, 0x0700f493, /* 0700f493 //C 0f21c ld	r0,called */
0x0000f21d, 0x020b0000, /* 020b0000 //C 0f21d sz	r0 */
0x0000f21e, 0x11f2f221, /* 11f2f221 //C 0f21e jz	g_err */
0x0000f21f, 0x07b0f4a4, /* 07b0f4a4 //C 0f21f ld	r11,reg15 */
0x0000f220, 0x01f2f1fc, /* 01f2f1fc //C 0f220 jmp	g_go11 */
0x0000f221, 0x0102f225, /* 0102f225 //C 0f221 mvzl	r0,g_err_addr */
0x0000f222, 0x0400f3f8, /* 0400f3f8 //C 0f222 call	printsnl */
...
0x0000f236, 0x0122f523, /* 0122f523 //C 0f236 mvzl	r2,helps */
...
0x0000f23e, 0x0400f3da, /* 0400f3da //C 0f23e call	putchar */
...
0x0000f24a, 0x0400f3da, /* 0400f3da //C 0f24a call	putchar */
0x0000f24b, 0x01020020, /* 01020020 //C 0f24b mvzl	r0,32 */
0x0000f24c, 0x0400f3da, /* 0400f3da //C 0f24c call	putchar */
0x0000f24d, 0x0400f3da, /* 0400f3da //C 0f24d call	putchar */
...
0x0000f252, 0x0400f3e4, /* 0400f3e4 //C 0f252 call	prints */
...
0x0000f25b, 0x0400f3e4, /* 0400f3e4 //C 0f25b call	prints */
...
0x0000f264, 0x0400f3e4, /* 0400f3e4 //C 0f264 call	prints */
...
0x0000f26b, 0x0400f3da, /* 0400f3da //C 0f26b call	putchar */
...
0x0000f270, 0x0400f3da, /* 0400f3da //C 0f270 call	putchar */
0x0000f271, 0x01020020, /* 01020020 //C 0f271 mvzl	r0,32 */
0x0000f272, 0x0400f3da, /* 0400f3da //C 0f272 call	putchar */
0x0000f273, 0x01f2f27a, /* 01f2f27a //C 0f273 jmp	prn_ret */
0x0000f274, 0x01020031, /* 01020031 //C 0f274 mvzl	r0,'1' */
0x0000f275, 0x0400f3da, /* 0400f3da //C 0f275 call	putchar */
...
0x0000f279, 0x0400f3da, /* 0400f3da //C 0f279 call	putchar */
...
0x0000f281, 0x0112f495, /* 0112f495 //C 0f281 mvzl	r1,reg0 */
0x0000f282, 0x0a010000, /* 0a010000 //C 0f282 ld	r0,r1,r0 */
0x0000f283, 0x01120004, /* 01120004 //C 0f283 mvzl	r1,4 */
0x0000f284, 0x0400f400, /* 0400f400 //C 0f284 call	print_vhex */
...
0x0000f28e, 0x0400f3da, /* 0400f3da //C 0f28e call	putchar */
...
0x0000f292, 0x0400f3da, /* 0400f3da //C 0f292 call	putchar */
...
0x0000f298, 0x0400f3da, /* 0400f3da //C 0f298 call	putchar */
...
0x0000f29c, 0x0400f3da, /* 0400f3da //C 0f29c call	putchar */
0x0000f29d, 0x00000300, /* 00000300 //C 0f29d mov	r0,r3 */
0x0000f29e, 0x0400f3da, /* 0400f3da //C 0f29e call	putchar */
...
0x0000f2a7, 0x0710f4a5, /* 0710f4a5 //C 0f2a7 ld	r1,regf */
...
0x0000f2bf, 0x07a0f494, /* 07a0f494 //C 0f2bf ld	r10,nuof_reg	; Reg num is in R10 */
...
0x0000f2c3, 0x0400f3f8, /* 0400f3f8 //C 0f2c3 call	printsnl */
...
0x0000f2d6, 0x0122f48d, /* 0122f48d //C 0f2d6 mvzl	r2,words */
...
0x0000f2df, 0x0400f3f8, /* 0400f3f8 //C 0f2df call	printsnl */
...
0x0000f2ef, 0x0102f495, /* 0102f495 //C 0f2ef mvzl	r0,reg0 */
...
0x0000f3a5, 0x30f00e00, /* 30f00e00 //C 0f3a5 C1 ret */
0x0000f3a6, 0x0d0d0000, /* 0d0d0000 //C 0f3a6 push	r0 */
0x0000f3a7, 0x0d1d0000, /* 0d1d0000 //C 0f3a7 push	r1 */
0x0000f3a8, 0x0d2d0000, /* 0d2d0000 //C 0f3a8 push	r2 */
0x0000f3a9, 0x0700f4c6, /* 0700f4c6 //C 0f3a9 ld	r0,sc_active */
0x0000f3aa, 0x020b0000, /* 020b0000 //C 0f3aa sz	r0 */
0x0000f3ab, 0x21f2f3c0, /* 21f2f3c0 //C 0f3ab jnz	check_uart_ret_true */
0x0000f3ac, 0x0700ff20, /* 0700ff20 //C 0f3ac ld	r0,GPIO_PORTI */
0x0000f3ad, 0x010b0001, /* 010b0001 //C 0f3ad btst	r0,1 */
0x0000f3ae, 0x0710f3c7, /* 0710f3c7 //C 0f3ae ld	r1,prev_porti */
0x0000f3af, 0x011b0001, /* 011b0001 //C 0f3af btst	r1,1 */
0x0000f3b0, 0x00080100, /* 00080100 //C 0f3b0 cmp	r0,r1 */
0x0000f3b1, 0x11f2f3c2, /* 11f2f3c2 //C 0f3b1 EQ jmp	check_uart_ret_false */
0x0000f3b2, 0x0600f3c7, /* 0600f3c7 //C 0f3b2 st	r0,prev_porti */
0x0000f3b3, 0x010b0001, /* 010b0001 //C 0f3b3 btst	r0,1 */
0x0000f3b4, 0x11f2f3c2, /* 11f2f3c2 //C 0f3b4 jz	check_uart_ret_false */
0x0000f3b5, 0x01220000, /* 01220000 //C 0f3b5 mvzl	r2,0 */
0x0000f3b6, 0x01020001, /* 01020001 //C 0f3b6 mvzl	r0,1 */
0x0000f3b7, 0x0600f4c6, /* 0600f4c6 //C 0f3b7 st	r0,sc_active */
0x0000f3b8, 0x0102f4c8, /* 0102f4c8 //C 0f3b8 mvzl	r0,sc_buffer */
0x0000f3b9, 0x0600f4c7, /* 0600f4c7 //C 0f3b9 st	r0,sc_ptr */
0x0000f3ba, 0x01120068, /* 01120068 //C 0f3ba mvzl	r1,'h' */
0x0000f3bb, 0x09108200, /* 09108200 //C 0f3bb st	r1,r0+,r2 */
0x0000f3bc, 0x0112000d, /* 0112000d //C 0f3bc mvzl	r1,CR */
0x0000f3bd, 0x09108200, /* 09108200 //C 0f3bd st	r1,r0+,r2 */
0x0000f3be, 0x01120000, /* 01120000 //C 0f3be mvzl	r1,0 */
0x0000f3bf, 0x09108200, /* 09108200 //C 0f3bf st	r1,r0+,r2 */
0x0000f3c0, 0x020c0000, /* 020c0000 //C 0f3c0 sec */
0x0000f3c1, 0x01f2f3c3, /* 01f2f3c3 //C 0f3c1 jmp	check_uart_ret */
0x0000f3c2, 0x020d0000, /* 020d0000 //C 0f3c2 clc */
0x0000f3c3, 0x0f2d0000, /* 0f2d0000 //C 0f3c3 pop	r2 */
0x0000f3c4, 0x0f1d0000, /* 0f1d0000 //C 0f3c4 pop	r1 */
0x0000f3c5, 0x0f0d0000, /* 0f0d0000 //C 0f3c5 pop	r0 */
0x0000f3c6, 0x00f00e00, /* 00f00e00 //C 0f3c6 ret */
0x0000f3c7, 0x00000000, /* 00000000 //C 0f3c7 db	0 */
0x0000f3c8, 0x0d1d0000, /* 0d1d0000 //C 0f3c8 push	r1 */
0x0000f3c9, 0x0d2d0000, /* 0d2d0000 //C 0f3c9 push	r2 */
0x0000f3ca, 0x0710f4c6, /* 0710f4c6 //C 0f3ca ld	r1,sc_active */
0x0000f3cb, 0x021b0000, /* 021b0000 //C 0f3cb sz	r1 */
0x0000f3cc, 0x11f2f3d6, /* 11f2f3d6 //C 0f3cc jz	read_uart */
0x0000f3cd, 0x0710f4c7, /* 0710f4c7 //C 0f3cd ld	r1,sc_ptr */
0x0000f3ce, 0x0e010000, /* 0e010000 //C 0f3ce ld	r0,r1 */
0x0000f3cf, 0x01140001, /* 01140001 //C 0f3cf add	r1,1 */
0x0000f3d0, 0x0610f4c7, /* 0610f4c7 //C 0f3d0 st	r1,sc_ptr */
0x0000f3d1, 0x0e210000, /* 0e210000 //C 0f3d1 ld	r2,r1 */
0x0000f3d2, 0x022b0000, /* 022b0000 //C 0f3d2 sz	r2 */
0x0000f3d3, 0x21f2f3d7, /* 21f2f3d7 //C 0f3d3 jnz	read_sc_ret */
0x0000f3d4, 0x0620f4c6, /* 0620f4c6 //C 0f3d4 st	r2,sc_active */
0x0000f3d5, 0x01f2f3d7, /* 01f2f3d7 //C 0f3d5 jmp	read_sc_ret */
0x0000f3d6, 0x0700ff40, /* 0700ff40 //C 0f3d6 ld	r0,UART_DR */
0x0000f3d7, 0x0f2d0000, /* 0f2d0000 //C 0f3d7 pop	r2 */
0x0000f3d8, 0x0f1d0000, /* 0f1d0000 //C 0f3d8 pop	r1 */
0x0000f3d9, 0x00f00e00, /* 00f00e00 //C 0f3d9 ret */
0x0000f3da, 0x0d9d0000, /* 0d9d0000 //C 0f3da push	r9 */
0x0000f3db, 0x01920070, /* 01920070 //C 0f3db mvzl	r9,'p' */
0x0000f3dc, 0x0690ffff, /* 0690ffff //C 0f3dc st	r9,SIMIF */
0x0000f3dd, 0x0600ffff, /* 0600ffff //C 0f3dd st	r0,SIMIF */
0x0000f3de, 0x0790ff43, /* 0790ff43 //C 0f3de ld	r9,UART_TSTAT */
0x0000f3df, 0x019c0001, /* 019c0001 //C 0f3df test	r9,1 */
0x0000f3e0, 0x11f2f3de, /* 11f2f3de //C 0f3e0 jz	wait_tc */
0x0000f3e1, 0x0600ff40, /* 0600ff40 //C 0f3e1 st	r0,UART_DR */
0x0000f3e2, 0x0f9d0000, /* 0f9d0000 //C 0f3e2 pop	r9 */
0x0000f3e3, 0x00f00e00, /* 00f00e00 //C 0f3e3 ret */
0x0000f3e4, 0x0ded0000, /* 0ded0000 //C 0f3e4 push	lr */
0x0000f3e5, 0x0d0d0000, /* 0d0d0000 //C 0f3e5 push	r0 */
0x0000f3e6, 0x0d3d0000, /* 0d3d0000 //C 0f3e6 push	r3 */
0x0000f3e7, 0x0d4d0000, /* 0d4d0000 //C 0f3e7 push	r4 */
0x0000f3e8, 0x0d2d0000, /* 0d2d0000 //C 0f3e8 push	r2 */
0x0000f3e9, 0x01420000, /* 01420000 //C 0f3e9 mvzl	r4,0 */
0x0000f3ea, 0x020b0000, /* 020b0000 //C 0f3ea sz	r0 */
0x0000f3eb, 0x1102f4bf, /* 1102f4bf //C 0f3eb Z1 mvzl	r0,null_str */
0x0000f3ec, 0x00200000, /* 00200000 //C 0f3ec mov	r2,r0 */
0x0000f3ed, 0x0b048200, /* 0b048200 //C 0f3ed ld	r0,r4+,r2 */
0x0000f3ee, 0x020b0000, /* 020b0000 //C 0f3ee sz	r0 */
0x0000f3ef, 0x11f2f3f2, /* 11f2f3f2 //C 0f3ef jz	prints_done */
0x0000f3f0, 0x0400f3da, /* 0400f3da //C 0f3f0 call	putchar */
0x0000f3f1, 0x01f2f3ed, /* 01f2f3ed //C 0f3f1 jmp	prints_go */
0x0000f3f2, 0x0f2d0000, /* 0f2d0000 //C 0f3f2 pop	r2 */
0x0000f3f3, 0x0f4d0000, /* 0f4d0000 //C 0f3f3 pop	r4 */
0x0000f3f4, 0x0f3d0000, /* 0f3d0000 //C 0f3f4 pop	r3 */
0x0000f3f5, 0x0f0d0000, /* 0f0d0000 //C 0f3f5 pop	r0 */
0x0000f3f6, 0x0fed0000, /* 0fed0000 //C 0f3f6 pop	lr */
0x0000f3f7, 0x00f00e00, /* 00f00e00 //C 0f3f7 ret */
0x0000f3f8, 0x0ded0000, /* 0ded0000 //C 0f3f8 push	lr */
0x0000f3f9, 0x0400f3e4, /* 0400f3e4 //C 0f3f9 call	prints */
0x0000f3fa, 0x0d0d0000, /* 0d0d0000 //C 0f3fa push	r0 */
0x0000f3fb, 0x0102000a, /* 0102000a //C 0f3fb mvzl	r0,LF */
0x0000f3fc, 0x0400f3da, /* 0400f3da //C 0f3fc call	putchar */
...
0x0000f401, 0x0d0d0000, /* 0d0d0000 //C 0f401 push	r0 */
0x0000f402, 0x0d1d0000, /* 0d1d0000 //C 0f402 push	r1 */
0x0000f403, 0x0d2d0000, /* 0d2d0000 //C 0f403 push	r2 */
0x0000f404, 0x0d3d0000, /* 0d3d0000 //C 0f404 push	r3 */
0x0000f405, 0x0d4d0000, /* 0d4d0000 //C 0f405 push	r4 */
0x0000f406, 0x00300000, /* 00300000 //C 0f406 mov	r3,r0 */
0x0000f407, 0x01220000, /* 01220000 //C 0f407 mvzl	r2,0 */
0x0000f408, 0x01420001, /* 01420001 //C 0f408 mvzl	r4,1 */
0x0000f409, 0x01020000, /* 01020000 //C 0f409 mvzl	r0,0 */
0x0000f40a, 0x02380000, /* 02380000 //C 0f40a shl	r3 */
0x0000f40b, 0x02070000, /* 02070000 //C 0f40b rol	r0 */
0x0000f40c, 0x02380000, /* 02380000 //C 0f40c shl	r3 */
0x0000f40d, 0x02070000, /* 02070000 //C 0f40d rol	r0 */
0x0000f40e, 0x02380000, /* 02380000 //C 0f40e shl	r3 */
0x0000f40f, 0x02070000, /* 02070000 //C 0f40f rol	r0 */
0x0000f410, 0x02380000, /* 02380000 //C 0f410 shl	r3 */
0x0000f411, 0x02070000, /* 02070000 //C 0f411 rol	r0 */
0x0000f412, 0x0400f361, /* 0400f361 //C 0f412 call	value2Hexchar */
0x0000f413, 0x0400f3da, /* 0400f3da //C 0f413 call	putchar */
0x0000f414, 0x01240001, /* 01240001 //C 0f414 add	r2,1 */
0x0000f415, 0x01280008, /* 01280008 //C 0f415 cmp	r2,8 */
0x0000f416, 0x11f2f420, /* 11f2f420 //C 0f416 jz	print_vhex_ret */
0x0000f417, 0x021b0000, /* 021b0000 //C 0f417 sz	r1 */
0x0000f418, 0x11f2f41e, /* 11f2f41e //C 0f418 jz	print_vhex_nosep */
0x0000f419, 0x00480100, /* 00480100 //C 0f419 cmp	r4,r1 */
0x0000f41a, 0x21f2f41e, /* 21f2f41e //C 0f41a jnz	print_vhex_nosep */
0x0000f41b, 0x0102005f, /* 0102005f //C 0f41b mvzl	r0,'_' */
0x0000f41c, 0x0400f3da, /* 0400f3da //C 0f41c call	putchar */
0x0000f41d, 0x01420000, /* 01420000 //C 0f41d mvzl	r4,0 */
0x0000f41e, 0x01440001, /* 01440001 //C 0f41e add	r4,1 */
0x0000f41f, 0x01f2f409, /* 01f2f409 //C 0f41f jmp	print_vhex_cyc */
0x0000f420, 0x0f4d0000, /* 0f4d0000 //C 0f420 pop	r4 */
0x0000f421, 0x0f3d0000, /* 0f3d0000 //C 0f421 pop	r3 */
0x0000f422, 0x0f2d0000, /* 0f2d0000 //C 0f422 pop	r2 */
0x0000f423, 0x0f1d0000, /* 0f1d0000 //C 0f423 pop	r1 */
0x0000f424, 0x0f0d0000, /* 0f0d0000 //C 0f424 pop	r0 */
...
0x0000f494, 0x00000000, /* 00000000 //C 0f494 dd	0 */
0x0000f495, 0x00000000, /* 00000000 //C 0f495 dd	0 */
...
0x0000f4a6, 0x00000050, /* 00000050 //C 0f4a6 db	80 */
0x0000f4a7, 0x0000004d, /* 0000004d //C 0f4a7 db	77 */
0x0000f4a8, 0x0000006f, /* 0000006f //C 0f4a8 db	111 */
0x0000f4a9, 0x0000006e, /* 0000006e //C 0f4a9 db	110 */
0x0000f4aa, 0x00000069, /* 00000069 //C 0f4aa db	105 */
0x0000f4ab, 0x00000074, /* 00000074 //C 0f4ab db	116 */
0x0000f4ac, 0x0000006f, /* 0000006f //C 0f4ac db	111 */
0x0000f4ad, 0x00000072, /* 00000072 //C 0f4ad db	114 */
0x0000f4ae, 0x00000020, /* 00000020 //C 0f4ae db	32 */
0x0000f4af, 0x00000076, /* 00000076 //C 0f4af db	118 */
0x0000f4b0, 0x00000031, /* 00000031 //C 0f4b0 db	49 */
0x0000f4b1, 0x0000002e, /* 0000002e //C 0f4b1 db	46 */
0x0000f4b2, 0x00000030, /* 00000030 //C 0f4b2 db	48 */
0x0000f4b3, 0x00000000, /* 00000000 //C 0f4b3 db */
0x0000f4b4, 0x0000003e, /* 0000003e //C 0f4b4 db	62 */
0x0000f4b5, 0x00000000, /* 00000000 //C 0f4b5 db */
0x0000f4b6, 0x00000020, /* 00000020 //C 0f4b6 db	32 */
0x0000f4b7, 0x0000003b, /* 0000003b //C 0f4b7 db	59 */
0x0000f4b8, 0x00000009, /* 00000009 //C 0f4b8 db	9 */
0x0000f4b9, 0x0000000b, /* 0000000b //C 0f4b9 db	11 */
0x0000f4ba, 0x0000002c, /* 0000002c //C 0f4ba db	44 */
0x0000f4bb, 0x0000003d, /* 0000003d //C 0f4bb db	61 */
0x0000f4bc, 0x0000005b, /* 0000005b //C 0f4bc db	91 */
0x0000f4bd, 0x0000005d, /* 0000005d //C 0f4bd db	93 */
0x0000f4be, 0x00000000, /* 00000000 //C 0f4be db */
0x0000f4bf, 0x00000028, /* 00000028 //C 0f4bf db	40 */
0x0000f4c0, 0x0000006e, /* 0000006e //C 0f4c0 db	110 */
0x0000f4c1, 0x00000075, /* 00000075 //C 0f4c1 db	117 */
0x0000f4c2, 0x0000006c, /* 0000006c //C 0f4c2 db	108 */
0x0000f4c3, 0x0000006c, /* 0000006c //C 0f4c3 db	108 */
0x0000f4c4, 0x00000029, /* 00000029 //C 0f4c4 db	41 */
0x0000f4c5, 0x00000000, /* 00000000 //C 0f4c5 db */
0x0000f4c6, 0x00000000, /* 00000000 //C 0f4c6 db	0 */
0x0000f4c7, 0x00000000, /* 00000000 //C 0f4c7 db	0 */
0x0000f4d2, 0x0000f0ff, /* 0000f0ff //C 0f4d2 dd	cmd_m */
0x0000f4d3, 0x0000006d, /* 0000006d //C 0f4d3 db	109 */
0x0000f4d4, 0x00000000, /* 00000000 //C 0f4d4 db */
0x0000f4d5, 0x0000f0ff, /* 0000f0ff //C 0f4d5 dd	cmd_m */
0x0000f4d6, 0x0000006d, /* 0000006d //C 0f4d6 db	109 */
0x0000f4d7, 0x00000065, /* 00000065 //C 0f4d7 db	101 */
0x0000f4d8, 0x0000006d, /* 0000006d //C 0f4d8 db	109 */
0x0000f4d9, 0x00000000, /* 00000000 //C 0f4d9 db */
0x0000f4da, 0x0000f154, /* 0000f154 //C 0f4da dd	cmd_d */
0x0000f4db, 0x00000064, /* 00000064 //C 0f4db db	100 */
0x0000f4dc, 0x00000000, /* 00000000 //C 0f4dc db */
0x0000f4dd, 0x0000f154, /* 0000f154 //C 0f4dd dd	cmd_d */
0x0000f4de, 0x00000064, /* 00000064 //C 0f4de db	100 */
0x0000f4df, 0x00000075, /* 00000075 //C 0f4df db	117 */
0x0000f4e0, 0x0000006d, /* 0000006d //C 0f4e0 db	109 */
0x0000f4e1, 0x00000070, /* 00000070 //C 0f4e1 db	112 */
0x0000f4e2, 0x00000000, /* 00000000 //C 0f4e2 db */
0x0000f4e3, 0x0000f188, /* 0000f188 //C 0f4e3 dd	cmd_l */
0x0000f4e4, 0x0000006c, /* 0000006c //C 0f4e4 db	108 */
0x0000f4e5, 0x00000000, /* 00000000 //C 0f4e5 db */
0x0000f4e6, 0x0000f188, /* 0000f188 //C 0f4e6 dd	cmd_l */
0x0000f4e7, 0x0000006c, /* 0000006c //C 0f4e7 db	108 */
0x0000f4e8, 0x0000006f, /* 0000006f //C 0f4e8 db	111 */
0x0000f4e9, 0x00000061, /* 00000061 //C 0f4e9 db	97 */
0x0000f4ea, 0x00000064, /* 00000064 //C 0f4ea db	100 */
0x0000f4eb, 0x00000000, /* 00000000 //C 0f4eb db */
0x0000f4ec, 0x0000f1f5, /* 0000f1f5 //C 0f4ec dd	cmd_g */
0x0000f4ed, 0x00000067, /* 00000067 //C 0f4ed db	103 */
0x0000f4ee, 0x00000000, /* 00000000 //C 0f4ee db */
0x0000f4ef, 0x0000f1f5, /* 0000f1f5 //C 0f4ef dd	cmd_g */
0x0000f4f0, 0x00000067, /* 00000067 //C 0f4f0 db	103 */
0x0000f4f1, 0x0000006f, /* 0000006f //C 0f4f1 db	111 */
0x0000f4f2, 0x00000000, /* 00000000 //C 0f4f2 db */
0x0000f4f3, 0x0000f1f5, /* 0000f1f5 //C 0f4f3 dd	cmd_g */
0x0000f4f4, 0x00000072, /* 00000072 //C 0f4f4 db	114 */
0x0000f4f5, 0x00000075, /* 00000075 //C 0f4f5 db	117 */
0x0000f4f6, 0x0000006e, /* 0000006e //C 0f4f6 db	110 */
0x0000f4f7, 0x00000000, /* 00000000 //C 0f4f7 db */
0x0000f4f8, 0x0000f235, /* 0000f235 //C 0f4f8 dd	cmd_h */
0x0000f4f9, 0x0000003f, /* 0000003f //C 0f4f9 db	63 */
0x0000f4fa, 0x00000000, /* 00000000 //C 0f4fa db */
0x0000f4fb, 0x0000f235, /* 0000f235 //C 0f4fb dd	cmd_h */
0x0000f4fc, 0x00000068, /* 00000068 //C 0f4fc db	104 */
0x0000f4fd, 0x00000000, /* 00000000 //C 0f4fd db */
0x0000f4fe, 0x0000f235, /* 0000f235 //C 0f4fe dd	cmd_h */
0x0000f4ff, 0x00000068, /* 00000068 //C 0f4ff db	104 */
0x0000f500, 0x00000065, /* 00000065 //C 0f500 db	101 */
0x0000f501, 0x0000006c, /* 0000006c //C 0f501 db	108 */
0x0000f502, 0x00000070, /* 00000070 //C 0f502 db	112 */
0x0000f503, 0x00000000, /* 00000000 //C 0f503 db */
0x0000f504, 0x0000f2a1, /* 0000f2a1 //C 0f504 dd	cmd_r */
0x0000f505, 0x00000072, /* 00000072 //C 0f505 db	114 */
0x0000f506, 0x00000000, /* 00000000 //C 0f506 db */
0x0000f507, 0x0000f2a1, /* 0000f2a1 //C 0f507 dd	cmd_r */
0x0000f508, 0x00000072, /* 00000072 //C 0f508 db	114 */
0x0000f509, 0x00000065, /* 00000065 //C 0f509 db	101 */
0x0000f50a, 0x00000067, /* 00000067 //C 0f50a db	103 */
0x0000f50b, 0x00000000, /* 00000000 //C 0f50b db */
0x0000f50c, 0x0000f2a1, /* 0000f2a1 //C 0f50c dd	cmd_r */
0x0000f50d, 0x00000072, /* 00000072 //C 0f50d db	114 */
0x0000f50e, 0x00000065, /* 00000065 //C 0f50e db	101 */
0x0000f50f, 0x00000067, /* 00000067 //C 0f50f db	103 */
0x0000f510, 0x00000073, /* 00000073 //C 0f510 db	115 */
0x0000f511, 0x00000000, /* 00000000 //C 0f511 db */
0x0000f512, 0x0000f2f4, /* 0000f2f4 //C 0f512 dd	cmd_sp */
0x0000f513, 0x00000073, /* 00000073 //C 0f513 db	115 */
0x0000f514, 0x00000070, /* 00000070 //C 0f514 db	112 */
0x0000f515, 0x00000000, /* 00000000 //C 0f515 db */
0x0000f516, 0x0000f2f7, /* 0000f2f7 //C 0f516 dd	cmd_lr */
0x0000f517, 0x0000006c, /* 0000006c //C 0f517 db	108 */
0x0000f518, 0x00000072, /* 00000072 //C 0f518 db	114 */
0x0000f519, 0x00000000, /* 00000000 //C 0f519 db */
0x0000f51a, 0x0000f2fa, /* 0000f2fa //C 0f51a dd	cmd_pc */
0x0000f51b, 0x00000070, /* 00000070 //C 0f51b db	112 */
0x0000f51c, 0x00000063, /* 00000063 //C 0f51c db	99 */
0x0000f51d, 0x00000000, /* 00000000 //C 0f51d db */
0x0000f51e, 0x0000f2fd, /* 0000f2fd //C 0f51e dd	cmd_f */
0x0000f51f, 0x00000066, /* 00000066 //C 0f51f db	102 */
0x0000f520, 0x00000000, /* 00000000 //C 0f520 db */
0x0000f521, 0x00000000, /* 00000000 //C 0f521 dd	0 */
0x0000f522, 0x00000000, /* 00000000 //C 0f522 dd	0 */
0x0000f523, 0x0000006d, /* 0000006d //C 0f523 db	109 */
0x0000f524, 0x0000005b, /* 0000005b //C 0f524 db	91 */
0x0000f525, 0x00000065, /* 00000065 //C 0f525 db	101 */
0x0000f526, 0x0000006d, /* 0000006d //C 0f526 db	109 */
0x0000f527, 0x0000005d, /* 0000005d //C 0f527 db	93 */
0x0000f528, 0x00000020, /* 00000020 //C 0f528 db	32 */
0x0000f529, 0x00000061, /* 00000061 //C 0f529 db	97 */
0x0000f52a, 0x00000064, /* 00000064 //C 0f52a db	100 */
0x0000f52b, 0x00000064, /* 00000064 //C 0f52b db	100 */
0x0000f52c, 0x00000072, /* 00000072 //C 0f52c db	114 */
0x0000f52d, 0x00000020, /* 00000020 //C 0f52d db	32 */
0x0000f52e, 0x0000005b, /* 0000005b //C 0f52e db	91 */
0x0000f52f, 0x00000076, /* 00000076 //C 0f52f db	118 */
0x0000f530, 0x00000061, /* 00000061 //C 0f530 db	97 */
0x0000f531, 0x0000006c, /* 0000006c //C 0f531 db	108 */
0x0000f532, 0x0000005d, /* 0000005d //C 0f532 db	93 */
0x0000f533, 0x00000020, /* 00000020 //C 0f533 db	32 */
0x0000f534, 0x00000020, /* 00000020 //C 0f534 db	32 */
0x0000f535, 0x00000047, /* 00000047 //C 0f535 db	71 */
0x0000f536, 0x00000065, /* 00000065 //C 0f536 db	101 */
0x0000f537, 0x00000074, /* 00000074 //C 0f537 db	116 */
0x0000f538, 0x0000002f, /* 0000002f //C 0f538 db	47 */
0x0000f539, 0x00000073, /* 00000073 //C 0f539 db	115 */
0x0000f53a, 0x00000065, /* 00000065 //C 0f53a db	101 */
0x0000f53b, 0x00000074, /* 00000074 //C 0f53b db	116 */
0x0000f53c, 0x00000020, /* 00000020 //C 0f53c db	32 */
0x0000f53d, 0x0000006d, /* 0000006d //C 0f53d db	109 */
0x0000f53e, 0x00000065, /* 00000065 //C 0f53e db	101 */
0x0000f53f, 0x0000006d, /* 0000006d //C 0f53f db	109 */
0x0000f540, 0x0000006f, /* 0000006f //C 0f540 db	111 */
0x0000f541, 0x00000072, /* 00000072 //C 0f541 db	114 */
0x0000f542, 0x00000079, /* 00000079 //C 0f542 db	121 */
0x0000f543, 0x0000000a, /* 0000000a //C 0f543 db	10 */
0x0000f544, 0x00000000, /* 00000000 //C 0f544 db */
0x0000f545, 0x00000064, /* 00000064 //C 0f545 db	100 */
0x0000f546, 0x0000005b, /* 0000005b //C 0f546 db	91 */
0x0000f547, 0x00000075, /* 00000075 //C 0f547 db	117 */
0x0000f548, 0x0000006d, /* 0000006d //C 0f548 db	109 */
0x0000f549, 0x00000070, /* 00000070 //C 0f549 db	112 */
0x0000f54a, 0x0000005d, /* 0000005d //C 0f54a db	93 */
0x0000f54b, 0x00000020, /* 00000020 //C 0f54b db	32 */
0x0000f54c, 0x00000073, /* 00000073 //C 0f54c db	115 */
0x0000f54d, 0x00000074, /* 00000074 //C 0f54d db	116 */
0x0000f54e, 0x00000061, /* 00000061 //C 0f54e db	97 */
0x0000f54f, 0x00000072, /* 00000072 //C 0f54f db	114 */
0x0000f550, 0x00000074, /* 00000074 //C 0f550 db	116 */
0x0000f551, 0x00000020, /* 00000020 //C 0f551 db	32 */
0x0000f552, 0x00000065, /* 00000065 //C 0f552 db	101 */
0x0000f553, 0x0000006e, /* 0000006e //C 0f553 db	110 */
0x0000f554, 0x00000064, /* 00000064 //C 0f554 db	100 */
0x0000f555, 0x00000020, /* 00000020 //C 0f555 db	32 */
0x0000f556, 0x00000020, /* 00000020 //C 0f556 db	32 */
0x0000f557, 0x00000044, /* 00000044 //C 0f557 db	68 */
...
0x0000f55c, 0x0000006d, /* 0000006d //C 0f55c db	109 */
0x0000f55d, 0x00000065, /* 00000065 //C 0f55d db	101 */
0x0000f55e, 0x0000006d, /* 0000006d //C 0f55e db	109 */
0x0000f55f, 0x0000006f, /* 0000006f //C 0f55f db	111 */
0x0000f560, 0x00000072, /* 00000072 //C 0f560 db	114 */
0x0000f561, 0x00000079, /* 00000079 //C 0f561 db	121 */
0x0000f562, 0x00000020, /* 00000020 //C 0f562 db	32 */
0x0000f563, 0x00000063, /* 00000063 //C 0f563 db	99 */
0x0000f564, 0x0000006f, /* 0000006f //C 0f564 db	111 */
0x0000f565, 0x0000006e, /* 0000006e //C 0f565 db	110 */
0x0000f566, 0x00000074, /* 00000074 //C 0f566 db	116 */
0x0000f567, 0x00000065, /* 00000065 //C 0f567 db	101 */
0x0000f568, 0x0000006e, /* 0000006e //C 0f568 db	110 */
0x0000f569, 0x00000074, /* 00000074 //C 0f569 db	116 */
0x0000f56a, 0x0000000a, /* 0000000a //C 0f56a db	10 */
0x0000f56b, 0x00000000, /* 00000000 //C 0f56b db */
0x0000f56c, 0x0000006c, /* 0000006c //C 0f56c db	108 */
0x0000f56d, 0x0000005b, /* 0000005b //C 0f56d db	91 */
0x0000f56e, 0x0000006f, /* 0000006f //C 0f56e db	111 */
0x0000f56f, 0x00000061, /* 00000061 //C 0f56f db	97 */
0x0000f570, 0x00000064, /* 00000064 //C 0f570 db	100 */
0x0000f571, 0x0000005d, /* 0000005d //C 0f571 db	93 */
...
0x0000f576, 0x00000020, /* 00000020 //C 0f576 db	32 */
0x0000f577, 0x00000020, /* 00000020 //C 0f577 db	32 */
...
0x0000f57e, 0x0000004c, /* 0000004c //C 0f57e db	76 */
...
0x0000f583, 0x00000068, /* 00000068 //C 0f583 db	104 */
0x0000f584, 0x00000065, /* 00000065 //C 0f584 db	101 */
0x0000f585, 0x00000078, /* 00000078 //C 0f585 db	120 */
0x0000f586, 0x00000020, /* 00000020 //C 0f586 db	32 */
0x0000f587, 0x00000066, /* 00000066 //C 0f587 db	102 */
0x0000f588, 0x00000069, /* 00000069 //C 0f588 db	105 */
...
0x0000f58c, 0x00000074, /* 00000074 //C 0f58c db	116 */
0x0000f58d, 0x0000006f, /* 0000006f //C 0f58d db	111 */
...
0x0000f599, 0x0000006f, /* 0000006f //C 0f599 db	111 */
0x0000f59a, 0x0000005d, /* 0000005d //C 0f59a db	93 */
0x0000f59b, 0x0000007c, /* 0000007c //C 0f59b db	124 */
0x0000f59c, 0x00000072, /* 00000072 //C 0f59c db	114 */
0x0000f59d, 0x00000075, /* 00000075 //C 0f59d db	117 */
0x0000f59e, 0x0000006e, /* 0000006e //C 0f59e db	110 */
0x0000f59f, 0x00000020, /* 00000020 //C 0f59f db	32 */
0x0000f5a0, 0x0000005b, /* 0000005b //C 0f5a0 db	91 */
0x0000f5a1, 0x00000061, /* 00000061 //C 0f5a1 db	97 */
0x0000f5a2, 0x00000064, /* 00000064 //C 0f5a2 db	100 */
0x0000f5a3, 0x00000064, /* 00000064 //C 0f5a3 db	100 */
...
0x0000f5a9, 0x00000052, /* 00000052 //C 0f5a9 db	82 */
...
0x0000f5ad, 0x00000066, /* 00000066 //C 0f5ad db	102 */
0x0000f5ae, 0x00000072, /* 00000072 //C 0f5ae db	114 */
0x0000f5af, 0x0000006f, /* 0000006f //C 0f5af db	111 */
...
0x0000f5b6, 0x00000065, /* 00000065 //C 0f5b6 db	101 */
0x0000f5b7, 0x00000073, /* 00000073 //C 0f5b7 db	115 */
0x0000f5b8, 0x00000073, /* 00000073 //C 0f5b8 db	115 */
0x0000f5b9, 0x0000000a, /* 0000000a //C 0f5b9 db	10 */
0x0000f5ba, 0x00000000, /* 00000000 //C 0f5ba db */
0x0000f5bb, 0x00000072, /* 00000072 //C 0f5bb db	114 */
0x0000f5bc, 0x0000005b, /* 0000005b //C 0f5bc db	91 */
0x0000f5bd, 0x00000065, /* 00000065 //C 0f5bd db	101 */
0x0000f5be, 0x00000067, /* 00000067 //C 0f5be db	103 */
0x0000f5bf, 0x0000005b, /* 0000005b //C 0f5bf db	91 */
0x0000f5c0, 0x00000073, /* 00000073 //C 0f5c0 db	115 */
0x0000f5c1, 0x0000005d, /* 0000005d //C 0f5c1 db	93 */
0x0000f5c2, 0x0000005d, /* 0000005d //C 0f5c2 db	93 */
...
0x0000f5cd, 0x00000050, /* 00000050 //C 0f5cd db	80 */
0x0000f5ce, 0x00000072, /* 00000072 //C 0f5ce db	114 */
0x0000f5cf, 0x00000069, /* 00000069 //C 0f5cf db	105 */
0x0000f5d0, 0x0000006e, /* 0000006e //C 0f5d0 db	110 */
0x0000f5d1, 0x00000074, /* 00000074 //C 0f5d1 db	116 */
0x0000f5d2, 0x00000020, /* 00000020 //C 0f5d2 db	32 */
0x0000f5d3, 0x00000072, /* 00000072 //C 0f5d3 db	114 */
0x0000f5d4, 0x00000065, /* 00000065 //C 0f5d4 db	101 */
0x0000f5d5, 0x00000067, /* 00000067 //C 0f5d5 db	103 */
0x0000f5d6, 0x00000069, /* 00000069 //C 0f5d6 db	105 */
0x0000f5d7, 0x00000073, /* 00000073 //C 0f5d7 db	115 */
0x0000f5d8, 0x00000074, /* 00000074 //C 0f5d8 db	116 */
0x0000f5d9, 0x00000065, /* 00000065 //C 0f5d9 db	101 */
0x0000f5da, 0x00000072, /* 00000072 //C 0f5da db	114 */
0x0000f5db, 0x00000073, /* 00000073 //C 0f5db db	115 */
0x0000f5dc, 0x0000000a, /* 0000000a //C 0f5dc db	10 */
0x0000f5dd, 0x00000000, /* 00000000 //C 0f5dd db */
0x0000f5de, 0x00000072, /* 00000072 //C 0f5de db	114 */
0x0000f5df, 0x00000058, /* 00000058 //C 0f5df db	88 */
0x0000f5e0, 0x00000020, /* 00000020 //C 0f5e0 db	32 */
0x0000f5e1, 0x0000005b, /* 0000005b //C 0f5e1 db	91 */
0x0000f5e2, 0x00000076, /* 00000076 //C 0f5e2 db	118 */
0x0000f5e3, 0x00000061, /* 00000061 //C 0f5e3 db	97 */
0x0000f5e4, 0x0000006c, /* 0000006c //C 0f5e4 db	108 */
0x0000f5e5, 0x0000005d, /* 0000005d //C 0f5e5 db	93 */
...
0x0000f5f0, 0x00000047, /* 00000047 //C 0f5f0 db	71 */
0x0000f5f1, 0x00000065, /* 00000065 //C 0f5f1 db	101 */
0x0000f5f2, 0x00000074, /* 00000074 //C 0f5f2 db	116 */
0x0000f5f3, 0x0000002f, /* 0000002f //C 0f5f3 db	47 */
0x0000f5f4, 0x00000073, /* 00000073 //C 0f5f4 db	115 */
0x0000f5f5, 0x00000065, /* 00000065 //C 0f5f5 db	101 */
0x0000f5f6, 0x00000074, /* 00000074 //C 0f5f6 db	116 */
0x0000f5f7, 0x00000020, /* 00000020 //C 0f5f7 db	32 */
0x0000f5f8, 0x00000052, /* 00000052 //C 0f5f8 db	82 */
0x0000f5f9, 0x00000058, /* 00000058 //C 0f5f9 db	88 */
...
0x0000f5fd, 0x00000070, /* 00000070 //C 0f5fd db	112 */
...
0x0000f618, 0x00000033, /* 00000033 //C 0f618 db	51 */
0x0000f619, 0x0000000a, /* 0000000a //C 0f619 db	10 */
0x0000f61a, 0x00000000, /* 00000000 //C 0f61a db */
0x0000f61b, 0x0000006c, /* 0000006c //C 0f61b db	108 */
0x0000f61c, 0x00000072, /* 00000072 //C 0f61c db	114 */
0x0000f61d, 0x00000020, /* 00000020 //C 0f61d db	32 */
0x0000f61e, 0x0000005b, /* 0000005b //C 0f61e db	91 */
0x0000f61f, 0x00000076, /* 00000076 //C 0f61f db	118 */
0x0000f620, 0x00000061, /* 00000061 //C 0f620 db	97 */
0x0000f621, 0x0000006c, /* 0000006c //C 0f621 db	108 */
0x0000f622, 0x0000005d, /* 0000005d //C 0f622 db	93 */
...
0x0000f635, 0x00000052, /* 00000052 //C 0f635 db	82 */
0x0000f636, 0x00000031, /* 00000031 //C 0f636 db	49 */
0x0000f637, 0x00000034, /* 00000034 //C 0f637 db	52 */
0x0000f638, 0x0000000a, /* 0000000a //C 0f638 db	10 */
0x0000f639, 0x00000000, /* 00000000 //C 0f639 db */
0x0000f63a, 0x00000070, /* 00000070 //C 0f63a db	112 */
0x0000f63b, 0x00000063, /* 00000063 //C 0f63b db	99 */
0x0000f63c, 0x00000020, /* 00000020 //C 0f63c db	32 */
0x0000f63d, 0x0000005b, /* 0000005b //C 0f63d db	91 */
0x0000f63e, 0x00000076, /* 00000076 //C 0f63e db	118 */
0x0000f63f, 0x00000061, /* 00000061 //C 0f63f db	97 */
0x0000f640, 0x0000006c, /* 0000006c //C 0f640 db	108 */
...
0x0000f64c, 0x00000047, /* 00000047 //C 0f64c db	71 */
0x0000f64d, 0x00000065, /* 00000065 //C 0f64d db	101 */
0x0000f64e, 0x00000074, /* 00000074 //C 0f64e db	116 */
0x0000f64f, 0x0000002f, /* 0000002f //C 0f64f db	47 */
0x0000f650, 0x00000073, /* 00000073 //C 0f650 db	115 */
0x0000f651, 0x00000065, /* 00000065 //C 0f651 db	101 */
0x0000f652, 0x00000074, /* 00000074 //C 0f652 db	116 */
0x0000f653, 0x00000020, /* 00000020 //C 0f653 db	32 */
0x0000f654, 0x00000052, /* 00000052 //C 0f654 db	82 */
0x0000f655, 0x00000031, /* 00000031 //C 0f655 db	49 */
0x0000f656, 0x00000035, /* 00000035 //C 0f656 db	53 */
0x0000f657, 0x0000000a, /* 0000000a //C 0f657 db	10 */
0x0000f658, 0x00000000, /* 00000000 //C 0f658 db */
0x0000f659, 0x00000066, /* 00000066 //C 0f659 db	102 */
0x0000f65a, 0x00000020, /* 00000020 //C 0f65a db	32 */
0x0000f65b, 0x0000005b, /* 0000005b //C 0f65b db	91 */
0x0000f65c, 0x00000076, /* 00000076 //C 0f65c db	118 */
0x0000f65d, 0x00000061, /* 00000061 //C 0f65d db	97 */
0x0000f65e, 0x0000006c, /* 0000006c //C 0f65e db	108 */
0x0000f65f, 0x0000005d, /* 0000005d //C 0f65f db	93 */
...
0x0000f66b, 0x00000047, /* 00000047 //C 0f66b db	71 */
0x0000f66c, 0x00000065, /* 00000065 //C 0f66c db	101 */
0x0000f66d, 0x00000074, /* 00000074 //C 0f66d db	116 */
0x0000f66e, 0x0000002f, /* 0000002f //C 0f66e db	47 */
...
0x0000f673, 0x00000066, /* 00000066 //C 0f673 db	102 */
0x0000f674, 0x0000006c, /* 0000006c //C 0f674 db	108 */
0x0000f675, 0x00000061, /* 00000061 //C 0f675 db	97 */
0x0000f676, 0x00000067, /* 00000067 //C 0f676 db	103 */
0x0000f677, 0x00000073, /* 00000073 //C 0f677 db	115 */
0x0000f678, 0x0000000a, /* 0000000a //C 0f678 db	10 */
0x0000f679, 0x00000000, /* 00000000 //C 0f679 db */
0x0000f67a, 0x00000068, /* 00000068 //C 0f67a db	104 */
0x0000f67b, 0x0000002c, /* 0000002c //C 0f67b db	44 */
0x0000f67c, 0x0000003f, /* 0000003f //C 0f67c db	63 */
...
0x0000f68c, 0x00000048, /* 00000048 //C 0f68c db	72 */
0x0000f68d, 0x00000065, /* 00000065 //C 0f68d db	101 */
0x0000f68e, 0x0000006c, /* 0000006c //C 0f68e db	108 */
0x0000f68f, 0x00000070, /* 00000070 //C 0f68f db	112 */
0x0000f690, 0x0000000a, /* 0000000a //C 0f690 db	10 */
0x0000f691, 0x00000000, /* 00000000 //C 0f691 db */
0x0000f692, 0x00000000, /* 00000000 //C 0f692 dd	0 */
0x0000f6d4, 0x00000045, /* 00000045 //C 0f6d4 db	69 */
0x0000f6d5, 0x0000004f, /* 0000004f //C 0f6d5 db	79 */
0x0000f6d6, 0x00000046, /* 00000046 //C 0f6d6 db	70 */
0x0000f6d7, 0x00000020, /* 00000020 //C 0f6d7 db	32 */
0x0000f6d8, 0x00000050, /* 00000050 //C 0f6d8 db	80 */
0x0000f6d9, 0x0000004d, /* 0000004d //C 0f6d9 db	77 */
0x0000f6da, 0x0000006f, /* 0000006f //C 0f6da db	111 */
0x0000f6db, 0x0000006e, /* 0000006e //C 0f6db db	110 */
0x0000f6dc, 0x00000069, /* 00000069 //C 0f6dc db	105 */
0x0000f6dd, 0x00000074, /* 00000074 //C 0f6dd db	116 */
0x0000f6de, 0x0000006f, /* 0000006f //C 0f6de db	111 */
0x0000f6df, 0x00000072, /* 00000072 //C 0f6df db	114 */
0x0000f6e0, 0x0000000a, /* 0000000a //C 0f6e0 db	10 */
0x0000f6e1, 0x00000000, /* 00000000 //C 0f6e1 db */
