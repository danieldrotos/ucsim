...
0x0000f801, 0x01f2f9b5, /* 01f2f9b5 //C 0f801 _f801:	jmp	strchr */
0x0000f802, 0x01f2f9f0, /* 01f2f9f0 //C 0f802 _f802:	jmp	streq */
0x0000f803, 0x01f2f9f7, /* 01f2f9f7 //C 0f803 _f803:	jmp	strieq */
0x0000f804, 0x01f2f9fe, /* 01f2f9fe //C 0f804 _f804:	jmp	hexchar2value */
0x0000f805, 0x01f2fa2d, /* 01f2fa2d //C 0f805 _f805:	jmp	value2hexchar */
0x0000f806, 0x01f2fa32, /* 01f2fa32 //C 0f806 _f806:	jmp	htoi */
0x0000f807, 0x01f2fa54, /* 01f2fa54 //C 0f807 _f807:	jmp	check_uart */
0x0000f808, 0x01f2fa5c, /* 01f2fa5c //C 0f808 _f808:	jmp	read */
0x0000f809, 0x01f2fa5f, /* 01f2fa5f //C 0f809 _f809:	jmp	putchar */
0x0000f80a, 0x01f2fa6a, /* 01f2fa6a //C 0f80a _f80a:	jmp	prints */
0x0000f80b, 0x01f2fa7e, /* 01f2fa7e //C 0f80b _f80b:	jmp	printsnl */
0x0000f80c, 0x01f2fa86, /* 01f2fa86 //C 0f80c _f80c:	jmp	print_vhex */
0x0000f80d, 0x01f2f80e, /* 01f2f80e //C 0f80d jmp	start */
0x0000f80e, 0x01d2fc67, /* 01d2fc67 //C 0f80e mvzl	sp,stack_end */
0x0000f80f, 0x01020001, /* 01020001 //C 0f80f mvzl	r0,1 */
0x0000f810, 0x0112fb18, /* 0112fb18 //C 0f810 mvzl	r1,echo */
...
0x0000f818, 0x0102fb19, /* 0102fb19 //C 0f818 mvzl	r0,msg_start */
0x0000f819, 0x0400fa7e, /* 0400fa7e //C 0f819 call	printsnl */
...
0x0000f81d, 0x0102fb11, /* 0102fb11 //C 0f81d mvzl	r0,line_ptr	; lptr= 0 */
0x0000f81e, 0x01120000, /* 01120000 //C 0f81e mvzl	r1,0 */
0x0000f81f, 0x0c100000, /* 0c100000 //C 0f81f st	r1,r0 */
0x0000f820, 0x0102faad, /* 0102faad //C 0f820 mvzl	r0,line		; line[0]= 0 */
0x0000f821, 0x0c100000, /* 0c100000 //C 0f821 st	r1,r0 */
0x0000f822, 0x0102fb12, /* 0102fb12 //C 0f822 mvzl	r0,at_eol	; at_eol= 1 */
0x0000f823, 0x01120001, /* 01120001 //C 0f823 mvzl	r1,1 */
0x0000f824, 0x0c100000, /* 0c100000 //C 0f824 st	r1,r0 */
0x0000f825, 0x0102fb27, /* 0102fb27 //C 0f825 mvzl	r0,prompt */
0x0000f826, 0x0400fa6a, /* 0400fa6a //C 0f826 call	prints */
0x0000f827, 0x0fed0000, /* 0fed0000 //C 0f827 pop	lr */
0x0000f828, 0x00f00e00, /* 00f00e00 //C 0f828 ret */
0x0000f829, 0x0400fa54, /* 0400fa54 //C 0f829 call	check_uart */
0x0000f82a, 0x41f2f830, /* 41f2f830 //C 0f82a C0 jmp	no_input */
0x0000f82b, 0x0400fa5c, /* 0400fa5c //C 0f82b call	read */
...
0x0000f836, 0x0112fb12, /* 0112fb12 //C 0f836 mvzl	r1,at_eol	; at_aol= 0 */
0x0000f837, 0x01220000, /* 01220000 //C 0f837 mvzl	r2,0 */
0x0000f838, 0x0c210000, /* 0c210000 //C 0f838 st	r2,r1 */
0x0000f839, 0x0112fb11, /* 0112fb11 //C 0f839 mvzl	r1,line_ptr	; line[line_ptr]= char */
0x0000f83a, 0x0e310000, /* 0e310000 //C 0f83a ld	r3,r1 */
0x0000f83b, 0x0122faad, /* 0122faad //C 0f83b mvzl	r2,line */
...
0x0000f842, 0x0142fb18, /* 0142fb18 //C 0f842 mvzl	r4,echo		; check if echo is turned on */
0x0000f843, 0x0e440000, /* 0e440000 //C 0f843 ld	r4,r4 */
0x0000f844, 0x024b0000, /* 024b0000 //C 0f844 sz	r4 */
0x0000f845, 0x2400fa5f, /* 2400fa5f //C 0f845 NZ call	putchar		; echo */
0x0000f846, 0x020d0000, /* 020d0000 //C 0f846 clc */
0x0000f847, 0x01f2f84d, /* 01f2f84d //C 0f847 jmp	proc_input_ret */
0x0000f848, 0x0112fb12, /* 0112fb12 //C 0f848 mvzl	r1,at_eol */
...
0x0000f851, 0x0400fa5f, /* 0400fa5f //C 0f851 call	putchar */
...
0x0000f858, 0x0400fa7e, /* 0400fa7e //C 0f858 call	printsnl */
0x0000f859, 0x0102fb12, /* 0102fb12 //C 0f859 mvzl	r0,at_eol	; at_eol= 1 */
...
0x0000f874, 0x0112fb29, /* 0112fb29 //C 0f874 mvzl	r1,delimiters */
0x0000f875, 0x0400f9b5, /* 0400f9b5 //C 0f875 call	strchr */
...
0x0000f879, 0x0142fb13, /* 0142fb13 //C 0f879 mvzl	r4,words	; array of result */
0x0000f87a, 0x0152faad, /* 0152faad //C 0f87a mvzl	r5,line		; address of next char */
...
0x0000f89e, 0x0102fb13, /* 0102fb13 //C 0f89e mvzl	r0,words	; R0= 1st word of command */
...
0x0000f8a2, 0x01a2fb39, /* 01a2fb39 //C 0f8a2 mvzl	r10,commands */
...
0x0000f8ad, 0x0400f9f0, /* 0400f9f0 //C 0f8ad call	streq */
...
0x0000f8bb, 0x0400f9f0, /* 0400f9f0 //C 0f8bb call	streq */
...
0x0000f8c8, 0x0122fb13, /* 0122fb13 //C 0f8c8 mvzl	r2,words */
...
0x0000f8cf, 0x0400fa32, /* 0400fa32 //C 0f8cf call	htoi */
...
0x0000f8d3, 0x0400fa7e, /* 0400fa7e //C 0f8d3 call	printsnl */
...
0x0000f8e1, 0x0400fa7e, /* 0400fa7e //C 0f8e1 call	printsnl */
...
0x0000f8e6, 0x0400fa86, /* 0400fa86 //C 0f8e6 call	print_vhex */
0x0000f8e7, 0x01020020, /* 01020020 //C 0f8e7 mvzl	r0,0x20 */
0x0000f8e8, 0x0400fa5f, /* 0400fa5f //C 0f8e8 call	putchar */
0x0000f8e9, 0x0e040000, /* 0e040000 //C 0f8e9 ld	r0,r4 */
0x0000f8ea, 0x01120004, /* 01120004 //C 0f8ea mvzl	r1,4 */
0x0000f8eb, 0x0400fa86, /* 0400fa86 //C 0f8eb call	print_vhex */
0x0000f8ec, 0x0102000a, /* 0102000a //C 0f8ec mvzl	r0,LF */
0x0000f8ed, 0x0400fa5f, /* 0400fa5f //C 0f8ed call	putchar */
...
0x0000f91d, 0x0122fb13, /* 0122fb13 //C 0f91d mvzl	r2,words */
0x0000f91e, 0x0e020001, /* 0e020001 //C 0f91e ld	r0,r2,1		; start address */
0x0000f91f, 0x0400fa32, /* 0400fa32 //C 0f91f call	htoi */
...
0x0000f927, 0x0400fa32, /* 0400fa32 //C 0f927 call	htoi */
...
0x0000f93a, 0x0400fa7e, /* 0400fa7e //C 0f93a call	printsnl */
...
0x0000f955, 0x0400fa54, /* 0400fa54 //C 0f955 call	check_uart */
0x0000f956, 0x41f2f955, /* 41f2f955 //C 0f956 C0 jmp	l_cyc */
0x0000f957, 0x0400fa5c, /* 0400fa5c //C 0f957 call	read */
...
0x0000f95f, 0x0400f9fe, /* 0400f9fe //C 0f95f call	hexchar2value */
...
0x0000f987, 0x0400f9fe, /* 0400f9fe //C 0f987 call	hexchar2value */
...
0x0000f993, 0x0400f9fe, /* 0400f9fe //C 0f993 call	hexchar2value */
...
0x0000f9a9, 0x0400fa5f, /* 0400fa5f //C 0f9a9 call	putchar */
...
0x0000f9af, 0x0400fa5f, /* 0400fa5f //C 0f9af call	putchar */
...
0x0000f9b3, 0x0fed0000, /* 0fed0000 //C 0f9b3 pop	lr */
0x0000f9b4, 0x00f00e00, /* 00f00e00 //C 0f9b4 ret */
0x0000f9b5, 0x0d1d0000, /* 0d1d0000 //C 0f9b5 push	r1 */
0x0000f9b6, 0x0d2d0000, /* 0d2d0000 //C 0f9b6 push	r2 */
0x0000f9b7, 0x0e210000, /* 0e210000 //C 0f9b7 ld	r2,r1 */
0x0000f9b8, 0x022b0000, /* 022b0000 //C 0f9b8 sz	r2 */
0x0000f9b9, 0x11f2f9c0, /* 11f2f9c0 //C 0f9b9 jz	strchr_no	; eof string found */
0x0000f9ba, 0x00280000, /* 00280000 //C 0f9ba cmp	r2,r0		; compare */
0x0000f9bb, 0x11f2f9be, /* 11f2f9be //C 0f9bb jz	strchr_yes */
0x0000f9bc, 0x011a0001, /* 011a0001 //C 0f9bc plus	r1,1		; go to next char */
0x0000f9bd, 0x01f2f9b7, /* 01f2f9b7 //C 0f9bd jmp	strchr_cyc */
0x0000f9be, 0x020c0000, /* 020c0000 //C 0f9be sec */
0x0000f9bf, 0x01f2f9c2, /* 01f2f9c2 //C 0f9bf jmp	strchr_ret */
0x0000f9c0, 0x01120000, /* 01120000 //C 0f9c0 mvzl	r1,0 */
0x0000f9c1, 0x020d0000, /* 020d0000 //C 0f9c1 clc */
0x0000f9c2, 0x0f2d0000, /* 0f2d0000 //C 0f9c2 pop	r2 */
0x0000f9c3, 0x0f1d0000, /* 0f1d0000 //C 0f9c3 pop	r1 */
0x0000f9c4, 0x00f00e00, /* 00f00e00 //C 0f9c4 ret */
0x0000f9c5, 0x0ded0000, /* 0ded0000 //C 0f9c5 push	lr		; Save used registers */
0x0000f9c6, 0x0d0d0000, /* 0d0d0000 //C 0f9c6 push	r0		; and input parameters */
0x0000f9c7, 0x0d1d0000, /* 0d1d0000 //C 0f9c7 push	r1 */
0x0000f9c8, 0x0d2d0000, /* 0d2d0000 //C 0f9c8 push	r2 */
0x0000f9c9, 0x0d4d0000, /* 0d4d0000 //C 0f9c9 push	r4 */
0x0000f9ca, 0x0d5d0000, /* 0d5d0000 //C 0f9ca push	r5 */
0x0000f9cb, 0x0d6d0000, /* 0d6d0000 //C 0f9cb push	r6 */
0x0000f9cc, 0x0e200000, /* 0e200000 //C 0f9cc ld	r2,r0		; Got one-one char */
0x0000f9cd, 0x0e610000, /* 0e610000 //C 0f9cd ld	r6,r1		; from two strings */
0x0000f9ce, 0x023b0000, /* 023b0000 //C 0f9ce sz	r3		; Prepare for comparing */
0x0000f9cf, 0x112d0020, /* 112d0020 //C 0f9cf Z1 or	r2,0x20		; if insensitive case */
0x0000f9d0, 0x023b0000, /* 023b0000 //C 0f9d0 sz	r3 */
0x0000f9d1, 0x116d0020, /* 116d0020 //C 0f9d1 Z1 or	r6,0x20 */
0x0000f9d2, 0x00280600, /* 00280600 //C 0f9d2 cmp	r2,r6		; compare them */
0x0000f9d3, 0x21f2f9e5, /* 21f2f9e5 //C 0f9d3 jnz	streq_no	; if differs: strings are not equal */
0x0000f9d4, 0x0e200000, /* 0e200000 //C 0f9d4 ld	r2,r0		; Pick original (non-prepared) */
0x0000f9d5, 0x0e610000, /* 0e610000 //C 0f9d5 ld	r6,r1		; chars to check EOS */
0x0000f9d6, 0x022b0000, /* 022b0000 //C 0f9d6 sz	r2		; convert them to boolean */
0x0000f9d7, 0x21220001, /* 21220001 //C 0f9d7 Z0 mvzl	r2,1		; values in R2,R6 */
0x0000f9d8, 0x11220000, /* 11220000 //C 0f9d8 Z1 mvzl	r2,0		; and copy in R4,R5 */
0x0000f9d9, 0x00400200, /* 00400200 //C 0f9d9 mov	r4,r2 */
0x0000f9da, 0x026b0000, /* 026b0000 //C 0f9da sz	r6 */
0x0000f9db, 0x21620001, /* 21620001 //C 0f9db Z0 mvzl	r6,1 */
0x0000f9dc, 0x11620000, /* 11620000 //C 0f9dc Z1 mvzl r6,0 */
0x0000f9dd, 0x00500600, /* 00500600 //C 0f9dd mov	r5,r6 */
0x0000f9de, 0x004d0500, /* 004d0500 //C 0f9de or	r4,r5		; if both are EOS: equal */
0x0000f9df, 0x11f2f9e7, /* 11f2f9e7 //C 0f9df jz	streq_yes */
0x0000f9e0, 0x002f0600, /* 002f0600 //C 0f9e0 and 	r2,r6		; just one is EOS: not equal */
0x0000f9e1, 0x11f2f9e5, /* 11f2f9e5 //C 0f9e1 jz	streq_no */
0x0000f9e2, 0x010a0001, /* 010a0001 //C 0f9e2 plus	r0,1		; non are EOS: go to check next char */
0x0000f9e3, 0x011a0001, /* 011a0001 //C 0f9e3 plus	r1,1 */
0x0000f9e4, 0x01f2f9cc, /* 01f2f9cc //C 0f9e4 jmp	streq_cyc */
0x0000f9e5, 0x020d0000, /* 020d0000 //C 0f9e5 clc			; False result */
0x0000f9e6, 0x01f2f9e8, /* 01f2f9e8 //C 0f9e6 jmp	streq_ret */
0x0000f9e7, 0x020c0000, /* 020c0000 //C 0f9e7 sec			; True result */
0x0000f9e8, 0x0f6d0000, /* 0f6d0000 //C 0f9e8 pop	r6 */
0x0000f9e9, 0x0f5d0000, /* 0f5d0000 //C 0f9e9 pop	r5 */
0x0000f9ea, 0x0f4d0000, /* 0f4d0000 //C 0f9ea pop	r4 */
0x0000f9eb, 0x0f2d0000, /* 0f2d0000 //C 0f9eb pop	r2 */
0x0000f9ec, 0x0f1d0000, /* 0f1d0000 //C 0f9ec pop	r1 */
0x0000f9ed, 0x0f0d0000, /* 0f0d0000 //C 0f9ed pop	r0 */
0x0000f9ee, 0x0fed0000, /* 0fed0000 //C 0f9ee pop	lr */
0x0000f9ef, 0x00f00e00, /* 00f00e00 //C 0f9ef ret */
0x0000f9f0, 0x0ded0000, /* 0ded0000 //C 0f9f0 push	lr */
0x0000f9f1, 0x0d3d0000, /* 0d3d0000 //C 0f9f1 push	r3 */
0x0000f9f2, 0x01320001, /* 01320001 //C 0f9f2 mvzl	r3,1 */
0x0000f9f3, 0x0400f9c5, /* 0400f9c5 //C 0f9f3 call	str_cmp_eq */
0x0000f9f4, 0x0f3d0000, /* 0f3d0000 //C 0f9f4 pop	r3 */
0x0000f9f5, 0x0fed0000, /* 0fed0000 //C 0f9f5 pop	lr */
0x0000f9f6, 0x00f00e00, /* 00f00e00 //C 0f9f6 ret */
0x0000f9f7, 0x0ded0000, /* 0ded0000 //C 0f9f7 push	lr */
0x0000f9f8, 0x0d3d0000, /* 0d3d0000 //C 0f9f8 push	r3 */
0x0000f9f9, 0x01320000, /* 01320000 //C 0f9f9 mvzl	r3,0 */
0x0000f9fa, 0x0400f9c5, /* 0400f9c5 //C 0f9fa call	str_cmp_eq */
0x0000f9fb, 0x0f3d0000, /* 0f3d0000 //C 0f9fb pop	r3 */
0x0000f9fc, 0x0fed0000, /* 0fed0000 //C 0f9fc pop	lr */
0x0000f9fd, 0x00f00e00, /* 00f00e00 //C 0f9fd ret */
0x0000f9fe, 0x0108002f, /* 0108002f //C 0f9fe cmp	r0,'/' */
0x0000f9ff, 0xa1f2fa14, /* a1f2fa14 //C 0f9ff LS jmp	hc2v_nok */
0x0000fa00, 0x01080039, /* 01080039 //C 0fa00 cmp	r0,'9' */
0x0000fa01, 0xa1f2fa11, /* a1f2fa11 //C 0fa01 LS jmp	hc2v_0_9 */
0x0000fa02, 0x01080040, /* 01080040 //C 0fa02 cmp	r0,'@' */
0x0000fa03, 0xa1f2fa14, /* a1f2fa14 //C 0fa03 LS jmp	hc2v_nok */
0x0000fa04, 0x01080046, /* 01080046 //C 0fa04 cmp	r0,'F' */
0x0000fa05, 0xa1f2fa0e, /* a1f2fa0e //C 0fa05 LS jmp	hc2v_A_F */
0x0000fa06, 0x01080060, /* 01080060 //C 0fa06 cmp	r0,'`' */
0x0000fa07, 0xa1f2fa14, /* a1f2fa14 //C 0fa07 LS jmp	hc2v_nok */
0x0000fa08, 0x01080066, /* 01080066 //C 0fa08 cmp	r0,'f' */
0x0000fa09, 0xa1f2fa0b, /* a1f2fa0b //C 0fa09 LS jmp	hc2v_a_f */
0x0000fa0a, 0x01f2fa14, /* 01f2fa14 //C 0fa0a jmp	hc2v_nok */
0x0000fa0b, 0x0104000a, /* 0104000a //C 0fa0b add	r0,10 */
0x0000fa0c, 0x01060061, /* 01060061 //C 0fa0c sub	r0,'a' */
0x0000fa0d, 0x01f2fa12, /* 01f2fa12 //C 0fa0d jmp	hc2v_ok */
0x0000fa0e, 0x0104000a, /* 0104000a //C 0fa0e add	r0,10 */
0x0000fa0f, 0x01060041, /* 01060041 //C 0fa0f sub	r0,'A' */
0x0000fa10, 0x01f2fa12, /* 01f2fa12 //C 0fa10 jmp	hc2v_ok */
0x0000fa11, 0x01060030, /* 01060030 //C 0fa11 sub	r0,'0' */
0x0000fa12, 0x020c0000, /* 020c0000 //C 0fa12 sec */
0x0000fa13, 0x00f00e00, /* 00f00e00 //C 0fa13 ret */
0x0000fa14, 0x020d0000, /* 020d0000 //C 0fa14 clc */
0x0000fa15, 0x00f00e00, /* 00f00e00 //C 0fa15 ret */
0x0000fa16, 0x0d1d0000, /* 0d1d0000 //C 0fa16 push	r1 */
0x0000fa17, 0x010f000f, /* 010f000f //C 0fa17 and	r0,0xf */
0x0000fa18, 0x0112fa1c, /* 0112fa1c //C 0fa18 mvzl	r1,v2hc_table */
0x0000fa19, 0x0a010000, /* 0a010000 //C 0fa19 ld	r0,r1,r0 */
0x0000fa1a, 0x0f1d0000, /* 0f1d0000 //C 0fa1a pop	r1 */
0x0000fa1b, 0x00f00e00, /* 00f00e00 //C 0fa1b ret */
0x0000fa1c, 0x00000030, /* 00000030 //C 0fa1c db	48 */
0x0000fa1d, 0x00000031, /* 00000031 //C 0fa1d db	49 */
0x0000fa1e, 0x00000032, /* 00000032 //C 0fa1e db	50 */
0x0000fa1f, 0x00000033, /* 00000033 //C 0fa1f db	51 */
0x0000fa20, 0x00000034, /* 00000034 //C 0fa20 db	52 */
0x0000fa21, 0x00000035, /* 00000035 //C 0fa21 db	53 */
0x0000fa22, 0x00000036, /* 00000036 //C 0fa22 db	54 */
0x0000fa23, 0x00000037, /* 00000037 //C 0fa23 db	55 */
0x0000fa24, 0x00000038, /* 00000038 //C 0fa24 db	56 */
0x0000fa25, 0x00000039, /* 00000039 //C 0fa25 db	57 */
0x0000fa26, 0x00000041, /* 00000041 //C 0fa26 db	65 */
0x0000fa27, 0x00000042, /* 00000042 //C 0fa27 db	66 */
0x0000fa28, 0x00000043, /* 00000043 //C 0fa28 db	67 */
0x0000fa29, 0x00000044, /* 00000044 //C 0fa29 db	68 */
0x0000fa2a, 0x00000045, /* 00000045 //C 0fa2a db	69 */
0x0000fa2b, 0x00000046, /* 00000046 //C 0fa2b db	70 */
0x0000fa2c, 0x00000000, /* 00000000 //C 0fa2c db */
0x0000fa2d, 0x0ded0000, /* 0ded0000 //C 0fa2d push	lr */
0x0000fa2e, 0x0400fa16, /* 0400fa16 //C 0fa2e call	value2Hexchar */
0x0000fa2f, 0x010d0020, /* 010d0020 //C 0fa2f or	r0,0x20 */
0x0000fa30, 0x0fed0000, /* 0fed0000 //C 0fa30 pop	lr */
0x0000fa31, 0x00f00e00, /* 00f00e00 //C 0fa31 ret */
0x0000fa32, 0x0ded0000, /* 0ded0000 //C 0fa32 push	lr */
0x0000fa33, 0x0d2d0000, /* 0d2d0000 //C 0fa33 push	r2 */
0x0000fa34, 0x0d3d0000, /* 0d3d0000 //C 0fa34 push	r3 */
0x0000fa35, 0x01120000, /* 01120000 //C 0fa35 mvzl	r1,0		; return value */
0x0000fa36, 0x01320000, /* 01320000 //C 0fa36 mvzl	r3,0		; index */
0x0000fa37, 0x0b238000, /* 0b238000 //C 0fa37 ld	r2,r3+,r0	; pick a char */
0x0000fa38, 0x022b0000, /* 022b0000 //C 0fa38 sz	r2		; check eof string */
0x0000fa39, 0x11f2fa4d, /* 11f2fa4d //C 0fa39 jz	htoi_eos */
0x0000fa3a, 0x0128002e, /* 0128002e //C 0fa3a cmp	r2,'.'		; skip separators */
0x0000fa3b, 0x11f2fa37, /* 11f2fa37 //C 0fa3b jz	htoi_cyc */
0x0000fa3c, 0x0128005f, /* 0128005f //C 0fa3c cmp	r2,'_' */
0x0000fa3d, 0x11f2fa37, /* 11f2fa37 //C 0fa3d jz	htoi_cyc */
0x0000fa3e, 0x0d0d0000, /* 0d0d0000 //C 0fa3e push	r0 */
0x0000fa3f, 0x00000200, /* 00000200 //C 0fa3f mov	r0,r2 */
0x0000fa40, 0x0400f9fe, /* 0400f9fe //C 0fa40 call	hexchar2value */
0x0000fa41, 0x00200000, /* 00200000 //C 0fa41 mov	r2,r0 */
0x0000fa42, 0x0f0d0000, /* 0f0d0000 //C 0fa42 pop	r0 */
0x0000fa43, 0x41f2fa4b, /* 41f2fa4b //C 0fa43 C0 jmp	htoi_nok */
0x0000fa44, 0x02180000, /* 02180000 //C 0fa44 shl	r1 */
0x0000fa45, 0x02180000, /* 02180000 //C 0fa45 shl	r1 */
0x0000fa46, 0x02180000, /* 02180000 //C 0fa46 shl	r1 */
0x0000fa47, 0x02180000, /* 02180000 //C 0fa47 shl	r1 */
0x0000fa48, 0x012f000f, /* 012f000f //C 0fa48 and	r2,0xf */
0x0000fa49, 0x001d0200, /* 001d0200 //C 0fa49 or	r1,r2 */
0x0000fa4a, 0x01f2fa37, /* 01f2fa37 //C 0fa4a jmp	htoi_cyc */
0x0000fa4b, 0x020d0000, /* 020d0000 //C 0fa4b clc */
0x0000fa4c, 0x01f2fa50, /* 01f2fa50 //C 0fa4c jmp	htoi_ret */
0x0000fa4d, 0x01380001, /* 01380001 //C 0fa4d cmp	r3,1 */
0x0000fa4e, 0x920d0000, /* 920d0000 //C 0fa4e HI clc */
0x0000fa4f, 0xa20c0000, /* a20c0000 //C 0fa4f LS sec */
0x0000fa50, 0x0f3d0000, /* 0f3d0000 //C 0fa50 pop	r3 */
0x0000fa51, 0x0f2d0000, /* 0f2d0000 //C 0fa51 pop	r2 */
0x0000fa52, 0x0fed0000, /* 0fed0000 //C 0fa52 pop	lr */
0x0000fa53, 0x00f00e00, /* 00f00e00 //C 0fa53 ret */
0x0000fa54, 0x0d0d0000, /* 0d0d0000 //C 0fa54 push	r0 */
0x0000fa55, 0x0102ff42, /* 0102ff42 //C 0fa55 mvzl	r0,UART_RSTAT */
0x0000fa56, 0x0e000000, /* 0e000000 //C 0fa56 ld	r0,r0 */
0x0000fa57, 0x010c0001, /* 010c0001 //C 0fa57 test	r0,1 */
0x0000fa58, 0x020d0000, /* 020d0000 //C 0fa58 clc */
0x0000fa59, 0x220c0000, /* 220c0000 //C 0fa59 Z0 sec */
0x0000fa5a, 0x0f0d0000, /* 0f0d0000 //C 0fa5a pop	r0 */
0x0000fa5b, 0x00f00e00, /* 00f00e00 //C 0fa5b ret */
0x0000fa5c, 0x0102ff40, /* 0102ff40 //C 0fa5c mvzl	r0,UART_DR */
0x0000fa5d, 0x0e000000, /* 0e000000 //C 0fa5d ld	r0,r0 */
0x0000fa5e, 0x00f00e00, /* 00f00e00 //C 0fa5e ret */
0x0000fa5f, 0x0d2d0000, /* 0d2d0000 //C 0fa5f push	r2 */
0x0000fa60, 0x0d9d0000, /* 0d9d0000 //C 0fa60 push	r9 */
0x0000fa61, 0x0122ff43, /* 0122ff43 //C 0fa61 mvzl	r2,UART_TSTAT */
0x0000fa62, 0x0e920000, /* 0e920000 //C 0fa62 ld	r9,r2 */
0x0000fa63, 0x019c0001, /* 019c0001 //C 0fa63 test	r9,1 */
0x0000fa64, 0x11f2fa62, /* 11f2fa62 //C 0fa64 jz	wait_tc */
0x0000fa65, 0x0122ff40, /* 0122ff40 //C 0fa65 mvzl	r2,UART_DR */
0x0000fa66, 0x0c020000, /* 0c020000 //C 0fa66 st	r0,r2 */
0x0000fa67, 0x0f9d0000, /* 0f9d0000 //C 0fa67 pop	r9 */
0x0000fa68, 0x0f2d0000, /* 0f2d0000 //C 0fa68 pop	r2 */
0x0000fa69, 0x00f00e00, /* 00f00e00 //C 0fa69 ret */
0x0000fa6a, 0x0ded0000, /* 0ded0000 //C 0fa6a push	lr */
0x0000fa6b, 0x0d0d0000, /* 0d0d0000 //C 0fa6b push	r0 */
0x0000fa6c, 0x0d3d0000, /* 0d3d0000 //C 0fa6c push	r3 */
0x0000fa6d, 0x0d4d0000, /* 0d4d0000 //C 0fa6d push	r4 */
0x0000fa6e, 0x01420000, /* 01420000 //C 0fa6e mvzl	r4,0 */
0x0000fa6f, 0x020b0000, /* 020b0000 //C 0fa6f sz	r0 */
0x0000fa70, 0x1102fb32, /* 1102fb32 //C 0fa70 Z1 mvzl	r0,null_str */
0x0000fa71, 0x0b348000, /* 0b348000 //C 0fa71 ld	r3,r4+,r0 */
0x0000fa72, 0x023b0000, /* 023b0000 //C 0fa72 sz	r3 */
0x0000fa73, 0x11f2fa79, /* 11f2fa79 //C 0fa73 jz	prints_done */
0x0000fa74, 0x0d0d0000, /* 0d0d0000 //C 0fa74 push	r0 */
0x0000fa75, 0x00000300, /* 00000300 //C 0fa75 mov	r0,r3 */
0x0000fa76, 0x0400fa5f, /* 0400fa5f //C 0fa76 call	putchar */
0x0000fa77, 0x0f0d0000, /* 0f0d0000 //C 0fa77 pop	r0 */
0x0000fa78, 0x01f2fa71, /* 01f2fa71 //C 0fa78 jmp	prints_go */
0x0000fa79, 0x0f4d0000, /* 0f4d0000 //C 0fa79 pop	r4 */
0x0000fa7a, 0x0f3d0000, /* 0f3d0000 //C 0fa7a pop	r3 */
0x0000fa7b, 0x0f0d0000, /* 0f0d0000 //C 0fa7b pop	r0 */
0x0000fa7c, 0x0fed0000, /* 0fed0000 //C 0fa7c pop	lr */
0x0000fa7d, 0x00f00e00, /* 00f00e00 //C 0fa7d ret */
0x0000fa7e, 0x0ded0000, /* 0ded0000 //C 0fa7e push	lr */
0x0000fa7f, 0x0400fa6a, /* 0400fa6a //C 0fa7f call	prints */
0x0000fa80, 0x0d0d0000, /* 0d0d0000 //C 0fa80 push	r0 */
0x0000fa81, 0x0102000a, /* 0102000a //C 0fa81 mvzl	r0,LF */
0x0000fa82, 0x0400fa5f, /* 0400fa5f //C 0fa82 call	putchar */
0x0000fa83, 0x0f0d0000, /* 0f0d0000 //C 0fa83 pop	r0 */
0x0000fa84, 0x0fed0000, /* 0fed0000 //C 0fa84 pop	lr */
0x0000fa85, 0x00f00e00, /* 00f00e00 //C 0fa85 ret */
0x0000fa86, 0x0ded0000, /* 0ded0000 //C 0fa86 push	lr */
0x0000fa87, 0x0d0d0000, /* 0d0d0000 //C 0fa87 push	r0 */
0x0000fa88, 0x0d1d0000, /* 0d1d0000 //C 0fa88 push	r1 */
0x0000fa89, 0x0d2d0000, /* 0d2d0000 //C 0fa89 push	r2 */
0x0000fa8a, 0x0d3d0000, /* 0d3d0000 //C 0fa8a push	r3 */
0x0000fa8b, 0x0d4d0000, /* 0d4d0000 //C 0fa8b push	r4 */
0x0000fa8c, 0x00300000, /* 00300000 //C 0fa8c mov	r3,r0 */
0x0000fa8d, 0x01220000, /* 01220000 //C 0fa8d mvzl	r2,0 */
0x0000fa8e, 0x01420001, /* 01420001 //C 0fa8e mvzl	r4,1 */
0x0000fa8f, 0x01020000, /* 01020000 //C 0fa8f mvzl	r0,0 */
0x0000fa90, 0x02380000, /* 02380000 //C 0fa90 shl	r3 */
0x0000fa91, 0x02070000, /* 02070000 //C 0fa91 rol	r0 */
0x0000fa92, 0x02380000, /* 02380000 //C 0fa92 shl	r3 */
0x0000fa93, 0x02070000, /* 02070000 //C 0fa93 rol	r0 */
0x0000fa94, 0x02380000, /* 02380000 //C 0fa94 shl	r3 */
0x0000fa95, 0x02070000, /* 02070000 //C 0fa95 rol	r0 */
0x0000fa96, 0x02380000, /* 02380000 //C 0fa96 shl	r3 */
0x0000fa97, 0x02070000, /* 02070000 //C 0fa97 rol	r0 */
0x0000fa98, 0x0400fa16, /* 0400fa16 //C 0fa98 call	value2Hexchar */
0x0000fa99, 0x0400fa5f, /* 0400fa5f //C 0fa99 call	putchar */
0x0000fa9a, 0x01240001, /* 01240001 //C 0fa9a add	r2,1 */
0x0000fa9b, 0x01280008, /* 01280008 //C 0fa9b cmp	r2,8 */
0x0000fa9c, 0x11f2faa6, /* 11f2faa6 //C 0fa9c jz	print_vhex_ret */
0x0000fa9d, 0x021b0000, /* 021b0000 //C 0fa9d sz	r1 */
0x0000fa9e, 0x11f2faa4, /* 11f2faa4 //C 0fa9e jz	print_vhex_nosep */
0x0000fa9f, 0x00480100, /* 00480100 //C 0fa9f cmp	r4,r1 */
0x0000faa0, 0x21f2faa4, /* 21f2faa4 //C 0faa0 jnz	print_vhex_nosep */
0x0000faa1, 0x0102005f, /* 0102005f //C 0faa1 mvzl	r0,'_' */
0x0000faa2, 0x0400fa5f, /* 0400fa5f //C 0faa2 call	putchar */
0x0000faa3, 0x01420000, /* 01420000 //C 0faa3 mvzl	r4,0 */
0x0000faa4, 0x01440001, /* 01440001 //C 0faa4 add	r4,1 */
0x0000faa5, 0x01f2fa8f, /* 01f2fa8f //C 0faa5 jmp	print_vhex_cyc */
0x0000faa6, 0x0f4d0000, /* 0f4d0000 //C 0faa6 pop	r4 */
0x0000faa7, 0x0f3d0000, /* 0f3d0000 //C 0faa7 pop	r3 */
0x0000faa8, 0x0f2d0000, /* 0f2d0000 //C 0faa8 pop	r2 */
0x0000faa9, 0x0f1d0000, /* 0f1d0000 //C 0faa9 pop	r1 */
0x0000faaa, 0x0f0d0000, /* 0f0d0000 //C 0faaa pop	r0 */
0x0000faab, 0x0fed0000, /* 0fed0000 //C 0faab pop	lr */
0x0000faac, 0x00f00e00, /* 00f00e00 //C 0faac ret */
0x0000fb19, 0x00000050, /* 00000050 //C 0fb19 db	80 */
0x0000fb1a, 0x0000004d, /* 0000004d //C 0fb1a db	77 */
0x0000fb1b, 0x0000006f, /* 0000006f //C 0fb1b db	111 */
0x0000fb1c, 0x0000006e, /* 0000006e //C 0fb1c db	110 */
0x0000fb1d, 0x00000069, /* 00000069 //C 0fb1d db	105 */
0x0000fb1e, 0x00000074, /* 00000074 //C 0fb1e db	116 */
0x0000fb1f, 0x0000006f, /* 0000006f //C 0fb1f db	111 */
0x0000fb20, 0x00000072, /* 00000072 //C 0fb20 db	114 */
0x0000fb21, 0x00000020, /* 00000020 //C 0fb21 db	32 */
0x0000fb22, 0x00000076, /* 00000076 //C 0fb22 db	118 */
0x0000fb23, 0x00000031, /* 00000031 //C 0fb23 db	49 */
0x0000fb24, 0x0000002e, /* 0000002e //C 0fb24 db	46 */
0x0000fb25, 0x00000030, /* 00000030 //C 0fb25 db	48 */
0x0000fb26, 0x00000000, /* 00000000 //C 0fb26 db */
0x0000fb27, 0x0000003e, /* 0000003e //C 0fb27 db	62 */
0x0000fb28, 0x00000000, /* 00000000 //C 0fb28 db */
0x0000fb29, 0x00000020, /* 00000020 //C 0fb29 db	32 */
0x0000fb2a, 0x0000003b, /* 0000003b //C 0fb2a db	59 */
0x0000fb2b, 0x00000009, /* 00000009 //C 0fb2b db	9 */
0x0000fb2c, 0x0000000b, /* 0000000b //C 0fb2c db	11 */
0x0000fb2d, 0x0000002c, /* 0000002c //C 0fb2d db	44 */
0x0000fb2e, 0x0000003d, /* 0000003d //C 0fb2e db	61 */
0x0000fb2f, 0x0000005b, /* 0000005b //C 0fb2f db	91 */
0x0000fb30, 0x0000005d, /* 0000005d //C 0fb30 db	93 */
0x0000fb31, 0x00000000, /* 00000000 //C 0fb31 db */
0x0000fb32, 0x00000028, /* 00000028 //C 0fb32 db	40 */
0x0000fb33, 0x0000006e, /* 0000006e //C 0fb33 db	110 */
0x0000fb34, 0x00000075, /* 00000075 //C 0fb34 db	117 */
0x0000fb35, 0x0000006c, /* 0000006c //C 0fb35 db	108 */
0x0000fb36, 0x0000006c, /* 0000006c //C 0fb36 db	108 */
0x0000fb37, 0x00000029, /* 00000029 //C 0fb37 db	41 */
...
0x0000fb3c, 0x0000f8c7, /* 0000f8c7 //C 0fb3c dd	cmd_m */
0x0000fb3d, 0x0000006d, /* 0000006d //C 0fb3d db	109 */
0x0000fb3e, 0x00000065, /* 00000065 //C 0fb3e db	101 */
0x0000fb3f, 0x0000006d, /* 0000006d //C 0fb3f db	109 */
...
0x0000fb43, 0x00000000, /* 00000000 //C 0fb43 db */
0x0000fb44, 0x0000f91c, /* 0000f91c //C 0fb44 dd	cmd_d */
0x0000fb45, 0x00000064, /* 00000064 //C 0fb45 db	100 */
0x0000fb46, 0x00000075, /* 00000075 //C 0fb46 db	117 */
0x0000fb47, 0x0000006d, /* 0000006d //C 0fb47 db	109 */
0x0000fb48, 0x00000070, /* 00000070 //C 0fb48 db	112 */
0x0000fb49, 0x00000000, /* 00000000 //C 0fb49 db */
0x0000fb4a, 0x0000f94f, /* 0000f94f //C 0fb4a dd	cmd_e */
0x0000fb4b, 0x00000065, /* 00000065 //C 0fb4b db	101 */
...
0x0000fb4f, 0x00000000, /* 00000000 //C 0fb4f db */
0x0000fb50, 0x0000f951, /* 0000f951 //C 0fb50 dd	cmd_l */
0x0000fb51, 0x0000006c, /* 0000006c //C 0fb51 db	108 */
0x0000fb52, 0x0000006f, /* 0000006f //C 0fb52 db	111 */
0x0000fb53, 0x00000061, /* 00000061 //C 0fb53 db	97 */
0x0000fb54, 0x00000064, /* 00000064 //C 0fb54 db	100 */
0x0000fb55, 0x00000000, /* 00000000 //C 0fb55 db */
0x0000fb56, 0x0000f9b2, /* 0000f9b2 //C 0fb56 dd	cmd_g */
0x0000fb57, 0x00000067, /* 00000067 //C 0fb57 db	103 */
0x0000fb58, 0x00000000, /* 00000000 //C 0fb58 db */
0x0000fb59, 0x0000f9b2, /* 0000f9b2 //C 0fb59 dd	cmd_g */
0x0000fb5a, 0x00000067, /* 00000067 //C 0fb5a db	103 */
0x0000fb5b, 0x0000006f, /* 0000006f //C 0fb5b db	111 */
0x0000fb5c, 0x00000000, /* 00000000 //C 0fb5c db */
0x0000fb5d, 0x0000f9b2, /* 0000f9b2 //C 0fb5d dd	cmd_g */
0x0000fb5e, 0x00000072, /* 00000072 //C 0fb5e db	114 */
0x0000fb5f, 0x00000000, /* 00000000 //C 0fb5f db */
0x0000fb60, 0x0000f9b2, /* 0000f9b2 //C 0fb60 dd	cmd_g */
0x0000fb61, 0x00000072, /* 00000072 //C 0fb61 db	114 */
0x0000fb62, 0x00000075, /* 00000075 //C 0fb62 db	117 */
0x0000fb63, 0x0000006e, /* 0000006e //C 0fb63 db	110 */
0x0000fb64, 0x00000000, /* 00000000 //C 0fb64 db */
0x0000fb65, 0x00000000, /* 00000000 //C 0fb65 dd	0 */
0x0000fb66, 0x00000000, /* 00000000 //C 0fb66 db	0 */
0x0000fc68, 0x00000045, /* 00000045 //C 0fc68 db	69 */
0x0000fc69, 0x0000004f, /* 0000004f //C 0fc69 db	79 */
0x0000fc6a, 0x00000046, /* 00000046 //C 0fc6a db	70 */
0x0000fc6b, 0x00000020, /* 00000020 //C 0fc6b db	32 */
0x0000fc6c, 0x00000050, /* 00000050 //C 0fc6c db	80 */
0x0000fc6d, 0x0000004d, /* 0000004d //C 0fc6d db	77 */
0x0000fc6e, 0x0000006f, /* 0000006f //C 0fc6e db	111 */
0x0000fc6f, 0x0000006e, /* 0000006e //C 0fc6f db	110 */
0x0000fc70, 0x00000069, /* 00000069 //C 0fc70 db	105 */
0x0000fc71, 0x00000074, /* 00000074 //C 0fc71 db	116 */
0x0000fc72, 0x0000006f, /* 0000006f //C 0fc72 db	111 */
0x0000fc73, 0x00000072, /* 00000072 //C 0fc73 db	114 */
0x0000fc74, 0x0000000a, /* 0000000a //C 0fc74 db	10 */
0x0000fc75, 0x00000000, /* 00000000 //C 0fc75 db */
