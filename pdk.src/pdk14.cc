...
cl_fppa14::cl_fppa14(class cl_pdk *the_puc, class cl_sim *asim):
  cl_fppa13(the_puc, asim)
{
}

cl_fppa14::cl_fppa14(class cl_pdk *the_puc, struct cpu_entry *IType, class cl_sim *asim):
  cl_fppa13(the_puc, IType, asim)
{
}
