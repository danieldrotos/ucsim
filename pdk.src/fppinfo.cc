...
struct fppinfo_t fppinfo[]= {
  ...
  /*  10 */ { "PFC151",     1,   0x80,  0x800, "",     "83B2"  },
  /*  11 */ { "PFC154",     1,   0x80,  0x800, "",     "83B2"  },
  /*  12 */ { "PFC161",     1,   0x80,  0x800, "",     "83B2"  },
  /*  13 */ { "PFC232",     2,   0x80,  0x800, "85A",  "83B2"  },
  /*  14 */ { "PFC460",     4,  0x200, 0x1000, "",     ""      },
  ...
  /*  19 */ { "PFS122",     1,  0x080, 0x0800, "",     "83B2"  },
  /*  20 */ { "PFS123",     1,  0x100, 0x0C00, "",     "83B2"  },
  ...
  /*  25 */ { "PFS172",     1,  0x080, 0x0800, "",     "83B2"  },
  /*  26 */ { "PFS173B",    1,  0x100, 0x0C00, "",     "83B2"  },
  /*  27 */ { "PFS173",     1,  0x100, 0x0C00, "",     "83B2"  },
