...
DEC(0x18, 18,	maxa	, _NONE		, "MAXA %p"	, ' ', -3	, 0x77644)
DEC(0x18, 19,	mina	, _NONE		, "MINA %p"	, ' ', -3	, 0x77644)
DEC(0x18, 1a,	emaxd	, _NONE		, "EMAXD %P"	, ' ', -3	, 0x77644)
DEC(0x18, 1b,	emind	, _NONE		, "EMIND %P"	, ' ', -3	, 0x77644)
DEC(0x18, 1c,	maxm	, _NONE		, "MAXM %p"	, ' ', -3	, 0x77644)
DEC(0x18, 1d,	minm	, _NONE		, "MINM %p"	, ' ', -3	, 0x77644)
