...
DEC(0, 30,	pul16	, _X		, "PULX"	, ' ', 1	, 3)
DEC(0, 31,	pul16	, _Y		, "PULY"	, ' ', 1	, 3)
DEC(0, 32,	pul8	, _A		, "PULA"	, ' ', 1	, 3)
DEC(0, 33,	pul8	, _B		, "PULB"	, ' ', 1	, 3)
DEC(0, 34,	psh16	, _Xop		, "PSHX"	, ' ', 1	, 2)
DEC(0, 35,	psh16	, _Yop		, "PSHY"	, ' ', 1	, 2)
DEC(0, 36,	psh8	, _Aop		, "PSHA"	, ' ', 1	, 2)
DEC(0, 37,	psh8	, _Bop		, "PSHB"	, ' ', 1	, 2)
DEC(0, 38,	pul8	, _C		, "PULC"	, ' ', 1	, 3)
DEC(0, 39,	psh8	, _Cop		, "PSHC"	, ' ', 1	, 2)
DEC(0, 3a,	pul16	, _D		, "PULD"	, ' ', 1	, 3)
