...
i8_t m6801ticks[256]= {
  ...
  /* 0 */ 0, 2, 0, 0, 3, 3, 2, 2, 4, 4, 2, 2, 2, 2, 2, 2,
  ...
  /* 6 */ 7, 0, 0, 6, 7, 0, 7, 7, 7, 7, 7, 0, 7, 7, 4, 7,
  /* 7 */ 6, 0, 0, 6, 6, 0, 6, 6, 6, 6, 6, 0, 6, 6, 3, 6,
  /* 8 */ 2, 2, 2, 4, 2, 2, 2, 0, 2, 2, 2, 2, 4, 8, 3, 0,
  /* 9 */ 3, 3, 3, 5, 3, 3, 3, 4, 3, 3, 3, 3, 5, 5, 4, 5,
  /* a */ 5, 5, 5, 6, 5, 5, 5, 6, 5, 5, 5, 5, 6, 8, 6, 7,
  /* b */ 4, 4, 4, 6, 4, 4, 4, 5, 4, 4, 4, 4, 6, 9, 5, 6,
  /* c */ 2, 2, 2, 0, 2, 2, 2, 0, 2, 2, 2, 2, 0, 0, 3, 0,
  /* d */ 3, 3, 3, 0, 3, 3, 3, 4, 3, 3, 3, 3, 0, 4, 4, 5,
  /* e */ 5, 5, 5, 0, 5, 5, 5, 6, 5, 5, 5, 5, 0, 5, 6, 7,
  /* f */ 4, 4, 4, 0, 4, 4, 4, 5, 4, 4, 4, 4, 0, 5, 5, 6
};
