...
0x0000f010, 0x01f2f483, /* 01f2f483 //C 0f010    42 _f010:	jmp	printsnl */
0x0000f011, 0x01f2f48a, /* 01f2f48a //C 0f011    43 _f011:	jmp	print_vhex */
0x0000f012, 0x01f2f474, /* 01f2f474 //C 0f012    44 _f012:	jmp	pes */
0x0000f013, 0x01f2f508, /* 01f2f508 //C 0f013    45 _f013:	jmp	printd */
0x0000f014, 0x01f2f50d, /* 01f2f50d //C 0f014    46 _f014:	jmp	printf */
0x0000f015, 0x01f2f571, /* 01f2f571 //C 0f015    47 _f015:	jmp	pesf */
...
0x0000f025, 0x0600f5e8, /* 0600f5e8 //C 0f025    69 st	r0,reg0 */
0x0000f026, 0x0610f5e9, /* 0610f5e9 //C 0f026    70 st	r1,reg1 */
0x0000f027, 0x0620f5ea, /* 0620f5ea //C 0f027    71 st	r2,reg2 */
0x0000f028, 0x0630f5eb, /* 0630f5eb //C 0f028    72 st	r3,reg3 */
0x0000f029, 0x0640f5ec, /* 0640f5ec //C 0f029    73 st	r4,reg4 */
0x0000f02a, 0x0650f5ed, /* 0650f5ed //C 0f02a    74 st	r5,reg5 */
0x0000f02b, 0x0660f5ee, /* 0660f5ee //C 0f02b    75 st	r6,reg6 */
0x0000f02c, 0x0670f5ef, /* 0670f5ef //C 0f02c    76 st	r7,reg7 */
0x0000f02d, 0x0680f5f0, /* 0680f5f0 //C 0f02d    77 st	r8,reg8 */
0x0000f02e, 0x0690f5f1, /* 0690f5f1 //C 0f02e    78 st	r9,reg9 */
0x0000f02f, 0x06a0f5f2, /* 06a0f5f2 //C 0f02f    79 st	r10,reg10 */
0x0000f030, 0x06b0f5f3, /* 06b0f5f3 //C 0f030    80 st	r11,reg11 */
0x0000f031, 0x06c0f5f4, /* 06c0f5f4 //C 0f031    81 st	r12,reg12 */
0x0000f032, 0x06d0f5f5, /* 06d0f5f5 //C 0f032    82 st	r13,reg13 */
0x0000f033, 0x06e0f5f6, /* 06e0f5f6 //C 0f033    83 st	r14,reg14 */
0x0000f034, 0x06e0f5f7, /* 06e0f5f7 //C 0f034    84 st	r14,reg15 */
0x0000f035, 0x020e0000, /* 020e0000 //C 0f035    85 getf	r0 */
0x0000f036, 0x0600f5f8, /* 0600f5f8 //C 0f036    86 st	r0,regf */
0x0000f037, 0x01020001, /* 01020001 //C 0f037    87 mvzl	r0,1 */
0x0000f038, 0x0600f5e6, /* 0600f5e6 //C 0f038    88 st	r0,called */
...
0x0000f03d, 0x0600f5e6, /* 0600f5e6 //C 0f03d    96 st	r0,called */
...
0x0000f042, 0x0600f5f8, /* 0600f5f8 //C 0f042   101 st	r0,regf		; FALGS= 0 */
0x0000f043, 0x0102f7ff, /* 0102f7ff //C 0f043   102 mvzl	r0,0xf7ff	; R13= 0xf7ff */
0x0000f044, 0x0600f5f5, /* 0600f5f5 //C 0f044   103 st	r0,reg13 */
0x0000f045, 0x01f2f046, /* 01f2f046 //C 0f045   104 jmp	common_start: */
0x0000f046, 0x01d2f838, /* 01d2f838 //C 0f046   107 mvzl	sp,stack_end */
0x0000f047, 0x01020001, /* 01020001 //C 0f047   108 mvzl	r0,1 */
0x0000f048, 0x0600f5e5, /* 0600f5e5 //C 0f048   109 st	r0,echo */
...
0x0000f055, 0x0102f5f9, /* 0102f5f9 //C 0f055   130 mvzl	r0,msg_start */
0x0000f056, 0x0400f483, /* 0400f483 //C 0f056   131 call	printsnl */
0x0000f057, 0x0700f5e6, /* 0700f5e6 //C 0f057   133 ld	r0,called */
...
0x0000f05c, 0x0102f607, /* 0102f607 //C 0f05c   138 mvzl	r0,msg_stopat */
0x0000f05d, 0x0400f457, /* 0400f457 //C 0f05d   139 call	prints */
0x0000f05e, 0x0700f5f6, /* 0700f5f6 //C 0f05e   140 ld	r0,reg14 */
0x0000f05f, 0x01120004, /* 01120004 //C 0f05f   141 mvzl	r1,4 */
0x0000f060, 0x0400f48a, /* 0400f48a //C 0f060   142 call	print_vhex */
...
0x0000f067, 0x0610f5de, /* 0610f5de //C 0f067   160 st	r1,line_ptr */
0x0000f068, 0x0610f57a, /* 0610f57a //C 0f068   161 st	r1,line		; line[0]= 0 */
0x0000f069, 0x01120000, /* 01120000 //C 0f069   162 mvzl	r1,0		; at_eol= 0 */
0x0000f06a, 0x0610f5df, /* 0610f5df //C 0f06a   163 st	r1,at_eol */
0x0000f06b, 0x0102f615, /* 0102f615 //C 0f06b   165 mvzl	r0,prompt */
...
0x0000f080, 0x0700f5de, /* 0700f5de //C 0f080   204 ld	r0,line_ptr */
...
0x0000f084, 0x0600f5de, /* 0600f5de //C 0f084   208 st	r0,line_ptr */
0x0000f085, 0x0112f57a, /* 0112f57a //C 0f085   209 mvzl	r1,line */
0x0000f086, 0x01220000, /* 01220000 //C 0f086   210 mvzl	r2,0 */
0x0000f087, 0x08210000, /* 08210000 //C 0f087   211 st	r2,r1,r0 */
0x0000f088, 0x0102f611, /* 0102f611 //C 0f088   212 mvzl	r0,msg_BS */
...
0x0000f091, 0x0620f5df, /* 0620f5df //C 0f091   223 st	r2,at_eol */
0x0000f092, 0x0112f5de, /* 0112f5de //C 0f092   224 mvzl	r1,line_ptr	; line[line_ptr]= char */
0x0000f093, 0x0e310000, /* 0e310000 //C 0f093   225 ld	r3,r1 */
0x0000f094, 0x0122f57a, /* 0122f57a //C 0f094   226 mvzl	r2,line */
...
0x0000f09b, 0x0142f5e5, /* 0142f5e5 //C 0f09b   234 mvzl	r4,echo		; check if echo is turned on */
...
0x0000f0a1, 0x0112f5df, /* 0112f5df //C 0f0a1   241 mvzl	r1,at_eol */
...
0x0000f0aa, 0x0700f57a, /* 0700f57a //C 0f0aa   261 ld	r0,line */
...
0x0000f0b3, 0x0400f483, /* 0400f483 //C 0f0b3   291 call	printsnl */
0x0000f0b4, 0x01120001, /* 01120001 //C 0f0b4   294 mvzl	r1,1		; at_eol= 1 */
0x0000f0b5, 0x0610f5df, /* 0610f5df //C 0f0b5   295 st	r1,at_eol */
...
0x0000f0cd, 0x0112f617, /* 0112f617 //C 0f0cd   308 mvzl	r1,delimiters */
...
0x0000f0d1, 0x0142f5e0, /* 0142f5e0 //C 0f0d1   320 mvzl	r4,words	; array of result */
0x0000f0d2, 0x0152f57a, /* 0152f57a //C 0f0d2   321 mvzl	r5,line		; address of next char */
...
0x0000f0f5, 0x0700f5e0, /* 0700f5e0 //C 0f0f5   373 ld	r0,words	; R0= 1st word of command */
...
0x0000f10c, 0x0630f5e7, /* 0630f5e7 //C 0f10c   399 st	r3,nuof_reg */
0x0000f10d, 0x01f2f110, /* 01f2f110 //C 0f10d   400 jmp	find_rx */
0x0000f10e, 0x01260030, /* 01260030 //C 0f10e   402 sub	r2,'0' */
0x0000f10f, 0x0620f5e7, /* 0620f5e7 //C 0f10f   403 st	r2,nuof_reg */
...
0x0000f113, 0x01a2f633, /* 01a2f633 //C 0f113   410 mvzl	r10,commands */
...
0x0000f138, 0x0122f5e0, /* 0122f5e0 //C 0f138   456 mvzl	r2,words */
...
0x0000f143, 0x0400f483, /* 0400f483 //C 0f143   469 call	printsnl */
...
0x0000f14a, 0x0132f839, /* 0132f839 //C 0f14a   478 mvzl	r3,the_end */
...
0x0000f14f, 0x0400f483, /* 0400f483 //C 0f14f   490 call	printsnl */
...
0x0000f156, 0x0400f483, /* 0400f483 //C 0f156   498 call	printsnl */
...
0x0000f15b, 0x0400f48a, /* 0400f48a //C 0f15b   506 call	print_vhex */
...
0x0000f160, 0x0400f48a, /* 0400f48a //C 0f160   511 call	print_vhex */
...
0x0000f191, 0x0122f5e0, /* 0122f5e0 //C 0f191   525 mvzl	r2,words */
...
0x0000f19c, 0x0400f483, /* 0400f483 //C 0f19c   538 call	printsnl */
...
0x0000f1a3, 0x0132f839, /* 0132f839 //C 0f1a3   547 mvzl	r3,the_end */
...
0x0000f1a8, 0x0400f483, /* 0400f483 //C 0f1a8   553 call	printsnl */
...
0x0000f1af, 0x0400f483, /* 0400f483 //C 0f1af   561 call	printsnl */
...
0x0000f1b4, 0x0122f5e0, /* 0122f5e0 //C 0f1b4   574 mvzl	r2,words */
...
0x0000f1c4, 0x0400f48a, /* 0400f48a //C 0f1c4   599 call	print_vhex */
...
0x0000f1c9, 0x0400f48a, /* 0400f48a //C 0f1c9   604 call	print_vhex */
...
0x0000f1d1, 0x0400f483, /* 0400f483 //C 0f1d1   613 call	printsnl */
...
0x0000f258, 0x0400f48a, /* 0400f48a //C 0f258   786 call	print_vhex */
...
0x0000f25d, 0x0122f5e0, /* 0122f5e0 //C 0f25d   796 mvzl	r2,words */
...
0x0000f267, 0x0400f48a, /* 0400f48a //C 0f267   807 call	print_vhex */
0x0000f268, 0x0102000a, /* 0102000a //C 0f268   808 mvzl	r0,LF */
0x0000f269, 0x0400f450, /* 0400f450 //C 0f269   809 call	putchar */
0x0000f26a, 0x06b0f5f7, /* 06b0f5f7 //C 0f26a   810 st	r11,reg15 */
...
0x0000f270, 0x0600f5e6, /* 0600f5e6 //C 0f270   819 st	r0,called */
0x0000f271, 0x0700f5f8, /* 0700f5f8 //C 0f271   821 ld	r0,regf */
0x0000f272, 0x020f0000, /* 020f0000 //C 0f272   822 setf	r0 */
0x0000f273, 0x0700f5e8, /* 0700f5e8 //C 0f273   823 ld	r0,reg0 */
0x0000f274, 0x0710f5e9, /* 0710f5e9 //C 0f274   824 ld	r1,reg1 */
0x0000f275, 0x0720f5ea, /* 0720f5ea //C 0f275   825 ld	r2,reg2 */
0x0000f276, 0x0730f5eb, /* 0730f5eb //C 0f276   826 ld	r3,reg3 */
0x0000f277, 0x0740f5ec, /* 0740f5ec //C 0f277   827 ld	r4,reg4 */
0x0000f278, 0x0750f5ed, /* 0750f5ed //C 0f278   828 ld	r5,reg5 */
0x0000f279, 0x0760f5ee, /* 0760f5ee //C 0f279   829 ld	r6,reg6 */
0x0000f27a, 0x0770f5ef, /* 0770f5ef //C 0f27a   830 ld	r7,reg7 */
0x0000f27b, 0x0780f5f0, /* 0780f5f0 //C 0f27b   831 ld	r8,reg8 */
0x0000f27c, 0x0790f5f1, /* 0790f5f1 //C 0f27c   832 ld	r9,reg9 */
0x0000f27d, 0x07a0f5f2, /* 07a0f5f2 //C 0f27d   833 ld	r10,reg10 */
0x0000f27e, 0x07b0f5f3, /* 07b0f5f3 //C 0f27e   834 ld	r11,reg11 */
0x0000f27f, 0x07c0f5f4, /* 07c0f5f4 //C 0f27f   835 ld	r12,reg12 */
0x0000f280, 0x07d0f5f5, /* 07d0f5f5 //C 0f280   836 ld	r13,reg13 */
0x0000f281, 0x07e0f5f6, /* 07e0f5f6 //C 0f281   837 ld	r14,reg14 */
0x0000f282, 0x07f0f5f7, /* 07f0f5f7 //C 0f282   839 ld	r15,reg15 */
0x0000f283, 0x0700f5e6, /* 0700f5e6 //C 0f283   842 ld	r0,called */
0x0000f284, 0x020b0000, /* 020b0000 //C 0f284   843 sz	r0 */
0x0000f285, 0x11f2f288, /* 11f2f288 //C 0f285   844 jz	g_err */
0x0000f286, 0x07b0f5f7, /* 07b0f5f7 //C 0f286   845 ld	r11,reg15 */
0x0000f287, 0x01f2f263, /* 01f2f263 //C 0f287   846 jmp	g_go11 */
0x0000f288, 0x0102f28b, /* 0102f28b //C 0f288   848 mvzl	r0,g_err_addr */
0x0000f289, 0x0400f483, /* 0400f483 //C 0f289   849 call	printsnl */
...
0x0000f29c, 0x0122f688, /* 0122f688 //C 0f29c   860 mvzl	r2,helps */
...
0x0000f2e5, 0x0112f5e8, /* 0112f5e8 //C 0f2e5   946 mvzl	r1,reg0 */
0x0000f2e6, 0x0a010000, /* 0a010000 //C 0f2e6   947 ld	r0,r1,r0 */
0x0000f2e7, 0x01120004, /* 01120004 //C 0f2e7   948 mvzl	r1,4 */
0x0000f2e8, 0x0400f48a, /* 0400f48a //C 0f2e8   949 call	print_vhex */
...
0x0000f303, 0x0700f5e6, /* 0700f5e6 //C 0f303   994 ld	r0,called */
...
0x0000f308, 0x0700f5f7, /* 0700f5f7 //C 0f308  1000 ld	r0,reg15 */
0x0000f309, 0x01120004, /* 01120004 //C 0f309  1001 mvzl	r1,4 */
0x0000f30a, 0x0400f48a, /* 0400f48a //C 0f30a  1002 call	print_vhex */
...
0x0000f315, 0x0710f5f8, /* 0710f5f8 //C 0f315  1017 ld	r1,regf */
...
0x0000f35e, 0x07a0f5e7, /* 07a0f5e7 //C 0f35e  1047 ld	r10,nuof_reg	; Reg num is in R10 */
...
0x0000f362, 0x0400f483, /* 0400f483 //C 0f362  1051 call	printsnl */
...
0x0000f375, 0x0122f5e0, /* 0122f5e0 //C 0f375  1056 mvzl	r2,words */
...
0x0000f37e, 0x0400f483, /* 0400f483 //C 0f37e  1065 call	printsnl */
...
0x0000f38e, 0x0102f5e8, /* 0102f5e8 //C 0f38e  1072 mvzl	r0,reg0 */
...
0x0000f460, 0x1102f620, /* 1102f620 //C 0f460  1472 Z1 mvzl	r0,null_str */
...
0x0000f465, 0x11f2f46c, /* 11f2f46c //C 0f465  1478 jz	prints_done */
0x0000f466, 0x06010105, /* 06010105 //C 0f466  1480 getb	r0,r1,r5 */
0x0000f467, 0x2400f450, /* 2400f450 //C 0f467  1481 NZ call	putchar */
0x0000f468, 0x01540001, /* 01540001 //C 0f468  1482 inc	r5 */
0x0000f469, 0x01580004, /* 01580004 //C 0f469  1483 cmp	r5,4 */
0x0000f46a, 0x21f2f466, /* 21f2f466 //C 0f46a  1484 jnz	prints_byte */
0x0000f46b, 0x01f2f462, /* 01f2f462 //C 0f46b  1485 jmp	prints_go */
0x0000f46c, 0x0f5d0000, /* 0f5d0000 //C 0f46c  1488 pop	r5 */
0x0000f46d, 0x0f1d0000, /* 0f1d0000 //C 0f46d  1489 pop	r1 */
0x0000f46e, 0x0f2d0000, /* 0f2d0000 //C 0f46e  1490 pop	r2 */
0x0000f46f, 0x0f4d0000, /* 0f4d0000 //C 0f46f  1491 pop	r4 */
0x0000f470, 0x0f3d0000, /* 0f3d0000 //C 0f470  1492 pop	r3 */
0x0000f471, 0x0f0d0000, /* 0f0d0000 //C 0f471  1493 pop	r0 */
0x0000f472, 0x0ffd0000, /* 0ffd0000 //C 0f472  1494 pop	pc */
0x0000f473, 0x00000000, /* 00000000 //C 0f473  1502 dd	0 */
0x0000f474, 0x0ded0000, /* 0ded0000 //C 0f474  1505 push	lr */
0x0000f475, 0x0d0d0000, /* 0d0d0000 //C 0f475  1506 push	r0 */
0x0000f476, 0x0d1d0000, /* 0d1d0000 //C 0f476  1507 push	r1 */
0x0000f477, 0x00100e00, /* 00100e00 //C 0f477  1508 mov	r1,lr */
0x0000f478, 0x0e010000, /* 0e010000 //C 0f478  1510 ld	r0,r1 */
0x0000f479, 0x01140001, /* 01140001 //C 0f479  1511 inc	r1 */
0x0000f47a, 0x020b0000, /* 020b0000 //C 0f47a  1512 sz	r0 */
0x0000f47b, 0x11f2f47e, /* 11f2f47e //C 0f47b  1513 jz	pes_done */
0x0000f47c, 0x0400f450, /* 0400f450 //C 0f47c  1514 call	putchar */
0x0000f47d, 0x01f2f478, /* 01f2f478 //C 0f47d  1515 jmp	pes_next */
0x0000f47e, 0x0610f473, /* 0610f473 //C 0f47e  1517 st	r1,pes_ret_to */
0x0000f47f, 0x0f1d0000, /* 0f1d0000 //C 0f47f  1518 pop	r1 */
0x0000f480, 0x0f0d0000, /* 0f0d0000 //C 0f480  1519 pop	r0 */
0x0000f481, 0x0fed0000, /* 0fed0000 //C 0f481  1520 pop	lr */
0x0000f482, 0x07f0f473, /* 07f0f473 //C 0f482  1521 ld	pc,pes_ret_to */
0x0000f483, 0x0ded0000, /* 0ded0000 //C 0f483  1529 push	lr */
0x0000f484, 0x0400f457, /* 0400f457 //C 0f484  1530 call	prints */
0x0000f485, 0x0d0d0000, /* 0d0d0000 //C 0f485  1531 push	r0 */
0x0000f486, 0x0102000a, /* 0102000a //C 0f486  1532 mvzl	r0,LF */
0x0000f487, 0x0400f450, /* 0400f450 //C 0f487  1533 call	putchar */
0x0000f488, 0x0f0d0000, /* 0f0d0000 //C 0f488  1534 pop	r0 */
0x0000f489, 0x0ffd0000, /* 0ffd0000 //C 0f489  1535 pop	pc */
0x0000f48a, 0x0ded0000, /* 0ded0000 //C 0f48a  1543 push	lr */
0x0000f48b, 0x0d0d0000, /* 0d0d0000 //C 0f48b  1544 push	r0 */
0x0000f48c, 0x0d1d0000, /* 0d1d0000 //C 0f48c  1545 push	r1 */
0x0000f48d, 0x0d2d0000, /* 0d2d0000 //C 0f48d  1546 push	r2 */
0x0000f48e, 0x0d3d0000, /* 0d3d0000 //C 0f48e  1547 push	r3 */
0x0000f48f, 0x0d4d0000, /* 0d4d0000 //C 0f48f  1548 push	r4 */
0x0000f490, 0x00300000, /* 00300000 //C 0f490  1549 mov	r3,r0 */
0x0000f491, 0x01220000, /* 01220000 //C 0f491  1550 mvzl	r2,0 */
0x0000f492, 0x01420001, /* 01420001 //C 0f492  1551 mvzl	r4,1 */
0x0000f493, 0x01020000, /* 01020000 //C 0f493  1554 mvzl	r0,0 */
0x0000f494, 0x02380000, /* 02380000 //C 0f494  1555 shl	r3 */
0x0000f495, 0x02070000, /* 02070000 //C 0f495  1556 rol	r0 */
0x0000f496, 0x02380000, /* 02380000 //C 0f496  1557 shl	r3 */
0x0000f497, 0x02070000, /* 02070000 //C 0f497  1558 rol	r0 */
0x0000f498, 0x02380000, /* 02380000 //C 0f498  1559 shl	r3 */
0x0000f499, 0x02070000, /* 02070000 //C 0f499  1560 rol	r0 */
0x0000f49a, 0x02380000, /* 02380000 //C 0f49a  1561 shl	r3 */
0x0000f49b, 0x02070000, /* 02070000 //C 0f49b  1562 rol	r0 */
0x0000f49c, 0x0400f403, /* 0400f403 //C 0f49c  1563 call	value2Hexchar */
0x0000f49d, 0x0400f450, /* 0400f450 //C 0f49d  1564 call	putchar */
0x0000f49e, 0x01240001, /* 01240001 //C 0f49e  1565 add	r2,1 */
0x0000f49f, 0x01280008, /* 01280008 //C 0f49f  1566 cmp	r2,8 */
0x0000f4a0, 0x11f2f4aa, /* 11f2f4aa //C 0f4a0  1567 jz	print_vhex_ret */
0x0000f4a1, 0x021b0000, /* 021b0000 //C 0f4a1  1568 sz	r1 */
0x0000f4a2, 0x11f2f4a8, /* 11f2f4a8 //C 0f4a2  1569 jz	print_vhex_nosep */
0x0000f4a3, 0x00480100, /* 00480100 //C 0f4a3  1570 cmp	r4,r1 */
0x0000f4a4, 0x21f2f4a8, /* 21f2f4a8 //C 0f4a4  1571 jnz	print_vhex_nosep */
0x0000f4a5, 0x0102005f, /* 0102005f //C 0f4a5  1572 mvzl	r0,'_' */
0x0000f4a6, 0x0400f450, /* 0400f450 //C 0f4a6  1573 call	putchar */
0x0000f4a7, 0x01420000, /* 01420000 //C 0f4a7  1574 mvzl	r4,0 */
0x0000f4a8, 0x01440001, /* 01440001 //C 0f4a8  1576 add	r4,1 */
0x0000f4a9, 0x01f2f493, /* 01f2f493 //C 0f4a9  1577 jmp	print_vhex_cyc */
0x0000f4aa, 0x0f4d0000, /* 0f4d0000 //C 0f4aa  1579 pop	r4 */
0x0000f4ab, 0x0f3d0000, /* 0f3d0000 //C 0f4ab  1580 pop	r3 */
0x0000f4ac, 0x0f2d0000, /* 0f2d0000 //C 0f4ac  1581 pop	r2 */
0x0000f4ad, 0x0f1d0000, /* 0f1d0000 //C 0f4ad  1582 pop	r1 */
0x0000f4ae, 0x0f0d0000, /* 0f0d0000 //C 0f4ae  1583 pop	r0 */
0x0000f4af, 0x0ffd0000, /* 0ffd0000 //C 0f4af  1584 pop	pc */
0x0000f4b0, 0x0ded0000, /* 0ded0000 //C 0f4b0  1592 push	lr */
0x0000f4b1, 0x0d4d0000, /* 0d4d0000 //C 0f4b1  1593 push	r4 */
0x0000f4b2, 0x021b0000, /* 021b0000 //C 0f4b2  1595 sz	r1 */
0x0000f4b3, 0x21f2f4b7, /* 21f2f4b7 //C 0f4b3  1596 NZ jmp	div_dok */
0x0000f4b4, 0x00200000, /* 00200000 //C 0f4b4  1597 mov	r2,r0		; div by zero */
0x0000f4b5, 0x01320000, /* 01320000 //C 0f4b5  1598 mvzl	r3,0 */
0x0000f4b6, 0x01f2f4c8, /* 01f2f4c8 //C 0f4b6  1599 jmp	div_ret */
0x0000f4b7, 0x01220000, /* 01220000 //C 0f4b7  1601 mvzl	r2,0		; Q= 0 */
0x0000f4b8, 0x01320000, /* 01320000 //C 0f4b8  1602 mvzl	r3,0		; R= 0 */
0x0000f4b9, 0x01418000, /* 01418000 //C 0f4b9  1603 mvh	r4,0x80000000	; m= 1<<31 */
0x0000f4ba, 0x01400000, /* 01400000 //C 0f4ba  1604 mvl	r4,0x80000000 */
0x0000f4bb, 0x024b0000, /* 024b0000 //C 0f4bb  1606 sz	r4 */
0x0000f4bc, 0x11f2f4c8, /* 11f2f4c8 //C 0f4bc  1607 Z jmp	div_ret */
0x0000f4bd, 0x02380000, /* 02380000 //C 0f4bd  1608 shl	r3		; r<<= 1 */
0x0000f4be, 0x000c0400, /* 000c0400 //C 0f4be  1609 test	r0,r4		; if (n&m) */
0x0000f4bf, 0x213d0001, /* 213d0001 //C 0f4bf  1610 NZ or	r3,1		; r|= 1 */
0x0000f4c0, 0x00380100, /* 00380100 //C 0f4c0  1611 cmp	r3,r1		; if (r>=d) */
0x0000f4c1, 0x41f2f4c6, /* 41f2f4c6 //C 0f4c1  1612 LO jmp	div_cyc_next */
0x0000f4c2, 0x00360100, /* 00360100 //C 0f4c2  1613 sub	r3,r1		;r-= d */
0x0000f4c3, 0x002d0400, /* 002d0400 //C 0f4c3  1614 or	r2,r4		;q|= m */
0x0000f4c4, 0x01f2f4c6, /* 01f2f4c6 //C 0f4c4  1615 jmp	div_cyc_next */
0x0000f4c5, 0x01f2f4bb, /* 01f2f4bb //C 0f4c5  1616 jmp	div_cyc */
0x0000f4c6, 0x02490000, /* 02490000 //C 0f4c6  1618 shr	r4		; m>>= 1 */
0x0000f4c7, 0x01f2f4bb, /* 01f2f4bb //C 0f4c7  1619 jmp	div_cyc */
0x0000f4c8, 0x0f4d0000, /* 0f4d0000 //C 0f4c8  1621 pop	r4 */
0x0000f4c9, 0x0ffd0000, /* 0ffd0000 //C 0f4c9  1622 pop	pc */
0x0000f4ca, 0x0ded0000, /* 0ded0000 //C 0f4ca  1630 push	lr */
0x0000f4cb, 0x0d0d0000, /* 0d0d0000 //C 0f4cb  1631 push	r0 */
0x0000f4cc, 0x0d1d0000, /* 0d1d0000 //C 0f4cc  1632 push	r1 */
0x0000f4cd, 0x0d2d0000, /* 0d2d0000 //C 0f4cd  1633 push	r2 */
0x0000f4ce, 0x0d3d0000, /* 0d3d0000 //C 0f4ce  1634 push	r3 */
0x0000f4cf, 0x0dad0000, /* 0dad0000 //C 0f4cf  1635 push	r10 */
0x0000f4d0, 0x0dbd0000, /* 0dbd0000 //C 0f4d0  1636 push	r11 */
0x0000f4d1, 0x0dcd0000, /* 0dcd0000 //C 0f4d1  1637 push	r12 */
0x0000f4d2, 0x01c2f4f2, /* 01c2f4f2 //C 0f4d2  1639 mvzl	r12,itoa_buffer	; pointer to output buffer */
0x0000f4d3, 0x01b2f4fd, /* 01b2f4fd //C 0f4d3  1640 mvzl	r11,itoa_divs	; pointer to dividers */
0x0000f4d4, 0x01a20000, /* 01a20000 //C 0f4d4  1641 mvzl	r10,0		; bool: first non-zero char found */
0x0000f4d5, 0x0e1b0000, /* 0e1b0000 //C 0f4d5  1643 ld	r1,r11		; get next divider */
0x0000f4d6, 0x021b0000, /* 021b0000 //C 0f4d6  1644 sz	r1		; if 0, then */
0x0000f4d7, 0x11f2f4ea, /* 11f2f4ea //C 0f4d7  1645 jz	itoa_ret	; finish */
0x0000f4d8, 0x01180001, /* 01180001 //C 0f4d8  1646 cmp	r1,1		; last divider? */
0x0000f4d9, 0x11a20001, /* 11a20001 //C 0f4d9  1647 EQ mvzl	r10,1		; always print last char */
0x0000f4da, 0x0400f4b0, /* 0400f4b0 //C 0f4da  1648 call	div		; R2,R3= R0/R1 */
0x0000f4db, 0x022b0000, /* 022b0000 //C 0f4db  1649 sz	r2		; is the result zero? */
0x0000f4dc, 0x11f2f4e7, /* 11f2f4e7 //C 0f4dc  1650 jz	itoa_f0 */
0x0000f4dd, 0x01a20001, /* 01a20001 //C 0f4dd  1652 mvzl	r10,1		; non-zero: start to print */
0x0000f4de, 0x00000200, /* 00000200 //C 0f4de  1654 mov	r0,r2		; convert result to ASCII char */
0x0000f4df, 0x0400f41a, /* 0400f41a //C 0f4df  1655 call	value2hexchar */
0x0000f4e0, 0x0c0c0000, /* 0c0c0000 //C 0f4e0  1656 st	r0,r12		; and store it in buffer */
0x0000f4e1, 0x01c40001, /* 01c40001 //C 0f4e1  1657 inc	r12		; inc buf ptr */
0x0000f4e2, 0x01020000, /* 01020000 //C 0f4e2  1658 mvzl	r0,0		; put 0 after last char */
0x0000f4e3, 0x0c0c0000, /* 0c0c0000 //C 0f4e3  1659 st	r0,r12 */
0x0000f4e4, 0x00000300, /* 00000300 //C 0f4e4  1661 mov	r0,r3		; continue with the reminder */
0x0000f4e5, 0x01b40001, /* 01b40001 //C 0f4e5  1662 inc	r11		; and next divider */
0x0000f4e6, 0x01f2f4d5, /* 01f2f4d5 //C 0f4e6  1663 jmp	itoa_cyc */
0x0000f4e7, 0x02ab0000, /* 02ab0000 //C 0f4e7  1665 sz	r10		; just zeros so far? */
0x0000f4e8, 0x21f2f4de, /* 21f2f4de //C 0f4e8  1666 jnz	itoa_store	; no, print */
0x0000f4e9, 0x01f2f4e4, /* 01f2f4e4 //C 0f4e9  1667 jmp	itoa_next */
0x0000f4ea, 0x0fcd0000, /* 0fcd0000 //C 0f4ea  1669 pop	r12 */
0x0000f4eb, 0x0fbd0000, /* 0fbd0000 //C 0f4eb  1670 pop	r11 */
0x0000f4ec, 0x0fad0000, /* 0fad0000 //C 0f4ec  1671 pop	r10 */
0x0000f4ed, 0x0f3d0000, /* 0f3d0000 //C 0f4ed  1672 pop	r3 */
0x0000f4ee, 0x0f2d0000, /* 0f2d0000 //C 0f4ee  1673 pop	r2 */
0x0000f4ef, 0x0f1d0000, /* 0f1d0000 //C 0f4ef  1674 pop	r1 */
0x0000f4f0, 0x0f0d0000, /* 0f0d0000 //C 0f4f0  1675 pop	r0 */
0x0000f4f1, 0x0ffd0000, /* 0ffd0000 //C 0f4f1  1676 pop	pc */
0x0000f4f2, 0x00000000, /* 00000000 //C 0f4f2  1678 itoa_buffer:	ds	11 */
0x0000f4fd, 0x3b9aca00, /* 3b9aca00 //C 0f4fd  1680 dd	1000000000 */
0x0000f4fe, 0x05f5e100, /* 05f5e100 //C 0f4fe  1681 dd	100000000 */
0x0000f4ff, 0x00989680, /* 00989680 //C 0f4ff  1682 dd	10000000 */
0x0000f500, 0x000f4240, /* 000f4240 //C 0f500  1683 dd	1000000 */
0x0000f501, 0x000186a0, /* 000186a0 //C 0f501  1684 dd	100000 */
0x0000f502, 0x00002710, /* 00002710 //C 0f502  1685 dd	10000 */
0x0000f503, 0x000003e8, /* 000003e8 //C 0f503  1686 dd	1000 */
0x0000f504, 0x00000064, /* 00000064 //C 0f504  1687 dd	100 */
0x0000f505, 0x0000000a, /* 0000000a //C 0f505  1688 dd	10 */
0x0000f506, 0x00000001, /* 00000001 //C 0f506  1689 dd	1 */
0x0000f507, 0x00000000, /* 00000000 //C 0f507  1690 dd	0 */
0x0000f508, 0x0ded0000, /* 0ded0000 //C 0f508  1697 push	lr */
0x0000f509, 0x0400f4ca, /* 0400f4ca //C 0f509  1698 call	itoa */
0x0000f50a, 0x0102f4f2, /* 0102f4f2 //C 0f50a  1699 mvzl	r0,itoa_buffer */
0x0000f50b, 0x0400f457, /* 0400f457 //C 0f50b  1700 call	prints */
0x0000f50c, 0x0ffd0000, /* 0ffd0000 //C 0f50c  1701 pop	pc */
0x0000f50d, 0x0ded0000, /* 0ded0000 //C 0f50d  1710 push	lr */
0x0000f50e, 0x0d0d0000, /* 0d0d0000 //C 0f50e  1711 push	r0 */
0x0000f50f, 0x0d1d0000, /* 0d1d0000 //C 0f50f  1712 push	r1 */
0x0000f510, 0x0610f5e9, /* 0610f5e9 //C 0f510  1714 st	r1,reg1 */
0x0000f511, 0x0620f5ea, /* 0620f5ea //C 0f511  1715 st	r2,reg2 */
0x0000f512, 0x0630f5eb, /* 0630f5eb //C 0f512  1716 st	r3,reg3 */
0x0000f513, 0x0640f5ec, /* 0640f5ec //C 0f513  1717 st	r4,reg4 */
0x0000f514, 0x0650f5ed, /* 0650f5ed //C 0f514  1718 st	r5,reg5 */
0x0000f515, 0x0660f5ee, /* 0660f5ee //C 0f515  1719 st	r6,reg6 */
0x0000f516, 0x0670f5ef, /* 0670f5ef //C 0f516  1720 st	r7,reg7 */
0x0000f517, 0x0680f5f0, /* 0680f5f0 //C 0f517  1721 st	r8,reg8 */
0x0000f518, 0x0690f5f1, /* 0690f5f1 //C 0f518  1722 st	r9,reg9 */
0x0000f519, 0x06a0f5f2, /* 06a0f5f2 //C 0f519  1723 st	r10,reg10 */
0x0000f51a, 0x06b0f5f3, /* 06b0f5f3 //C 0f51a  1724 st	r11,reg11 */
0x0000f51b, 0x06c0f5f4, /* 06c0f5f4 //C 0f51b  1725 st	r12,reg12 */
0x0000f51c, 0x00200000, /* 00200000 //C 0f51c  1727 mov	r2,r0		; pointer to format string */
0x0000f51d, 0x0112f5e9, /* 0112f5e9 //C 0f51d  1728 mvzl	r1,reg1		; pointer to params */
0x0000f51e, 0x0e020000, /* 0e020000 //C 0f51e  1730 ld	r0,r2		; get next char */
0x0000f51f, 0x020b0000, /* 020b0000 //C 0f51f  1731 sz	r0		; is it EOS? */
0x0000f520, 0x11f2f56e, /* 11f2f56e //C 0f520  1732 jz	printf_ret */
0x0000f521, 0x0108005c, /* 0108005c //C 0f521  1734 cmp	r0,'\\' */
0x0000f522, 0x21f2f545, /* 21f2f545 //C 0f522  1735 jnz	printf_notescape */
0x0000f523, 0x01240001, /* 01240001 //C 0f523  1737 inc	r2 */
0x0000f524, 0x0e020000, /* 0e020000 //C 0f524  1738 ld	r0,r2 */
0x0000f525, 0x020b0000, /* 020b0000 //C 0f525  1739 sz	r0 */
0x0000f526, 0x11f2f56e, /* 11f2f56e //C 0f526  1740 jz	printf_ret */
0x0000f527, 0x01080061, /* 01080061 //C 0f527  1742 cmp	r0,'a' */
0x0000f528, 0x11020007, /* 11020007 //C 0f528  1743 Z mvzl	r0,7 */
0x0000f529, 0x11f2f56b, /* 11f2f56b //C 0f529  1744 Z jmp	printf_print */
0x0000f52a, 0x01080062, /* 01080062 //C 0f52a  1745 cmp	r0,'b' */
0x0000f52b, 0x11020008, /* 11020008 //C 0f52b  1746 Z mvzl	r0,8 */
0x0000f52c, 0x11f2f56b, /* 11f2f56b //C 0f52c  1747 Z jmp	printf_print */
0x0000f52d, 0x01080065, /* 01080065 //C 0f52d  1748 cmp	r0,'e' */
0x0000f52e, 0x1102001b, /* 1102001b //C 0f52e  1749 Z mvzl	r0,0x1b */
0x0000f52f, 0x11f2f56b, /* 11f2f56b //C 0f52f  1750 Z jmp	printf_print */
0x0000f530, 0x01080066, /* 01080066 //C 0f530  1751 cmp	r0,'f' */
0x0000f531, 0x1102000c, /* 1102000c //C 0f531  1752 Z mvzl	r0,0xc */
0x0000f532, 0x11f2f56b, /* 11f2f56b //C 0f532  1753 Z jmp	printf_print */
0x0000f533, 0x0108006e, /* 0108006e //C 0f533  1754 cmp	r0,'n' */
0x0000f534, 0x1102000a, /* 1102000a //C 0f534  1755 Z mvzl	r0,0xa */
0x0000f535, 0x11f2f56b, /* 11f2f56b //C 0f535  1756 Z jmp	printf_print */
0x0000f536, 0x01080072, /* 01080072 //C 0f536  1757 cmp	r0,'r' */
0x0000f537, 0x1102000d, /* 1102000d //C 0f537  1758 Z mvzl	r0,0xd */
0x0000f538, 0x11f2f56b, /* 11f2f56b //C 0f538  1759 Z jmp	printf_print */
0x0000f539, 0x01080074, /* 01080074 //C 0f539  1760 cmp	r0,'t' */
0x0000f53a, 0x11020009, /* 11020009 //C 0f53a  1761 Z mvzl	r0,9 */
0x0000f53b, 0x11f2f56b, /* 11f2f56b //C 0f53b  1762 Z jmp	printf_print */
0x0000f53c, 0x01080076, /* 01080076 //C 0f53c  1763 cmp	r0,'v' */
0x0000f53d, 0x1102000b, /* 1102000b //C 0f53d  1764 Z mvzl	r0,0xb */
0x0000f53e, 0x11f2f56b, /* 11f2f56b //C 0f53e  1765 Z jmp	printf_print */
0x0000f53f, 0x0108005c, /* 0108005c //C 0f53f  1766 cmp	r0,0x5c */
0x0000f540, 0x11f2f56b, /* 11f2f56b //C 0f540  1767 Z jmp	printf_print */
0x0000f541, 0x01080030, /* 01080030 //C 0f541  1768 cmp	r0,'0' */
0x0000f542, 0x11020000, /* 11020000 //C 0f542  1769 Z mvzl	r0,0 */
0x0000f543, 0x11f2f56b, /* 11f2f56b //C 0f543  1770 Z jmp	printf_print */
0x0000f544, 0x01f2f56b, /* 01f2f56b //C 0f544  1772 jmp	printf_print */
0x0000f545, 0x01080025, /* 01080025 //C 0f545  1775 cmp	r0,'%'		; is it a format char? */
0x0000f546, 0x21f2f56b, /* 21f2f56b //C 0f546  1776 jnz	printf_print */
0x0000f547, 0x01240001, /* 01240001 //C 0f547  1778 inc	r2		; go to format char */
0x0000f548, 0x0e020000, /* 0e020000 //C 0f548  1779 ld	r0,r2 */
0x0000f549, 0x022b0000, /* 022b0000 //C 0f549  1780 sz	r2		; is it EOS? */
0x0000f54a, 0x11f2f56e, /* 11f2f56e //C 0f54a  1781 jz	printf_ret */
0x0000f54b, 0x01080025, /* 01080025 //C 0f54b  1783 cmp	r0,'%'		; % is used to print % */
0x0000f54c, 0x11f2f56b, /* 11f2f56b //C 0f54c  1784 jz	printf_print */
0x0000f54d, 0x01080075, /* 01080075 //C 0f54d  1786 cmp	r0,'u'		; u,d print in decimal */
0x0000f54e, 0x11f2f551, /* 11f2f551 //C 0f54e  1787 jz	printf_d */
0x0000f54f, 0x01080064, /* 01080064 //C 0f54f  1788 cmp	r0,'d' */
0x0000f550, 0x21f2f555, /* 21f2f555 //C 0f550  1789 jnz	printf_notd */
0x0000f551, 0x0e010000, /* 0e010000 //C 0f551  1791 ld	r0,r1 */
0x0000f552, 0x01140001, /* 01140001 //C 0f552  1792 inc	r1 */
0x0000f553, 0x0400f508, /* 0400f508 //C 0f553  1793 call	printd */
0x0000f554, 0x01f2f56c, /* 01f2f56c //C 0f554  1794 jmp	printf_next */
0x0000f555, 0x01080078, /* 01080078 //C 0f555  1797 cmp	r0,'x' */
0x0000f556, 0x21f2f55e, /* 21f2f55e //C 0f556  1798 jnz	printf_notx */
0x0000f557, 0x0e010000, /* 0e010000 //C 0f557  1800 ld	r0,r1 */
0x0000f558, 0x01140001, /* 01140001 //C 0f558  1801 inc	r1 */
0x0000f559, 0x0d1d0000, /* 0d1d0000 //C 0f559  1802 push	r1 */
0x0000f55a, 0x01120000, /* 01120000 //C 0f55a  1803 mvzl	r1,0 */
0x0000f55b, 0x0400f48a, /* 0400f48a //C 0f55b  1804 call	print_vhex */
0x0000f55c, 0x0f1d0000, /* 0f1d0000 //C 0f55c  1805 pop	r1 */
0x0000f55d, 0x01f2f56c, /* 01f2f56c //C 0f55d  1806 jmp	printf_next */
0x0000f55e, 0x01080073, /* 01080073 //C 0f55e  1809 cmp	r0,'s' */
0x0000f55f, 0x21f2f564, /* 21f2f564 //C 0f55f  1810 jnz	printf_nots */
0x0000f560, 0x0e010000, /* 0e010000 //C 0f560  1811 ld	r0,r1 */
0x0000f561, 0x01140001, /* 01140001 //C 0f561  1812 inc	r1 */
0x0000f562, 0x0400f457, /* 0400f457 //C 0f562  1813 call	prints */
0x0000f563, 0x01f2f56c, /* 01f2f56c //C 0f563  1814 jmp	printf_next */
0x0000f564, 0x01080063, /* 01080063 //C 0f564  1817 cmp	r0,'c' */
0x0000f565, 0x21f2f56a, /* 21f2f56a //C 0f565  1818 jnz	printf_notc */
0x0000f566, 0x0e010000, /* 0e010000 //C 0f566  1819 ld	r0,r1 */
0x0000f567, 0x01140001, /* 01140001 //C 0f567  1820 inc	r1 */
0x0000f568, 0x0400f450, /* 0400f450 //C 0f568  1821 call	putchar */
0x0000f569, 0x01f2f56c, /* 01f2f56c //C 0f569  1822 jmp	printf_next */
0x0000f56a, 0x01f2f56c, /* 01f2f56c //C 0f56a  1825 jmp	printf_next */
0x0000f56b, 0x0400f450, /* 0400f450 //C 0f56b  1827 call	putchar		; print actual char */
0x0000f56c, 0x01240001, /* 01240001 //C 0f56c  1829 inc	r2		; inc string ptr */
0x0000f56d, 0x01f2f51e, /* 01f2f51e //C 0f56d  1830 jmp	printf_cyc */
0x0000f56e, 0x0f1d0000, /* 0f1d0000 //C 0f56e  1833 pop	r1 */
0x0000f56f, 0x0f0d0000, /* 0f0d0000 //C 0f56f  1834 pop	r0 */
0x0000f570, 0x0ffd0000, /* 0ffd0000 //C 0f570  1835 pop	pc */
0x0000f571, 0x0d0d0000, /* 0d0d0000 //C 0f571  1840 push	r0 */
0x0000f572, 0x0d2d0000, /* 0d2d0000 //C 0f572  1841 push	r2 */
0x0000f573, 0x00000e00, /* 00000e00 //C 0f573  1842 mov	r0,LR */
0x0000f574, 0x0400f50d, /* 0400f50d //C 0f574  1843 call	printf */
0x0000f575, 0x01240001, /* 01240001 //C 0f575  1844 inc	r2 */
0x0000f576, 0x0620f5ea, /* 0620f5ea //C 0f576  1845 st	r2,reg2 */
0x0000f577, 0x0f2d0000, /* 0f2d0000 //C 0f577  1846 pop	r2 */
0x0000f578, 0x0f0d0000, /* 0f0d0000 //C 0f578  1847 pop	r0 */
0x0000f579, 0x07f0f5ea, /* 07f0f5ea //C 0f579  1848 ld	PC,reg2 */
0x0000f57a, 0x00000000, /* 00000000 //C 0f57a  1853 line:		ds	100		; line buffer */
0x0000f5de, 0x00000000, /* 00000000 //C 0f5de  1854 line_ptr:	ds	1		; line pointer (index) */
0x0000f5df, 0x00000000, /* 00000000 //C 0f5df  1855 at_eol:		ds	1		; bool, true if EOL arrived */
0x0000f5e0, 0x00000000, /* 00000000 //C 0f5e0  1856 words:		ds	5		; Tokens of line */
0x0000f5e5, 0x00000000, /* 00000000 //C 0f5e5  1857 echo:		ds	1		; bool, do echo or not */
0x0000f5e6, 0x00000000, /* 00000000 //C 0f5e6  1858 dd	0 */
0x0000f5e7, 0x00000000, /* 00000000 //C 0f5e7  1859 dd	0 */
0x0000f5e8, 0x00000000, /* 00000000 //C 0f5e8  1861 dd	0 */
0x0000f5e9, 0x00000000, /* 00000000 //C 0f5e9  1862 dd	0 */
0x0000f5ea, 0x00000000, /* 00000000 //C 0f5ea  1863 dd	0 */
0x0000f5eb, 0x00000000, /* 00000000 //C 0f5eb  1864 dd	0 */
0x0000f5ec, 0x00000000, /* 00000000 //C 0f5ec  1865 dd	0 */
0x0000f5ed, 0x00000000, /* 00000000 //C 0f5ed  1866 dd	0 */
0x0000f5ee, 0x00000000, /* 00000000 //C 0f5ee  1867 dd	0 */
0x0000f5ef, 0x00000000, /* 00000000 //C 0f5ef  1868 dd	0 */
0x0000f5f0, 0x00000000, /* 00000000 //C 0f5f0  1869 dd	0 */
0x0000f5f1, 0x00000000, /* 00000000 //C 0f5f1  1870 dd	0 */
0x0000f5f2, 0x00000000, /* 00000000 //C 0f5f2  1871 dd	0 */
0x0000f5f3, 0x00000000, /* 00000000 //C 0f5f3  1872 dd	0 */
0x0000f5f4, 0x00000000, /* 00000000 //C 0f5f4  1873 dd	0 */
0x0000f5f5, 0x00000000, /* 00000000 //C 0f5f5  1874 dd	0 */
0x0000f5f6, 0x00000000, /* 00000000 //C 0f5f6  1875 dd	0 */
0x0000f5f7, 0x00000000, /* 00000000 //C 0f5f7  1876 dd	0 */
0x0000f5f8, 0x00000000, /* 00000000 //C 0f5f8  1877 dd	0 */
0x0000f5f9, 0x00000050, /* 00000050 //C 0f5f9  1879 db	80 */
0x0000f5fa, 0x0000004d, /* 0000004d //C 0f5fa  1879 db	77 */
0x0000f5fb, 0x0000006f, /* 0000006f //C 0f5fb  1879 db	111 */
0x0000f5fc, 0x0000006e, /* 0000006e //C 0f5fc  1879 db	110 */
0x0000f5fd, 0x00000069, /* 00000069 //C 0f5fd  1879 db	105 */
0x0000f5fe, 0x00000074, /* 00000074 //C 0f5fe  1879 db	116 */
0x0000f5ff, 0x0000006f, /* 0000006f //C 0f5ff  1879 db	111 */
0x0000f600, 0x00000072, /* 00000072 //C 0f600  1879 db	114 */
0x0000f601, 0x00000020, /* 00000020 //C 0f601  1879 db	32 */
0x0000f602, 0x00000076, /* 00000076 //C 0f602  1879 db	118 */
0x0000f603, 0x00000031, /* 00000031 //C 0f603  1879 db	49 */
0x0000f604, 0x0000002e, /* 0000002e //C 0f604  1879 db	46 */
0x0000f605, 0x00000030, /* 00000030 //C 0f605  1879 db	48 */
0x0000f606, 0x00000000, /* 00000000 //C 0f606  1879 db */
0x0000f607, 0x00000053, /* 00000053 //C 0f607  1880 db	83 */
0x0000f608, 0x00000074, /* 00000074 //C 0f608  1880 db	116 */
0x0000f609, 0x0000006f, /* 0000006f //C 0f609  1880 db	111 */
0x0000f60a, 0x00000070, /* 00000070 //C 0f60a  1880 db	112 */
0x0000f60b, 0x00000020, /* 00000020 //C 0f60b  1880 db	32 */
0x0000f60c, 0x00000061, /* 00000061 //C 0f60c  1880 db	97 */
0x0000f60d, 0x00000074, /* 00000074 //C 0f60d  1880 db	116 */
0x0000f60e, 0x0000003a, /* 0000003a //C 0f60e  1880 db	58 */
0x0000f60f, 0x00000020, /* 00000020 //C 0f60f  1880 db	32 */
0x0000f610, 0x00000000, /* 00000000 //C 0f610  1880 db */
0x0000f611, 0x00000008, /* 00000008 //C 0f611  1881 db	8 */
0x0000f612, 0x00000020, /* 00000020 //C 0f612  1881 db	32 */
0x0000f613, 0x00000008, /* 00000008 //C 0f613  1881 db	8 */
0x0000f614, 0x00000000, /* 00000000 //C 0f614  1881 db	0 */
0x0000f615, 0x0000003a, /* 0000003a //C 0f615  1882 db	58 */
0x0000f616, 0x00000000, /* 00000000 //C 0f616  1882 db */
0x0000f617, 0x00000020, /* 00000020 //C 0f617  1883 db	32 */
0x0000f618, 0x0000003b, /* 0000003b //C 0f618  1883 db	59 */
0x0000f619, 0x00000009, /* 00000009 //C 0f619  1883 db	9 */
0x0000f61a, 0x0000000b, /* 0000000b //C 0f61a  1883 db	11 */
0x0000f61b, 0x0000002c, /* 0000002c //C 0f61b  1883 db	44 */
0x0000f61c, 0x0000003d, /* 0000003d //C 0f61c  1883 db	61 */
0x0000f61d, 0x0000005b, /* 0000005b //C 0f61d  1883 db	91 */
0x0000f61e, 0x0000005d, /* 0000005d //C 0f61e  1883 db	93 */
0x0000f61f, 0x00000000, /* 00000000 //C 0f61f  1883 db */
0x0000f620, 0x00000028, /* 00000028 //C 0f620  1884 db	40 */
0x0000f621, 0x0000006e, /* 0000006e //C 0f621  1884 db	110 */
0x0000f622, 0x00000075, /* 00000075 //C 0f622  1884 db	117 */
0x0000f623, 0x0000006c, /* 0000006c //C 0f623  1884 db	108 */
0x0000f624, 0x0000006c, /* 0000006c //C 0f624  1884 db	108 */
0x0000f625, 0x00000029, /* 00000029 //C 0f625  1884 db	41 */
0x0000f626, 0x00000000, /* 00000000 //C 0f626  1884 db */
0x0000f627, 0x00000000, /* 00000000 //C 0f627  1885 db	0 */
0x0000f628, 0x00000000, /* 00000000 //C 0f628  1886 db	0 */
0x0000f629, 0x00000000, /* 00000000 //C 0f629  1887 sc_buffer:	ds	10 */
0x0000f633, 0x0000f190, /* 0000f190 //C 0f633  1891 dd	cmd_sm */
0x0000f634, 0x00000073, /* 00000073 //C 0f634  1892 db	115 */
0x0000f635, 0x0000006d, /* 0000006d //C 0f635  1892 db	109 */
0x0000f636, 0x00000000, /* 00000000 //C 0f636  1892 db */
0x0000f637, 0x0000f137, /* 0000f137 //C 0f637  1893 dd	cmd_m */
0x0000f638, 0x0000006d, /* 0000006d //C 0f638  1894 db	109 */
0x0000f639, 0x00000000, /* 00000000 //C 0f639  1894 db */
0x0000f63a, 0x0000f137, /* 0000f137 //C 0f63a  1895 dd	cmd_m */
0x0000f63b, 0x0000006d, /* 0000006d //C 0f63b  1896 db	109 */
0x0000f63c, 0x00000065, /* 00000065 //C 0f63c  1896 db	101 */
0x0000f63d, 0x0000006d, /* 0000006d //C 0f63d  1896 db	109 */
0x0000f63e, 0x00000000, /* 00000000 //C 0f63e  1896 db */
0x0000f63f, 0x0000f1b3, /* 0000f1b3 //C 0f63f  1897 dd	cmd_d */
0x0000f640, 0x00000064, /* 00000064 //C 0f640  1898 db	100 */
0x0000f641, 0x00000000, /* 00000000 //C 0f641  1898 db */
0x0000f642, 0x0000f1b3, /* 0000f1b3 //C 0f642  1899 dd	cmd_d */
0x0000f643, 0x00000064, /* 00000064 //C 0f643  1900 db	100 */
0x0000f644, 0x00000075, /* 00000075 //C 0f644  1900 db	117 */
0x0000f645, 0x0000006d, /* 0000006d //C 0f645  1900 db	109 */
0x0000f646, 0x00000070, /* 00000070 //C 0f646  1900 db	112 */
0x0000f647, 0x00000000, /* 00000000 //C 0f647  1900 db */
0x0000f648, 0x0000f1e6, /* 0000f1e6 //C 0f648  1901 dd	cmd_l */
0x0000f649, 0x0000006c, /* 0000006c //C 0f649  1902 db	108 */
0x0000f64a, 0x00000000, /* 00000000 //C 0f64a  1902 db */
0x0000f64b, 0x0000f1e6, /* 0000f1e6 //C 0f64b  1903 dd	cmd_l */
0x0000f64c, 0x0000006c, /* 0000006c //C 0f64c  1904 db	108 */
0x0000f64d, 0x0000006f, /* 0000006f //C 0f64d  1904 db	111 */
0x0000f64e, 0x00000061, /* 00000061 //C 0f64e  1904 db	97 */
0x0000f64f, 0x00000064, /* 00000064 //C 0f64f  1904 db	100 */
0x0000f650, 0x00000000, /* 00000000 //C 0f650  1904 db */
0x0000f651, 0x0000f25c, /* 0000f25c //C 0f651  1905 dd	cmd_g */
0x0000f652, 0x00000067, /* 00000067 //C 0f652  1906 db	103 */
0x0000f653, 0x00000000, /* 00000000 //C 0f653  1906 db */
0x0000f654, 0x0000f25c, /* 0000f25c //C 0f654  1907 dd	cmd_g */
0x0000f655, 0x00000067, /* 00000067 //C 0f655  1908 db	103 */
0x0000f656, 0x0000006f, /* 0000006f //C 0f656  1908 db	111 */
0x0000f657, 0x00000000, /* 00000000 //C 0f657  1908 db */
0x0000f658, 0x0000f25c, /* 0000f25c //C 0f658  1909 dd	cmd_g */
0x0000f659, 0x00000072, /* 00000072 //C 0f659  1910 db	114 */
0x0000f65a, 0x00000075, /* 00000075 //C 0f65a  1910 db	117 */
0x0000f65b, 0x0000006e, /* 0000006e //C 0f65b  1910 db	110 */
0x0000f65c, 0x00000000, /* 00000000 //C 0f65c  1910 db */
0x0000f65d, 0x0000f29b, /* 0000f29b //C 0f65d  1911 dd	cmd_h */
0x0000f65e, 0x0000003f, /* 0000003f //C 0f65e  1912 db	63 */
0x0000f65f, 0x00000000, /* 00000000 //C 0f65f  1912 db */
0x0000f660, 0x0000f29b, /* 0000f29b //C 0f660  1913 dd	cmd_h */
0x0000f661, 0x00000068, /* 00000068 //C 0f661  1914 db	104 */
0x0000f662, 0x00000000, /* 00000000 //C 0f662  1914 db */
0x0000f663, 0x0000f29b, /* 0000f29b //C 0f663  1915 dd	cmd_h */
0x0000f664, 0x00000068, /* 00000068 //C 0f664  1916 db	104 */
0x0000f665, 0x00000065, /* 00000065 //C 0f665  1916 db	101 */
0x0000f666, 0x0000006c, /* 0000006c //C 0f666  1916 db	108 */
0x0000f667, 0x00000070, /* 00000070 //C 0f667  1916 db	112 */
0x0000f668, 0x00000000, /* 00000000 //C 0f668  1916 db */
0x0000f669, 0x0000f302, /* 0000f302 //C 0f669  1917 dd	cmd_r */
0x0000f66a, 0x00000072, /* 00000072 //C 0f66a  1918 db	114 */
0x0000f66b, 0x00000000, /* 00000000 //C 0f66b  1918 db */
0x0000f66c, 0x0000f302, /* 0000f302 //C 0f66c  1919 dd	cmd_r */
0x0000f66d, 0x00000072, /* 00000072 //C 0f66d  1920 db	114 */
0x0000f66e, 0x00000065, /* 00000065 //C 0f66e  1920 db	101 */
0x0000f66f, 0x00000067, /* 00000067 //C 0f66f  1920 db	103 */
0x0000f670, 0x00000000, /* 00000000 //C 0f670  1920 db */
0x0000f671, 0x0000f302, /* 0000f302 //C 0f671  1921 dd	cmd_r */
0x0000f672, 0x00000072, /* 00000072 //C 0f672  1922 db	114 */
0x0000f673, 0x00000065, /* 00000065 //C 0f673  1922 db	101 */
0x0000f674, 0x00000067, /* 00000067 //C 0f674  1922 db	103 */
0x0000f675, 0x00000073, /* 00000073 //C 0f675  1922 db	115 */
0x0000f676, 0x00000000, /* 00000000 //C 0f676  1922 db */
0x0000f677, 0x0000f392, /* 0000f392 //C 0f677  1923 dd	cmd_sp */
0x0000f678, 0x00000073, /* 00000073 //C 0f678  1924 db	115 */
0x0000f679, 0x00000070, /* 00000070 //C 0f679  1924 db	112 */
0x0000f67a, 0x00000000, /* 00000000 //C 0f67a  1924 db */
0x0000f67b, 0x0000f395, /* 0000f395 //C 0f67b  1925 dd	cmd_lr */
0x0000f67c, 0x0000006c, /* 0000006c //C 0f67c  1926 db	108 */
0x0000f67d, 0x00000072, /* 00000072 //C 0f67d  1926 db	114 */
0x0000f67e, 0x00000000, /* 00000000 //C 0f67e  1926 db */
0x0000f67f, 0x0000f398, /* 0000f398 //C 0f67f  1927 dd	cmd_pc */
0x0000f680, 0x00000070, /* 00000070 //C 0f680  1928 db	112 */
0x0000f681, 0x00000063, /* 00000063 //C 0f681  1928 db	99 */
0x0000f682, 0x00000000, /* 00000000 //C 0f682  1928 db */
0x0000f683, 0x0000f39b, /* 0000f39b //C 0f683  1929 dd	cmd_f */
0x0000f684, 0x00000066, /* 00000066 //C 0f684  1930 db	102 */
0x0000f685, 0x00000000, /* 00000000 //C 0f685  1930 db */
0x0000f686, 0x00000000, /* 00000000 //C 0f686  1931 dd	0 */
0x0000f687, 0x00000000, /* 00000000 //C 0f687  1932 dd	0 */
0x0000f688, 0x0000006d, /* 0000006d //C 0f688  1934 db	109 */
0x0000f689, 0x0000005b, /* 0000005b //C 0f689  1934 db	91 */
0x0000f68a, 0x00000065, /* 00000065 //C 0f68a  1934 db	101 */
0x0000f68b, 0x0000006d, /* 0000006d //C 0f68b  1934 db	109 */
0x0000f68c, 0x0000005d, /* 0000005d //C 0f68c  1934 db	93 */
0x0000f68d, 0x00000020, /* 00000020 //C 0f68d  1934 db	32 */
0x0000f68e, 0x00000061, /* 00000061 //C 0f68e  1934 db	97 */
0x0000f68f, 0x00000064, /* 00000064 //C 0f68f  1934 db	100 */
0x0000f690, 0x00000064, /* 00000064 //C 0f690  1934 db	100 */
0x0000f691, 0x00000072, /* 00000072 //C 0f691  1934 db	114 */
0x0000f692, 0x00000020, /* 00000020 //C 0f692  1934 db	32 */
0x0000f693, 0x0000005b, /* 0000005b //C 0f693  1934 db	91 */
0x0000f694, 0x00000076, /* 00000076 //C 0f694  1934 db	118 */
0x0000f695, 0x00000061, /* 00000061 //C 0f695  1934 db	97 */
0x0000f696, 0x0000006c, /* 0000006c //C 0f696  1934 db	108 */
0x0000f697, 0x0000005d, /* 0000005d //C 0f697  1934 db	93 */
0x0000f698, 0x00000020, /* 00000020 //C 0f698  1934 db	32 */
0x0000f699, 0x00000020, /* 00000020 //C 0f699  1934 db	32 */
0x0000f69a, 0x00000047, /* 00000047 //C 0f69a  1934 db	71 */
0x0000f69b, 0x00000065, /* 00000065 //C 0f69b  1934 db	101 */
0x0000f69c, 0x00000074, /* 00000074 //C 0f69c  1934 db	116 */
0x0000f69d, 0x0000002f, /* 0000002f //C 0f69d  1934 db	47 */
0x0000f69e, 0x00000073, /* 00000073 //C 0f69e  1934 db	115 */
0x0000f69f, 0x00000065, /* 00000065 //C 0f69f  1934 db	101 */
0x0000f6a0, 0x00000074, /* 00000074 //C 0f6a0  1934 db	116 */
0x0000f6a1, 0x00000020, /* 00000020 //C 0f6a1  1934 db	32 */
0x0000f6a2, 0x0000006d, /* 0000006d //C 0f6a2  1934 db	109 */
0x0000f6a3, 0x00000065, /* 00000065 //C 0f6a3  1934 db	101 */
0x0000f6a4, 0x0000006d, /* 0000006d //C 0f6a4  1934 db	109 */
0x0000f6a5, 0x0000006f, /* 0000006f //C 0f6a5  1934 db	111 */
0x0000f6a6, 0x00000072, /* 00000072 //C 0f6a6  1934 db	114 */
0x0000f6a7, 0x00000079, /* 00000079 //C 0f6a7  1934 db	121 */
0x0000f6a8, 0x0000000a, /* 0000000a //C 0f6a8  1934 db	10 */
0x0000f6a9, 0x00000000, /* 00000000 //C 0f6a9  1934 db */
0x0000f6aa, 0x00000064, /* 00000064 //C 0f6aa  1935 db	100 */
0x0000f6ab, 0x0000005b, /* 0000005b //C 0f6ab  1935 db	91 */
0x0000f6ac, 0x00000075, /* 00000075 //C 0f6ac  1935 db	117 */
0x0000f6ad, 0x0000006d, /* 0000006d //C 0f6ad  1935 db	109 */
0x0000f6ae, 0x00000070, /* 00000070 //C 0f6ae  1935 db	112 */
0x0000f6af, 0x0000005d, /* 0000005d //C 0f6af  1935 db	93 */
0x0000f6b0, 0x00000020, /* 00000020 //C 0f6b0  1935 db	32 */
0x0000f6b1, 0x00000073, /* 00000073 //C 0f6b1  1935 db	115 */
0x0000f6b2, 0x00000074, /* 00000074 //C 0f6b2  1935 db	116 */
0x0000f6b3, 0x00000061, /* 00000061 //C 0f6b3  1935 db	97 */
0x0000f6b4, 0x00000072, /* 00000072 //C 0f6b4  1935 db	114 */
0x0000f6b5, 0x00000074, /* 00000074 //C 0f6b5  1935 db	116 */
0x0000f6b6, 0x00000020, /* 00000020 //C 0f6b6  1935 db	32 */
0x0000f6b7, 0x00000065, /* 00000065 //C 0f6b7  1935 db	101 */
0x0000f6b8, 0x0000006e, /* 0000006e //C 0f6b8  1935 db	110 */
0x0000f6b9, 0x00000064, /* 00000064 //C 0f6b9  1935 db	100 */
0x0000f6ba, 0x00000020, /* 00000020 //C 0f6ba  1935 db	32 */
0x0000f6bb, 0x00000020, /* 00000020 //C 0f6bb  1935 db	32 */
0x0000f6bc, 0x00000044, /* 00000044 //C 0f6bc  1935 db	68 */
0x0000f6bd, 0x00000075, /* 00000075 //C 0f6bd  1935 db	117 */
0x0000f6be, 0x0000006d, /* 0000006d //C 0f6be  1935 db	109 */
0x0000f6bf, 0x00000070, /* 00000070 //C 0f6bf  1935 db	112 */
0x0000f6c0, 0x00000020, /* 00000020 //C 0f6c0  1935 db	32 */
0x0000f6c1, 0x0000006d, /* 0000006d //C 0f6c1  1935 db	109 */
0x0000f6c2, 0x00000065, /* 00000065 //C 0f6c2  1935 db	101 */
0x0000f6c3, 0x0000006d, /* 0000006d //C 0f6c3  1935 db	109 */
0x0000f6c4, 0x0000006f, /* 0000006f //C 0f6c4  1935 db	111 */
0x0000f6c5, 0x00000072, /* 00000072 //C 0f6c5  1935 db	114 */
0x0000f6c6, 0x00000079, /* 00000079 //C 0f6c6  1935 db	121 */
0x0000f6c7, 0x00000020, /* 00000020 //C 0f6c7  1935 db	32 */
0x0000f6c8, 0x00000063, /* 00000063 //C 0f6c8  1935 db	99 */
0x0000f6c9, 0x0000006f, /* 0000006f //C 0f6c9  1935 db	111 */
0x0000f6ca, 0x0000006e, /* 0000006e //C 0f6ca  1935 db	110 */
0x0000f6cb, 0x00000074, /* 00000074 //C 0f6cb  1935 db	116 */
0x0000f6cc, 0x00000065, /* 00000065 //C 0f6cc  1935 db	101 */
0x0000f6cd, 0x0000006e, /* 0000006e //C 0f6cd  1935 db	110 */
0x0000f6ce, 0x00000074, /* 00000074 //C 0f6ce  1935 db	116 */
0x0000f6cf, 0x0000000a, /* 0000000a //C 0f6cf  1935 db	10 */
0x0000f6d0, 0x00000000, /* 00000000 //C 0f6d0  1935 db */
0x0000f6d1, 0x0000006c, /* 0000006c //C 0f6d1  1936 db	108 */
0x0000f6d2, 0x0000005b, /* 0000005b //C 0f6d2  1936 db	91 */
0x0000f6d3, 0x0000006f, /* 0000006f //C 0f6d3  1936 db	111 */
0x0000f6d4, 0x00000061, /* 00000061 //C 0f6d4  1936 db	97 */
0x0000f6d5, 0x00000064, /* 00000064 //C 0f6d5  1936 db	100 */
0x0000f6d6, 0x0000005d, /* 0000005d //C 0f6d6  1936 db	93 */
0x0000f6d7, 0x00000020, /* 00000020 //C 0f6d7  1936 db	32 */
0x0000f6d8, 0x00000020, /* 00000020 //C 0f6d8  1936 db	32 */
0x0000f6d9, 0x00000020, /* 00000020 //C 0f6d9  1936 db	32 */
0x0000f6da, 0x00000020, /* 00000020 //C 0f6da  1936 db	32 */
0x0000f6db, 0x00000020, /* 00000020 //C 0f6db  1936 db	32 */
0x0000f6dc, 0x00000020, /* 00000020 //C 0f6dc  1936 db	32 */
0x0000f6dd, 0x00000020, /* 00000020 //C 0f6dd  1936 db	32 */
0x0000f6de, 0x00000020, /* 00000020 //C 0f6de  1936 db	32 */
0x0000f6df, 0x00000020, /* 00000020 //C 0f6df  1936 db	32 */
0x0000f6e0, 0x00000020, /* 00000020 //C 0f6e0  1936 db	32 */
0x0000f6e1, 0x00000020, /* 00000020 //C 0f6e1  1936 db	32 */
0x0000f6e2, 0x00000020, /* 00000020 //C 0f6e2  1936 db	32 */
0x0000f6e3, 0x0000004c, /* 0000004c //C 0f6e3  1936 db	76 */
0x0000f6e4, 0x0000006f, /* 0000006f //C 0f6e4  1936 db	111 */
0x0000f6e5, 0x00000061, /* 00000061 //C 0f6e5  1936 db	97 */
0x0000f6e6, 0x00000064, /* 00000064 //C 0f6e6  1936 db	100 */
0x0000f6e7, 0x00000020, /* 00000020 //C 0f6e7  1936 db	32 */
0x0000f6e8, 0x00000068, /* 00000068 //C 0f6e8  1936 db	104 */
0x0000f6e9, 0x00000065, /* 00000065 //C 0f6e9  1936 db	101 */
0x0000f6ea, 0x00000078, /* 00000078 //C 0f6ea  1936 db	120 */
0x0000f6eb, 0x00000020, /* 00000020 //C 0f6eb  1936 db	32 */
0x0000f6ec, 0x00000066, /* 00000066 //C 0f6ec  1936 db	102 */
0x0000f6ed, 0x00000069, /* 00000069 //C 0f6ed  1936 db	105 */
0x0000f6ee, 0x0000006c, /* 0000006c //C 0f6ee  1936 db	108 */
0x0000f6ef, 0x00000065, /* 00000065 //C 0f6ef  1936 db	101 */
0x0000f6f0, 0x00000020, /* 00000020 //C 0f6f0  1936 db	32 */
0x0000f6f1, 0x00000074, /* 00000074 //C 0f6f1  1936 db	116 */
0x0000f6f2, 0x0000006f, /* 0000006f //C 0f6f2  1936 db	111 */
0x0000f6f3, 0x00000020, /* 00000020 //C 0f6f3  1936 db	32 */
0x0000f6f4, 0x0000006d, /* 0000006d //C 0f6f4  1936 db	109 */
0x0000f6f5, 0x00000065, /* 00000065 //C 0f6f5  1936 db	101 */
0x0000f6f6, 0x0000006d, /* 0000006d //C 0f6f6  1936 db	109 */
0x0000f6f7, 0x0000006f, /* 0000006f //C 0f6f7  1936 db	111 */
0x0000f6f8, 0x00000072, /* 00000072 //C 0f6f8  1936 db	114 */
0x0000f6f9, 0x00000079, /* 00000079 //C 0f6f9  1936 db	121 */
0x0000f6fa, 0x0000000a, /* 0000000a //C 0f6fa  1936 db	10 */
0x0000f6fb, 0x00000000, /* 00000000 //C 0f6fb  1936 db */
0x0000f6fc, 0x00000067, /* 00000067 //C 0f6fc  1937 db	103 */
0x0000f6fd, 0x0000005b, /* 0000005b //C 0f6fd  1937 db	91 */
0x0000f6fe, 0x0000006f, /* 0000006f //C 0f6fe  1937 db	111 */
0x0000f6ff, 0x0000005d, /* 0000005d //C 0f6ff  1937 db	93 */
0x0000f700, 0x0000007c, /* 0000007c //C 0f700  1937 db	124 */
0x0000f701, 0x00000072, /* 00000072 //C 0f701  1937 db	114 */
0x0000f702, 0x00000075, /* 00000075 //C 0f702  1937 db	117 */
0x0000f703, 0x0000006e, /* 0000006e //C 0f703  1937 db	110 */
0x0000f704, 0x00000020, /* 00000020 //C 0f704  1937 db	32 */
0x0000f705, 0x0000005b, /* 0000005b //C 0f705  1937 db	91 */
0x0000f706, 0x00000061, /* 00000061 //C 0f706  1937 db	97 */
0x0000f707, 0x00000064, /* 00000064 //C 0f707  1937 db	100 */
0x0000f708, 0x00000064, /* 00000064 //C 0f708  1937 db	100 */
0x0000f709, 0x00000072, /* 00000072 //C 0f709  1937 db	114 */
0x0000f70a, 0x0000005d, /* 0000005d //C 0f70a  1937 db	93 */
0x0000f70b, 0x00000020, /* 00000020 //C 0f70b  1937 db	32 */
0x0000f70c, 0x00000020, /* 00000020 //C 0f70c  1937 db	32 */
0x0000f70d, 0x00000020, /* 00000020 //C 0f70d  1937 db	32 */
0x0000f70e, 0x00000052, /* 00000052 //C 0f70e  1937 db	82 */
0x0000f70f, 0x00000075, /* 00000075 //C 0f70f  1937 db	117 */
0x0000f710, 0x0000006e, /* 0000006e //C 0f710  1937 db	110 */
0x0000f711, 0x00000020, /* 00000020 //C 0f711  1937 db	32 */
0x0000f712, 0x00000066, /* 00000066 //C 0f712  1937 db	102 */
0x0000f713, 0x00000072, /* 00000072 //C 0f713  1937 db	114 */
0x0000f714, 0x0000006f, /* 0000006f //C 0f714  1937 db	111 */
0x0000f715, 0x0000006d, /* 0000006d //C 0f715  1937 db	109 */
0x0000f716, 0x00000020, /* 00000020 //C 0f716  1937 db	32 */
0x0000f717, 0x00000061, /* 00000061 //C 0f717  1937 db	97 */
0x0000f718, 0x00000064, /* 00000064 //C 0f718  1937 db	100 */
0x0000f719, 0x00000064, /* 00000064 //C 0f719  1937 db	100 */
0x0000f71a, 0x00000072, /* 00000072 //C 0f71a  1937 db	114 */
0x0000f71b, 0x00000065, /* 00000065 //C 0f71b  1937 db	101 */
0x0000f71c, 0x00000073, /* 00000073 //C 0f71c  1937 db	115 */
0x0000f71d, 0x00000073, /* 00000073 //C 0f71d  1937 db	115 */
0x0000f71e, 0x0000000a, /* 0000000a //C 0f71e  1937 db	10 */
0x0000f71f, 0x00000000, /* 00000000 //C 0f71f  1937 db */
0x0000f720, 0x00000072, /* 00000072 //C 0f720  1938 db	114 */
0x0000f721, 0x0000005b, /* 0000005b //C 0f721  1938 db	91 */
0x0000f722, 0x00000065, /* 00000065 //C 0f722  1938 db	101 */
0x0000f723, 0x00000067, /* 00000067 //C 0f723  1938 db	103 */
0x0000f724, 0x0000005b, /* 0000005b //C 0f724  1938 db	91 */
0x0000f725, 0x00000073, /* 00000073 //C 0f725  1938 db	115 */
0x0000f726, 0x0000005d, /* 0000005d //C 0f726  1938 db	93 */
0x0000f727, 0x0000005d, /* 0000005d //C 0f727  1938 db	93 */
0x0000f728, 0x00000020, /* 00000020 //C 0f728  1938 db	32 */
0x0000f729, 0x00000020, /* 00000020 //C 0f729  1938 db	32 */
0x0000f72a, 0x00000020, /* 00000020 //C 0f72a  1938 db	32 */
0x0000f72b, 0x00000020, /* 00000020 //C 0f72b  1938 db	32 */
0x0000f72c, 0x00000020, /* 00000020 //C 0f72c  1938 db	32 */
0x0000f72d, 0x00000020, /* 00000020 //C 0f72d  1938 db	32 */
0x0000f72e, 0x00000020, /* 00000020 //C 0f72e  1938 db	32 */
0x0000f72f, 0x00000020, /* 00000020 //C 0f72f  1938 db	32 */
0x0000f730, 0x00000020, /* 00000020 //C 0f730  1938 db	32 */
0x0000f731, 0x00000020, /* 00000020 //C 0f731  1938 db	32 */
0x0000f732, 0x00000050, /* 00000050 //C 0f732  1938 db	80 */
0x0000f733, 0x00000072, /* 00000072 //C 0f733  1938 db	114 */
0x0000f734, 0x00000069, /* 00000069 //C 0f734  1938 db	105 */
0x0000f735, 0x0000006e, /* 0000006e //C 0f735  1938 db	110 */
0x0000f736, 0x00000074, /* 00000074 //C 0f736  1938 db	116 */
0x0000f737, 0x00000020, /* 00000020 //C 0f737  1938 db	32 */
0x0000f738, 0x00000072, /* 00000072 //C 0f738  1938 db	114 */
0x0000f739, 0x00000065, /* 00000065 //C 0f739  1938 db	101 */
0x0000f73a, 0x00000067, /* 00000067 //C 0f73a  1938 db	103 */
0x0000f73b, 0x00000069, /* 00000069 //C 0f73b  1938 db	105 */
0x0000f73c, 0x00000073, /* 00000073 //C 0f73c  1938 db	115 */
0x0000f73d, 0x00000074, /* 00000074 //C 0f73d  1938 db	116 */
0x0000f73e, 0x00000065, /* 00000065 //C 0f73e  1938 db	101 */
0x0000f73f, 0x00000072, /* 00000072 //C 0f73f  1938 db	114 */
0x0000f740, 0x00000073, /* 00000073 //C 0f740  1938 db	115 */
0x0000f741, 0x0000000a, /* 0000000a //C 0f741  1938 db	10 */
0x0000f742, 0x00000000, /* 00000000 //C 0f742  1938 db */
0x0000f743, 0x00000072, /* 00000072 //C 0f743  1939 db	114 */
0x0000f744, 0x00000058, /* 00000058 //C 0f744  1939 db	88 */
0x0000f745, 0x00000020, /* 00000020 //C 0f745  1939 db	32 */
0x0000f746, 0x0000005b, /* 0000005b //C 0f746  1939 db	91 */
0x0000f747, 0x00000076, /* 00000076 //C 0f747  1939 db	118 */
0x0000f748, 0x00000061, /* 00000061 //C 0f748  1939 db	97 */
0x0000f749, 0x0000006c, /* 0000006c //C 0f749  1939 db	108 */
0x0000f74a, 0x0000005d, /* 0000005d //C 0f74a  1939 db	93 */
0x0000f74b, 0x00000020, /* 00000020 //C 0f74b  1939 db	32 */
0x0000f74c, 0x00000020, /* 00000020 //C 0f74c  1939 db	32 */
0x0000f74d, 0x00000020, /* 00000020 //C 0f74d  1939 db	32 */
0x0000f74e, 0x00000020, /* 00000020 //C 0f74e  1939 db	32 */
0x0000f74f, 0x00000020, /* 00000020 //C 0f74f  1939 db	32 */
0x0000f750, 0x00000020, /* 00000020 //C 0f750  1939 db	32 */
0x0000f751, 0x00000020, /* 00000020 //C 0f751  1939 db	32 */
0x0000f752, 0x00000020, /* 00000020 //C 0f752  1939 db	32 */
0x0000f753, 0x00000020, /* 00000020 //C 0f753  1939 db	32 */
0x0000f754, 0x00000020, /* 00000020 //C 0f754  1939 db	32 */
0x0000f755, 0x00000047, /* 00000047 //C 0f755  1939 db	71 */
0x0000f756, 0x00000065, /* 00000065 //C 0f756  1939 db	101 */
0x0000f757, 0x00000074, /* 00000074 //C 0f757  1939 db	116 */
0x0000f758, 0x0000002f, /* 0000002f //C 0f758  1939 db	47 */
0x0000f759, 0x00000073, /* 00000073 //C 0f759  1939 db	115 */
0x0000f75a, 0x00000065, /* 00000065 //C 0f75a  1939 db	101 */
0x0000f75b, 0x00000074, /* 00000074 //C 0f75b  1939 db	116 */
0x0000f75c, 0x00000020, /* 00000020 //C 0f75c  1939 db	32 */
0x0000f75d, 0x00000052, /* 00000052 //C 0f75d  1939 db	82 */
0x0000f75e, 0x00000058, /* 00000058 //C 0f75e  1939 db	88 */
0x0000f75f, 0x0000000a, /* 0000000a //C 0f75f  1939 db	10 */
0x0000f760, 0x00000000, /* 00000000 //C 0f760  1939 db */
0x0000f761, 0x00000073, /* 00000073 //C 0f761  1940 db	115 */
0x0000f762, 0x00000070, /* 00000070 //C 0f762  1940 db	112 */
0x0000f763, 0x00000020, /* 00000020 //C 0f763  1940 db	32 */
0x0000f764, 0x0000005b, /* 0000005b //C 0f764  1940 db	91 */
0x0000f765, 0x00000076, /* 00000076 //C 0f765  1940 db	118 */
0x0000f766, 0x00000061, /* 00000061 //C 0f766  1940 db	97 */
0x0000f767, 0x0000006c, /* 0000006c //C 0f767  1940 db	108 */
0x0000f768, 0x0000005d, /* 0000005d //C 0f768  1940 db	93 */
0x0000f769, 0x00000020, /* 00000020 //C 0f769  1940 db	32 */
0x0000f76a, 0x00000020, /* 00000020 //C 0f76a  1940 db	32 */
0x0000f76b, 0x00000020, /* 00000020 //C 0f76b  1940 db	32 */
0x0000f76c, 0x00000020, /* 00000020 //C 0f76c  1940 db	32 */
0x0000f76d, 0x00000020, /* 00000020 //C 0f76d  1940 db	32 */
0x0000f76e, 0x00000020, /* 00000020 //C 0f76e  1940 db	32 */
0x0000f76f, 0x00000020, /* 00000020 //C 0f76f  1940 db	32 */
0x0000f770, 0x00000020, /* 00000020 //C 0f770  1940 db	32 */
0x0000f771, 0x00000020, /* 00000020 //C 0f771  1940 db	32 */
0x0000f772, 0x00000020, /* 00000020 //C 0f772  1940 db	32 */
0x0000f773, 0x00000047, /* 00000047 //C 0f773  1940 db	71 */
0x0000f774, 0x00000065, /* 00000065 //C 0f774  1940 db	101 */
0x0000f775, 0x00000074, /* 00000074 //C 0f775  1940 db	116 */
0x0000f776, 0x0000002f, /* 0000002f //C 0f776  1940 db	47 */
0x0000f777, 0x00000073, /* 00000073 //C 0f777  1940 db	115 */
0x0000f778, 0x00000065, /* 00000065 //C 0f778  1940 db	101 */
0x0000f779, 0x00000074, /* 00000074 //C 0f779  1940 db	116 */
0x0000f77a, 0x00000020, /* 00000020 //C 0f77a  1940 db	32 */
0x0000f77b, 0x00000052, /* 00000052 //C 0f77b  1940 db	82 */
0x0000f77c, 0x00000031, /* 00000031 //C 0f77c  1940 db	49 */
0x0000f77d, 0x00000033, /* 00000033 //C 0f77d  1940 db	51 */
0x0000f77e, 0x0000000a, /* 0000000a //C 0f77e  1940 db	10 */
0x0000f77f, 0x00000000, /* 00000000 //C 0f77f  1940 db */
0x0000f780, 0x0000006c, /* 0000006c //C 0f780  1941 db	108 */
0x0000f781, 0x00000072, /* 00000072 //C 0f781  1941 db	114 */
0x0000f782, 0x00000020, /* 00000020 //C 0f782  1941 db	32 */
0x0000f783, 0x0000005b, /* 0000005b //C 0f783  1941 db	91 */
0x0000f784, 0x00000076, /* 00000076 //C 0f784  1941 db	118 */
0x0000f785, 0x00000061, /* 00000061 //C 0f785  1941 db	97 */
0x0000f786, 0x0000006c, /* 0000006c //C 0f786  1941 db	108 */
0x0000f787, 0x0000005d, /* 0000005d //C 0f787  1941 db	93 */
0x0000f788, 0x00000020, /* 00000020 //C 0f788  1941 db	32 */
0x0000f789, 0x00000020, /* 00000020 //C 0f789  1941 db	32 */
0x0000f78a, 0x00000020, /* 00000020 //C 0f78a  1941 db	32 */
0x0000f78b, 0x00000020, /* 00000020 //C 0f78b  1941 db	32 */
0x0000f78c, 0x00000020, /* 00000020 //C 0f78c  1941 db	32 */
0x0000f78d, 0x00000020, /* 00000020 //C 0f78d  1941 db	32 */
0x0000f78e, 0x00000020, /* 00000020 //C 0f78e  1941 db	32 */
0x0000f78f, 0x00000020, /* 00000020 //C 0f78f  1941 db	32 */
0x0000f790, 0x00000020, /* 00000020 //C 0f790  1941 db	32 */
0x0000f791, 0x00000020, /* 00000020 //C 0f791  1941 db	32 */
0x0000f792, 0x00000047, /* 00000047 //C 0f792  1941 db	71 */
0x0000f793, 0x00000065, /* 00000065 //C 0f793  1941 db	101 */
0x0000f794, 0x00000074, /* 00000074 //C 0f794  1941 db	116 */
0x0000f795, 0x0000002f, /* 0000002f //C 0f795  1941 db	47 */
0x0000f796, 0x00000073, /* 00000073 //C 0f796  1941 db	115 */
0x0000f797, 0x00000065, /* 00000065 //C 0f797  1941 db	101 */
0x0000f798, 0x00000074, /* 00000074 //C 0f798  1941 db	116 */
0x0000f799, 0x00000020, /* 00000020 //C 0f799  1941 db	32 */
0x0000f79a, 0x00000052, /* 00000052 //C 0f79a  1941 db	82 */
0x0000f79b, 0x00000031, /* 00000031 //C 0f79b  1941 db	49 */
0x0000f79c, 0x00000034, /* 00000034 //C 0f79c  1941 db	52 */
0x0000f79d, 0x0000000a, /* 0000000a //C 0f79d  1941 db	10 */
0x0000f79e, 0x00000000, /* 00000000 //C 0f79e  1941 db */
0x0000f79f, 0x00000070, /* 00000070 //C 0f79f  1942 db	112 */
0x0000f7a0, 0x00000063, /* 00000063 //C 0f7a0  1942 db	99 */
0x0000f7a1, 0x00000020, /* 00000020 //C 0f7a1  1942 db	32 */
0x0000f7a2, 0x0000005b, /* 0000005b //C 0f7a2  1942 db	91 */
0x0000f7a3, 0x00000076, /* 00000076 //C 0f7a3  1942 db	118 */
0x0000f7a4, 0x00000061, /* 00000061 //C 0f7a4  1942 db	97 */
0x0000f7a5, 0x0000006c, /* 0000006c //C 0f7a5  1942 db	108 */
0x0000f7a6, 0x0000005d, /* 0000005d //C 0f7a6  1942 db	93 */
0x0000f7a7, 0x00000020, /* 00000020 //C 0f7a7  1942 db	32 */
0x0000f7a8, 0x00000020, /* 00000020 //C 0f7a8  1942 db	32 */
0x0000f7a9, 0x00000020, /* 00000020 //C 0f7a9  1942 db	32 */
0x0000f7aa, 0x00000020, /* 00000020 //C 0f7aa  1942 db	32 */
0x0000f7ab, 0x00000020, /* 00000020 //C 0f7ab  1942 db	32 */
0x0000f7ac, 0x00000020, /* 00000020 //C 0f7ac  1942 db	32 */
0x0000f7ad, 0x00000020, /* 00000020 //C 0f7ad  1942 db	32 */
0x0000f7ae, 0x00000020, /* 00000020 //C 0f7ae  1942 db	32 */
0x0000f7af, 0x00000020, /* 00000020 //C 0f7af  1942 db	32 */
0x0000f7b0, 0x00000020, /* 00000020 //C 0f7b0  1942 db	32 */
0x0000f7b1, 0x00000047, /* 00000047 //C 0f7b1  1942 db	71 */
0x0000f7b2, 0x00000065, /* 00000065 //C 0f7b2  1942 db	101 */
0x0000f7b3, 0x00000074, /* 00000074 //C 0f7b3  1942 db	116 */
0x0000f7b4, 0x0000002f, /* 0000002f //C 0f7b4  1942 db	47 */
0x0000f7b5, 0x00000073, /* 00000073 //C 0f7b5  1942 db	115 */
0x0000f7b6, 0x00000065, /* 00000065 //C 0f7b6  1942 db	101 */
0x0000f7b7, 0x00000074, /* 00000074 //C 0f7b7  1942 db	116 */
0x0000f7b8, 0x00000020, /* 00000020 //C 0f7b8  1942 db	32 */
0x0000f7b9, 0x00000052, /* 00000052 //C 0f7b9  1942 db	82 */
0x0000f7ba, 0x00000031, /* 00000031 //C 0f7ba  1942 db	49 */
0x0000f7bb, 0x00000035, /* 00000035 //C 0f7bb  1942 db	53 */
0x0000f7bc, 0x0000000a, /* 0000000a //C 0f7bc  1942 db	10 */
0x0000f7bd, 0x00000000, /* 00000000 //C 0f7bd  1942 db */
0x0000f7be, 0x00000066, /* 00000066 //C 0f7be  1943 db	102 */
0x0000f7bf, 0x00000020, /* 00000020 //C 0f7bf  1943 db	32 */
0x0000f7c0, 0x0000005b, /* 0000005b //C 0f7c0  1943 db	91 */
0x0000f7c1, 0x00000076, /* 00000076 //C 0f7c1  1943 db	118 */
0x0000f7c2, 0x00000061, /* 00000061 //C 0f7c2  1943 db	97 */
0x0000f7c3, 0x0000006c, /* 0000006c //C 0f7c3  1943 db	108 */
0x0000f7c4, 0x0000005d, /* 0000005d //C 0f7c4  1943 db	93 */
0x0000f7c5, 0x00000020, /* 00000020 //C 0f7c5  1943 db	32 */
0x0000f7c6, 0x00000020, /* 00000020 //C 0f7c6  1943 db	32 */
0x0000f7c7, 0x00000020, /* 00000020 //C 0f7c7  1943 db	32 */
0x0000f7c8, 0x00000020, /* 00000020 //C 0f7c8  1943 db	32 */
0x0000f7c9, 0x00000020, /* 00000020 //C 0f7c9  1943 db	32 */
0x0000f7ca, 0x00000020, /* 00000020 //C 0f7ca  1943 db	32 */
0x0000f7cb, 0x00000020, /* 00000020 //C 0f7cb  1943 db	32 */
0x0000f7cc, 0x00000020, /* 00000020 //C 0f7cc  1943 db	32 */
0x0000f7cd, 0x00000020, /* 00000020 //C 0f7cd  1943 db	32 */
0x0000f7ce, 0x00000020, /* 00000020 //C 0f7ce  1943 db	32 */
0x0000f7cf, 0x00000020, /* 00000020 //C 0f7cf  1943 db	32 */
0x0000f7d0, 0x00000047, /* 00000047 //C 0f7d0  1943 db	71 */
0x0000f7d1, 0x00000065, /* 00000065 //C 0f7d1  1943 db	101 */
0x0000f7d2, 0x00000074, /* 00000074 //C 0f7d2  1943 db	116 */
0x0000f7d3, 0x0000002f, /* 0000002f //C 0f7d3  1943 db	47 */
0x0000f7d4, 0x00000073, /* 00000073 //C 0f7d4  1943 db	115 */
0x0000f7d5, 0x00000065, /* 00000065 //C 0f7d5  1943 db	101 */
0x0000f7d6, 0x00000074, /* 00000074 //C 0f7d6  1943 db	116 */
0x0000f7d7, 0x00000020, /* 00000020 //C 0f7d7  1943 db	32 */
0x0000f7d8, 0x00000066, /* 00000066 //C 0f7d8  1943 db	102 */
0x0000f7d9, 0x0000006c, /* 0000006c //C 0f7d9  1943 db	108 */
0x0000f7da, 0x00000061, /* 00000061 //C 0f7da  1943 db	97 */
0x0000f7db, 0x00000067, /* 00000067 //C 0f7db  1943 db	103 */
0x0000f7dc, 0x00000073, /* 00000073 //C 0f7dc  1943 db	115 */
0x0000f7dd, 0x0000000a, /* 0000000a //C 0f7dd  1943 db	10 */
0x0000f7de, 0x00000000, /* 00000000 //C 0f7de  1943 db */
0x0000f7df, 0x00000068, /* 00000068 //C 0f7df  1944 db	104 */
0x0000f7e0, 0x0000005b, /* 0000005b //C 0f7e0  1944 db	91 */
0x0000f7e1, 0x00000065, /* 00000065 //C 0f7e1  1944 db	101 */
0x0000f7e2, 0x0000006c, /* 0000006c //C 0f7e2  1944 db	108 */
0x0000f7e3, 0x00000070, /* 00000070 //C 0f7e3  1944 db	112 */
0x0000f7e4, 0x0000005d, /* 0000005d //C 0f7e4  1944 db	93 */
0x0000f7e5, 0x0000002c, /* 0000002c //C 0f7e5  1944 db	44 */
0x0000f7e6, 0x0000003f, /* 0000003f //C 0f7e6  1944 db	63 */
0x0000f7e7, 0x00000020, /* 00000020 //C 0f7e7  1944 db	32 */
0x0000f7e8, 0x00000020, /* 00000020 //C 0f7e8  1944 db	32 */
0x0000f7e9, 0x00000020, /* 00000020 //C 0f7e9  1944 db	32 */
0x0000f7ea, 0x00000020, /* 00000020 //C 0f7ea  1944 db	32 */
0x0000f7eb, 0x00000020, /* 00000020 //C 0f7eb  1944 db	32 */
0x0000f7ec, 0x00000020, /* 00000020 //C 0f7ec  1944 db	32 */
0x0000f7ed, 0x00000020, /* 00000020 //C 0f7ed  1944 db	32 */
0x0000f7ee, 0x00000020, /* 00000020 //C 0f7ee  1944 db	32 */
0x0000f7ef, 0x00000020, /* 00000020 //C 0f7ef  1944 db	32 */
0x0000f7f0, 0x00000020, /* 00000020 //C 0f7f0  1944 db	32 */
0x0000f7f1, 0x00000048, /* 00000048 //C 0f7f1  1944 db	72 */
0x0000f7f2, 0x00000065, /* 00000065 //C 0f7f2  1944 db	101 */
0x0000f7f3, 0x0000006c, /* 0000006c //C 0f7f3  1944 db	108 */
0x0000f7f4, 0x00000070, /* 00000070 //C 0f7f4  1944 db	112 */
0x0000f7f5, 0x0000000a, /* 0000000a //C 0f7f5  1944 db	10 */
0x0000f7f6, 0x00000000, /* 00000000 //C 0f7f6  1944 db */
0x0000f7f7, 0x00000000, /* 00000000 //C 0f7f7  1945 dd	0 */
0x0000f7f8, 0x00000000, /* 00000000 //C 0f7f8  1951 ds	0x40 */
0x0000f838, 0x00000000, /* 00000000 //C 0f838  1953 ds	1 */
0x0000f839, 0x00000000, /* 00000000 //C 0f839     3  */
