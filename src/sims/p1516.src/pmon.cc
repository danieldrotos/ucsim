...
0x0000f003, 0x00f00e00, /* 00f00e00 //C 0f003    32 _f003:	ret */
...
0x0000f025, 0x0600f655, /* 0600f655 //C 0f025    72 st	r0,reg0 */
0x0000f026, 0x0610f656, /* 0610f656 //C 0f026    73 st	r1,reg1 */
0x0000f027, 0x0620f657, /* 0620f657 //C 0f027    74 st	r2,reg2 */
0x0000f028, 0x0630f658, /* 0630f658 //C 0f028    75 st	r3,reg3 */
0x0000f029, 0x0640f659, /* 0640f659 //C 0f029    76 st	r4,reg4 */
0x0000f02a, 0x0650f65a, /* 0650f65a //C 0f02a    77 st	r5,reg5 */
0x0000f02b, 0x0660f65b, /* 0660f65b //C 0f02b    78 st	r6,reg6 */
0x0000f02c, 0x0670f65c, /* 0670f65c //C 0f02c    79 st	r7,reg7 */
0x0000f02d, 0x0680f65d, /* 0680f65d //C 0f02d    80 st	r8,reg8 */
0x0000f02e, 0x0690f65e, /* 0690f65e //C 0f02e    81 st	r9,reg9 */
0x0000f02f, 0x06a0f65f, /* 06a0f65f //C 0f02f    82 st	r10,reg10 */
0x0000f030, 0x06b0f660, /* 06b0f660 //C 0f030    83 st	r11,reg11 */
0x0000f031, 0x06c0f661, /* 06c0f661 //C 0f031    84 st	r12,reg12 */
0x0000f032, 0x06d0f662, /* 06d0f662 //C 0f032    85 st	r13,reg13 */
0x0000f033, 0x06e0f663, /* 06e0f663 //C 0f033    86 st	r14,reg14 */
0x0000f034, 0x06e0f664, /* 06e0f664 //C 0f034    87 st	r14,reg15 */
0x0000f035, 0x020e0000, /* 020e0000 //C 0f035    88 getf	r0 */
0x0000f036, 0x0600f665, /* 0600f665 //C 0f036    89 st	r0,regf */
0x0000f037, 0x01020001, /* 01020001 //C 0f037    90 mvzl	r0,1 */
0x0000f038, 0x0600f653, /* 0600f653 //C 0f038    91 st	r0,called */
...
0x0000f03d, 0x0600f653, /* 0600f653 //C 0f03d    99 st	r0,called */
...
0x0000f042, 0x0600f665, /* 0600f665 //C 0f042   104 st	r0,regf		; FALGS= 0 */
0x0000f043, 0x0102f7ff, /* 0102f7ff //C 0f043   105 mvzl	r0,0xf7ff	; R13= 0xf7ff */
0x0000f044, 0x0600f662, /* 0600f662 //C 0f044   106 st	r0,reg13 */
0x0000f045, 0x01f2f046, /* 01f2f046 //C 0f045   107 jmp	common_start */
0x0000f046, 0x01d2f8b8, /* 01d2f8b8 //C 0f046   110 mvzl	sp,stack_end */
0x0000f047, 0x01020001, /* 01020001 //C 0f047   111 mvzl	r0,1 */
0x0000f048, 0x0600f652, /* 0600f652 //C 0f048   112 st	r0,echo */
...
0x0000f05b, 0x0102f666, /* 0102f666 //C 0f05b   139 mvzl	r0,msg_start */
0x0000f05c, 0x0400f560, /* 0400f560 //C 0f05c   140 call	printf */
0x0000f05d, 0x0700f653, /* 0700f653 //C 0f05d   142 ld	r0,called */
...
0x0000f062, 0x0102f687, /* 0102f687 //C 0f062   147 mvzl	r0,msg_stopat */
0x0000f063, 0x0400f49d, /* 0400f49d //C 0f063   148 call	prints */
0x0000f064, 0x0700f663, /* 0700f663 //C 0f064   149 ld	r0,reg14 */
...
0x0000f06d, 0x0610f64b, /* 0610f64b //C 0f06d   169 st	r1,line_ptr */
0x0000f06e, 0x0610f5e7, /* 0610f5e7 //C 0f06e   170 st	r1,line		; line[0]= 0 */
0x0000f06f, 0x01120000, /* 01120000 //C 0f06f   171 mvzl	r1,0		; at_eol= 0 */
0x0000f070, 0x0610f64c, /* 0610f64c //C 0f070   172 st	r1,at_eol */
0x0000f071, 0x0102f695, /* 0102f695 //C 0f071   174 mvzl	r0,prompt */
...
0x0000f086, 0x0700f64b, /* 0700f64b //C 0f086   213 ld	r0,line_ptr */
...
0x0000f08a, 0x0600f64b, /* 0600f64b //C 0f08a   217 st	r0,line_ptr */
0x0000f08b, 0x0112f5e7, /* 0112f5e7 //C 0f08b   218 mvzl	r1,line */
0x0000f08c, 0x01220000, /* 01220000 //C 0f08c   219 mvzl	r2,0 */
0x0000f08d, 0x08210000, /* 08210000 //C 0f08d   220 st	r2,r1,r0 */
0x0000f08e, 0x0102f691, /* 0102f691 //C 0f08e   221 mvzl	r0,msg_BS */
...
0x0000f097, 0x0620f64c, /* 0620f64c //C 0f097   232 st	r2,at_eol */
0x0000f098, 0x0112f64b, /* 0112f64b //C 0f098   233 mvzl	r1,line_ptr	; line[line_ptr]= char */
0x0000f099, 0x0e310000, /* 0e310000 //C 0f099   234 ld	r3,r1 */
0x0000f09a, 0x0122f5e7, /* 0122f5e7 //C 0f09a   235 mvzl	r2,line */
...
0x0000f0a1, 0x0142f652, /* 0142f652 //C 0f0a1   243 mvzl	r4,echo		; check if echo is turned on */
...
0x0000f0a7, 0x0112f64c, /* 0112f64c //C 0f0a7   250 mvzl	r1,at_eol */
...
0x0000f0b0, 0x0700f5e7, /* 0700f5e7 //C 0f0b0   270 ld	r0,line */
...
0x0000f0bb, 0x0610f64c, /* 0610f64c //C 0f0bb   304 st	r1,at_eol */
...
0x0000f0d3, 0x0112f697, /* 0112f697 //C 0f0d3   317 mvzl	r1,delimiters */
...
0x0000f0d7, 0x0142f64d, /* 0142f64d //C 0f0d7   329 mvzl	r4,words	; array of result */
0x0000f0d8, 0x0152f5e7, /* 0152f5e7 //C 0f0d8   330 mvzl	r5,line		; address of next char */
...
0x0000f0fb, 0x0700f64d, /* 0700f64d //C 0f0fb   382 ld	r0,words	; R0= 1st word of command */
...
0x0000f112, 0x0630f654, /* 0630f654 //C 0f112   408 st	r3,nuof_reg */
0x0000f113, 0x01f2f116, /* 01f2f116 //C 0f113   409 jmp	find_rx */
0x0000f114, 0x01260030, /* 01260030 //C 0f114   411 sub	r2,'0' */
0x0000f115, 0x0620f654, /* 0620f654 //C 0f115   412 st	r2,nuof_reg */
...
0x0000f119, 0x01a2f6b3, /* 01a2f6b3 //C 0f119   419 mvzl	r10,commands */
...
0x0000f13e, 0x0122f64d, /* 0122f64d //C 0f13e   465 mvzl	r2,words */
...
0x0000f150, 0x0132f8b9, /* 0132f8b9 //C 0f150   487 mvzl	r3,the_end */
...
0x0000f197, 0x0122f64d, /* 0122f64d //C 0f197   534 mvzl	r2,words */
...
0x0000f1a9, 0x0132f8b9, /* 0132f8b9 //C 0f1a9   556 mvzl	r3,the_end */
...
0x0000f1ba, 0x0122f64d, /* 0122f64d //C 0f1ba   583 mvzl	r2,words */
...
0x0000f263, 0x0122f64d, /* 0122f64d //C 0f263   805 mvzl	r2,words */
...
0x0000f270, 0x06b0f664, /* 06b0f664 //C 0f270   819 st	r11,reg15 */
...
0x0000f276, 0x0600f653, /* 0600f653 //C 0f276   828 st	r0,called */
0x0000f277, 0x0700f665, /* 0700f665 //C 0f277   830 ld	r0,regf */
0x0000f278, 0x020f0000, /* 020f0000 //C 0f278   831 setf	r0 */
0x0000f279, 0x0700f655, /* 0700f655 //C 0f279   832 ld	r0,reg0 */
0x0000f27a, 0x0710f656, /* 0710f656 //C 0f27a   833 ld	r1,reg1 */
0x0000f27b, 0x0720f657, /* 0720f657 //C 0f27b   834 ld	r2,reg2 */
0x0000f27c, 0x0730f658, /* 0730f658 //C 0f27c   835 ld	r3,reg3 */
0x0000f27d, 0x0740f659, /* 0740f659 //C 0f27d   836 ld	r4,reg4 */
0x0000f27e, 0x0750f65a, /* 0750f65a //C 0f27e   837 ld	r5,reg5 */
0x0000f27f, 0x0760f65b, /* 0760f65b //C 0f27f   838 ld	r6,reg6 */
0x0000f280, 0x0770f65c, /* 0770f65c //C 0f280   839 ld	r7,reg7 */
0x0000f281, 0x0780f65d, /* 0780f65d //C 0f281   840 ld	r8,reg8 */
0x0000f282, 0x0790f65e, /* 0790f65e //C 0f282   841 ld	r9,reg9 */
0x0000f283, 0x07a0f65f, /* 07a0f65f //C 0f283   842 ld	r10,reg10 */
0x0000f284, 0x07b0f660, /* 07b0f660 //C 0f284   843 ld	r11,reg11 */
0x0000f285, 0x07c0f661, /* 07c0f661 //C 0f285   844 ld	r12,reg12 */
0x0000f286, 0x07d0f662, /* 07d0f662 //C 0f286   845 ld	r13,reg13 */
0x0000f287, 0x07e0f663, /* 07e0f663 //C 0f287   846 ld	r14,reg14 */
0x0000f288, 0x07f0f664, /* 07f0f664 //C 0f288   848 ld	r15,reg15 */
0x0000f289, 0x0700f653, /* 0700f653 //C 0f289   851 ld	r0,called */
0x0000f28a, 0x020b0000, /* 020b0000 //C 0f28a   852 sz	r0 */
0x0000f28b, 0x11f2f28e, /* 11f2f28e //C 0f28b   853 jz	g_err */
0x0000f28c, 0x07b0f664, /* 07b0f664 //C 0f28c   854 ld	r11,reg15 */
...
0x0000f2a2, 0x0122f708, /* 0122f708 //C 0f2a2   869 mvzl	r2,helps */
...
0x0000f2eb, 0x0112f655, /* 0112f655 //C 0f2eb   955 mvzl	r1,reg0 */
...
0x0000f309, 0x0700f653, /* 0700f653 //C 0f309  1003 ld	r0,called */
...
0x0000f30e, 0x0700f664, /* 0700f664 //C 0f30e  1009 ld	r0,reg15 */
...
0x0000f31b, 0x0710f665, /* 0710f665 //C 0f31b  1026 ld	r1,regf */
...
0x0000f364, 0x07a0f654, /* 07a0f654 //C 0f364  1056 ld	r10,nuof_reg	; Reg num is in R10 */
...
0x0000f37b, 0x0122f64d, /* 0122f64d //C 0f37b  1065 mvzl	r2,words */
...
0x0000f394, 0x0102f655, /* 0102f655 //C 0f394  1081 mvzl	r0,reg0 */
...
0x0000f4a6, 0x1102f6a0, /* 1102f6a0 //C 0f4a6  1566 Z1 mvzl	r0,null_str */
...
0x0000f564, 0x0610f656, /* 0610f656 //C 0f564  1823 st	r1,reg1 */
0x0000f565, 0x0620f657, /* 0620f657 //C 0f565  1824 st	r2,reg2 */
0x0000f566, 0x0630f658, /* 0630f658 //C 0f566  1825 st	r3,reg3 */
0x0000f567, 0x0640f659, /* 0640f659 //C 0f567  1826 st	r4,reg4 */
0x0000f568, 0x0650f65a, /* 0650f65a //C 0f568  1827 st	r5,reg5 */
0x0000f569, 0x0660f65b, /* 0660f65b //C 0f569  1828 st	r6,reg6 */
0x0000f56a, 0x0670f65c, /* 0670f65c //C 0f56a  1829 st	r7,reg7 */
0x0000f56b, 0x0680f65d, /* 0680f65d //C 0f56b  1830 st	r8,reg8 */
0x0000f56c, 0x0690f65e, /* 0690f65e //C 0f56c  1831 st	r9,reg9 */
0x0000f56d, 0x06a0f65f, /* 06a0f65f //C 0f56d  1832 st	r10,reg10 */
0x0000f56e, 0x06b0f660, /* 06b0f660 //C 0f56e  1833 st	r11,reg11 */
0x0000f56f, 0x06c0f661, /* 06c0f661 //C 0f56f  1834 st	r12,reg12 */
0x0000f570, 0x00200000, /* 00200000 //C 0f570  1836 mov	r2,r0		; pointer to format string */
0x0000f571, 0x0112f656, /* 0112f656 //C 0f571  1837 mvzl	r1,reg1		; pointer to params */
...
0x0000f5e3, 0x0620f657, /* 0620f657 //C 0f5e3  1985 st	r2,reg2 */
0x0000f5e4, 0x0f2d0000, /* 0f2d0000 //C 0f5e4  1986 pop	r2 */
0x0000f5e5, 0x0f0d0000, /* 0f0d0000 //C 0f5e5  1987 pop	r0 */
0x0000f5e6, 0x07f0f657, /* 07f0f657 //C 0f5e6  1988 ld	PC,reg2 */
0x0000f5e7, 0x00000000, /* 00000000 //C 0f5e7  1993 line:		ds	100		; line buffer */
0x0000f64b, 0x00000000, /* 00000000 //C 0f64b  1994 line_ptr:	ds	1		; line pointer (index) */
0x0000f64c, 0x00000000, /* 00000000 //C 0f64c  1995 at_eol:		ds	1		; bool, true if EOL arrived */
0x0000f64d, 0x00000000, /* 00000000 //C 0f64d  1996 words:		ds	5		; Tokens of line */
0x0000f652, 0x00000000, /* 00000000 //C 0f652  1997 echo:		ds	1		; bool, do echo or not */
0x0000f653, 0x00000000, /* 00000000 //C 0f653  1998 dd	0 */
0x0000f654, 0x00000000, /* 00000000 //C 0f654  1999 dd	0 */
0x0000f655, 0x00000000, /* 00000000 //C 0f655  2001 dd	0 */
0x0000f656, 0x00000000, /* 00000000 //C 0f656  2002 dd	0 */
0x0000f657, 0x00000000, /* 00000000 //C 0f657  2003 dd	0 */
0x0000f658, 0x00000000, /* 00000000 //C 0f658  2004 dd	0 */
0x0000f659, 0x00000000, /* 00000000 //C 0f659  2005 dd	0 */
0x0000f65a, 0x00000000, /* 00000000 //C 0f65a  2006 dd	0 */
0x0000f65b, 0x00000000, /* 00000000 //C 0f65b  2007 dd	0 */
0x0000f65c, 0x00000000, /* 00000000 //C 0f65c  2008 dd	0 */
0x0000f65d, 0x00000000, /* 00000000 //C 0f65d  2009 dd	0 */
0x0000f65e, 0x00000000, /* 00000000 //C 0f65e  2010 dd	0 */
0x0000f65f, 0x00000000, /* 00000000 //C 0f65f  2011 dd	0 */
0x0000f660, 0x00000000, /* 00000000 //C 0f660  2012 dd	0 */
0x0000f661, 0x00000000, /* 00000000 //C 0f661  2013 dd	0 */
0x0000f662, 0x00000000, /* 00000000 //C 0f662  2014 dd	0 */
0x0000f663, 0x00000000, /* 00000000 //C 0f663  2015 dd	0 */
0x0000f664, 0x00000000, /* 00000000 //C 0f664  2016 dd	0 */
0x0000f665, 0x00000000, /* 00000000 //C 0f665  2017 dd	0 */
0x0000f666, 0x00000050, /* 00000050 //C 0f666  2019 db	80 */
0x0000f667, 0x0000004d, /* 0000004d //C 0f667  2019 db	77 */
0x0000f668, 0x0000006f, /* 0000006f //C 0f668  2019 db	111 */
0x0000f669, 0x0000006e, /* 0000006e //C 0f669  2019 db	110 */
0x0000f66a, 0x00000069, /* 00000069 //C 0f66a  2019 db	105 */
0x0000f66b, 0x00000074, /* 00000074 //C 0f66b  2019 db	116 */
0x0000f66c, 0x0000006f, /* 0000006f //C 0f66c  2019 db	111 */
0x0000f66d, 0x00000072, /* 00000072 //C 0f66d  2019 db	114 */
0x0000f66e, 0x00000020, /* 00000020 //C 0f66e  2019 db	32 */
0x0000f66f, 0x00000076, /* 00000076 //C 0f66f  2019 db	118 */
0x0000f670, 0x00000025, /* 00000025 //C 0f670  2019 db	37 */
0x0000f671, 0x00000064, /* 00000064 //C 0f671  2019 db	100 */
0x0000f672, 0x0000002e, /* 0000002e //C 0f672  2019 db	46 */
0x0000f673, 0x00000025, /* 00000025 //C 0f673  2019 db	37 */
0x0000f674, 0x00000064, /* 00000064 //C 0f674  2019 db	100 */
0x0000f675, 0x00000020, /* 00000020 //C 0f675  2019 db	32 */
0x0000f676, 0x00000028, /* 00000028 //C 0f676  2019 db	40 */
0x0000f677, 0x00000063, /* 00000063 //C 0f677  2019 db	99 */
0x0000f678, 0x00000070, /* 00000070 //C 0f678  2019 db	112 */
0x0000f679, 0x00000075, /* 00000075 //C 0f679  2019 db	117 */
0x0000f67a, 0x00000020, /* 00000020 //C 0f67a  2019 db	32 */
0x0000f67b, 0x00000076, /* 00000076 //C 0f67b  2019 db	118 */
0x0000f67c, 0x00000025, /* 00000025 //C 0f67c  2019 db	37 */
0x0000f67d, 0x00000064, /* 00000064 //C 0f67d  2019 db	100 */
0x0000f67e, 0x0000002e, /* 0000002e //C 0f67e  2019 db	46 */
0x0000f67f, 0x00000025, /* 00000025 //C 0f67f  2019 db	37 */
0x0000f680, 0x00000064, /* 00000064 //C 0f680  2019 db	100 */
0x0000f681, 0x0000002e, /* 0000002e //C 0f681  2019 db	46 */
0x0000f682, 0x00000025, /* 00000025 //C 0f682  2019 db	37 */
0x0000f683, 0x00000064, /* 00000064 //C 0f683  2019 db	100 */
0x0000f684, 0x00000029, /* 00000029 //C 0f684  2019 db	41 */
0x0000f685, 0x0000000a, /* 0000000a //C 0f685  2019 db	10 */
0x0000f686, 0x00000000, /* 00000000 //C 0f686  2019 db */
0x0000f687, 0x00000053, /* 00000053 //C 0f687  2020 db	83 */
0x0000f688, 0x00000074, /* 00000074 //C 0f688  2020 db	116 */
0x0000f689, 0x0000006f, /* 0000006f //C 0f689  2020 db	111 */
0x0000f68a, 0x00000070, /* 00000070 //C 0f68a  2020 db	112 */
0x0000f68b, 0x00000020, /* 00000020 //C 0f68b  2020 db	32 */
0x0000f68c, 0x00000061, /* 00000061 //C 0f68c  2020 db	97 */
0x0000f68d, 0x00000074, /* 00000074 //C 0f68d  2020 db	116 */
0x0000f68e, 0x0000003a, /* 0000003a //C 0f68e  2020 db	58 */
0x0000f68f, 0x00000020, /* 00000020 //C 0f68f  2020 db	32 */
0x0000f690, 0x00000000, /* 00000000 //C 0f690  2020 db */
0x0000f691, 0x00000008, /* 00000008 //C 0f691  2021 db	8 */
0x0000f692, 0x00000020, /* 00000020 //C 0f692  2021 db	32 */
0x0000f693, 0x00000008, /* 00000008 //C 0f693  2021 db	8 */
0x0000f694, 0x00000000, /* 00000000 //C 0f694  2021 db	0 */
0x0000f695, 0x0000003a, /* 0000003a //C 0f695  2022 db	58 */
0x0000f696, 0x00000000, /* 00000000 //C 0f696  2022 db */
0x0000f697, 0x00000020, /* 00000020 //C 0f697  2023 db	32 */
0x0000f698, 0x0000003b, /* 0000003b //C 0f698  2023 db	59 */
0x0000f699, 0x00000009, /* 00000009 //C 0f699  2023 db	9 */
0x0000f69a, 0x0000000b, /* 0000000b //C 0f69a  2023 db	11 */
0x0000f69b, 0x0000002c, /* 0000002c //C 0f69b  2023 db	44 */
0x0000f69c, 0x0000003d, /* 0000003d //C 0f69c  2023 db	61 */
0x0000f69d, 0x0000005b, /* 0000005b //C 0f69d  2023 db	91 */
0x0000f69e, 0x0000005d, /* 0000005d //C 0f69e  2023 db	93 */
0x0000f69f, 0x00000000, /* 00000000 //C 0f69f  2023 db */
0x0000f6a0, 0x00000028, /* 00000028 //C 0f6a0  2024 db	40 */
0x0000f6a1, 0x0000006e, /* 0000006e //C 0f6a1  2024 db	110 */
0x0000f6a2, 0x00000075, /* 00000075 //C 0f6a2  2024 db	117 */
0x0000f6a3, 0x0000006c, /* 0000006c //C 0f6a3  2024 db	108 */
0x0000f6a4, 0x0000006c, /* 0000006c //C 0f6a4  2024 db	108 */
0x0000f6a5, 0x00000029, /* 00000029 //C 0f6a5  2024 db	41 */
0x0000f6a6, 0x00000000, /* 00000000 //C 0f6a6  2024 db */
0x0000f6a7, 0x00000000, /* 00000000 //C 0f6a7  2025 db	0 */
0x0000f6a8, 0x00000000, /* 00000000 //C 0f6a8  2026 db	0 */
0x0000f6a9, 0x00000000, /* 00000000 //C 0f6a9  2027 sc_buffer:	ds	10 */
0x0000f6b3, 0x0000f196, /* 0000f196 //C 0f6b3  2031 dd	cmd_sm */
0x0000f6b4, 0x00000073, /* 00000073 //C 0f6b4  2032 db	115 */
0x0000f6b5, 0x0000006d, /* 0000006d //C 0f6b5  2032 db	109 */
0x0000f6b6, 0x00000000, /* 00000000 //C 0f6b6  2032 db */
0x0000f6b7, 0x0000f13d, /* 0000f13d //C 0f6b7  2033 dd	cmd_m */
0x0000f6b8, 0x0000006d, /* 0000006d //C 0f6b8  2034 db	109 */
0x0000f6b9, 0x00000000, /* 00000000 //C 0f6b9  2034 db */
0x0000f6ba, 0x0000f13d, /* 0000f13d //C 0f6ba  2035 dd	cmd_m */
0x0000f6bb, 0x0000006d, /* 0000006d //C 0f6bb  2036 db	109 */
0x0000f6bc, 0x00000065, /* 00000065 //C 0f6bc  2036 db	101 */
0x0000f6bd, 0x0000006d, /* 0000006d //C 0f6bd  2036 db	109 */
0x0000f6be, 0x00000000, /* 00000000 //C 0f6be  2036 db */
0x0000f6bf, 0x0000f1b9, /* 0000f1b9 //C 0f6bf  2037 dd	cmd_d */
0x0000f6c0, 0x00000064, /* 00000064 //C 0f6c0  2038 db	100 */
0x0000f6c1, 0x00000000, /* 00000000 //C 0f6c1  2038 db */
0x0000f6c2, 0x0000f1b9, /* 0000f1b9 //C 0f6c2  2039 dd	cmd_d */
0x0000f6c3, 0x00000064, /* 00000064 //C 0f6c3  2040 db	100 */
0x0000f6c4, 0x00000075, /* 00000075 //C 0f6c4  2040 db	117 */
0x0000f6c5, 0x0000006d, /* 0000006d //C 0f6c5  2040 db	109 */
0x0000f6c6, 0x00000070, /* 00000070 //C 0f6c6  2040 db	112 */
0x0000f6c7, 0x00000000, /* 00000000 //C 0f6c7  2040 db */
0x0000f6c8, 0x0000f1ec, /* 0000f1ec //C 0f6c8  2041 dd	cmd_l */
0x0000f6c9, 0x0000006c, /* 0000006c //C 0f6c9  2042 db	108 */
0x0000f6ca, 0x00000000, /* 00000000 //C 0f6ca  2042 db */
0x0000f6cb, 0x0000f1ec, /* 0000f1ec //C 0f6cb  2043 dd	cmd_l */
0x0000f6cc, 0x0000006c, /* 0000006c //C 0f6cc  2044 db	108 */
0x0000f6cd, 0x0000006f, /* 0000006f //C 0f6cd  2044 db	111 */
0x0000f6ce, 0x00000061, /* 00000061 //C 0f6ce  2044 db	97 */
0x0000f6cf, 0x00000064, /* 00000064 //C 0f6cf  2044 db	100 */
0x0000f6d0, 0x00000000, /* 00000000 //C 0f6d0  2044 db */
0x0000f6d1, 0x0000f262, /* 0000f262 //C 0f6d1  2045 dd	cmd_g */
0x0000f6d2, 0x00000067, /* 00000067 //C 0f6d2  2046 db	103 */
0x0000f6d3, 0x00000000, /* 00000000 //C 0f6d3  2046 db */
0x0000f6d4, 0x0000f262, /* 0000f262 //C 0f6d4  2047 dd	cmd_g */
0x0000f6d5, 0x00000067, /* 00000067 //C 0f6d5  2048 db	103 */
0x0000f6d6, 0x0000006f, /* 0000006f //C 0f6d6  2048 db	111 */
0x0000f6d7, 0x00000000, /* 00000000 //C 0f6d7  2048 db */
0x0000f6d8, 0x0000f262, /* 0000f262 //C 0f6d8  2049 dd	cmd_g */
0x0000f6d9, 0x00000072, /* 00000072 //C 0f6d9  2050 db	114 */
0x0000f6da, 0x00000075, /* 00000075 //C 0f6da  2050 db	117 */
0x0000f6db, 0x0000006e, /* 0000006e //C 0f6db  2050 db	110 */
0x0000f6dc, 0x00000000, /* 00000000 //C 0f6dc  2050 db */
0x0000f6dd, 0x0000f2a1, /* 0000f2a1 //C 0f6dd  2051 dd	cmd_h */
0x0000f6de, 0x0000003f, /* 0000003f //C 0f6de  2052 db	63 */
0x0000f6df, 0x00000000, /* 00000000 //C 0f6df  2052 db */
0x0000f6e0, 0x0000f2a1, /* 0000f2a1 //C 0f6e0  2053 dd	cmd_h */
0x0000f6e1, 0x00000068, /* 00000068 //C 0f6e1  2054 db	104 */
0x0000f6e2, 0x00000000, /* 00000000 //C 0f6e2  2054 db */
0x0000f6e3, 0x0000f2a1, /* 0000f2a1 //C 0f6e3  2055 dd	cmd_h */
0x0000f6e4, 0x00000068, /* 00000068 //C 0f6e4  2056 db	104 */
0x0000f6e5, 0x00000065, /* 00000065 //C 0f6e5  2056 db	101 */
0x0000f6e6, 0x0000006c, /* 0000006c //C 0f6e6  2056 db	108 */
0x0000f6e7, 0x00000070, /* 00000070 //C 0f6e7  2056 db	112 */
0x0000f6e8, 0x00000000, /* 00000000 //C 0f6e8  2056 db */
0x0000f6e9, 0x0000f308, /* 0000f308 //C 0f6e9  2057 dd	cmd_r */
0x0000f6ea, 0x00000072, /* 00000072 //C 0f6ea  2058 db	114 */
0x0000f6eb, 0x00000000, /* 00000000 //C 0f6eb  2058 db */
0x0000f6ec, 0x0000f308, /* 0000f308 //C 0f6ec  2059 dd	cmd_r */
0x0000f6ed, 0x00000072, /* 00000072 //C 0f6ed  2060 db	114 */
0x0000f6ee, 0x00000065, /* 00000065 //C 0f6ee  2060 db	101 */
0x0000f6ef, 0x00000067, /* 00000067 //C 0f6ef  2060 db	103 */
0x0000f6f0, 0x00000000, /* 00000000 //C 0f6f0  2060 db */
0x0000f6f1, 0x0000f308, /* 0000f308 //C 0f6f1  2061 dd	cmd_r */
0x0000f6f2, 0x00000072, /* 00000072 //C 0f6f2  2062 db	114 */
0x0000f6f3, 0x00000065, /* 00000065 //C 0f6f3  2062 db	101 */
0x0000f6f4, 0x00000067, /* 00000067 //C 0f6f4  2062 db	103 */
0x0000f6f5, 0x00000073, /* 00000073 //C 0f6f5  2062 db	115 */
0x0000f6f6, 0x00000000, /* 00000000 //C 0f6f6  2062 db */
0x0000f6f7, 0x0000f398, /* 0000f398 //C 0f6f7  2063 dd	cmd_sp */
0x0000f6f8, 0x00000073, /* 00000073 //C 0f6f8  2064 db	115 */
0x0000f6f9, 0x00000070, /* 00000070 //C 0f6f9  2064 db	112 */
0x0000f6fa, 0x00000000, /* 00000000 //C 0f6fa  2064 db */
0x0000f6fb, 0x0000f39b, /* 0000f39b //C 0f6fb  2065 dd	cmd_lr */
0x0000f6fc, 0x0000006c, /* 0000006c //C 0f6fc  2066 db	108 */
0x0000f6fd, 0x00000072, /* 00000072 //C 0f6fd  2066 db	114 */
0x0000f6fe, 0x00000000, /* 00000000 //C 0f6fe  2066 db */
0x0000f6ff, 0x0000f39e, /* 0000f39e //C 0f6ff  2067 dd	cmd_pc */
0x0000f700, 0x00000070, /* 00000070 //C 0f700  2068 db	112 */
0x0000f701, 0x00000063, /* 00000063 //C 0f701  2068 db	99 */
0x0000f702, 0x00000000, /* 00000000 //C 0f702  2068 db */
0x0000f703, 0x0000f3a1, /* 0000f3a1 //C 0f703  2069 dd	cmd_f */
0x0000f704, 0x00000066, /* 00000066 //C 0f704  2070 db	102 */
0x0000f705, 0x00000000, /* 00000000 //C 0f705  2070 db */
0x0000f706, 0x00000000, /* 00000000 //C 0f706  2071 dd	0 */
0x0000f707, 0x00000000, /* 00000000 //C 0f707  2072 dd	0 */
0x0000f708, 0x0000006d, /* 0000006d //C 0f708  2074 db	109 */
0x0000f709, 0x0000005b, /* 0000005b //C 0f709  2074 db	91 */
0x0000f70a, 0x00000065, /* 00000065 //C 0f70a  2074 db	101 */
0x0000f70b, 0x0000006d, /* 0000006d //C 0f70b  2074 db	109 */
0x0000f70c, 0x0000005d, /* 0000005d //C 0f70c  2074 db	93 */
0x0000f70d, 0x00000020, /* 00000020 //C 0f70d  2074 db	32 */
0x0000f70e, 0x00000061, /* 00000061 //C 0f70e  2074 db	97 */
0x0000f70f, 0x00000064, /* 00000064 //C 0f70f  2074 db	100 */
0x0000f710, 0x00000064, /* 00000064 //C 0f710  2074 db	100 */
0x0000f711, 0x00000072, /* 00000072 //C 0f711  2074 db	114 */
0x0000f712, 0x00000020, /* 00000020 //C 0f712  2074 db	32 */
0x0000f713, 0x0000005b, /* 0000005b //C 0f713  2074 db	91 */
0x0000f714, 0x00000076, /* 00000076 //C 0f714  2074 db	118 */
0x0000f715, 0x00000061, /* 00000061 //C 0f715  2074 db	97 */
0x0000f716, 0x0000006c, /* 0000006c //C 0f716  2074 db	108 */
0x0000f717, 0x0000005d, /* 0000005d //C 0f717  2074 db	93 */
0x0000f718, 0x00000020, /* 00000020 //C 0f718  2074 db	32 */
0x0000f719, 0x00000020, /* 00000020 //C 0f719  2074 db	32 */
0x0000f71a, 0x00000047, /* 00000047 //C 0f71a  2074 db	71 */
0x0000f71b, 0x00000065, /* 00000065 //C 0f71b  2074 db	101 */
0x0000f71c, 0x00000074, /* 00000074 //C 0f71c  2074 db	116 */
0x0000f71d, 0x0000002f, /* 0000002f //C 0f71d  2074 db	47 */
0x0000f71e, 0x00000073, /* 00000073 //C 0f71e  2074 db	115 */
0x0000f71f, 0x00000065, /* 00000065 //C 0f71f  2074 db	101 */
0x0000f720, 0x00000074, /* 00000074 //C 0f720  2074 db	116 */
0x0000f721, 0x00000020, /* 00000020 //C 0f721  2074 db	32 */
0x0000f722, 0x0000006d, /* 0000006d //C 0f722  2074 db	109 */
0x0000f723, 0x00000065, /* 00000065 //C 0f723  2074 db	101 */
0x0000f724, 0x0000006d, /* 0000006d //C 0f724  2074 db	109 */
0x0000f725, 0x0000006f, /* 0000006f //C 0f725  2074 db	111 */
0x0000f726, 0x00000072, /* 00000072 //C 0f726  2074 db	114 */
0x0000f727, 0x00000079, /* 00000079 //C 0f727  2074 db	121 */
0x0000f728, 0x0000000a, /* 0000000a //C 0f728  2074 db	10 */
0x0000f729, 0x00000000, /* 00000000 //C 0f729  2074 db */
0x0000f72a, 0x00000064, /* 00000064 //C 0f72a  2075 db	100 */
0x0000f72b, 0x0000005b, /* 0000005b //C 0f72b  2075 db	91 */
0x0000f72c, 0x00000075, /* 00000075 //C 0f72c  2075 db	117 */
0x0000f72d, 0x0000006d, /* 0000006d //C 0f72d  2075 db	109 */
0x0000f72e, 0x00000070, /* 00000070 //C 0f72e  2075 db	112 */
0x0000f72f, 0x0000005d, /* 0000005d //C 0f72f  2075 db	93 */
0x0000f730, 0x00000020, /* 00000020 //C 0f730  2075 db	32 */
0x0000f731, 0x00000073, /* 00000073 //C 0f731  2075 db	115 */
0x0000f732, 0x00000074, /* 00000074 //C 0f732  2075 db	116 */
0x0000f733, 0x00000061, /* 00000061 //C 0f733  2075 db	97 */
0x0000f734, 0x00000072, /* 00000072 //C 0f734  2075 db	114 */
0x0000f735, 0x00000074, /* 00000074 //C 0f735  2075 db	116 */
0x0000f736, 0x00000020, /* 00000020 //C 0f736  2075 db	32 */
0x0000f737, 0x00000065, /* 00000065 //C 0f737  2075 db	101 */
0x0000f738, 0x0000006e, /* 0000006e //C 0f738  2075 db	110 */
0x0000f739, 0x00000064, /* 00000064 //C 0f739  2075 db	100 */
0x0000f73a, 0x00000020, /* 00000020 //C 0f73a  2075 db	32 */
0x0000f73b, 0x00000020, /* 00000020 //C 0f73b  2075 db	32 */
0x0000f73c, 0x00000044, /* 00000044 //C 0f73c  2075 db	68 */
0x0000f73d, 0x00000075, /* 00000075 //C 0f73d  2075 db	117 */
0x0000f73e, 0x0000006d, /* 0000006d //C 0f73e  2075 db	109 */
0x0000f73f, 0x00000070, /* 00000070 //C 0f73f  2075 db	112 */
0x0000f740, 0x00000020, /* 00000020 //C 0f740  2075 db	32 */
0x0000f741, 0x0000006d, /* 0000006d //C 0f741  2075 db	109 */
0x0000f742, 0x00000065, /* 00000065 //C 0f742  2075 db	101 */
0x0000f743, 0x0000006d, /* 0000006d //C 0f743  2075 db	109 */
0x0000f744, 0x0000006f, /* 0000006f //C 0f744  2075 db	111 */
0x0000f745, 0x00000072, /* 00000072 //C 0f745  2075 db	114 */
0x0000f746, 0x00000079, /* 00000079 //C 0f746  2075 db	121 */
0x0000f747, 0x00000020, /* 00000020 //C 0f747  2075 db	32 */
0x0000f748, 0x00000063, /* 00000063 //C 0f748  2075 db	99 */
0x0000f749, 0x0000006f, /* 0000006f //C 0f749  2075 db	111 */
0x0000f74a, 0x0000006e, /* 0000006e //C 0f74a  2075 db	110 */
0x0000f74b, 0x00000074, /* 00000074 //C 0f74b  2075 db	116 */
0x0000f74c, 0x00000065, /* 00000065 //C 0f74c  2075 db	101 */
0x0000f74d, 0x0000006e, /* 0000006e //C 0f74d  2075 db	110 */
0x0000f74e, 0x00000074, /* 00000074 //C 0f74e  2075 db	116 */
0x0000f74f, 0x0000000a, /* 0000000a //C 0f74f  2075 db	10 */
0x0000f750, 0x00000000, /* 00000000 //C 0f750  2075 db */
0x0000f751, 0x0000006c, /* 0000006c //C 0f751  2076 db	108 */
0x0000f752, 0x0000005b, /* 0000005b //C 0f752  2076 db	91 */
0x0000f753, 0x0000006f, /* 0000006f //C 0f753  2076 db	111 */
0x0000f754, 0x00000061, /* 00000061 //C 0f754  2076 db	97 */
0x0000f755, 0x00000064, /* 00000064 //C 0f755  2076 db	100 */
0x0000f756, 0x0000005d, /* 0000005d //C 0f756  2076 db	93 */
0x0000f757, 0x00000020, /* 00000020 //C 0f757  2076 db	32 */
0x0000f758, 0x00000020, /* 00000020 //C 0f758  2076 db	32 */
0x0000f759, 0x00000020, /* 00000020 //C 0f759  2076 db	32 */
0x0000f75a, 0x00000020, /* 00000020 //C 0f75a  2076 db	32 */
0x0000f75b, 0x00000020, /* 00000020 //C 0f75b  2076 db	32 */
0x0000f75c, 0x00000020, /* 00000020 //C 0f75c  2076 db	32 */
0x0000f75d, 0x00000020, /* 00000020 //C 0f75d  2076 db	32 */
0x0000f75e, 0x00000020, /* 00000020 //C 0f75e  2076 db	32 */
0x0000f75f, 0x00000020, /* 00000020 //C 0f75f  2076 db	32 */
0x0000f760, 0x00000020, /* 00000020 //C 0f760  2076 db	32 */
0x0000f761, 0x00000020, /* 00000020 //C 0f761  2076 db	32 */
0x0000f762, 0x00000020, /* 00000020 //C 0f762  2076 db	32 */
0x0000f763, 0x0000004c, /* 0000004c //C 0f763  2076 db	76 */
0x0000f764, 0x0000006f, /* 0000006f //C 0f764  2076 db	111 */
0x0000f765, 0x00000061, /* 00000061 //C 0f765  2076 db	97 */
0x0000f766, 0x00000064, /* 00000064 //C 0f766  2076 db	100 */
0x0000f767, 0x00000020, /* 00000020 //C 0f767  2076 db	32 */
0x0000f768, 0x00000068, /* 00000068 //C 0f768  2076 db	104 */
0x0000f769, 0x00000065, /* 00000065 //C 0f769  2076 db	101 */
0x0000f76a, 0x00000078, /* 00000078 //C 0f76a  2076 db	120 */
0x0000f76b, 0x00000020, /* 00000020 //C 0f76b  2076 db	32 */
0x0000f76c, 0x00000066, /* 00000066 //C 0f76c  2076 db	102 */
0x0000f76d, 0x00000069, /* 00000069 //C 0f76d  2076 db	105 */
0x0000f76e, 0x0000006c, /* 0000006c //C 0f76e  2076 db	108 */
0x0000f76f, 0x00000065, /* 00000065 //C 0f76f  2076 db	101 */
0x0000f770, 0x00000020, /* 00000020 //C 0f770  2076 db	32 */
0x0000f771, 0x00000074, /* 00000074 //C 0f771  2076 db	116 */
0x0000f772, 0x0000006f, /* 0000006f //C 0f772  2076 db	111 */
0x0000f773, 0x00000020, /* 00000020 //C 0f773  2076 db	32 */
0x0000f774, 0x0000006d, /* 0000006d //C 0f774  2076 db	109 */
0x0000f775, 0x00000065, /* 00000065 //C 0f775  2076 db	101 */
0x0000f776, 0x0000006d, /* 0000006d //C 0f776  2076 db	109 */
0x0000f777, 0x0000006f, /* 0000006f //C 0f777  2076 db	111 */
0x0000f778, 0x00000072, /* 00000072 //C 0f778  2076 db	114 */
0x0000f779, 0x00000079, /* 00000079 //C 0f779  2076 db	121 */
0x0000f77a, 0x0000000a, /* 0000000a //C 0f77a  2076 db	10 */
0x0000f77b, 0x00000000, /* 00000000 //C 0f77b  2076 db */
0x0000f77c, 0x00000067, /* 00000067 //C 0f77c  2077 db	103 */
0x0000f77d, 0x0000005b, /* 0000005b //C 0f77d  2077 db	91 */
0x0000f77e, 0x0000006f, /* 0000006f //C 0f77e  2077 db	111 */
0x0000f77f, 0x0000005d, /* 0000005d //C 0f77f  2077 db	93 */
0x0000f780, 0x0000007c, /* 0000007c //C 0f780  2077 db	124 */
0x0000f781, 0x00000072, /* 00000072 //C 0f781  2077 db	114 */
0x0000f782, 0x00000075, /* 00000075 //C 0f782  2077 db	117 */
0x0000f783, 0x0000006e, /* 0000006e //C 0f783  2077 db	110 */
0x0000f784, 0x00000020, /* 00000020 //C 0f784  2077 db	32 */
0x0000f785, 0x0000005b, /* 0000005b //C 0f785  2077 db	91 */
0x0000f786, 0x00000061, /* 00000061 //C 0f786  2077 db	97 */
0x0000f787, 0x00000064, /* 00000064 //C 0f787  2077 db	100 */
0x0000f788, 0x00000064, /* 00000064 //C 0f788  2077 db	100 */
0x0000f789, 0x00000072, /* 00000072 //C 0f789  2077 db	114 */
0x0000f78a, 0x0000005d, /* 0000005d //C 0f78a  2077 db	93 */
0x0000f78b, 0x00000020, /* 00000020 //C 0f78b  2077 db	32 */
0x0000f78c, 0x00000020, /* 00000020 //C 0f78c  2077 db	32 */
0x0000f78d, 0x00000020, /* 00000020 //C 0f78d  2077 db	32 */
0x0000f78e, 0x00000052, /* 00000052 //C 0f78e  2077 db	82 */
0x0000f78f, 0x00000075, /* 00000075 //C 0f78f  2077 db	117 */
0x0000f790, 0x0000006e, /* 0000006e //C 0f790  2077 db	110 */
0x0000f791, 0x00000020, /* 00000020 //C 0f791  2077 db	32 */
0x0000f792, 0x00000066, /* 00000066 //C 0f792  2077 db	102 */
0x0000f793, 0x00000072, /* 00000072 //C 0f793  2077 db	114 */
0x0000f794, 0x0000006f, /* 0000006f //C 0f794  2077 db	111 */
0x0000f795, 0x0000006d, /* 0000006d //C 0f795  2077 db	109 */
0x0000f796, 0x00000020, /* 00000020 //C 0f796  2077 db	32 */
0x0000f797, 0x00000061, /* 00000061 //C 0f797  2077 db	97 */
0x0000f798, 0x00000064, /* 00000064 //C 0f798  2077 db	100 */
0x0000f799, 0x00000064, /* 00000064 //C 0f799  2077 db	100 */
0x0000f79a, 0x00000072, /* 00000072 //C 0f79a  2077 db	114 */
0x0000f79b, 0x00000065, /* 00000065 //C 0f79b  2077 db	101 */
0x0000f79c, 0x00000073, /* 00000073 //C 0f79c  2077 db	115 */
0x0000f79d, 0x00000073, /* 00000073 //C 0f79d  2077 db	115 */
0x0000f79e, 0x0000000a, /* 0000000a //C 0f79e  2077 db	10 */
0x0000f79f, 0x00000000, /* 00000000 //C 0f79f  2077 db */
0x0000f7a0, 0x00000072, /* 00000072 //C 0f7a0  2078 db	114 */
0x0000f7a1, 0x0000005b, /* 0000005b //C 0f7a1  2078 db	91 */
0x0000f7a2, 0x00000065, /* 00000065 //C 0f7a2  2078 db	101 */
0x0000f7a3, 0x00000067, /* 00000067 //C 0f7a3  2078 db	103 */
0x0000f7a4, 0x0000005b, /* 0000005b //C 0f7a4  2078 db	91 */
0x0000f7a5, 0x00000073, /* 00000073 //C 0f7a5  2078 db	115 */
0x0000f7a6, 0x0000005d, /* 0000005d //C 0f7a6  2078 db	93 */
0x0000f7a7, 0x0000005d, /* 0000005d //C 0f7a7  2078 db	93 */
0x0000f7a8, 0x00000020, /* 00000020 //C 0f7a8  2078 db	32 */
0x0000f7a9, 0x00000020, /* 00000020 //C 0f7a9  2078 db	32 */
0x0000f7aa, 0x00000020, /* 00000020 //C 0f7aa  2078 db	32 */
0x0000f7ab, 0x00000020, /* 00000020 //C 0f7ab  2078 db	32 */
0x0000f7ac, 0x00000020, /* 00000020 //C 0f7ac  2078 db	32 */
0x0000f7ad, 0x00000020, /* 00000020 //C 0f7ad  2078 db	32 */
0x0000f7ae, 0x00000020, /* 00000020 //C 0f7ae  2078 db	32 */
0x0000f7af, 0x00000020, /* 00000020 //C 0f7af  2078 db	32 */
0x0000f7b0, 0x00000020, /* 00000020 //C 0f7b0  2078 db	32 */
0x0000f7b1, 0x00000020, /* 00000020 //C 0f7b1  2078 db	32 */
0x0000f7b2, 0x00000050, /* 00000050 //C 0f7b2  2078 db	80 */
0x0000f7b3, 0x00000072, /* 00000072 //C 0f7b3  2078 db	114 */
0x0000f7b4, 0x00000069, /* 00000069 //C 0f7b4  2078 db	105 */
0x0000f7b5, 0x0000006e, /* 0000006e //C 0f7b5  2078 db	110 */
0x0000f7b6, 0x00000074, /* 00000074 //C 0f7b6  2078 db	116 */
0x0000f7b7, 0x00000020, /* 00000020 //C 0f7b7  2078 db	32 */
0x0000f7b8, 0x00000072, /* 00000072 //C 0f7b8  2078 db	114 */
0x0000f7b9, 0x00000065, /* 00000065 //C 0f7b9  2078 db	101 */
0x0000f7ba, 0x00000067, /* 00000067 //C 0f7ba  2078 db	103 */
0x0000f7bb, 0x00000069, /* 00000069 //C 0f7bb  2078 db	105 */
0x0000f7bc, 0x00000073, /* 00000073 //C 0f7bc  2078 db	115 */
0x0000f7bd, 0x00000074, /* 00000074 //C 0f7bd  2078 db	116 */
0x0000f7be, 0x00000065, /* 00000065 //C 0f7be  2078 db	101 */
0x0000f7bf, 0x00000072, /* 00000072 //C 0f7bf  2078 db	114 */
0x0000f7c0, 0x00000073, /* 00000073 //C 0f7c0  2078 db	115 */
0x0000f7c1, 0x0000000a, /* 0000000a //C 0f7c1  2078 db	10 */
0x0000f7c2, 0x00000000, /* 00000000 //C 0f7c2  2078 db */
0x0000f7c3, 0x00000072, /* 00000072 //C 0f7c3  2079 db	114 */
0x0000f7c4, 0x00000058, /* 00000058 //C 0f7c4  2079 db	88 */
0x0000f7c5, 0x00000020, /* 00000020 //C 0f7c5  2079 db	32 */
0x0000f7c6, 0x0000005b, /* 0000005b //C 0f7c6  2079 db	91 */
0x0000f7c7, 0x00000076, /* 00000076 //C 0f7c7  2079 db	118 */
0x0000f7c8, 0x00000061, /* 00000061 //C 0f7c8  2079 db	97 */
0x0000f7c9, 0x0000006c, /* 0000006c //C 0f7c9  2079 db	108 */
0x0000f7ca, 0x0000005d, /* 0000005d //C 0f7ca  2079 db	93 */
0x0000f7cb, 0x00000020, /* 00000020 //C 0f7cb  2079 db	32 */
0x0000f7cc, 0x00000020, /* 00000020 //C 0f7cc  2079 db	32 */
0x0000f7cd, 0x00000020, /* 00000020 //C 0f7cd  2079 db	32 */
0x0000f7ce, 0x00000020, /* 00000020 //C 0f7ce  2079 db	32 */
0x0000f7cf, 0x00000020, /* 00000020 //C 0f7cf  2079 db	32 */
0x0000f7d0, 0x00000020, /* 00000020 //C 0f7d0  2079 db	32 */
0x0000f7d1, 0x00000020, /* 00000020 //C 0f7d1  2079 db	32 */
0x0000f7d2, 0x00000020, /* 00000020 //C 0f7d2  2079 db	32 */
0x0000f7d3, 0x00000020, /* 00000020 //C 0f7d3  2079 db	32 */
0x0000f7d4, 0x00000020, /* 00000020 //C 0f7d4  2079 db	32 */
0x0000f7d5, 0x00000047, /* 00000047 //C 0f7d5  2079 db	71 */
0x0000f7d6, 0x00000065, /* 00000065 //C 0f7d6  2079 db	101 */
0x0000f7d7, 0x00000074, /* 00000074 //C 0f7d7  2079 db	116 */
0x0000f7d8, 0x0000002f, /* 0000002f //C 0f7d8  2079 db	47 */
0x0000f7d9, 0x00000073, /* 00000073 //C 0f7d9  2079 db	115 */
0x0000f7da, 0x00000065, /* 00000065 //C 0f7da  2079 db	101 */
0x0000f7db, 0x00000074, /* 00000074 //C 0f7db  2079 db	116 */
0x0000f7dc, 0x00000020, /* 00000020 //C 0f7dc  2079 db	32 */
0x0000f7dd, 0x00000052, /* 00000052 //C 0f7dd  2079 db	82 */
0x0000f7de, 0x00000058, /* 00000058 //C 0f7de  2079 db	88 */
0x0000f7df, 0x0000000a, /* 0000000a //C 0f7df  2079 db	10 */
0x0000f7e0, 0x00000000, /* 00000000 //C 0f7e0  2079 db */
0x0000f7e1, 0x00000073, /* 00000073 //C 0f7e1  2080 db	115 */
0x0000f7e2, 0x00000070, /* 00000070 //C 0f7e2  2080 db	112 */
0x0000f7e3, 0x00000020, /* 00000020 //C 0f7e3  2080 db	32 */
0x0000f7e4, 0x0000005b, /* 0000005b //C 0f7e4  2080 db	91 */
0x0000f7e5, 0x00000076, /* 00000076 //C 0f7e5  2080 db	118 */
0x0000f7e6, 0x00000061, /* 00000061 //C 0f7e6  2080 db	97 */
0x0000f7e7, 0x0000006c, /* 0000006c //C 0f7e7  2080 db	108 */
0x0000f7e8, 0x0000005d, /* 0000005d //C 0f7e8  2080 db	93 */
0x0000f7e9, 0x00000020, /* 00000020 //C 0f7e9  2080 db	32 */
0x0000f7ea, 0x00000020, /* 00000020 //C 0f7ea  2080 db	32 */
0x0000f7eb, 0x00000020, /* 00000020 //C 0f7eb  2080 db	32 */
0x0000f7ec, 0x00000020, /* 00000020 //C 0f7ec  2080 db	32 */
0x0000f7ed, 0x00000020, /* 00000020 //C 0f7ed  2080 db	32 */
0x0000f7ee, 0x00000020, /* 00000020 //C 0f7ee  2080 db	32 */
0x0000f7ef, 0x00000020, /* 00000020 //C 0f7ef  2080 db	32 */
0x0000f7f0, 0x00000020, /* 00000020 //C 0f7f0  2080 db	32 */
0x0000f7f1, 0x00000020, /* 00000020 //C 0f7f1  2080 db	32 */
0x0000f7f2, 0x00000020, /* 00000020 //C 0f7f2  2080 db	32 */
0x0000f7f3, 0x00000047, /* 00000047 //C 0f7f3  2080 db	71 */
0x0000f7f4, 0x00000065, /* 00000065 //C 0f7f4  2080 db	101 */
0x0000f7f5, 0x00000074, /* 00000074 //C 0f7f5  2080 db	116 */
0x0000f7f6, 0x0000002f, /* 0000002f //C 0f7f6  2080 db	47 */
0x0000f7f7, 0x00000073, /* 00000073 //C 0f7f7  2080 db	115 */
0x0000f7f8, 0x00000065, /* 00000065 //C 0f7f8  2080 db	101 */
0x0000f7f9, 0x00000074, /* 00000074 //C 0f7f9  2080 db	116 */
0x0000f7fa, 0x00000020, /* 00000020 //C 0f7fa  2080 db	32 */
0x0000f7fb, 0x00000052, /* 00000052 //C 0f7fb  2080 db	82 */
0x0000f7fc, 0x00000031, /* 00000031 //C 0f7fc  2080 db	49 */
0x0000f7fd, 0x00000033, /* 00000033 //C 0f7fd  2080 db	51 */
0x0000f7fe, 0x0000000a, /* 0000000a //C 0f7fe  2080 db	10 */
0x0000f7ff, 0x00000000, /* 00000000 //C 0f7ff  2080 db */
0x0000f800, 0x0000006c, /* 0000006c //C 0f800  2081 db	108 */
0x0000f801, 0x00000072, /* 00000072 //C 0f801  2081 db	114 */
0x0000f802, 0x00000020, /* 00000020 //C 0f802  2081 db	32 */
0x0000f803, 0x0000005b, /* 0000005b //C 0f803  2081 db	91 */
0x0000f804, 0x00000076, /* 00000076 //C 0f804  2081 db	118 */
0x0000f805, 0x00000061, /* 00000061 //C 0f805  2081 db	97 */
0x0000f806, 0x0000006c, /* 0000006c //C 0f806  2081 db	108 */
0x0000f807, 0x0000005d, /* 0000005d //C 0f807  2081 db	93 */
0x0000f808, 0x00000020, /* 00000020 //C 0f808  2081 db	32 */
0x0000f809, 0x00000020, /* 00000020 //C 0f809  2081 db	32 */
0x0000f80a, 0x00000020, /* 00000020 //C 0f80a  2081 db	32 */
0x0000f80b, 0x00000020, /* 00000020 //C 0f80b  2081 db	32 */
0x0000f80c, 0x00000020, /* 00000020 //C 0f80c  2081 db	32 */
0x0000f80d, 0x00000020, /* 00000020 //C 0f80d  2081 db	32 */
0x0000f80e, 0x00000020, /* 00000020 //C 0f80e  2081 db	32 */
0x0000f80f, 0x00000020, /* 00000020 //C 0f80f  2081 db	32 */
0x0000f810, 0x00000020, /* 00000020 //C 0f810  2081 db	32 */
0x0000f811, 0x00000020, /* 00000020 //C 0f811  2081 db	32 */
0x0000f812, 0x00000047, /* 00000047 //C 0f812  2081 db	71 */
0x0000f813, 0x00000065, /* 00000065 //C 0f813  2081 db	101 */
0x0000f814, 0x00000074, /* 00000074 //C 0f814  2081 db	116 */
0x0000f815, 0x0000002f, /* 0000002f //C 0f815  2081 db	47 */
0x0000f816, 0x00000073, /* 00000073 //C 0f816  2081 db	115 */
0x0000f817, 0x00000065, /* 00000065 //C 0f817  2081 db	101 */
0x0000f818, 0x00000074, /* 00000074 //C 0f818  2081 db	116 */
0x0000f819, 0x00000020, /* 00000020 //C 0f819  2081 db	32 */
0x0000f81a, 0x00000052, /* 00000052 //C 0f81a  2081 db	82 */
0x0000f81b, 0x00000031, /* 00000031 //C 0f81b  2081 db	49 */
0x0000f81c, 0x00000034, /* 00000034 //C 0f81c  2081 db	52 */
0x0000f81d, 0x0000000a, /* 0000000a //C 0f81d  2081 db	10 */
0x0000f81e, 0x00000000, /* 00000000 //C 0f81e  2081 db */
0x0000f81f, 0x00000070, /* 00000070 //C 0f81f  2082 db	112 */
0x0000f820, 0x00000063, /* 00000063 //C 0f820  2082 db	99 */
0x0000f821, 0x00000020, /* 00000020 //C 0f821  2082 db	32 */
0x0000f822, 0x0000005b, /* 0000005b //C 0f822  2082 db	91 */
0x0000f823, 0x00000076, /* 00000076 //C 0f823  2082 db	118 */
0x0000f824, 0x00000061, /* 00000061 //C 0f824  2082 db	97 */
0x0000f825, 0x0000006c, /* 0000006c //C 0f825  2082 db	108 */
0x0000f826, 0x0000005d, /* 0000005d //C 0f826  2082 db	93 */
0x0000f827, 0x00000020, /* 00000020 //C 0f827  2082 db	32 */
0x0000f828, 0x00000020, /* 00000020 //C 0f828  2082 db	32 */
0x0000f829, 0x00000020, /* 00000020 //C 0f829  2082 db	32 */
0x0000f82a, 0x00000020, /* 00000020 //C 0f82a  2082 db	32 */
0x0000f82b, 0x00000020, /* 00000020 //C 0f82b  2082 db	32 */
0x0000f82c, 0x00000020, /* 00000020 //C 0f82c  2082 db	32 */
0x0000f82d, 0x00000020, /* 00000020 //C 0f82d  2082 db	32 */
0x0000f82e, 0x00000020, /* 00000020 //C 0f82e  2082 db	32 */
0x0000f82f, 0x00000020, /* 00000020 //C 0f82f  2082 db	32 */
0x0000f830, 0x00000020, /* 00000020 //C 0f830  2082 db	32 */
0x0000f831, 0x00000047, /* 00000047 //C 0f831  2082 db	71 */
0x0000f832, 0x00000065, /* 00000065 //C 0f832  2082 db	101 */
0x0000f833, 0x00000074, /* 00000074 //C 0f833  2082 db	116 */
0x0000f834, 0x0000002f, /* 0000002f //C 0f834  2082 db	47 */
0x0000f835, 0x00000073, /* 00000073 //C 0f835  2082 db	115 */
0x0000f836, 0x00000065, /* 00000065 //C 0f836  2082 db	101 */
0x0000f837, 0x00000074, /* 00000074 //C 0f837  2082 db	116 */
0x0000f838, 0x00000020, /* 00000020 //C 0f838  2082 db	32 */
0x0000f839, 0x00000052, /* 00000052 //C 0f839  2082 db	82 */
0x0000f83a, 0x00000031, /* 00000031 //C 0f83a  2082 db	49 */
0x0000f83b, 0x00000035, /* 00000035 //C 0f83b  2082 db	53 */
0x0000f83c, 0x0000000a, /* 0000000a //C 0f83c  2082 db	10 */
0x0000f83d, 0x00000000, /* 00000000 //C 0f83d  2082 db */
0x0000f83e, 0x00000066, /* 00000066 //C 0f83e  2083 db	102 */
0x0000f83f, 0x00000020, /* 00000020 //C 0f83f  2083 db	32 */
0x0000f840, 0x0000005b, /* 0000005b //C 0f840  2083 db	91 */
0x0000f841, 0x00000076, /* 00000076 //C 0f841  2083 db	118 */
0x0000f842, 0x00000061, /* 00000061 //C 0f842  2083 db	97 */
0x0000f843, 0x0000006c, /* 0000006c //C 0f843  2083 db	108 */
0x0000f844, 0x0000005d, /* 0000005d //C 0f844  2083 db	93 */
0x0000f845, 0x00000020, /* 00000020 //C 0f845  2083 db	32 */
0x0000f846, 0x00000020, /* 00000020 //C 0f846  2083 db	32 */
0x0000f847, 0x00000020, /* 00000020 //C 0f847  2083 db	32 */
0x0000f848, 0x00000020, /* 00000020 //C 0f848  2083 db	32 */
0x0000f849, 0x00000020, /* 00000020 //C 0f849  2083 db	32 */
0x0000f84a, 0x00000020, /* 00000020 //C 0f84a  2083 db	32 */
0x0000f84b, 0x00000020, /* 00000020 //C 0f84b  2083 db	32 */
0x0000f84c, 0x00000020, /* 00000020 //C 0f84c  2083 db	32 */
0x0000f84d, 0x00000020, /* 00000020 //C 0f84d  2083 db	32 */
0x0000f84e, 0x00000020, /* 00000020 //C 0f84e  2083 db	32 */
0x0000f84f, 0x00000020, /* 00000020 //C 0f84f  2083 db	32 */
0x0000f850, 0x00000047, /* 00000047 //C 0f850  2083 db	71 */
0x0000f851, 0x00000065, /* 00000065 //C 0f851  2083 db	101 */
0x0000f852, 0x00000074, /* 00000074 //C 0f852  2083 db	116 */
0x0000f853, 0x0000002f, /* 0000002f //C 0f853  2083 db	47 */
0x0000f854, 0x00000073, /* 00000073 //C 0f854  2083 db	115 */
0x0000f855, 0x00000065, /* 00000065 //C 0f855  2083 db	101 */
0x0000f856, 0x00000074, /* 00000074 //C 0f856  2083 db	116 */
0x0000f857, 0x00000020, /* 00000020 //C 0f857  2083 db	32 */
0x0000f858, 0x00000066, /* 00000066 //C 0f858  2083 db	102 */
0x0000f859, 0x0000006c, /* 0000006c //C 0f859  2083 db	108 */
0x0000f85a, 0x00000061, /* 00000061 //C 0f85a  2083 db	97 */
0x0000f85b, 0x00000067, /* 00000067 //C 0f85b  2083 db	103 */
0x0000f85c, 0x00000073, /* 00000073 //C 0f85c  2083 db	115 */
0x0000f85d, 0x0000000a, /* 0000000a //C 0f85d  2083 db	10 */
0x0000f85e, 0x00000000, /* 00000000 //C 0f85e  2083 db */
0x0000f85f, 0x00000068, /* 00000068 //C 0f85f  2084 db	104 */
0x0000f860, 0x0000005b, /* 0000005b //C 0f860  2084 db	91 */
0x0000f861, 0x00000065, /* 00000065 //C 0f861  2084 db	101 */
0x0000f862, 0x0000006c, /* 0000006c //C 0f862  2084 db	108 */
0x0000f863, 0x00000070, /* 00000070 //C 0f863  2084 db	112 */
0x0000f864, 0x0000005d, /* 0000005d //C 0f864  2084 db	93 */
0x0000f865, 0x0000002c, /* 0000002c //C 0f865  2084 db	44 */
0x0000f866, 0x0000003f, /* 0000003f //C 0f866  2084 db	63 */
0x0000f867, 0x00000020, /* 00000020 //C 0f867  2084 db	32 */
0x0000f868, 0x00000020, /* 00000020 //C 0f868  2084 db	32 */
0x0000f869, 0x00000020, /* 00000020 //C 0f869  2084 db	32 */
0x0000f86a, 0x00000020, /* 00000020 //C 0f86a  2084 db	32 */
0x0000f86b, 0x00000020, /* 00000020 //C 0f86b  2084 db	32 */
0x0000f86c, 0x00000020, /* 00000020 //C 0f86c  2084 db	32 */
0x0000f86d, 0x00000020, /* 00000020 //C 0f86d  2084 db	32 */
0x0000f86e, 0x00000020, /* 00000020 //C 0f86e  2084 db	32 */
0x0000f86f, 0x00000020, /* 00000020 //C 0f86f  2084 db	32 */
0x0000f870, 0x00000020, /* 00000020 //C 0f870  2084 db	32 */
0x0000f871, 0x00000048, /* 00000048 //C 0f871  2084 db	72 */
0x0000f872, 0x00000065, /* 00000065 //C 0f872  2084 db	101 */
0x0000f873, 0x0000006c, /* 0000006c //C 0f873  2084 db	108 */
0x0000f874, 0x00000070, /* 00000070 //C 0f874  2084 db	112 */
0x0000f875, 0x0000000a, /* 0000000a //C 0f875  2084 db	10 */
0x0000f876, 0x00000000, /* 00000000 //C 0f876  2084 db */
0x0000f877, 0x00000000, /* 00000000 //C 0f877  2085 dd	0 */
0x0000f878, 0x00000000, /* 00000000 //C 0f878  2091 ds	0x40 */
0x0000f8b8, 0x00000000, /* 00000000 //C 0f8b8  2093 ds	1 */
0x0000f8b9, 0x00000000, /* 00000000 //C 0f8b9     3  */
