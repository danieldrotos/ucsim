...
0x0000f010, 0x01f2f490, /* 01f2f490 //C 0f010    42 _f010:	jmp	printsnl */
0x0000f011, 0x01f2f497, /* 01f2f497 //C 0f011    43 _f011:	jmp	print_vhex */
0x0000f012, 0x01f2f476, /* 01f2f476 //C 0f012    44 _f012:	jmp	pes */
0x0000f013, 0x01f2f515, /* 01f2f515 //C 0f013    45 _f013:	jmp	printd */
0x0000f014, 0x01f2f51a, /* 01f2f51a //C 0f014    46 _f014:	jmp	printf */
0x0000f015, 0x01f2f598, /* 01f2f598 //C 0f015    47 _f015:	jmp	pesf */
...
0x0000f025, 0x0600f60f, /* 0600f60f //C 0f025    69 st	r0,reg0 */
0x0000f026, 0x0610f610, /* 0610f610 //C 0f026    70 st	r1,reg1 */
0x0000f027, 0x0620f611, /* 0620f611 //C 0f027    71 st	r2,reg2 */
0x0000f028, 0x0630f612, /* 0630f612 //C 0f028    72 st	r3,reg3 */
0x0000f029, 0x0640f613, /* 0640f613 //C 0f029    73 st	r4,reg4 */
0x0000f02a, 0x0650f614, /* 0650f614 //C 0f02a    74 st	r5,reg5 */
0x0000f02b, 0x0660f615, /* 0660f615 //C 0f02b    75 st	r6,reg6 */
0x0000f02c, 0x0670f616, /* 0670f616 //C 0f02c    76 st	r7,reg7 */
0x0000f02d, 0x0680f617, /* 0680f617 //C 0f02d    77 st	r8,reg8 */
0x0000f02e, 0x0690f618, /* 0690f618 //C 0f02e    78 st	r9,reg9 */
0x0000f02f, 0x06a0f619, /* 06a0f619 //C 0f02f    79 st	r10,reg10 */
0x0000f030, 0x06b0f61a, /* 06b0f61a //C 0f030    80 st	r11,reg11 */
0x0000f031, 0x06c0f61b, /* 06c0f61b //C 0f031    81 st	r12,reg12 */
0x0000f032, 0x06d0f61c, /* 06d0f61c //C 0f032    82 st	r13,reg13 */
0x0000f033, 0x06e0f61d, /* 06e0f61d //C 0f033    83 st	r14,reg14 */
0x0000f034, 0x06e0f61e, /* 06e0f61e //C 0f034    84 st	r14,reg15 */
0x0000f035, 0x020e0000, /* 020e0000 //C 0f035    85 getf	r0 */
0x0000f036, 0x0600f61f, /* 0600f61f //C 0f036    86 st	r0,regf */
0x0000f037, 0x01020001, /* 01020001 //C 0f037    87 mvzl	r0,1 */
0x0000f038, 0x0600f60d, /* 0600f60d //C 0f038    88 st	r0,called */
...
0x0000f03d, 0x0600f60d, /* 0600f60d //C 0f03d    96 st	r0,called */
...
0x0000f042, 0x0600f61f, /* 0600f61f //C 0f042   101 st	r0,regf		; FALGS= 0 */
0x0000f043, 0x0102f7ff, /* 0102f7ff //C 0f043   102 mvzl	r0,0xf7ff	; R13= 0xf7ff */
0x0000f044, 0x0600f61c, /* 0600f61c //C 0f044   103 st	r0,reg13 */
0x0000f045, 0x01f2f046, /* 01f2f046 //C 0f045   104 jmp	common_start: */
0x0000f046, 0x01d2f85f, /* 01d2f85f //C 0f046   107 mvzl	sp,stack_end */
0x0000f047, 0x01020001, /* 01020001 //C 0f047   108 mvzl	r0,1 */
0x0000f048, 0x0600f60c, /* 0600f60c //C 0f048   109 st	r0,echo */
...
0x0000f055, 0x0102f620, /* 0102f620 //C 0f055   130 mvzl	r0,msg_start */
0x0000f056, 0x0400f490, /* 0400f490 //C 0f056   131 call	printsnl */
0x0000f057, 0x0700f60d, /* 0700f60d //C 0f057   133 ld	r0,called */
...
0x0000f05c, 0x0102f62e, /* 0102f62e //C 0f05c   138 mvzl	r0,msg_stopat */
0x0000f05d, 0x0400f457, /* 0400f457 //C 0f05d   139 call	prints */
0x0000f05e, 0x0700f61d, /* 0700f61d //C 0f05e   140 ld	r0,reg14 */
0x0000f05f, 0x01120004, /* 01120004 //C 0f05f   141 mvzl	r1,4 */
0x0000f060, 0x0400f497, /* 0400f497 //C 0f060   142 call	print_vhex */
...
0x0000f067, 0x0610f605, /* 0610f605 //C 0f067   160 st	r1,line_ptr */
0x0000f068, 0x0610f5a1, /* 0610f5a1 //C 0f068   161 st	r1,line		; line[0]= 0 */
0x0000f069, 0x01120000, /* 01120000 //C 0f069   162 mvzl	r1,0		; at_eol= 0 */
0x0000f06a, 0x0610f606, /* 0610f606 //C 0f06a   163 st	r1,at_eol */
0x0000f06b, 0x0102f63c, /* 0102f63c //C 0f06b   165 mvzl	r0,prompt */
...
0x0000f080, 0x0700f605, /* 0700f605 //C 0f080   204 ld	r0,line_ptr */
...
0x0000f084, 0x0600f605, /* 0600f605 //C 0f084   208 st	r0,line_ptr */
0x0000f085, 0x0112f5a1, /* 0112f5a1 //C 0f085   209 mvzl	r1,line */
0x0000f086, 0x01220000, /* 01220000 //C 0f086   210 mvzl	r2,0 */
0x0000f087, 0x08210000, /* 08210000 //C 0f087   211 st	r2,r1,r0 */
0x0000f088, 0x0102f638, /* 0102f638 //C 0f088   212 mvzl	r0,msg_BS */
...
0x0000f091, 0x0620f606, /* 0620f606 //C 0f091   223 st	r2,at_eol */
0x0000f092, 0x0112f605, /* 0112f605 //C 0f092   224 mvzl	r1,line_ptr	; line[line_ptr]= char */
0x0000f093, 0x0e310000, /* 0e310000 //C 0f093   225 ld	r3,r1 */
0x0000f094, 0x0122f5a1, /* 0122f5a1 //C 0f094   226 mvzl	r2,line */
...
0x0000f09b, 0x0142f60c, /* 0142f60c //C 0f09b   234 mvzl	r4,echo		; check if echo is turned on */
...
0x0000f0a1, 0x0112f606, /* 0112f606 //C 0f0a1   241 mvzl	r1,at_eol */
...
0x0000f0aa, 0x0700f5a1, /* 0700f5a1 //C 0f0aa   261 ld	r0,line */
...
0x0000f0b3, 0x0400f490, /* 0400f490 //C 0f0b3   291 call	printsnl */
0x0000f0b4, 0x01120001, /* 01120001 //C 0f0b4   294 mvzl	r1,1		; at_eol= 1 */
0x0000f0b5, 0x0610f606, /* 0610f606 //C 0f0b5   295 st	r1,at_eol */
...
0x0000f0cd, 0x0112f63e, /* 0112f63e //C 0f0cd   308 mvzl	r1,delimiters */
...
0x0000f0d1, 0x0142f607, /* 0142f607 //C 0f0d1   320 mvzl	r4,words	; array of result */
0x0000f0d2, 0x0152f5a1, /* 0152f5a1 //C 0f0d2   321 mvzl	r5,line		; address of next char */
...
0x0000f0f5, 0x0700f607, /* 0700f607 //C 0f0f5   373 ld	r0,words	; R0= 1st word of command */
...
0x0000f10c, 0x0630f60e, /* 0630f60e //C 0f10c   399 st	r3,nuof_reg */
0x0000f10d, 0x01f2f110, /* 01f2f110 //C 0f10d   400 jmp	find_rx */
0x0000f10e, 0x01260030, /* 01260030 //C 0f10e   402 sub	r2,'0' */
0x0000f10f, 0x0620f60e, /* 0620f60e //C 0f10f   403 st	r2,nuof_reg */
...
0x0000f113, 0x01a2f65a, /* 01a2f65a //C 0f113   410 mvzl	r10,commands */
...
0x0000f138, 0x0122f607, /* 0122f607 //C 0f138   456 mvzl	r2,words */
...
0x0000f143, 0x0400f490, /* 0400f490 //C 0f143   469 call	printsnl */
...
0x0000f14a, 0x0132f860, /* 0132f860 //C 0f14a   478 mvzl	r3,the_end */
...
0x0000f14f, 0x0400f490, /* 0400f490 //C 0f14f   490 call	printsnl */
...
0x0000f156, 0x0400f490, /* 0400f490 //C 0f156   498 call	printsnl */
...
0x0000f15b, 0x0400f497, /* 0400f497 //C 0f15b   506 call	print_vhex */
...
0x0000f160, 0x0400f497, /* 0400f497 //C 0f160   511 call	print_vhex */
...
0x0000f191, 0x0122f607, /* 0122f607 //C 0f191   525 mvzl	r2,words */
...
0x0000f19c, 0x0400f490, /* 0400f490 //C 0f19c   538 call	printsnl */
...
0x0000f1a3, 0x0132f860, /* 0132f860 //C 0f1a3   547 mvzl	r3,the_end */
...
0x0000f1a8, 0x0400f490, /* 0400f490 //C 0f1a8   553 call	printsnl */
...
0x0000f1af, 0x0400f490, /* 0400f490 //C 0f1af   561 call	printsnl */
...
0x0000f1b4, 0x0122f607, /* 0122f607 //C 0f1b4   574 mvzl	r2,words */
...
0x0000f1c4, 0x0400f497, /* 0400f497 //C 0f1c4   599 call	print_vhex */
...
0x0000f1c9, 0x0400f497, /* 0400f497 //C 0f1c9   604 call	print_vhex */
...
0x0000f1d1, 0x0400f490, /* 0400f490 //C 0f1d1   613 call	printsnl */
...
0x0000f258, 0x0400f497, /* 0400f497 //C 0f258   786 call	print_vhex */
...
0x0000f25d, 0x0122f607, /* 0122f607 //C 0f25d   796 mvzl	r2,words */
...
0x0000f267, 0x0400f497, /* 0400f497 //C 0f267   807 call	print_vhex */
0x0000f268, 0x0102000a, /* 0102000a //C 0f268   808 mvzl	r0,LF */
0x0000f269, 0x0400f450, /* 0400f450 //C 0f269   809 call	putchar */
0x0000f26a, 0x06b0f61e, /* 06b0f61e //C 0f26a   810 st	r11,reg15 */
...
0x0000f270, 0x0600f60d, /* 0600f60d //C 0f270   819 st	r0,called */
0x0000f271, 0x0700f61f, /* 0700f61f //C 0f271   821 ld	r0,regf */
0x0000f272, 0x020f0000, /* 020f0000 //C 0f272   822 setf	r0 */
0x0000f273, 0x0700f60f, /* 0700f60f //C 0f273   823 ld	r0,reg0 */
0x0000f274, 0x0710f610, /* 0710f610 //C 0f274   824 ld	r1,reg1 */
0x0000f275, 0x0720f611, /* 0720f611 //C 0f275   825 ld	r2,reg2 */
0x0000f276, 0x0730f612, /* 0730f612 //C 0f276   826 ld	r3,reg3 */
0x0000f277, 0x0740f613, /* 0740f613 //C 0f277   827 ld	r4,reg4 */
0x0000f278, 0x0750f614, /* 0750f614 //C 0f278   828 ld	r5,reg5 */
0x0000f279, 0x0760f615, /* 0760f615 //C 0f279   829 ld	r6,reg6 */
0x0000f27a, 0x0770f616, /* 0770f616 //C 0f27a   830 ld	r7,reg7 */
0x0000f27b, 0x0780f617, /* 0780f617 //C 0f27b   831 ld	r8,reg8 */
0x0000f27c, 0x0790f618, /* 0790f618 //C 0f27c   832 ld	r9,reg9 */
0x0000f27d, 0x07a0f619, /* 07a0f619 //C 0f27d   833 ld	r10,reg10 */
0x0000f27e, 0x07b0f61a, /* 07b0f61a //C 0f27e   834 ld	r11,reg11 */
0x0000f27f, 0x07c0f61b, /* 07c0f61b //C 0f27f   835 ld	r12,reg12 */
0x0000f280, 0x07d0f61c, /* 07d0f61c //C 0f280   836 ld	r13,reg13 */
0x0000f281, 0x07e0f61d, /* 07e0f61d //C 0f281   837 ld	r14,reg14 */
0x0000f282, 0x07f0f61e, /* 07f0f61e //C 0f282   839 ld	r15,reg15 */
0x0000f283, 0x0700f60d, /* 0700f60d //C 0f283   842 ld	r0,called */
0x0000f284, 0x020b0000, /* 020b0000 //C 0f284   843 sz	r0 */
0x0000f285, 0x11f2f288, /* 11f2f288 //C 0f285   844 jz	g_err */
0x0000f286, 0x07b0f61e, /* 07b0f61e //C 0f286   845 ld	r11,reg15 */
0x0000f287, 0x01f2f263, /* 01f2f263 //C 0f287   846 jmp	g_go11 */
0x0000f288, 0x0102f28b, /* 0102f28b //C 0f288   848 mvzl	r0,g_err_addr */
0x0000f289, 0x0400f490, /* 0400f490 //C 0f289   849 call	printsnl */
...
0x0000f29c, 0x0122f6af, /* 0122f6af //C 0f29c   860 mvzl	r2,helps */
...
0x0000f2e5, 0x0112f60f, /* 0112f60f //C 0f2e5   946 mvzl	r1,reg0 */
0x0000f2e6, 0x0a010000, /* 0a010000 //C 0f2e6   947 ld	r0,r1,r0 */
0x0000f2e7, 0x01120004, /* 01120004 //C 0f2e7   948 mvzl	r1,4 */
0x0000f2e8, 0x0400f497, /* 0400f497 //C 0f2e8   949 call	print_vhex */
...
0x0000f303, 0x0700f60d, /* 0700f60d //C 0f303   994 ld	r0,called */
...
0x0000f308, 0x0700f61e, /* 0700f61e //C 0f308  1000 ld	r0,reg15 */
0x0000f309, 0x01120004, /* 01120004 //C 0f309  1001 mvzl	r1,4 */
0x0000f30a, 0x0400f497, /* 0400f497 //C 0f30a  1002 call	print_vhex */
...
0x0000f315, 0x0710f61f, /* 0710f61f //C 0f315  1017 ld	r1,regf */
...
0x0000f35e, 0x07a0f60e, /* 07a0f60e //C 0f35e  1047 ld	r10,nuof_reg	; Reg num is in R10 */
...
0x0000f362, 0x0400f490, /* 0400f490 //C 0f362  1051 call	printsnl */
...
0x0000f375, 0x0122f607, /* 0122f607 //C 0f375  1056 mvzl	r2,words */
...
0x0000f37e, 0x0400f490, /* 0400f490 //C 0f37e  1065 call	printsnl */
...
0x0000f38e, 0x0102f60f, /* 0102f60f //C 0f38e  1072 mvzl	r0,reg0 */
...
0x0000f460, 0x1102f647, /* 1102f647 //C 0f460  1472 Z1 mvzl	r0,null_str */
...
0x0000f465, 0x11f2f46e, /* 11f2f46e //C 0f465  1478 jz	prints_done */
0x0000f466, 0x06014105, /* 06014105 //C 0f466  1480 getbz	r0,r1,r5 */
0x0000f467, 0x020b0000, /* 020b0000 //C 0f467  1481 sz	r0 */
0x0000f468, 0x2400f450, /* 2400f450 //C 0f468  1482 NZ call	putchar */
0x0000f469, 0x11f2f462, /* 11f2f462 //C 0f469  1483 jz 	prints_go */
0x0000f46a, 0x01540001, /* 01540001 //C 0f46a  1484 inc	r5 */
0x0000f46b, 0x01580004, /* 01580004 //C 0f46b  1485 cmp	r5,4 */
0x0000f46c, 0x21f2f466, /* 21f2f466 //C 0f46c  1486 jnz	prints_byte */
0x0000f46d, 0x01f2f462, /* 01f2f462 //C 0f46d  1487 jmp	prints_go */
0x0000f46e, 0x0f5d0000, /* 0f5d0000 //C 0f46e  1490 pop	r5 */
0x0000f46f, 0x0f1d0000, /* 0f1d0000 //C 0f46f  1491 pop	r1 */
0x0000f470, 0x0f2d0000, /* 0f2d0000 //C 0f470  1492 pop	r2 */
0x0000f471, 0x0f4d0000, /* 0f4d0000 //C 0f471  1493 pop	r4 */
0x0000f472, 0x0f3d0000, /* 0f3d0000 //C 0f472  1494 pop	r3 */
0x0000f473, 0x0f0d0000, /* 0f0d0000 //C 0f473  1495 pop	r0 */
0x0000f474, 0x0ffd0000, /* 0ffd0000 //C 0f474  1496 pop	pc */
0x0000f475, 0x00000000, /* 00000000 //C 0f475  1504 dd	0 */
0x0000f476, 0x0ded0000, /* 0ded0000 //C 0f476  1507 push	lr */
0x0000f477, 0x0d0d0000, /* 0d0d0000 //C 0f477  1508 push	r0 */
0x0000f478, 0x0d1d0000, /* 0d1d0000 //C 0f478  1509 push	r1 */
0x0000f479, 0x0d2d0000, /* 0d2d0000 //C 0f479  1510 push	r2 */
0x0000f47a, 0x0d3d0000, /* 0d3d0000 //C 0f47a  1511 push	r3 */
0x0000f47b, 0x00100e00, /* 00100e00 //C 0f47b  1512 mov	r1,lr */
0x0000f47c, 0x0e210000, /* 0e210000 //C 0f47c  1514 ld	r2,r1 */
0x0000f47d, 0x01140001, /* 01140001 //C 0f47d  1515 inc	r1 */
0x0000f47e, 0x022b0000, /* 022b0000 //C 0f47e  1516 sz	r2 */
0x0000f47f, 0x11f2f489, /* 11f2f489 //C 0f47f  1517 jz	pes_done */
0x0000f480, 0x01320000, /* 01320000 //C 0f480  1518 mvzl	r3,0 */
0x0000f481, 0x06014203, /* 06014203 //C 0f481  1520 getbz	r0,r2,r3 */
0x0000f482, 0x020b0000, /* 020b0000 //C 0f482  1521 sz	r0 */
0x0000f483, 0x2400f450, /* 2400f450 //C 0f483  1522 NZ call	putchar */
0x0000f484, 0x11f2f47c, /* 11f2f47c //C 0f484  1523 jz	pes_next */
0x0000f485, 0x01340001, /* 01340001 //C 0f485  1524 inc	r3 */
0x0000f486, 0x01380004, /* 01380004 //C 0f486  1525 cmp	r3,4 */
0x0000f487, 0x21f2f481, /* 21f2f481 //C 0f487  1526 jnz	pes_byte */
0x0000f488, 0x01f2f47c, /* 01f2f47c //C 0f488  1527 jmp	pes_next */
0x0000f489, 0x0610f475, /* 0610f475 //C 0f489  1529 st	r1,pes_ret_to */
0x0000f48a, 0x0f3d0000, /* 0f3d0000 //C 0f48a  1530 pop	r3 */
0x0000f48b, 0x0f2d0000, /* 0f2d0000 //C 0f48b  1531 pop	r2 */
0x0000f48c, 0x0f1d0000, /* 0f1d0000 //C 0f48c  1532 pop	r1 */
0x0000f48d, 0x0f0d0000, /* 0f0d0000 //C 0f48d  1533 pop	r0 */
0x0000f48e, 0x0fed0000, /* 0fed0000 //C 0f48e  1534 pop	lr */
0x0000f48f, 0x07f0f475, /* 07f0f475 //C 0f48f  1535 ld	pc,pes_ret_to */
0x0000f490, 0x0ded0000, /* 0ded0000 //C 0f490  1543 push	lr */
0x0000f491, 0x0400f457, /* 0400f457 //C 0f491  1544 call	prints */
0x0000f492, 0x0d0d0000, /* 0d0d0000 //C 0f492  1545 push	r0 */
0x0000f493, 0x0102000a, /* 0102000a //C 0f493  1546 mvzl	r0,LF */
0x0000f494, 0x0400f450, /* 0400f450 //C 0f494  1547 call	putchar */
0x0000f495, 0x0f0d0000, /* 0f0d0000 //C 0f495  1548 pop	r0 */
0x0000f496, 0x0ffd0000, /* 0ffd0000 //C 0f496  1549 pop	pc */
0x0000f497, 0x0ded0000, /* 0ded0000 //C 0f497  1557 push	lr */
0x0000f498, 0x0d0d0000, /* 0d0d0000 //C 0f498  1558 push	r0 */
0x0000f499, 0x0d1d0000, /* 0d1d0000 //C 0f499  1559 push	r1 */
0x0000f49a, 0x0d2d0000, /* 0d2d0000 //C 0f49a  1560 push	r2 */
0x0000f49b, 0x0d3d0000, /* 0d3d0000 //C 0f49b  1561 push	r3 */
0x0000f49c, 0x0d4d0000, /* 0d4d0000 //C 0f49c  1562 push	r4 */
0x0000f49d, 0x00300000, /* 00300000 //C 0f49d  1563 mov	r3,r0 */
0x0000f49e, 0x01220000, /* 01220000 //C 0f49e  1564 mvzl	r2,0 */
0x0000f49f, 0x01420001, /* 01420001 //C 0f49f  1565 mvzl	r4,1 */
0x0000f4a0, 0x01020000, /* 01020000 //C 0f4a0  1568 mvzl	r0,0 */
...
0x0000f4a7, 0x02380000, /* 02380000 //C 0f4a7  1575 shl	r3 */
0x0000f4a8, 0x02070000, /* 02070000 //C 0f4a8  1576 rol	r0 */
0x0000f4a9, 0x0400f403, /* 0400f403 //C 0f4a9  1577 call	value2Hexchar */
0x0000f4aa, 0x0400f450, /* 0400f450 //C 0f4aa  1578 call	putchar */
0x0000f4ab, 0x01240001, /* 01240001 //C 0f4ab  1579 add	r2,1 */
0x0000f4ac, 0x01280008, /* 01280008 //C 0f4ac  1580 cmp	r2,8 */
0x0000f4ad, 0x11f2f4b7, /* 11f2f4b7 //C 0f4ad  1581 jz	print_vhex_ret */
0x0000f4ae, 0x021b0000, /* 021b0000 //C 0f4ae  1582 sz	r1 */
0x0000f4af, 0x11f2f4b5, /* 11f2f4b5 //C 0f4af  1583 jz	print_vhex_nosep */
0x0000f4b0, 0x00480100, /* 00480100 //C 0f4b0  1584 cmp	r4,r1 */
0x0000f4b1, 0x21f2f4b5, /* 21f2f4b5 //C 0f4b1  1585 jnz	print_vhex_nosep */
0x0000f4b2, 0x0102005f, /* 0102005f //C 0f4b2  1586 mvzl	r0,'_' */
0x0000f4b3, 0x0400f450, /* 0400f450 //C 0f4b3  1587 call	putchar */
0x0000f4b4, 0x01420000, /* 01420000 //C 0f4b4  1588 mvzl	r4,0 */
0x0000f4b5, 0x01440001, /* 01440001 //C 0f4b5  1590 add	r4,1 */
0x0000f4b6, 0x01f2f4a0, /* 01f2f4a0 //C 0f4b6  1591 jmp	print_vhex_cyc */
0x0000f4b7, 0x0f4d0000, /* 0f4d0000 //C 0f4b7  1593 pop	r4 */
0x0000f4b8, 0x0f3d0000, /* 0f3d0000 //C 0f4b8  1594 pop	r3 */
0x0000f4b9, 0x0f2d0000, /* 0f2d0000 //C 0f4b9  1595 pop	r2 */
0x0000f4ba, 0x0f1d0000, /* 0f1d0000 //C 0f4ba  1596 pop	r1 */
0x0000f4bb, 0x0f0d0000, /* 0f0d0000 //C 0f4bb  1597 pop	r0 */
0x0000f4bc, 0x0ffd0000, /* 0ffd0000 //C 0f4bc  1598 pop	pc */
0x0000f4bd, 0x0ded0000, /* 0ded0000 //C 0f4bd  1606 push	lr */
0x0000f4be, 0x0d4d0000, /* 0d4d0000 //C 0f4be  1607 push	r4 */
0x0000f4bf, 0x021b0000, /* 021b0000 //C 0f4bf  1609 sz	r1 */
0x0000f4c0, 0x21f2f4c4, /* 21f2f4c4 //C 0f4c0  1610 NZ jmp	div_dok */
0x0000f4c1, 0x00200000, /* 00200000 //C 0f4c1  1611 mov	r2,r0		; div by zero */
0x0000f4c2, 0x01320000, /* 01320000 //C 0f4c2  1612 mvzl	r3,0 */
0x0000f4c3, 0x01f2f4d5, /* 01f2f4d5 //C 0f4c3  1613 jmp	div_ret */
0x0000f4c4, 0x01220000, /* 01220000 //C 0f4c4  1615 mvzl	r2,0		; Q= 0 */
0x0000f4c5, 0x01320000, /* 01320000 //C 0f4c5  1616 mvzl	r3,0		; R= 0 */
0x0000f4c6, 0x01418000, /* 01418000 //C 0f4c6  1617 mvh	r4,0x80000000	; m= 1<<31 */
0x0000f4c7, 0x01400000, /* 01400000 //C 0f4c7  1618 mvl	r4,0x80000000 */
0x0000f4c8, 0x024b0000, /* 024b0000 //C 0f4c8  1620 sz	r4 */
0x0000f4c9, 0x11f2f4d5, /* 11f2f4d5 //C 0f4c9  1621 Z jmp	div_ret */
0x0000f4ca, 0x02380000, /* 02380000 //C 0f4ca  1622 shl	r3		; r<<= 1 */
0x0000f4cb, 0x000c0400, /* 000c0400 //C 0f4cb  1623 test	r0,r4		; if (n&m) */
0x0000f4cc, 0x213d0001, /* 213d0001 //C 0f4cc  1624 NZ or	r3,1		; r|= 1 */
0x0000f4cd, 0x00380100, /* 00380100 //C 0f4cd  1625 cmp	r3,r1		; if (r>=d) */
0x0000f4ce, 0x41f2f4d3, /* 41f2f4d3 //C 0f4ce  1626 LO jmp	div_cyc_next */
0x0000f4cf, 0x00360100, /* 00360100 //C 0f4cf  1627 sub	r3,r1		;r-= d */
0x0000f4d0, 0x002d0400, /* 002d0400 //C 0f4d0  1628 or	r2,r4		;q|= m */
0x0000f4d1, 0x01f2f4d3, /* 01f2f4d3 //C 0f4d1  1629 jmp	div_cyc_next */
0x0000f4d2, 0x01f2f4c8, /* 01f2f4c8 //C 0f4d2  1630 jmp	div_cyc */
0x0000f4d3, 0x02490000, /* 02490000 //C 0f4d3  1632 shr	r4		; m>>= 1 */
0x0000f4d4, 0x01f2f4c8, /* 01f2f4c8 //C 0f4d4  1633 jmp	div_cyc */
0x0000f4d5, 0x0f4d0000, /* 0f4d0000 //C 0f4d5  1635 pop	r4 */
0x0000f4d6, 0x0ffd0000, /* 0ffd0000 //C 0f4d6  1636 pop	pc */
0x0000f4d7, 0x0ded0000, /* 0ded0000 //C 0f4d7  1644 push	lr */
0x0000f4d8, 0x0d0d0000, /* 0d0d0000 //C 0f4d8  1645 push	r0 */
0x0000f4d9, 0x0d1d0000, /* 0d1d0000 //C 0f4d9  1646 push	r1 */
0x0000f4da, 0x0d2d0000, /* 0d2d0000 //C 0f4da  1647 push	r2 */
0x0000f4db, 0x0d3d0000, /* 0d3d0000 //C 0f4db  1648 push	r3 */
0x0000f4dc, 0x0dad0000, /* 0dad0000 //C 0f4dc  1649 push	r10 */
0x0000f4dd, 0x0dbd0000, /* 0dbd0000 //C 0f4dd  1650 push	r11 */
0x0000f4de, 0x0dcd0000, /* 0dcd0000 //C 0f4de  1651 push	r12 */
0x0000f4df, 0x01c2f4ff, /* 01c2f4ff //C 0f4df  1653 mvzl	r12,itoa_buffer	; pointer to output buffer */
0x0000f4e0, 0x01b2f50a, /* 01b2f50a //C 0f4e0  1654 mvzl	r11,itoa_divs	; pointer to dividers */
0x0000f4e1, 0x01a20000, /* 01a20000 //C 0f4e1  1655 mvzl	r10,0		; bool: first non-zero char found */
0x0000f4e2, 0x0e1b0000, /* 0e1b0000 //C 0f4e2  1657 ld	r1,r11		; get next divider */
0x0000f4e3, 0x021b0000, /* 021b0000 //C 0f4e3  1658 sz	r1		; if 0, then */
0x0000f4e4, 0x11f2f4f7, /* 11f2f4f7 //C 0f4e4  1659 jz	itoa_ret	; finish */
0x0000f4e5, 0x01180001, /* 01180001 //C 0f4e5  1660 cmp	r1,1		; last divider? */
0x0000f4e6, 0x11a20001, /* 11a20001 //C 0f4e6  1661 EQ mvzl	r10,1		; always print last char */
0x0000f4e7, 0x0400f4bd, /* 0400f4bd //C 0f4e7  1662 call	div		; R2,R3= R0/R1 */
0x0000f4e8, 0x022b0000, /* 022b0000 //C 0f4e8  1663 sz	r2		; is the result zero? */
0x0000f4e9, 0x11f2f4f4, /* 11f2f4f4 //C 0f4e9  1664 jz	itoa_f0 */
0x0000f4ea, 0x01a20001, /* 01a20001 //C 0f4ea  1666 mvzl	r10,1		; non-zero: start to print */
0x0000f4eb, 0x00000200, /* 00000200 //C 0f4eb  1668 mov	r0,r2		; convert result to ASCII char */
0x0000f4ec, 0x0400f41a, /* 0400f41a //C 0f4ec  1669 call	value2hexchar */
0x0000f4ed, 0x0c0c0000, /* 0c0c0000 //C 0f4ed  1670 st	r0,r12		; and store it in buffer */
0x0000f4ee, 0x01c40001, /* 01c40001 //C 0f4ee  1671 inc	r12		; inc buf ptr */
0x0000f4ef, 0x01020000, /* 01020000 //C 0f4ef  1672 mvzl	r0,0		; put 0 after last char */
0x0000f4f0, 0x0c0c0000, /* 0c0c0000 //C 0f4f0  1673 st	r0,r12 */
0x0000f4f1, 0x00000300, /* 00000300 //C 0f4f1  1675 mov	r0,r3		; continue with the reminder */
0x0000f4f2, 0x01b40001, /* 01b40001 //C 0f4f2  1676 inc	r11		; and next divider */
0x0000f4f3, 0x01f2f4e2, /* 01f2f4e2 //C 0f4f3  1677 jmp	itoa_cyc */
0x0000f4f4, 0x02ab0000, /* 02ab0000 //C 0f4f4  1679 sz	r10		; just zeros so far? */
0x0000f4f5, 0x21f2f4eb, /* 21f2f4eb //C 0f4f5  1680 jnz	itoa_store	; no, print */
0x0000f4f6, 0x01f2f4f1, /* 01f2f4f1 //C 0f4f6  1681 jmp	itoa_next */
0x0000f4f7, 0x0fcd0000, /* 0fcd0000 //C 0f4f7  1683 pop	r12 */
0x0000f4f8, 0x0fbd0000, /* 0fbd0000 //C 0f4f8  1684 pop	r11 */
0x0000f4f9, 0x0fad0000, /* 0fad0000 //C 0f4f9  1685 pop	r10 */
0x0000f4fa, 0x0f3d0000, /* 0f3d0000 //C 0f4fa  1686 pop	r3 */
0x0000f4fb, 0x0f2d0000, /* 0f2d0000 //C 0f4fb  1687 pop	r2 */
0x0000f4fc, 0x0f1d0000, /* 0f1d0000 //C 0f4fc  1688 pop	r1 */
0x0000f4fd, 0x0f0d0000, /* 0f0d0000 //C 0f4fd  1689 pop	r0 */
0x0000f4fe, 0x0ffd0000, /* 0ffd0000 //C 0f4fe  1690 pop	pc */
0x0000f4ff, 0x00000000, /* 00000000 //C 0f4ff  1692 itoa_buffer:	ds	11 */
0x0000f50a, 0x3b9aca00, /* 3b9aca00 //C 0f50a  1694 dd	1000000000 */
0x0000f50b, 0x05f5e100, /* 05f5e100 //C 0f50b  1695 dd	100000000 */
0x0000f50c, 0x00989680, /* 00989680 //C 0f50c  1696 dd	10000000 */
0x0000f50d, 0x000f4240, /* 000f4240 //C 0f50d  1697 dd	1000000 */
0x0000f50e, 0x000186a0, /* 000186a0 //C 0f50e  1698 dd	100000 */
0x0000f50f, 0x00002710, /* 00002710 //C 0f50f  1699 dd	10000 */
0x0000f510, 0x000003e8, /* 000003e8 //C 0f510  1700 dd	1000 */
0x0000f511, 0x00000064, /* 00000064 //C 0f511  1701 dd	100 */
0x0000f512, 0x0000000a, /* 0000000a //C 0f512  1702 dd	10 */
0x0000f513, 0x00000001, /* 00000001 //C 0f513  1703 dd	1 */
0x0000f514, 0x00000000, /* 00000000 //C 0f514  1704 dd	0 */
0x0000f515, 0x0ded0000, /* 0ded0000 //C 0f515  1711 push	lr */
0x0000f516, 0x0400f4d7, /* 0400f4d7 //C 0f516  1712 call	itoa */
0x0000f517, 0x0102f4ff, /* 0102f4ff //C 0f517  1713 mvzl	r0,itoa_buffer */
0x0000f518, 0x0400f457, /* 0400f457 //C 0f518  1714 call	prints */
0x0000f519, 0x0ffd0000, /* 0ffd0000 //C 0f519  1715 pop	pc */
0x0000f51a, 0x0ded0000, /* 0ded0000 //C 0f51a  1724 push	lr */
0x0000f51b, 0x0d0d0000, /* 0d0d0000 //C 0f51b  1725 push	r0 */
0x0000f51c, 0x0d1d0000, /* 0d1d0000 //C 0f51c  1726 push	r1 */
0x0000f51d, 0x0d3d0000, /* 0d3d0000 //C 0f51d  1727 push	r3 */
0x0000f51e, 0x0610f610, /* 0610f610 //C 0f51e  1729 st	r1,reg1 */
0x0000f51f, 0x0620f611, /* 0620f611 //C 0f51f  1730 st	r2,reg2 */
0x0000f520, 0x0630f612, /* 0630f612 //C 0f520  1731 st	r3,reg3 */
0x0000f521, 0x0640f613, /* 0640f613 //C 0f521  1732 st	r4,reg4 */
0x0000f522, 0x0650f614, /* 0650f614 //C 0f522  1733 st	r5,reg5 */
0x0000f523, 0x0660f615, /* 0660f615 //C 0f523  1734 st	r6,reg6 */
0x0000f524, 0x0670f616, /* 0670f616 //C 0f524  1735 st	r7,reg7 */
0x0000f525, 0x0680f617, /* 0680f617 //C 0f525  1736 st	r8,reg8 */
0x0000f526, 0x0690f618, /* 0690f618 //C 0f526  1737 st	r9,reg9 */
0x0000f527, 0x06a0f619, /* 06a0f619 //C 0f527  1738 st	r10,reg10 */
0x0000f528, 0x06b0f61a, /* 06b0f61a //C 0f528  1739 st	r11,reg11 */
0x0000f529, 0x06c0f61b, /* 06c0f61b //C 0f529  1740 st	r12,reg12 */
0x0000f52a, 0x00200000, /* 00200000 //C 0f52a  1742 mov	r2,r0		; pointer to format string */
0x0000f52b, 0x0112f610, /* 0112f610 //C 0f52b  1743 mvzl	r1,reg1		; pointer to params */
0x0000f52c, 0x01320000, /* 01320000 //C 0f52c  1744 mvzl	r3,0		; byte idx in packed str */
0x0000f52d, 0x0e020000, /* 0e020000 //C 0f52d  1746 ld	r0,r2		; get next char */
0x0000f52e, 0x020b0000, /* 020b0000 //C 0f52e  1747 sz	r0		; is it EOS? */
0x0000f52f, 0x11f2f594, /* 11f2f594 //C 0f52f  1748 jz	printf_ret */
0x0000f530, 0x06014003, /* 06014003 //C 0f530  1749 getbz	r0,r0,r3	; pick next byte */
0x0000f531, 0x020b0000, /* 020b0000 //C 0f531  1750 sz	r0		; is it null? */
0x0000f532, 0x11f2f591, /* 11f2f591 //C 0f532  1751 jz	printf_nextword	; no more non-nulls */
0x0000f533, 0x0108005c, /* 0108005c //C 0f533  1753 cmp	r0,'\\' */
0x0000f534, 0x21f2f55f, /* 21f2f55f //C 0f534  1754 jnz	printf_notescape */
0x0000f535, 0x01340001, /* 01340001 //C 0f535  1756 inc	r3 */
0x0000f536, 0x01380004, /* 01380004 //C 0f536  1757 cmp	r3,4 */
0x0000f537, 0x21f2f53d, /* 21f2f53d //C 0f537  1758 jnz	printf_l1 */
0x0000f538, 0x01320000, /* 01320000 //C 0f538  1760 mvzl	r3,0 */
0x0000f539, 0x01240001, /* 01240001 //C 0f539  1761 inc	r2 */
0x0000f53a, 0x0e020000, /* 0e020000 //C 0f53a  1762 ld	r0,r2 */
0x0000f53b, 0x020b0000, /* 020b0000 //C 0f53b  1763 sz	r0 */
0x0000f53c, 0x11f2f594, /* 11f2f594 //C 0f53c  1764 jz	printf_ret */
0x0000f53d, 0x0e020000, /* 0e020000 //C 0f53d  1766 ld	r0,r2 */
0x0000f53e, 0x06014003, /* 06014003 //C 0f53e  1767 getbz	r0,r0,r3 */
0x0000f53f, 0x020b0000, /* 020b0000 //C 0f53f  1768 sz	r0 */
0x0000f540, 0x11f2f538, /* 11f2f538 //C 0f540  1769 jz	printf_l2 */
0x0000f541, 0x01080061, /* 01080061 //C 0f541  1771 cmp	r0,'a' */
0x0000f542, 0x11020007, /* 11020007 //C 0f542  1772 Z mvzl	r0,7 */
0x0000f543, 0x11f2f58d, /* 11f2f58d //C 0f543  1773 Z jmp	printf_print */
0x0000f544, 0x01080062, /* 01080062 //C 0f544  1774 cmp	r0,'b' */
0x0000f545, 0x11020008, /* 11020008 //C 0f545  1775 Z mvzl	r0,8 */
0x0000f546, 0x11f2f58d, /* 11f2f58d //C 0f546  1776 Z jmp	printf_print */
0x0000f547, 0x01080065, /* 01080065 //C 0f547  1777 cmp	r0,'e' */
0x0000f548, 0x1102001b, /* 1102001b //C 0f548  1778 Z mvzl	r0,0x1b */
0x0000f549, 0x11f2f58d, /* 11f2f58d //C 0f549  1779 Z jmp	printf_print */
0x0000f54a, 0x01080066, /* 01080066 //C 0f54a  1780 cmp	r0,'f' */
0x0000f54b, 0x1102000c, /* 1102000c //C 0f54b  1781 Z mvzl	r0,0xc */
0x0000f54c, 0x11f2f58d, /* 11f2f58d //C 0f54c  1782 Z jmp	printf_print */
0x0000f54d, 0x0108006e, /* 0108006e //C 0f54d  1783 cmp	r0,'n' */
0x0000f54e, 0x1102000a, /* 1102000a //C 0f54e  1784 Z mvzl	r0,0xa */
0x0000f54f, 0x11f2f58d, /* 11f2f58d //C 0f54f  1785 Z jmp	printf_print */
0x0000f550, 0x01080072, /* 01080072 //C 0f550  1786 cmp	r0,'r' */
0x0000f551, 0x1102000d, /* 1102000d //C 0f551  1787 Z mvzl	r0,0xd */
0x0000f552, 0x11f2f58d, /* 11f2f58d //C 0f552  1788 Z jmp	printf_print */
0x0000f553, 0x01080074, /* 01080074 //C 0f553  1789 cmp	r0,'t' */
0x0000f554, 0x11020009, /* 11020009 //C 0f554  1790 Z mvzl	r0,9 */
0x0000f555, 0x11f2f58d, /* 11f2f58d //C 0f555  1791 Z jmp	printf_print */
0x0000f556, 0x01080076, /* 01080076 //C 0f556  1792 cmp	r0,'v' */
0x0000f557, 0x1102000b, /* 1102000b //C 0f557  1793 Z mvzl	r0,0xb */
0x0000f558, 0x11f2f58d, /* 11f2f58d //C 0f558  1794 Z jmp	printf_print */
0x0000f559, 0x0108005c, /* 0108005c //C 0f559  1795 cmp	r0,0x5c */
0x0000f55a, 0x11f2f58d, /* 11f2f58d //C 0f55a  1796 Z jmp	printf_print */
0x0000f55b, 0x01080030, /* 01080030 //C 0f55b  1797 cmp	r0,'0' */
0x0000f55c, 0x11020000, /* 11020000 //C 0f55c  1798 Z mvzl	r0,0 */
0x0000f55d, 0x11f2f58d, /* 11f2f58d //C 0f55d  1799 Z jmp	printf_print */
0x0000f55e, 0x01f2f58d, /* 01f2f58d //C 0f55e  1801 jmp	printf_print */
0x0000f55f, 0x01080025, /* 01080025 //C 0f55f  1804 cmp	r0,'%'		; is it a format char? */
0x0000f560, 0x21f2f58d, /* 21f2f58d //C 0f560  1805 jnz	printf_print */
0x0000f561, 0x01340001, /* 01340001 //C 0f561  1807 inc	r3 */
0x0000f562, 0x01380004, /* 01380004 //C 0f562  1808 cmp	r3,4 */
0x0000f563, 0x21f2f569, /* 21f2f569 //C 0f563  1809 jnz	printf_l3 */
0x0000f564, 0x01320000, /* 01320000 //C 0f564  1811 mvzl	r3,0 */
0x0000f565, 0x01240001, /* 01240001 //C 0f565  1812 inc	r2		; go to format char */
0x0000f566, 0x0e020000, /* 0e020000 //C 0f566  1813 ld	r0,r2 */
0x0000f567, 0x022b0000, /* 022b0000 //C 0f567  1814 sz	r2		; is it EOS? */
0x0000f568, 0x11f2f594, /* 11f2f594 //C 0f568  1815 jz	printf_ret */
0x0000f569, 0x0e020000, /* 0e020000 //C 0f569  1817 ld	r0,r2 */
0x0000f56a, 0x06014003, /* 06014003 //C 0f56a  1818 getbz	r0,r0,r3 */
0x0000f56b, 0x020b0000, /* 020b0000 //C 0f56b  1819 sz	r0 */
0x0000f56c, 0x11f2f564, /* 11f2f564 //C 0f56c  1820 jz	printf_l4 */
0x0000f56d, 0x01080025, /* 01080025 //C 0f56d  1822 cmp	r0,'%'		; % is used to print % */
0x0000f56e, 0x11f2f58d, /* 11f2f58d //C 0f56e  1823 jz	printf_print */
0x0000f56f, 0x01080075, /* 01080075 //C 0f56f  1825 cmp	r0,'u'		; u,d print in decimal */
0x0000f570, 0x11f2f573, /* 11f2f573 //C 0f570  1826 jz	printf_d */
0x0000f571, 0x01080064, /* 01080064 //C 0f571  1827 cmp	r0,'d' */
0x0000f572, 0x21f2f577, /* 21f2f577 //C 0f572  1828 jnz	printf_notd */
0x0000f573, 0x0e010000, /* 0e010000 //C 0f573  1830 ld	r0,r1 */
0x0000f574, 0x01140001, /* 01140001 //C 0f574  1831 inc	r1 */
0x0000f575, 0x0400f515, /* 0400f515 //C 0f575  1832 call	printd */
0x0000f576, 0x01f2f58e, /* 01f2f58e //C 0f576  1833 jmp	printf_next */
0x0000f577, 0x01080078, /* 01080078 //C 0f577  1836 cmp	r0,'x' */
0x0000f578, 0x21f2f580, /* 21f2f580 //C 0f578  1837 jnz	printf_notx */
0x0000f579, 0x0e010000, /* 0e010000 //C 0f579  1839 ld	r0,r1 */
0x0000f57a, 0x01140001, /* 01140001 //C 0f57a  1840 inc	r1 */
0x0000f57b, 0x0d1d0000, /* 0d1d0000 //C 0f57b  1841 push	r1 */
0x0000f57c, 0x01120000, /* 01120000 //C 0f57c  1842 mvzl	r1,0 */
0x0000f57d, 0x0400f497, /* 0400f497 //C 0f57d  1843 call	print_vhex */
0x0000f57e, 0x0f1d0000, /* 0f1d0000 //C 0f57e  1844 pop	r1 */
0x0000f57f, 0x01f2f58e, /* 01f2f58e //C 0f57f  1845 jmp	printf_next */
0x0000f580, 0x01080073, /* 01080073 //C 0f580  1848 cmp	r0,'s' */
0x0000f581, 0x21f2f586, /* 21f2f586 //C 0f581  1849 jnz	printf_nots */
0x0000f582, 0x0e010000, /* 0e010000 //C 0f582  1851 ld	r0,r1 */
0x0000f583, 0x01140001, /* 01140001 //C 0f583  1852 inc	r1 */
0x0000f584, 0x0400f457, /* 0400f457 //C 0f584  1853 call	prints */
0x0000f585, 0x01f2f58e, /* 01f2f58e //C 0f585  1854 jmp	printf_next */
0x0000f586, 0x01080063, /* 01080063 //C 0f586  1857 cmp	r0,'c' */
0x0000f587, 0x21f2f58c, /* 21f2f58c //C 0f587  1858 jnz	printf_notc */
0x0000f588, 0x0e010000, /* 0e010000 //C 0f588  1859 ld	r0,r1 */
0x0000f589, 0x01140001, /* 01140001 //C 0f589  1860 inc	r1 */
0x0000f58a, 0x0400f450, /* 0400f450 //C 0f58a  1861 call	putchar */
0x0000f58b, 0x01f2f58e, /* 01f2f58e //C 0f58b  1862 jmp	printf_next */
0x0000f58c, 0x01f2f58e, /* 01f2f58e //C 0f58c  1865 jmp	printf_next */
0x0000f58d, 0x0400f450, /* 0400f450 //C 0f58d  1867 call	putchar		; print actual char */
0x0000f58e, 0x01340001, /* 01340001 //C 0f58e  1869 inc	r3		; next byte in word */
0x0000f58f, 0x01380004, /* 01380004 //C 0f58f  1870 cmp	r3,4		; all 4 processed? */
0x0000f590, 0x21f2f52d, /* 21f2f52d //C 0f590  1871 jnz	printf_cyc */
0x0000f591, 0x01240001, /* 01240001 //C 0f591  1873 inc	r2		; inc string ptr */
0x0000f592, 0x01320000, /* 01320000 //C 0f592  1874 mvzl	r3,0		; restart byte idx */
0x0000f593, 0x01f2f52d, /* 01f2f52d //C 0f593  1875 jmp	printf_cyc */
0x0000f594, 0x0f3d0000, /* 0f3d0000 //C 0f594  1878 pop	r3 */
0x0000f595, 0x0f1d0000, /* 0f1d0000 //C 0f595  1879 pop	r1 */
0x0000f596, 0x0f0d0000, /* 0f0d0000 //C 0f596  1880 pop	r0 */
0x0000f597, 0x0ffd0000, /* 0ffd0000 //C 0f597  1881 pop	pc */
0x0000f598, 0x0d0d0000, /* 0d0d0000 //C 0f598  1886 push	r0 */
0x0000f599, 0x0d2d0000, /* 0d2d0000 //C 0f599  1887 push	r2 */
0x0000f59a, 0x00000e00, /* 00000e00 //C 0f59a  1888 mov	r0,LR */
0x0000f59b, 0x0400f51a, /* 0400f51a //C 0f59b  1889 call	printf */
0x0000f59c, 0x01240001, /* 01240001 //C 0f59c  1890 inc	r2 */
0x0000f59d, 0x0620f611, /* 0620f611 //C 0f59d  1891 st	r2,reg2 */
0x0000f59e, 0x0f2d0000, /* 0f2d0000 //C 0f59e  1892 pop	r2 */
0x0000f59f, 0x0f0d0000, /* 0f0d0000 //C 0f59f  1893 pop	r0 */
0x0000f5a0, 0x07f0f611, /* 07f0f611 //C 0f5a0  1894 ld	PC,reg2 */
0x0000f5a1, 0x00000000, /* 00000000 //C 0f5a1  1899 line:		ds	100		; line buffer */
0x0000f605, 0x00000000, /* 00000000 //C 0f605  1900 line_ptr:	ds	1		; line pointer (index) */
0x0000f606, 0x00000000, /* 00000000 //C 0f606  1901 at_eol:		ds	1		; bool, true if EOL arrived */
0x0000f607, 0x00000000, /* 00000000 //C 0f607  1902 words:		ds	5		; Tokens of line */
0x0000f60c, 0x00000000, /* 00000000 //C 0f60c  1903 echo:		ds	1		; bool, do echo or not */
0x0000f60d, 0x00000000, /* 00000000 //C 0f60d  1904 dd	0 */
0x0000f60e, 0x00000000, /* 00000000 //C 0f60e  1905 dd	0 */
0x0000f60f, 0x00000000, /* 00000000 //C 0f60f  1907 dd	0 */
0x0000f610, 0x00000000, /* 00000000 //C 0f610  1908 dd	0 */
0x0000f611, 0x00000000, /* 00000000 //C 0f611  1909 dd	0 */
0x0000f612, 0x00000000, /* 00000000 //C 0f612  1910 dd	0 */
0x0000f613, 0x00000000, /* 00000000 //C 0f613  1911 dd	0 */
0x0000f614, 0x00000000, /* 00000000 //C 0f614  1912 dd	0 */
0x0000f615, 0x00000000, /* 00000000 //C 0f615  1913 dd	0 */
0x0000f616, 0x00000000, /* 00000000 //C 0f616  1914 dd	0 */
0x0000f617, 0x00000000, /* 00000000 //C 0f617  1915 dd	0 */
0x0000f618, 0x00000000, /* 00000000 //C 0f618  1916 dd	0 */
0x0000f619, 0x00000000, /* 00000000 //C 0f619  1917 dd	0 */
0x0000f61a, 0x00000000, /* 00000000 //C 0f61a  1918 dd	0 */
0x0000f61b, 0x00000000, /* 00000000 //C 0f61b  1919 dd	0 */
0x0000f61c, 0x00000000, /* 00000000 //C 0f61c  1920 dd	0 */
0x0000f61d, 0x00000000, /* 00000000 //C 0f61d  1921 dd	0 */
0x0000f61e, 0x00000000, /* 00000000 //C 0f61e  1922 dd	0 */
0x0000f61f, 0x00000000, /* 00000000 //C 0f61f  1923 dd	0 */
0x0000f620, 0x00000050, /* 00000050 //C 0f620  1925 db	80 */
0x0000f621, 0x0000004d, /* 0000004d //C 0f621  1925 db	77 */
0x0000f622, 0x0000006f, /* 0000006f //C 0f622  1925 db	111 */
0x0000f623, 0x0000006e, /* 0000006e //C 0f623  1925 db	110 */
0x0000f624, 0x00000069, /* 00000069 //C 0f624  1925 db	105 */
0x0000f625, 0x00000074, /* 00000074 //C 0f625  1925 db	116 */
0x0000f626, 0x0000006f, /* 0000006f //C 0f626  1925 db	111 */
0x0000f627, 0x00000072, /* 00000072 //C 0f627  1925 db	114 */
0x0000f628, 0x00000020, /* 00000020 //C 0f628  1925 db	32 */
0x0000f629, 0x00000076, /* 00000076 //C 0f629  1925 db	118 */
0x0000f62a, 0x00000031, /* 00000031 //C 0f62a  1925 db	49 */
0x0000f62b, 0x0000002e, /* 0000002e //C 0f62b  1925 db	46 */
0x0000f62c, 0x00000030, /* 00000030 //C 0f62c  1925 db	48 */
0x0000f62d, 0x00000000, /* 00000000 //C 0f62d  1925 db */
0x0000f62e, 0x00000053, /* 00000053 //C 0f62e  1926 db	83 */
0x0000f62f, 0x00000074, /* 00000074 //C 0f62f  1926 db	116 */
0x0000f630, 0x0000006f, /* 0000006f //C 0f630  1926 db	111 */
0x0000f631, 0x00000070, /* 00000070 //C 0f631  1926 db	112 */
0x0000f632, 0x00000020, /* 00000020 //C 0f632  1926 db	32 */
0x0000f633, 0x00000061, /* 00000061 //C 0f633  1926 db	97 */
0x0000f634, 0x00000074, /* 00000074 //C 0f634  1926 db	116 */
0x0000f635, 0x0000003a, /* 0000003a //C 0f635  1926 db	58 */
0x0000f636, 0x00000020, /* 00000020 //C 0f636  1926 db	32 */
0x0000f637, 0x00000000, /* 00000000 //C 0f637  1926 db */
0x0000f638, 0x00000008, /* 00000008 //C 0f638  1927 db	8 */
0x0000f639, 0x00000020, /* 00000020 //C 0f639  1927 db	32 */
0x0000f63a, 0x00000008, /* 00000008 //C 0f63a  1927 db	8 */
0x0000f63b, 0x00000000, /* 00000000 //C 0f63b  1927 db	0 */
0x0000f63c, 0x0000003a, /* 0000003a //C 0f63c  1928 db	58 */
0x0000f63d, 0x00000000, /* 00000000 //C 0f63d  1928 db */
0x0000f63e, 0x00000020, /* 00000020 //C 0f63e  1929 db	32 */
0x0000f63f, 0x0000003b, /* 0000003b //C 0f63f  1929 db	59 */
0x0000f640, 0x00000009, /* 00000009 //C 0f640  1929 db	9 */
0x0000f641, 0x0000000b, /* 0000000b //C 0f641  1929 db	11 */
0x0000f642, 0x0000002c, /* 0000002c //C 0f642  1929 db	44 */
0x0000f643, 0x0000003d, /* 0000003d //C 0f643  1929 db	61 */
0x0000f644, 0x0000005b, /* 0000005b //C 0f644  1929 db	91 */
0x0000f645, 0x0000005d, /* 0000005d //C 0f645  1929 db	93 */
0x0000f646, 0x00000000, /* 00000000 //C 0f646  1929 db */
0x0000f647, 0x00000028, /* 00000028 //C 0f647  1930 db	40 */
0x0000f648, 0x0000006e, /* 0000006e //C 0f648  1930 db	110 */
0x0000f649, 0x00000075, /* 00000075 //C 0f649  1930 db	117 */
0x0000f64a, 0x0000006c, /* 0000006c //C 0f64a  1930 db	108 */
0x0000f64b, 0x0000006c, /* 0000006c //C 0f64b  1930 db	108 */
0x0000f64c, 0x00000029, /* 00000029 //C 0f64c  1930 db	41 */
0x0000f64d, 0x00000000, /* 00000000 //C 0f64d  1930 db */
0x0000f64e, 0x00000000, /* 00000000 //C 0f64e  1931 db	0 */
0x0000f64f, 0x00000000, /* 00000000 //C 0f64f  1932 db	0 */
0x0000f650, 0x00000000, /* 00000000 //C 0f650  1933 sc_buffer:	ds	10 */
0x0000f65a, 0x0000f190, /* 0000f190 //C 0f65a  1937 dd	cmd_sm */
0x0000f65b, 0x00000073, /* 00000073 //C 0f65b  1938 db	115 */
0x0000f65c, 0x0000006d, /* 0000006d //C 0f65c  1938 db	109 */
0x0000f65d, 0x00000000, /* 00000000 //C 0f65d  1938 db */
0x0000f65e, 0x0000f137, /* 0000f137 //C 0f65e  1939 dd	cmd_m */
0x0000f65f, 0x0000006d, /* 0000006d //C 0f65f  1940 db	109 */
0x0000f660, 0x00000000, /* 00000000 //C 0f660  1940 db */
0x0000f661, 0x0000f137, /* 0000f137 //C 0f661  1941 dd	cmd_m */
0x0000f662, 0x0000006d, /* 0000006d //C 0f662  1942 db	109 */
0x0000f663, 0x00000065, /* 00000065 //C 0f663  1942 db	101 */
0x0000f664, 0x0000006d, /* 0000006d //C 0f664  1942 db	109 */
0x0000f665, 0x00000000, /* 00000000 //C 0f665  1942 db */
0x0000f666, 0x0000f1b3, /* 0000f1b3 //C 0f666  1943 dd	cmd_d */
0x0000f667, 0x00000064, /* 00000064 //C 0f667  1944 db	100 */
0x0000f668, 0x00000000, /* 00000000 //C 0f668  1944 db */
0x0000f669, 0x0000f1b3, /* 0000f1b3 //C 0f669  1945 dd	cmd_d */
0x0000f66a, 0x00000064, /* 00000064 //C 0f66a  1946 db	100 */
0x0000f66b, 0x00000075, /* 00000075 //C 0f66b  1946 db	117 */
0x0000f66c, 0x0000006d, /* 0000006d //C 0f66c  1946 db	109 */
0x0000f66d, 0x00000070, /* 00000070 //C 0f66d  1946 db	112 */
0x0000f66e, 0x00000000, /* 00000000 //C 0f66e  1946 db */
0x0000f66f, 0x0000f1e6, /* 0000f1e6 //C 0f66f  1947 dd	cmd_l */
0x0000f670, 0x0000006c, /* 0000006c //C 0f670  1948 db	108 */
0x0000f671, 0x00000000, /* 00000000 //C 0f671  1948 db */
0x0000f672, 0x0000f1e6, /* 0000f1e6 //C 0f672  1949 dd	cmd_l */
0x0000f673, 0x0000006c, /* 0000006c //C 0f673  1950 db	108 */
0x0000f674, 0x0000006f, /* 0000006f //C 0f674  1950 db	111 */
0x0000f675, 0x00000061, /* 00000061 //C 0f675  1950 db	97 */
0x0000f676, 0x00000064, /* 00000064 //C 0f676  1950 db	100 */
0x0000f677, 0x00000000, /* 00000000 //C 0f677  1950 db */
0x0000f678, 0x0000f25c, /* 0000f25c //C 0f678  1951 dd	cmd_g */
0x0000f679, 0x00000067, /* 00000067 //C 0f679  1952 db	103 */
0x0000f67a, 0x00000000, /* 00000000 //C 0f67a  1952 db */
0x0000f67b, 0x0000f25c, /* 0000f25c //C 0f67b  1953 dd	cmd_g */
0x0000f67c, 0x00000067, /* 00000067 //C 0f67c  1954 db	103 */
0x0000f67d, 0x0000006f, /* 0000006f //C 0f67d  1954 db	111 */
0x0000f67e, 0x00000000, /* 00000000 //C 0f67e  1954 db */
0x0000f67f, 0x0000f25c, /* 0000f25c //C 0f67f  1955 dd	cmd_g */
0x0000f680, 0x00000072, /* 00000072 //C 0f680  1956 db	114 */
0x0000f681, 0x00000075, /* 00000075 //C 0f681  1956 db	117 */
0x0000f682, 0x0000006e, /* 0000006e //C 0f682  1956 db	110 */
0x0000f683, 0x00000000, /* 00000000 //C 0f683  1956 db */
0x0000f684, 0x0000f29b, /* 0000f29b //C 0f684  1957 dd	cmd_h */
0x0000f685, 0x0000003f, /* 0000003f //C 0f685  1958 db	63 */
0x0000f686, 0x00000000, /* 00000000 //C 0f686  1958 db */
0x0000f687, 0x0000f29b, /* 0000f29b //C 0f687  1959 dd	cmd_h */
0x0000f688, 0x00000068, /* 00000068 //C 0f688  1960 db	104 */
0x0000f689, 0x00000000, /* 00000000 //C 0f689  1960 db */
0x0000f68a, 0x0000f29b, /* 0000f29b //C 0f68a  1961 dd	cmd_h */
0x0000f68b, 0x00000068, /* 00000068 //C 0f68b  1962 db	104 */
0x0000f68c, 0x00000065, /* 00000065 //C 0f68c  1962 db	101 */
0x0000f68d, 0x0000006c, /* 0000006c //C 0f68d  1962 db	108 */
0x0000f68e, 0x00000070, /* 00000070 //C 0f68e  1962 db	112 */
0x0000f68f, 0x00000000, /* 00000000 //C 0f68f  1962 db */
0x0000f690, 0x0000f302, /* 0000f302 //C 0f690  1963 dd	cmd_r */
0x0000f691, 0x00000072, /* 00000072 //C 0f691  1964 db	114 */
0x0000f692, 0x00000000, /* 00000000 //C 0f692  1964 db */
0x0000f693, 0x0000f302, /* 0000f302 //C 0f693  1965 dd	cmd_r */
0x0000f694, 0x00000072, /* 00000072 //C 0f694  1966 db	114 */
0x0000f695, 0x00000065, /* 00000065 //C 0f695  1966 db	101 */
0x0000f696, 0x00000067, /* 00000067 //C 0f696  1966 db	103 */
0x0000f697, 0x00000000, /* 00000000 //C 0f697  1966 db */
0x0000f698, 0x0000f302, /* 0000f302 //C 0f698  1967 dd	cmd_r */
0x0000f699, 0x00000072, /* 00000072 //C 0f699  1968 db	114 */
0x0000f69a, 0x00000065, /* 00000065 //C 0f69a  1968 db	101 */
0x0000f69b, 0x00000067, /* 00000067 //C 0f69b  1968 db	103 */
0x0000f69c, 0x00000073, /* 00000073 //C 0f69c  1968 db	115 */
0x0000f69d, 0x00000000, /* 00000000 //C 0f69d  1968 db */
0x0000f69e, 0x0000f392, /* 0000f392 //C 0f69e  1969 dd	cmd_sp */
0x0000f69f, 0x00000073, /* 00000073 //C 0f69f  1970 db	115 */
0x0000f6a0, 0x00000070, /* 00000070 //C 0f6a0  1970 db	112 */
0x0000f6a1, 0x00000000, /* 00000000 //C 0f6a1  1970 db */
0x0000f6a2, 0x0000f395, /* 0000f395 //C 0f6a2  1971 dd	cmd_lr */
0x0000f6a3, 0x0000006c, /* 0000006c //C 0f6a3  1972 db	108 */
0x0000f6a4, 0x00000072, /* 00000072 //C 0f6a4  1972 db	114 */
0x0000f6a5, 0x00000000, /* 00000000 //C 0f6a5  1972 db */
0x0000f6a6, 0x0000f398, /* 0000f398 //C 0f6a6  1973 dd	cmd_pc */
0x0000f6a7, 0x00000070, /* 00000070 //C 0f6a7  1974 db	112 */
0x0000f6a8, 0x00000063, /* 00000063 //C 0f6a8  1974 db	99 */
0x0000f6a9, 0x00000000, /* 00000000 //C 0f6a9  1974 db */
0x0000f6aa, 0x0000f39b, /* 0000f39b //C 0f6aa  1975 dd	cmd_f */
0x0000f6ab, 0x00000066, /* 00000066 //C 0f6ab  1976 db	102 */
0x0000f6ac, 0x00000000, /* 00000000 //C 0f6ac  1976 db */
0x0000f6ad, 0x00000000, /* 00000000 //C 0f6ad  1977 dd	0 */
0x0000f6ae, 0x00000000, /* 00000000 //C 0f6ae  1978 dd	0 */
0x0000f6af, 0x0000006d, /* 0000006d //C 0f6af  1980 db	109 */
0x0000f6b0, 0x0000005b, /* 0000005b //C 0f6b0  1980 db	91 */
0x0000f6b1, 0x00000065, /* 00000065 //C 0f6b1  1980 db	101 */
0x0000f6b2, 0x0000006d, /* 0000006d //C 0f6b2  1980 db	109 */
0x0000f6b3, 0x0000005d, /* 0000005d //C 0f6b3  1980 db	93 */
0x0000f6b4, 0x00000020, /* 00000020 //C 0f6b4  1980 db	32 */
0x0000f6b5, 0x00000061, /* 00000061 //C 0f6b5  1980 db	97 */
0x0000f6b6, 0x00000064, /* 00000064 //C 0f6b6  1980 db	100 */
0x0000f6b7, 0x00000064, /* 00000064 //C 0f6b7  1980 db	100 */
0x0000f6b8, 0x00000072, /* 00000072 //C 0f6b8  1980 db	114 */
0x0000f6b9, 0x00000020, /* 00000020 //C 0f6b9  1980 db	32 */
0x0000f6ba, 0x0000005b, /* 0000005b //C 0f6ba  1980 db	91 */
0x0000f6bb, 0x00000076, /* 00000076 //C 0f6bb  1980 db	118 */
0x0000f6bc, 0x00000061, /* 00000061 //C 0f6bc  1980 db	97 */
0x0000f6bd, 0x0000006c, /* 0000006c //C 0f6bd  1980 db	108 */
0x0000f6be, 0x0000005d, /* 0000005d //C 0f6be  1980 db	93 */
0x0000f6bf, 0x00000020, /* 00000020 //C 0f6bf  1980 db	32 */
0x0000f6c0, 0x00000020, /* 00000020 //C 0f6c0  1980 db	32 */
0x0000f6c1, 0x00000047, /* 00000047 //C 0f6c1  1980 db	71 */
0x0000f6c2, 0x00000065, /* 00000065 //C 0f6c2  1980 db	101 */
0x0000f6c3, 0x00000074, /* 00000074 //C 0f6c3  1980 db	116 */
0x0000f6c4, 0x0000002f, /* 0000002f //C 0f6c4  1980 db	47 */
0x0000f6c5, 0x00000073, /* 00000073 //C 0f6c5  1980 db	115 */
0x0000f6c6, 0x00000065, /* 00000065 //C 0f6c6  1980 db	101 */
0x0000f6c7, 0x00000074, /* 00000074 //C 0f6c7  1980 db	116 */
0x0000f6c8, 0x00000020, /* 00000020 //C 0f6c8  1980 db	32 */
0x0000f6c9, 0x0000006d, /* 0000006d //C 0f6c9  1980 db	109 */
0x0000f6ca, 0x00000065, /* 00000065 //C 0f6ca  1980 db	101 */
0x0000f6cb, 0x0000006d, /* 0000006d //C 0f6cb  1980 db	109 */
0x0000f6cc, 0x0000006f, /* 0000006f //C 0f6cc  1980 db	111 */
0x0000f6cd, 0x00000072, /* 00000072 //C 0f6cd  1980 db	114 */
0x0000f6ce, 0x00000079, /* 00000079 //C 0f6ce  1980 db	121 */
0x0000f6cf, 0x0000000a, /* 0000000a //C 0f6cf  1980 db	10 */
0x0000f6d0, 0x00000000, /* 00000000 //C 0f6d0  1980 db */
0x0000f6d1, 0x00000064, /* 00000064 //C 0f6d1  1981 db	100 */
0x0000f6d2, 0x0000005b, /* 0000005b //C 0f6d2  1981 db	91 */
0x0000f6d3, 0x00000075, /* 00000075 //C 0f6d3  1981 db	117 */
0x0000f6d4, 0x0000006d, /* 0000006d //C 0f6d4  1981 db	109 */
0x0000f6d5, 0x00000070, /* 00000070 //C 0f6d5  1981 db	112 */
0x0000f6d6, 0x0000005d, /* 0000005d //C 0f6d6  1981 db	93 */
0x0000f6d7, 0x00000020, /* 00000020 //C 0f6d7  1981 db	32 */
0x0000f6d8, 0x00000073, /* 00000073 //C 0f6d8  1981 db	115 */
0x0000f6d9, 0x00000074, /* 00000074 //C 0f6d9  1981 db	116 */
0x0000f6da, 0x00000061, /* 00000061 //C 0f6da  1981 db	97 */
0x0000f6db, 0x00000072, /* 00000072 //C 0f6db  1981 db	114 */
0x0000f6dc, 0x00000074, /* 00000074 //C 0f6dc  1981 db	116 */
0x0000f6dd, 0x00000020, /* 00000020 //C 0f6dd  1981 db	32 */
0x0000f6de, 0x00000065, /* 00000065 //C 0f6de  1981 db	101 */
0x0000f6df, 0x0000006e, /* 0000006e //C 0f6df  1981 db	110 */
0x0000f6e0, 0x00000064, /* 00000064 //C 0f6e0  1981 db	100 */
0x0000f6e1, 0x00000020, /* 00000020 //C 0f6e1  1981 db	32 */
0x0000f6e2, 0x00000020, /* 00000020 //C 0f6e2  1981 db	32 */
0x0000f6e3, 0x00000044, /* 00000044 //C 0f6e3  1981 db	68 */
0x0000f6e4, 0x00000075, /* 00000075 //C 0f6e4  1981 db	117 */
0x0000f6e5, 0x0000006d, /* 0000006d //C 0f6e5  1981 db	109 */
0x0000f6e6, 0x00000070, /* 00000070 //C 0f6e6  1981 db	112 */
0x0000f6e7, 0x00000020, /* 00000020 //C 0f6e7  1981 db	32 */
0x0000f6e8, 0x0000006d, /* 0000006d //C 0f6e8  1981 db	109 */
0x0000f6e9, 0x00000065, /* 00000065 //C 0f6e9  1981 db	101 */
0x0000f6ea, 0x0000006d, /* 0000006d //C 0f6ea  1981 db	109 */
0x0000f6eb, 0x0000006f, /* 0000006f //C 0f6eb  1981 db	111 */
0x0000f6ec, 0x00000072, /* 00000072 //C 0f6ec  1981 db	114 */
0x0000f6ed, 0x00000079, /* 00000079 //C 0f6ed  1981 db	121 */
0x0000f6ee, 0x00000020, /* 00000020 //C 0f6ee  1981 db	32 */
0x0000f6ef, 0x00000063, /* 00000063 //C 0f6ef  1981 db	99 */
0x0000f6f0, 0x0000006f, /* 0000006f //C 0f6f0  1981 db	111 */
0x0000f6f1, 0x0000006e, /* 0000006e //C 0f6f1  1981 db	110 */
0x0000f6f2, 0x00000074, /* 00000074 //C 0f6f2  1981 db	116 */
0x0000f6f3, 0x00000065, /* 00000065 //C 0f6f3  1981 db	101 */
0x0000f6f4, 0x0000006e, /* 0000006e //C 0f6f4  1981 db	110 */
0x0000f6f5, 0x00000074, /* 00000074 //C 0f6f5  1981 db	116 */
0x0000f6f6, 0x0000000a, /* 0000000a //C 0f6f6  1981 db	10 */
0x0000f6f7, 0x00000000, /* 00000000 //C 0f6f7  1981 db */
0x0000f6f8, 0x0000006c, /* 0000006c //C 0f6f8  1982 db	108 */
0x0000f6f9, 0x0000005b, /* 0000005b //C 0f6f9  1982 db	91 */
0x0000f6fa, 0x0000006f, /* 0000006f //C 0f6fa  1982 db	111 */
0x0000f6fb, 0x00000061, /* 00000061 //C 0f6fb  1982 db	97 */
0x0000f6fc, 0x00000064, /* 00000064 //C 0f6fc  1982 db	100 */
0x0000f6fd, 0x0000005d, /* 0000005d //C 0f6fd  1982 db	93 */
0x0000f6fe, 0x00000020, /* 00000020 //C 0f6fe  1982 db	32 */
0x0000f6ff, 0x00000020, /* 00000020 //C 0f6ff  1982 db	32 */
0x0000f700, 0x00000020, /* 00000020 //C 0f700  1982 db	32 */
0x0000f701, 0x00000020, /* 00000020 //C 0f701  1982 db	32 */
0x0000f702, 0x00000020, /* 00000020 //C 0f702  1982 db	32 */
0x0000f703, 0x00000020, /* 00000020 //C 0f703  1982 db	32 */
0x0000f704, 0x00000020, /* 00000020 //C 0f704  1982 db	32 */
0x0000f705, 0x00000020, /* 00000020 //C 0f705  1982 db	32 */
0x0000f706, 0x00000020, /* 00000020 //C 0f706  1982 db	32 */
0x0000f707, 0x00000020, /* 00000020 //C 0f707  1982 db	32 */
0x0000f708, 0x00000020, /* 00000020 //C 0f708  1982 db	32 */
0x0000f709, 0x00000020, /* 00000020 //C 0f709  1982 db	32 */
0x0000f70a, 0x0000004c, /* 0000004c //C 0f70a  1982 db	76 */
0x0000f70b, 0x0000006f, /* 0000006f //C 0f70b  1982 db	111 */
0x0000f70c, 0x00000061, /* 00000061 //C 0f70c  1982 db	97 */
0x0000f70d, 0x00000064, /* 00000064 //C 0f70d  1982 db	100 */
0x0000f70e, 0x00000020, /* 00000020 //C 0f70e  1982 db	32 */
0x0000f70f, 0x00000068, /* 00000068 //C 0f70f  1982 db	104 */
0x0000f710, 0x00000065, /* 00000065 //C 0f710  1982 db	101 */
0x0000f711, 0x00000078, /* 00000078 //C 0f711  1982 db	120 */
0x0000f712, 0x00000020, /* 00000020 //C 0f712  1982 db	32 */
0x0000f713, 0x00000066, /* 00000066 //C 0f713  1982 db	102 */
0x0000f714, 0x00000069, /* 00000069 //C 0f714  1982 db	105 */
0x0000f715, 0x0000006c, /* 0000006c //C 0f715  1982 db	108 */
0x0000f716, 0x00000065, /* 00000065 //C 0f716  1982 db	101 */
0x0000f717, 0x00000020, /* 00000020 //C 0f717  1982 db	32 */
0x0000f718, 0x00000074, /* 00000074 //C 0f718  1982 db	116 */
0x0000f719, 0x0000006f, /* 0000006f //C 0f719  1982 db	111 */
0x0000f71a, 0x00000020, /* 00000020 //C 0f71a  1982 db	32 */
0x0000f71b, 0x0000006d, /* 0000006d //C 0f71b  1982 db	109 */
0x0000f71c, 0x00000065, /* 00000065 //C 0f71c  1982 db	101 */
0x0000f71d, 0x0000006d, /* 0000006d //C 0f71d  1982 db	109 */
0x0000f71e, 0x0000006f, /* 0000006f //C 0f71e  1982 db	111 */
0x0000f71f, 0x00000072, /* 00000072 //C 0f71f  1982 db	114 */
0x0000f720, 0x00000079, /* 00000079 //C 0f720  1982 db	121 */
0x0000f721, 0x0000000a, /* 0000000a //C 0f721  1982 db	10 */
0x0000f722, 0x00000000, /* 00000000 //C 0f722  1982 db */
0x0000f723, 0x00000067, /* 00000067 //C 0f723  1983 db	103 */
0x0000f724, 0x0000005b, /* 0000005b //C 0f724  1983 db	91 */
0x0000f725, 0x0000006f, /* 0000006f //C 0f725  1983 db	111 */
0x0000f726, 0x0000005d, /* 0000005d //C 0f726  1983 db	93 */
0x0000f727, 0x0000007c, /* 0000007c //C 0f727  1983 db	124 */
0x0000f728, 0x00000072, /* 00000072 //C 0f728  1983 db	114 */
0x0000f729, 0x00000075, /* 00000075 //C 0f729  1983 db	117 */
0x0000f72a, 0x0000006e, /* 0000006e //C 0f72a  1983 db	110 */
0x0000f72b, 0x00000020, /* 00000020 //C 0f72b  1983 db	32 */
0x0000f72c, 0x0000005b, /* 0000005b //C 0f72c  1983 db	91 */
0x0000f72d, 0x00000061, /* 00000061 //C 0f72d  1983 db	97 */
0x0000f72e, 0x00000064, /* 00000064 //C 0f72e  1983 db	100 */
0x0000f72f, 0x00000064, /* 00000064 //C 0f72f  1983 db	100 */
0x0000f730, 0x00000072, /* 00000072 //C 0f730  1983 db	114 */
0x0000f731, 0x0000005d, /* 0000005d //C 0f731  1983 db	93 */
0x0000f732, 0x00000020, /* 00000020 //C 0f732  1983 db	32 */
0x0000f733, 0x00000020, /* 00000020 //C 0f733  1983 db	32 */
0x0000f734, 0x00000020, /* 00000020 //C 0f734  1983 db	32 */
0x0000f735, 0x00000052, /* 00000052 //C 0f735  1983 db	82 */
0x0000f736, 0x00000075, /* 00000075 //C 0f736  1983 db	117 */
0x0000f737, 0x0000006e, /* 0000006e //C 0f737  1983 db	110 */
0x0000f738, 0x00000020, /* 00000020 //C 0f738  1983 db	32 */
0x0000f739, 0x00000066, /* 00000066 //C 0f739  1983 db	102 */
0x0000f73a, 0x00000072, /* 00000072 //C 0f73a  1983 db	114 */
0x0000f73b, 0x0000006f, /* 0000006f //C 0f73b  1983 db	111 */
0x0000f73c, 0x0000006d, /* 0000006d //C 0f73c  1983 db	109 */
0x0000f73d, 0x00000020, /* 00000020 //C 0f73d  1983 db	32 */
0x0000f73e, 0x00000061, /* 00000061 //C 0f73e  1983 db	97 */
0x0000f73f, 0x00000064, /* 00000064 //C 0f73f  1983 db	100 */
0x0000f740, 0x00000064, /* 00000064 //C 0f740  1983 db	100 */
0x0000f741, 0x00000072, /* 00000072 //C 0f741  1983 db	114 */
0x0000f742, 0x00000065, /* 00000065 //C 0f742  1983 db	101 */
0x0000f743, 0x00000073, /* 00000073 //C 0f743  1983 db	115 */
0x0000f744, 0x00000073, /* 00000073 //C 0f744  1983 db	115 */
0x0000f745, 0x0000000a, /* 0000000a //C 0f745  1983 db	10 */
0x0000f746, 0x00000000, /* 00000000 //C 0f746  1983 db */
0x0000f747, 0x00000072, /* 00000072 //C 0f747  1984 db	114 */
0x0000f748, 0x0000005b, /* 0000005b //C 0f748  1984 db	91 */
0x0000f749, 0x00000065, /* 00000065 //C 0f749  1984 db	101 */
0x0000f74a, 0x00000067, /* 00000067 //C 0f74a  1984 db	103 */
0x0000f74b, 0x0000005b, /* 0000005b //C 0f74b  1984 db	91 */
0x0000f74c, 0x00000073, /* 00000073 //C 0f74c  1984 db	115 */
0x0000f74d, 0x0000005d, /* 0000005d //C 0f74d  1984 db	93 */
0x0000f74e, 0x0000005d, /* 0000005d //C 0f74e  1984 db	93 */
0x0000f74f, 0x00000020, /* 00000020 //C 0f74f  1984 db	32 */
0x0000f750, 0x00000020, /* 00000020 //C 0f750  1984 db	32 */
0x0000f751, 0x00000020, /* 00000020 //C 0f751  1984 db	32 */
0x0000f752, 0x00000020, /* 00000020 //C 0f752  1984 db	32 */
0x0000f753, 0x00000020, /* 00000020 //C 0f753  1984 db	32 */
0x0000f754, 0x00000020, /* 00000020 //C 0f754  1984 db	32 */
0x0000f755, 0x00000020, /* 00000020 //C 0f755  1984 db	32 */
0x0000f756, 0x00000020, /* 00000020 //C 0f756  1984 db	32 */
0x0000f757, 0x00000020, /* 00000020 //C 0f757  1984 db	32 */
0x0000f758, 0x00000020, /* 00000020 //C 0f758  1984 db	32 */
0x0000f759, 0x00000050, /* 00000050 //C 0f759  1984 db	80 */
0x0000f75a, 0x00000072, /* 00000072 //C 0f75a  1984 db	114 */
0x0000f75b, 0x00000069, /* 00000069 //C 0f75b  1984 db	105 */
0x0000f75c, 0x0000006e, /* 0000006e //C 0f75c  1984 db	110 */
0x0000f75d, 0x00000074, /* 00000074 //C 0f75d  1984 db	116 */
0x0000f75e, 0x00000020, /* 00000020 //C 0f75e  1984 db	32 */
0x0000f75f, 0x00000072, /* 00000072 //C 0f75f  1984 db	114 */
0x0000f760, 0x00000065, /* 00000065 //C 0f760  1984 db	101 */
0x0000f761, 0x00000067, /* 00000067 //C 0f761  1984 db	103 */
0x0000f762, 0x00000069, /* 00000069 //C 0f762  1984 db	105 */
0x0000f763, 0x00000073, /* 00000073 //C 0f763  1984 db	115 */
0x0000f764, 0x00000074, /* 00000074 //C 0f764  1984 db	116 */
0x0000f765, 0x00000065, /* 00000065 //C 0f765  1984 db	101 */
0x0000f766, 0x00000072, /* 00000072 //C 0f766  1984 db	114 */
0x0000f767, 0x00000073, /* 00000073 //C 0f767  1984 db	115 */
0x0000f768, 0x0000000a, /* 0000000a //C 0f768  1984 db	10 */
0x0000f769, 0x00000000, /* 00000000 //C 0f769  1984 db */
0x0000f76a, 0x00000072, /* 00000072 //C 0f76a  1985 db	114 */
0x0000f76b, 0x00000058, /* 00000058 //C 0f76b  1985 db	88 */
0x0000f76c, 0x00000020, /* 00000020 //C 0f76c  1985 db	32 */
0x0000f76d, 0x0000005b, /* 0000005b //C 0f76d  1985 db	91 */
0x0000f76e, 0x00000076, /* 00000076 //C 0f76e  1985 db	118 */
0x0000f76f, 0x00000061, /* 00000061 //C 0f76f  1985 db	97 */
0x0000f770, 0x0000006c, /* 0000006c //C 0f770  1985 db	108 */
0x0000f771, 0x0000005d, /* 0000005d //C 0f771  1985 db	93 */
0x0000f772, 0x00000020, /* 00000020 //C 0f772  1985 db	32 */
0x0000f773, 0x00000020, /* 00000020 //C 0f773  1985 db	32 */
0x0000f774, 0x00000020, /* 00000020 //C 0f774  1985 db	32 */
0x0000f775, 0x00000020, /* 00000020 //C 0f775  1985 db	32 */
0x0000f776, 0x00000020, /* 00000020 //C 0f776  1985 db	32 */
0x0000f777, 0x00000020, /* 00000020 //C 0f777  1985 db	32 */
0x0000f778, 0x00000020, /* 00000020 //C 0f778  1985 db	32 */
0x0000f779, 0x00000020, /* 00000020 //C 0f779  1985 db	32 */
0x0000f77a, 0x00000020, /* 00000020 //C 0f77a  1985 db	32 */
0x0000f77b, 0x00000020, /* 00000020 //C 0f77b  1985 db	32 */
0x0000f77c, 0x00000047, /* 00000047 //C 0f77c  1985 db	71 */
0x0000f77d, 0x00000065, /* 00000065 //C 0f77d  1985 db	101 */
0x0000f77e, 0x00000074, /* 00000074 //C 0f77e  1985 db	116 */
0x0000f77f, 0x0000002f, /* 0000002f //C 0f77f  1985 db	47 */
0x0000f780, 0x00000073, /* 00000073 //C 0f780  1985 db	115 */
0x0000f781, 0x00000065, /* 00000065 //C 0f781  1985 db	101 */
0x0000f782, 0x00000074, /* 00000074 //C 0f782  1985 db	116 */
0x0000f783, 0x00000020, /* 00000020 //C 0f783  1985 db	32 */
0x0000f784, 0x00000052, /* 00000052 //C 0f784  1985 db	82 */
0x0000f785, 0x00000058, /* 00000058 //C 0f785  1985 db	88 */
0x0000f786, 0x0000000a, /* 0000000a //C 0f786  1985 db	10 */
0x0000f787, 0x00000000, /* 00000000 //C 0f787  1985 db */
0x0000f788, 0x00000073, /* 00000073 //C 0f788  1986 db	115 */
0x0000f789, 0x00000070, /* 00000070 //C 0f789  1986 db	112 */
0x0000f78a, 0x00000020, /* 00000020 //C 0f78a  1986 db	32 */
0x0000f78b, 0x0000005b, /* 0000005b //C 0f78b  1986 db	91 */
0x0000f78c, 0x00000076, /* 00000076 //C 0f78c  1986 db	118 */
0x0000f78d, 0x00000061, /* 00000061 //C 0f78d  1986 db	97 */
0x0000f78e, 0x0000006c, /* 0000006c //C 0f78e  1986 db	108 */
0x0000f78f, 0x0000005d, /* 0000005d //C 0f78f  1986 db	93 */
0x0000f790, 0x00000020, /* 00000020 //C 0f790  1986 db	32 */
0x0000f791, 0x00000020, /* 00000020 //C 0f791  1986 db	32 */
0x0000f792, 0x00000020, /* 00000020 //C 0f792  1986 db	32 */
0x0000f793, 0x00000020, /* 00000020 //C 0f793  1986 db	32 */
0x0000f794, 0x00000020, /* 00000020 //C 0f794  1986 db	32 */
0x0000f795, 0x00000020, /* 00000020 //C 0f795  1986 db	32 */
0x0000f796, 0x00000020, /* 00000020 //C 0f796  1986 db	32 */
0x0000f797, 0x00000020, /* 00000020 //C 0f797  1986 db	32 */
0x0000f798, 0x00000020, /* 00000020 //C 0f798  1986 db	32 */
0x0000f799, 0x00000020, /* 00000020 //C 0f799  1986 db	32 */
0x0000f79a, 0x00000047, /* 00000047 //C 0f79a  1986 db	71 */
0x0000f79b, 0x00000065, /* 00000065 //C 0f79b  1986 db	101 */
0x0000f79c, 0x00000074, /* 00000074 //C 0f79c  1986 db	116 */
0x0000f79d, 0x0000002f, /* 0000002f //C 0f79d  1986 db	47 */
0x0000f79e, 0x00000073, /* 00000073 //C 0f79e  1986 db	115 */
0x0000f79f, 0x00000065, /* 00000065 //C 0f79f  1986 db	101 */
0x0000f7a0, 0x00000074, /* 00000074 //C 0f7a0  1986 db	116 */
0x0000f7a1, 0x00000020, /* 00000020 //C 0f7a1  1986 db	32 */
0x0000f7a2, 0x00000052, /* 00000052 //C 0f7a2  1986 db	82 */
0x0000f7a3, 0x00000031, /* 00000031 //C 0f7a3  1986 db	49 */
0x0000f7a4, 0x00000033, /* 00000033 //C 0f7a4  1986 db	51 */
0x0000f7a5, 0x0000000a, /* 0000000a //C 0f7a5  1986 db	10 */
0x0000f7a6, 0x00000000, /* 00000000 //C 0f7a6  1986 db */
0x0000f7a7, 0x0000006c, /* 0000006c //C 0f7a7  1987 db	108 */
0x0000f7a8, 0x00000072, /* 00000072 //C 0f7a8  1987 db	114 */
0x0000f7a9, 0x00000020, /* 00000020 //C 0f7a9  1987 db	32 */
0x0000f7aa, 0x0000005b, /* 0000005b //C 0f7aa  1987 db	91 */
0x0000f7ab, 0x00000076, /* 00000076 //C 0f7ab  1987 db	118 */
0x0000f7ac, 0x00000061, /* 00000061 //C 0f7ac  1987 db	97 */
0x0000f7ad, 0x0000006c, /* 0000006c //C 0f7ad  1987 db	108 */
0x0000f7ae, 0x0000005d, /* 0000005d //C 0f7ae  1987 db	93 */
0x0000f7af, 0x00000020, /* 00000020 //C 0f7af  1987 db	32 */
0x0000f7b0, 0x00000020, /* 00000020 //C 0f7b0  1987 db	32 */
0x0000f7b1, 0x00000020, /* 00000020 //C 0f7b1  1987 db	32 */
0x0000f7b2, 0x00000020, /* 00000020 //C 0f7b2  1987 db	32 */
0x0000f7b3, 0x00000020, /* 00000020 //C 0f7b3  1987 db	32 */
0x0000f7b4, 0x00000020, /* 00000020 //C 0f7b4  1987 db	32 */
0x0000f7b5, 0x00000020, /* 00000020 //C 0f7b5  1987 db	32 */
0x0000f7b6, 0x00000020, /* 00000020 //C 0f7b6  1987 db	32 */
0x0000f7b7, 0x00000020, /* 00000020 //C 0f7b7  1987 db	32 */
0x0000f7b8, 0x00000020, /* 00000020 //C 0f7b8  1987 db	32 */
0x0000f7b9, 0x00000047, /* 00000047 //C 0f7b9  1987 db	71 */
0x0000f7ba, 0x00000065, /* 00000065 //C 0f7ba  1987 db	101 */
0x0000f7bb, 0x00000074, /* 00000074 //C 0f7bb  1987 db	116 */
0x0000f7bc, 0x0000002f, /* 0000002f //C 0f7bc  1987 db	47 */
0x0000f7bd, 0x00000073, /* 00000073 //C 0f7bd  1987 db	115 */
0x0000f7be, 0x00000065, /* 00000065 //C 0f7be  1987 db	101 */
0x0000f7bf, 0x00000074, /* 00000074 //C 0f7bf  1987 db	116 */
0x0000f7c0, 0x00000020, /* 00000020 //C 0f7c0  1987 db	32 */
0x0000f7c1, 0x00000052, /* 00000052 //C 0f7c1  1987 db	82 */
0x0000f7c2, 0x00000031, /* 00000031 //C 0f7c2  1987 db	49 */
0x0000f7c3, 0x00000034, /* 00000034 //C 0f7c3  1987 db	52 */
0x0000f7c4, 0x0000000a, /* 0000000a //C 0f7c4  1987 db	10 */
0x0000f7c5, 0x00000000, /* 00000000 //C 0f7c5  1987 db */
0x0000f7c6, 0x00000070, /* 00000070 //C 0f7c6  1988 db	112 */
0x0000f7c7, 0x00000063, /* 00000063 //C 0f7c7  1988 db	99 */
0x0000f7c8, 0x00000020, /* 00000020 //C 0f7c8  1988 db	32 */
0x0000f7c9, 0x0000005b, /* 0000005b //C 0f7c9  1988 db	91 */
0x0000f7ca, 0x00000076, /* 00000076 //C 0f7ca  1988 db	118 */
0x0000f7cb, 0x00000061, /* 00000061 //C 0f7cb  1988 db	97 */
0x0000f7cc, 0x0000006c, /* 0000006c //C 0f7cc  1988 db	108 */
0x0000f7cd, 0x0000005d, /* 0000005d //C 0f7cd  1988 db	93 */
0x0000f7ce, 0x00000020, /* 00000020 //C 0f7ce  1988 db	32 */
0x0000f7cf, 0x00000020, /* 00000020 //C 0f7cf  1988 db	32 */
0x0000f7d0, 0x00000020, /* 00000020 //C 0f7d0  1988 db	32 */
0x0000f7d1, 0x00000020, /* 00000020 //C 0f7d1  1988 db	32 */
0x0000f7d2, 0x00000020, /* 00000020 //C 0f7d2  1988 db	32 */
0x0000f7d3, 0x00000020, /* 00000020 //C 0f7d3  1988 db	32 */
0x0000f7d4, 0x00000020, /* 00000020 //C 0f7d4  1988 db	32 */
0x0000f7d5, 0x00000020, /* 00000020 //C 0f7d5  1988 db	32 */
0x0000f7d6, 0x00000020, /* 00000020 //C 0f7d6  1988 db	32 */
0x0000f7d7, 0x00000020, /* 00000020 //C 0f7d7  1988 db	32 */
0x0000f7d8, 0x00000047, /* 00000047 //C 0f7d8  1988 db	71 */
0x0000f7d9, 0x00000065, /* 00000065 //C 0f7d9  1988 db	101 */
0x0000f7da, 0x00000074, /* 00000074 //C 0f7da  1988 db	116 */
0x0000f7db, 0x0000002f, /* 0000002f //C 0f7db  1988 db	47 */
0x0000f7dc, 0x00000073, /* 00000073 //C 0f7dc  1988 db	115 */
0x0000f7dd, 0x00000065, /* 00000065 //C 0f7dd  1988 db	101 */
0x0000f7de, 0x00000074, /* 00000074 //C 0f7de  1988 db	116 */
0x0000f7df, 0x00000020, /* 00000020 //C 0f7df  1988 db	32 */
0x0000f7e0, 0x00000052, /* 00000052 //C 0f7e0  1988 db	82 */
0x0000f7e1, 0x00000031, /* 00000031 //C 0f7e1  1988 db	49 */
0x0000f7e2, 0x00000035, /* 00000035 //C 0f7e2  1988 db	53 */
0x0000f7e3, 0x0000000a, /* 0000000a //C 0f7e3  1988 db	10 */
0x0000f7e4, 0x00000000, /* 00000000 //C 0f7e4  1988 db */
0x0000f7e5, 0x00000066, /* 00000066 //C 0f7e5  1989 db	102 */
0x0000f7e6, 0x00000020, /* 00000020 //C 0f7e6  1989 db	32 */
0x0000f7e7, 0x0000005b, /* 0000005b //C 0f7e7  1989 db	91 */
0x0000f7e8, 0x00000076, /* 00000076 //C 0f7e8  1989 db	118 */
0x0000f7e9, 0x00000061, /* 00000061 //C 0f7e9  1989 db	97 */
0x0000f7ea, 0x0000006c, /* 0000006c //C 0f7ea  1989 db	108 */
0x0000f7eb, 0x0000005d, /* 0000005d //C 0f7eb  1989 db	93 */
0x0000f7ec, 0x00000020, /* 00000020 //C 0f7ec  1989 db	32 */
0x0000f7ed, 0x00000020, /* 00000020 //C 0f7ed  1989 db	32 */
0x0000f7ee, 0x00000020, /* 00000020 //C 0f7ee  1989 db	32 */
0x0000f7ef, 0x00000020, /* 00000020 //C 0f7ef  1989 db	32 */
0x0000f7f0, 0x00000020, /* 00000020 //C 0f7f0  1989 db	32 */
0x0000f7f1, 0x00000020, /* 00000020 //C 0f7f1  1989 db	32 */
0x0000f7f2, 0x00000020, /* 00000020 //C 0f7f2  1989 db	32 */
0x0000f7f3, 0x00000020, /* 00000020 //C 0f7f3  1989 db	32 */
0x0000f7f4, 0x00000020, /* 00000020 //C 0f7f4  1989 db	32 */
0x0000f7f5, 0x00000020, /* 00000020 //C 0f7f5  1989 db	32 */
0x0000f7f6, 0x00000020, /* 00000020 //C 0f7f6  1989 db	32 */
0x0000f7f7, 0x00000047, /* 00000047 //C 0f7f7  1989 db	71 */
0x0000f7f8, 0x00000065, /* 00000065 //C 0f7f8  1989 db	101 */
0x0000f7f9, 0x00000074, /* 00000074 //C 0f7f9  1989 db	116 */
0x0000f7fa, 0x0000002f, /* 0000002f //C 0f7fa  1989 db	47 */
0x0000f7fb, 0x00000073, /* 00000073 //C 0f7fb  1989 db	115 */
0x0000f7fc, 0x00000065, /* 00000065 //C 0f7fc  1989 db	101 */
0x0000f7fd, 0x00000074, /* 00000074 //C 0f7fd  1989 db	116 */
0x0000f7fe, 0x00000020, /* 00000020 //C 0f7fe  1989 db	32 */
0x0000f7ff, 0x00000066, /* 00000066 //C 0f7ff  1989 db	102 */
0x0000f800, 0x0000006c, /* 0000006c //C 0f800  1989 db	108 */
0x0000f801, 0x00000061, /* 00000061 //C 0f801  1989 db	97 */
0x0000f802, 0x00000067, /* 00000067 //C 0f802  1989 db	103 */
0x0000f803, 0x00000073, /* 00000073 //C 0f803  1989 db	115 */
0x0000f804, 0x0000000a, /* 0000000a //C 0f804  1989 db	10 */
0x0000f805, 0x00000000, /* 00000000 //C 0f805  1989 db */
0x0000f806, 0x00000068, /* 00000068 //C 0f806  1990 db	104 */
0x0000f807, 0x0000005b, /* 0000005b //C 0f807  1990 db	91 */
0x0000f808, 0x00000065, /* 00000065 //C 0f808  1990 db	101 */
0x0000f809, 0x0000006c, /* 0000006c //C 0f809  1990 db	108 */
0x0000f80a, 0x00000070, /* 00000070 //C 0f80a  1990 db	112 */
0x0000f80b, 0x0000005d, /* 0000005d //C 0f80b  1990 db	93 */
0x0000f80c, 0x0000002c, /* 0000002c //C 0f80c  1990 db	44 */
0x0000f80d, 0x0000003f, /* 0000003f //C 0f80d  1990 db	63 */
0x0000f80e, 0x00000020, /* 00000020 //C 0f80e  1990 db	32 */
0x0000f80f, 0x00000020, /* 00000020 //C 0f80f  1990 db	32 */
0x0000f810, 0x00000020, /* 00000020 //C 0f810  1990 db	32 */
0x0000f811, 0x00000020, /* 00000020 //C 0f811  1990 db	32 */
0x0000f812, 0x00000020, /* 00000020 //C 0f812  1990 db	32 */
0x0000f813, 0x00000020, /* 00000020 //C 0f813  1990 db	32 */
0x0000f814, 0x00000020, /* 00000020 //C 0f814  1990 db	32 */
0x0000f815, 0x00000020, /* 00000020 //C 0f815  1990 db	32 */
0x0000f816, 0x00000020, /* 00000020 //C 0f816  1990 db	32 */
0x0000f817, 0x00000020, /* 00000020 //C 0f817  1990 db	32 */
0x0000f818, 0x00000048, /* 00000048 //C 0f818  1990 db	72 */
0x0000f819, 0x00000065, /* 00000065 //C 0f819  1990 db	101 */
0x0000f81a, 0x0000006c, /* 0000006c //C 0f81a  1990 db	108 */
0x0000f81b, 0x00000070, /* 00000070 //C 0f81b  1990 db	112 */
0x0000f81c, 0x0000000a, /* 0000000a //C 0f81c  1990 db	10 */
0x0000f81d, 0x00000000, /* 00000000 //C 0f81d  1990 db */
0x0000f81e, 0x00000000, /* 00000000 //C 0f81e  1991 dd	0 */
0x0000f81f, 0x00000000, /* 00000000 //C 0f81f  1997 ds	0x40 */
0x0000f85f, 0x00000000, /* 00000000 //C 0f85f  1999 ds	1 */
0x0000f860, 0x00000000, /* 00000000 //C 0f860     3  */
