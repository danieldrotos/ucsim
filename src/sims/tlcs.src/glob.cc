...
struct dis_entry disass_t870c[]=
  {
    ...
    { 0x00004fe8, 0x0000fff8, ' ', 0, "-- INVALID" },
    { 0x00007fe8, 0x0000fff8, ' ', 0, "-- INVALID" },
    { 0x0000dfe8, 0x0000fff8, ' ', 0, "-- INVALID" },
    { 0x0000f8e8, 0x0000fff8, ' ', 0, "-- INVALID" },
    { 0x0000f9e8, 0x0000fff8, ' ', 0, "-- INVALID" },
    { 0x0000fce8, 0x0000fff8, ' ', 0, "-- INVALID" },

    { 0x00000001, 0x000000ff, ' ', 0, "-- INVALID" },
    { 0x00000002, 0x000000ff, ' ', 0, "-- INVALID" },
    { 0x00000003, 0x000000ff, ' ', 0, "-- INVALID" },
    { 0x000000f8, 0x000000ff, ' ', 0, "-- INVALID" },
    { 0x00000068, 0x000000f8, ' ', 0, "-- INVALID" },
